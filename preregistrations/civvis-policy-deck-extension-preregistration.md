# ⚠ SUPERSEDED 2026-07-31 — see civvis-policy-deck-600-corrected-preregistration.md

This plan pools the recorded 300-map prefix into a 600-map extension. That is
invalid: the recorded 300 were measured on a superseded agent (#686, #697,
#708 and an Elo protocol bump to v3 have landed since), so the two halves
would be two different agents inside one interval. The replacement runs a
fresh, whole 600 on the current tip at the same seed.
