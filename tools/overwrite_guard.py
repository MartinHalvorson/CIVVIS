...
"deleting 2036 lines from #2335", a pull request it had never touched. The
workflow already passes the merge base, and the merge base of a merge base and
...
#: deliberate difference between the two, and the reason is the indented-block
#: fixture in `test_overwrite_guard.py`.)
