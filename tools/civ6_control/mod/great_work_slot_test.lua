...
-- Under the stubbed GameInfo the individual table is unreadable, so the class
-- fallback answers — which is exactly the path a DLC person takes live.
local writer = gw.objectsFor(nil, "GREAT_PERSON_CLASS_WRITER")
