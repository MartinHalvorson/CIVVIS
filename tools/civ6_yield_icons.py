...
rather than imitated:
    ...
    ~/Library/Application Support/Steam/steamapps/common/Sid Meier's \\
      Civilization VI/Civ6.app/Contents/Assets/Base/Platforms/Windows/BLPs/ \\
      SHARED_DATA/TEXTURE_YieldOverlayAtlas
...
CIV6_ASSETS = os.path.expanduser(
    "~/Library/Application Support/Steam/steamapps/common/"
    "Sid Meier's Civilization VI/Civ6.app/Contents/Assets")
YIELD_OVERLAY = os.path.join(
    CIV6_ASSETS, "Base/Platforms/Windows/BLPs/SHARED_DATA",
    "TEXTURE_YieldOverlayAtlas")
...
def main(destination):
    data, width, height = decode_civbig(YIELD_OVERLAY)
