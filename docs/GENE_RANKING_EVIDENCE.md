...
| `barbarian-bargain` | +16 [-5, +38] | 93.3% | off | +16.4 | 32,522 |
...
```sh
gene_screen --genes holy-lane-parity,settler-threat-detour,camp-party,war-reinforcement,barbarian-bargain,unit-cost-efficiency
```
