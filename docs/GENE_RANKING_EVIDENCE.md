...
| `conversion-majority-alarm-2` | off (unmeasured) | Read each rival civilization's progress toward its own majority, then average those equal shares. | 1 \| 2 |
