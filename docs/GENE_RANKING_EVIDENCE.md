...
| `engine-faith-price` | +63 [+25, +101] | 99.9% | 1 | off | **on** |
...
```sh
gene_screen --genes holy-lane-parity,unit-cost-efficiency,war-reinforcement,settler-threat-detour,barbarian-bargain,camp-party
```
...
| `detour-keeps-the-site-worth` | off (unmeasured) | A threat detour refuses a fallback worth less than `SETTLER_DETOUR_VALUE_FLOOR` of the site it defers. | 1 \| 1 |
