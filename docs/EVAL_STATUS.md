...
|---|---:|
| Built-in agents | 8 |
| Evaluator-only agents | 234 |
| Live-bridge treatments | 87 |
| Firaxis-only treatments | 29 |
| Native engine-repair treatments | 58 |
| Withholdable live treatments | 58 |
