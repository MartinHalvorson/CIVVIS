...
## v19 (2026-08-24) — the modifier catalog is imported and four rows change the ruleset
...
- Jakob Fugger awards the two Envoys his row grants;
...
the anchor. The anchor moves from v18's 18,596 decisions and
`0xf78a_2b10_c0e3_5945` to **18,400 and `0x0a41_d781_b45b_b3ae`** across its
five profiles.
