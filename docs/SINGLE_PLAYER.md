...
value to a player. What is left is the city screen: production is a flat
dropdown, a treasury can buy a unit but not a building or a district, and
where a district goes is picked out of that same list.
