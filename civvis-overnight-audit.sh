...
BASE=$HOME
OPS_DIR=${CIVVIS_OPS_DIR:-$BASE/CIVVIS/tools/ops}
RUNS=$BASE/civvis-civ6-runs/control
PLAY_LOGS=$BASE/civvis-climb-logs
AUDIT_LOG=$BASE/civvis-civ6-runs/overnight_audit.log
HOST_LAUNCHER=${CIVVIS_HOST_LAUNCHER:-$OPS_DIR/civvis-ladder-terminal-launcher.sh}
MIRROR_KEEPER=${CIVVIS_MIRROR_KEEPER:-$OPS_DIR/civvis-mirror-keeper.sh}
