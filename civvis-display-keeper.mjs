...
const profile = "/Users/martin/civvis-display-profile";
const pollMs = 5_000;
...
async function tick() {
  ...
  try {
    ...
    try {
      ...
      // A follower intentionally frees :8610 between batches.  Do not create
      // a replacement browser or call into a process while the source is absent.
      unhealthySince = null;
      return;
    }
