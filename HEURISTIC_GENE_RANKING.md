...
| 9 | `war-economy` | Send an adaptive Conquest plan through the war production path. | **on** | +38 | +8 | 16.28% (n=46,020) | 17.06% (n=46,020) | -0.78% | -0.31% ±0.40% | -0.82% ±0.62% |
...
| 28 | `apostle-promotion-by-role` | Promote an Apostle for the job the empire has rather than for the largest number on the card. | **on** | +14 | +12 | 16.64% (n=46,020) | 16.70% (n=46,020) | -0.06% | +0.13% ±0.33% | +0.19% ±0.58% |
...
| 47 | `siege-commitment` | Keep a live campaign pointed at its chosen city. | **on** | +1 | +3 | 16.56% (n=46,020) | 16.77% (n=46,020) | -0.21% | -0.25% ±0.33% | -0.20% ±0.57% |
