...
|---:|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 1 | `solvency-first-trade-slot` | Reserve the first empty trade route slot ahead of ordinary production in any city that can start a safe route. | 1 | **on** | +144 | – | – | 22.85% (n=1,046) | 14.78% (n=3,430) | 8.07% | +403 [+265, +541] | 100.0% | +2.08 (z +7.93) helps * | +2.60% ±1.00% | +2.66% ±1.40% |
| 2 | `settler-factory-coordination` | Give early Settler pipeline slots to cities that finish fastest and hold distinct reachable claim sites. | 1 | **on** | +35 | – | – | 18.03% (n=1,148) | 16.20% (n=3,328) | 1.84% | +92 [-37, +220] | 91.9% | +0.32 (z +1.28) ~ | +1.56% ±0.91% | +2.58% ±1.30% |
| 3 | `air-surge` | Beeline Advanced Flight, build an Aerodrome and bombers, and take the appointed city with cavalry behind them. | 1 | **on** | +3 | +30 | +25 | 17.31% (n=63,265) | 15.56% (n=36,869) | 1.76% | +95 [+72, +118] | 100.0% | +0.09 (z +0.33) ~ | +0.63% ±0.71% | +0.57% ±0.97% |
| 4 | `great-person-housing` | Reserve a city to build whatever unblocks an earned Great Person, selling duplicate works to make room. | 1 | **on** | +29 | +29 | +52 | 17.31% (n=80,785) | 15.72% (n=54,497) | 1.59% | +85 [+65, +105] | 100.0% | +0.38 (z +1.52) ~ | -0.11% ±0.75% | +0.02% ±1.05% |
| 5 | `wide-map-capacity` | Price the city ceiling off the passable land actually visible, at one city per 45 tiles, capped at twelve. | 1 | **on** | +16 | +41 | +23 | 17.19% (n=109,368) | 15.98% (n=82,806) | 1.20% | +62 [+35, +90] | 100.0% | +0.51 (z +1.95) ~ | +0.21% ±0.73% | -0.07% ±1.06% |
| 6 | `engine-faith-price` | Read Faith purchase prices from the engine at the game's speed and discounts, instead of a Standard-speed literal. | 1 | **on** | +51 | +28 | -20 | 17.17% (n=30,196) | 16.00% (n=22,694) | 1.17% | +62 [+10, +114] | 99.0% | -0.43 (z -1.54) ~ | -0.63% ±0.75% | -1.21% ±1.09% |
| 7 | `raid-pillage-prizes` | Count a neighbour's unpillaged improvements within reach as raid prizes and send raiders to pillage them. | 1 | **on** | +47 | +11 | +35 | 17.09% (n=80,814) | 16.04% (n=54,468) | 1.05% | +56 [+33, +78] | 100.0% | +0.40 (z +1.56) ~ | -1.33% ±0.70% | -1.54% ±1.07% |
| 8 | `one-war-at-a-time` | Fight one campaign front at a time, seeking peace with every other major and once the front turns against us. | 1 | **on** | +16 | +21 | – | 17.41% (n=2,630) | 16.42% (n=7,834) | 1.00% | +50 [-32, +132] | 88.4% | -0.13 (z -0.59) ~ | +0.14% ±0.87% | +0.79% ±1.14% |
| 9 | `recon-replacement` | Rebuild the recon arm when every scout is gone and unexplored ground remains to chart. | 1 | **on** | +3 | +35 | +27 | 17.08% (n=109,387) | 16.12% (n=82,787) | 0.96% | +51 [+34, +67] | 100.0% | +0.14 (z +0.55) ~ | +1.74% ±0.78% | +1.17% ±1.05% |
| 10 | `opportunistic-war` | Open a surprise war on a neighbour whose Settlers, Builders or tiles lie exposed nearby, then sue for peace. | 1 | **on** | +16 | +35 | +23 | 17.04% (n=80,822) | 16.11% (n=54,460) | 0.93% | +49 [+29, +69] | 100.0% | +0.50 (z +1.87) ~ | +0.21% ±0.78% | -0.05% ±1.14% |
| 11 | `religious-veto-defence` | Scale religious defence with a rival's progress toward religious victory, and walk the Inquisitor to the heresy. | 1 | **on** | +31 | +8 | – | 17.36% (n=2,685) | 16.43% (n=7,779) | 0.93% | +46 [-36, +129] | 86.5% | +0.56 (z +2.46) helps * | +1.25% ±0.87% | +2.13% ±1.12% |
| 12 | `price-the-suzerainty` | Credit the envoy scorer with the resources, bonuses and points a suzerainty pays, amortised over envoys still needed. | 1 | **on** | +7 | -1 | +8 | 17.04% (n=30,329) | 16.17% (n=22,561) | 0.87% | +46 [+13, +79] | 99.7% | +0.03 (z +0.09) ~ | -0.12% ±0.79% | -0.36% ±1.14% |
| 13 | `maintenance-aware-deck` | Subtract the unit-maintenance bill inside the policy counterfactual so maintenance-discount cards score above zero. | 1 | **on** | +15 | -22 | -2 | 17.03% (n=30,097) | 16.18% (n=22,793) | 0.85% | +24 [-34, +82] | 79.1% | +0.29 (z +1.07) ~ | +0.25% ±0.73% | -0.74% ±1.06% |
| 14 | `loyalty-rate-alarm` | Rank loyalty emergencies by turns until the city flips rather than by its current loyalty level. | 1 | **on** | -3 | +18 | +11 | 16.98% (n=109,141) | 16.25% (n=83,033) | 0.73% | +39 [+23, +55] | 100.0% | +0.37 (z +1.38) ~ | -0.85% ±0.86% | -1.60% ±1.17% |
| 15 | `settle-sooner` | Price a Settler's walk per turn, rising the longer it has walked, so it settles sooner. | 1 | **on** | +2 | -3 | +56 | 16.93% (n=81,054) | 16.27% (n=54,228) | 0.66% | +35 [+16, +55] | 100.0% | +0.69 (z +2.68) helps * | -0.44% ±0.72% | -0.52% ±1.03% |
| 16 | `escort-unstick` | Release a settler's linked escort after two turns without progress so the settler marches on by itself. | 1 | **on** | +8 | +46 | -25 | 17.00% (n=95,565) | 16.34% (n=96,609) | 0.66% | +31 [+8, +54] | 99.6% | +0.11 (z +0.46) ~ | -0.01% ±0.81% | -0.17% ±1.19% |
| 17 | `bounded-recovery` | Let the defensive Recovery posture expire after a turn limit instead of trapping the empire in it permanently. | 1 | **on** | +13 | -14 | +8 | 16.91% (n=109,248) | 16.35% (n=82,926) | 0.56% | +29 [+13, +46] | 100.0% | -0.38 (z -1.42) ~ | +0.18% ±0.77% | +0.80% ±1.14% |
| 18 | `barbarian-scouts-are-scouts` | Stop pricing a barbarian Scout as a threat, since it never attacks or captures; settlers and scouts ignore it. | 1 | **on** | +40 | +25 | -15 | 16.91% (n=109,366) | 16.35% (n=82,808) | 0.56% | +31 [+11, +52] | 99.8% | -0.06 (z -0.22) ~ | -0.55% ±0.69% | -0.79% ±1.02% |
| 19 | `buildings-before-projects` | Make a repeatable district project wait behind the science and production buildings the city can already build. | 1 | **on** | -12 | +4 | +27 | 16.90% (n=109,505) | 16.36% (n=82,669) | 0.55% | +28 [+8, +47] | 99.8% | +0.40 (z +1.47) ~ | -0.11% ±0.76% | -0.47% ±1.09% |
| 20 | `holy-lane-parity` | Price the Religion lane's Holy Site at what the Culture lane pays for its Theater Square. | 1 | **on** | -15 | +18 | -47 | 16.89% (n=94,083) | 16.36% (n=67,599) | 0.53% | +20 [-16, +57] | 86.3% | -0.19 (z -0.70) ~ | -0.12% ±0.75% | -0.19% ±1.14% |
| 21 | `war-economy` | Route an adaptive plan that switched to Conquest through the war production path instead of the basic governor. | 1 | **on** | -4 | -12 | +41 | 16.89% (n=109,448) | 16.38% (n=82,726) | 0.51% | +16 [-65, +96] | 64.9% | +1.00 (z +3.93) helps * | +1.98% ±0.76% | +2.21% ±1.13% |
| 22 | `missionary-last-charge-explores` | Let a Missionary on its last charge explore nearby fog for a few turns before spending it. | 1 | **on** | +3 | +20 | +12 | 16.93% (n=7,031) | 16.43% (n=7,699) | 0.49% | +30 [-37, +96] | 80.7% | -0.22 (z -1.01) ~ | -0.37% ±0.60% | +0.23% ±0.85% |
| 23 | `culture-building-debt` | Make a Theater Square owe its Amphitheater, Museum and Broadcast Center the way a Campus owes its buildings. | 1 | **on** | +25 | -1 | +12 | 16.85% (n=63,275) | 16.36% (n=36,859) | 0.49% | +26 [+3, +50] | 98.5% | +0.26 (z +1.01) ~ | +0.43% ±0.77% | -0.23% ±1.16% |
| 24 | `settler-threat-detour` | Send a Settler to the best safe alternative site when a visible threat blocks its route. | 1 | **on** | +19 | +5 | +6 | 16.85% (n=80,994) | 16.40% (n=54,288) | 0.45% | +25 [+5, +45] | 99.3% | +0.20 (z +0.70) ~ | +2.59% ±0.78% | +3.28% ±1.21% |
| 25 | `idle-faith-patronage` | Let a seat with no religion and 600+ banked Faith patronize Great People whatever the points shortfall. | 1 | **on** | -18 | -7 | -4 | 16.84% (n=86,878) | 16.42% (n=60,404) | 0.42% | +24 [+10, +38] | 100.0% | -0.08 (z -0.29) ~ | +0.68% ±0.79% | +0.93% ±1.15% |
| 26 | `promote-when-wounded` | Defer a unit's promotion until it is wounded enough to use the promotion's heal instead of wasting it. | 1 | **on** | +49 | +38 | -10 | 16.85% (n=30,161) | 16.43% (n=22,729) | 0.42% | +43 [-21, +108] | 90.5% | -0.04 (z -0.17) ~ | +0.92% ±0.77% | +1.34% ±1.12% |
| 27 | `settlement-gap-target` | Make the settlement-gap redirect and the Settler ranking read the same city target as the baseline cascade. | 1 | **on** | +17 | +11 | +29 | 16.87% (n=26,048) | 16.47% (n=26,842) | 0.41% | +21 [-11, +54] | 90.3% | +0.35 (z +1.60) ~ | +1.10% ±0.65% | +2.13% ±0.93% |
| 28 | `recorded-tactical-step` | Record each tactical step so a unit moved twice in one turn cannot return to the tile it just left. | 1 | **on** | +36 | +38 | +22 | 16.84% (n=109,258) | 16.44% (n=82,916) | 0.40% | +21 [+5, +37] | 99.4% | -0.15 (z -0.54) ~ | +0.56% ±0.81% | +1.31% ±1.17% |
| 29 | `score-horizon` | Skip a space race or Manhattan Project that cannot finish before the turn limit ends the game. | 1 | **on** | +8 | +30 | +28 | 16.83% (n=109,284) | 16.46% (n=82,890) | 0.37% | +19 [+3, +36] | 99.0% | +0.63 (z +2.27) helps * | +0.70% ±0.80% | +1.17% ±1.11% |
| 30 | `barbarian-bargain` | Price a fight against a barbarian below a fight against a major, since barbarians carry no war costs. | 1 | **on** | +3 | +24 | +17 | 16.81% (n=80,860) | 16.45% (n=54,422) | 0.36% | +18 [-1, +38] | 96.5% | +0.36 (z +1.35) ~ | -0.06% ±0.75% | +0.04% ±1.06% |
| 31 | `camp-party` | In peacetime let the whole army answer home threats, ranking a nearby barbarian camp above countryside raiders. | 1 | **on** | -30 | +20 | -8 | 16.84% (n=99,742) | 16.48% (n=92,432) | 0.36% | +19 [-4, +42] | 94.6% | -0.40 (z -1.51) ~ | -0.58% ±0.70% | -0.30% ±1.01% |
| 32 | `competition-victory-points` | Price first place in a scored competition by the Diplomatic Victory Points it pays. | 1 | **on** | +17 | +26 | -7 | 16.83% (n=53,713) | 16.48% (n=46,421) | 0.34% | +17 [-6, +39] | 92.4% | -0.08 (z -0.30) ~ | +0.24% ±0.78% | +0.97% ±1.13% |
| 33 | `peacetime-deterrence` | Let the strongest met major raise the army target in peacetime, so deterrence exists before any declaration. | 1 | **on** | -47 | +26 | -5 | 16.80% (n=109,183) | 16.49% (n=82,991) | 0.31% | +16 [-3, +35] | 95.3% | -0.00 (z -0.01) ~ | -0.61% ±0.82% | -0.66% ±1.21% |
| 34 | `unit-cost-efficiency` | Credit strength per production and the civilization's own unique unit when pricing military production. | 1 | **on** | +9 | +1 | -4 | 16.79% (n=30,018) | 16.51% (n=22,872) | 0.28% | +15 [-18, +48] | 80.6% | +0.23 (z +0.90) ~ | -0.43% ±0.66% | -0.55% ±0.93% |
| 35 | `slot-kind-tiebreak` | Break a production cost tie between museums by which great-work slots the empire can actually fill. | 1 | **on** | +10 | +17 | +59 | 16.80% (n=99,723) | 16.53% (n=92,451) | 0.27% | +15 [-4, +34] | 93.7% | +0.22 (z +0.81) ~ | -0.76% ±0.67% | -0.64% ±0.95% |
| 36 | `pantheon-board` | Choose the pantheon by what it would pay on the tiles the empire owns, not from a fixed order. | 1 | off | -37 | +83 | -19 | 16.82% (n=23,715) | 16.54% (n=29,175) | 0.27% | +21 [-86, +128] | 65.1% | +0.02 (z +0.07) ~ | -0.34% ±0.65% | -0.87% ±0.93% |
| 37 | `founder-temple` | Have a founder outside the Religion lane still build the Shrine and Temple an Apostle needs. | 1 | **on** | -15 | +36 | -51 | 16.78% (n=87,117) | 16.51% (n=60,165) | 0.27% | +17 [-10, +45] | 89.6% | -0.39 (z -1.44) ~ | -0.07% ±0.78% | -0.14% ±1.09% |
| 38 | `flip-nearby-city-states` | Add a city-state's proximity and hostile suzerain to the envoy score, amortised over envoys the flip needs. | 1 | off | +15 | -3 | – | 16.87% (n=2,531) | 16.60% (n=7,933) | 0.27% | +14 [-71, +98] | 62.5% | +0.01 (z +0.04) ~ | +0.96% ±0.93% | +1.35% ±1.22% |
| 39 | `war-reinforcement` | Keep marching newly built rear units to the campaign objective after war is declared, not only before. | 1 | **on** | +15 | -37 | -10 | 16.78% (n=109,330) | 16.52% (n=82,844) | 0.26% | +12 [-10, +34] | 85.9% | -0.64 (z -2.33) hurts * | +0.26% ±0.85% | -0.03% ±1.23% |
| 40 | `one-launch-pad` | Let only one city at a time claim the 3,000-point first Spaceport bonus, instead of every city at once. | 1 | **on** | -12 | +21 | +28 | 16.79% (n=99,835) | 16.53% (n=92,339) | 0.26% | +13 [-3, +28] | 94.2% | +0.00 (z +0.01) ~ | +0.27% ±0.79% | +0.59% ±1.18% |
| 41 | `strike-opening` | Credit a movement tile for the attack it opens next, not only charge it for the threat it accepts. | 1 | **on** | +16 | +22 | -10 | 16.77% (n=109,320) | 16.53% (n=82,854) | 0.25% | +13 [-3, +29] | 94.6% | +0.28 (z +1.03) ~ | +0.18% ±0.69% | -0.23% ±0.95% |
| 42 | `wonder-score-tally` | Let any civilization build wonders on merit by pricing the fifteen score points a finished wonder pays. | 1 | off | +1 | +3 | +13 | 16.83% (n=4,754) | 16.59% (n=9,976) | 0.24% | +13 [-53, +79] | 64.7% | +0.30 (z +1.27) ~ | +0.13% ±0.65% | +0.20% ±0.97% |
| 43 | `stranded-settler-discount` | Discount a Settler that has stopped walking from the expansion gate, and found where it stands when stalled. | 1 | off | -3 | +19 | -3 | 16.79% (n=93,484) | 16.55% (n=98,690) | 0.23% | +11 [-5, +27] | 91.6% | +0.18 (z +0.80) ~ | +0.54% ±0.64% | +0.58% ±0.91% |
| 44 | `science-multiplier-payoff` | Credit a Campus building the science its city's multipliers will actually pay, not its raw spec yield. | 1 | **on** | +53 | +1 | +20 | 16.78% (n=49,768) | 16.55% (n=50,366) | 0.23% | +18 [-16, +52] | 84.8% | -0.15 (z -0.69) ~ | +0.18% ±0.72% | +0.72% ±1.03% |
| 45 | `barbarian-ranged-answer` | Build a ranged defender, not a melee one, when the barbarian ring around a city is mostly shooters. | 1 | off | +34 | +15 | -9 | 16.77% (n=74,439) | 16.54% (n=60,843) | 0.23% | +13 [-7, +33] | 89.9% | -0.16 (z -0.68) ~ | -0.81% ±0.70% | -1.09% ±0.93% |
| 46 | `relief-targets-the-siege` | Send a relief force at the besiegers actually damaging the city, not the enemy nearest the force. | 1 | **on** | +17 | +11 | +22 | 16.77% (n=109,351) | 16.54% (n=82,823) | 0.23% | +12 [-5, +28] | 91.9% | -0.06 (z -0.24) ~ | -1.14% ±0.78% | -1.59% ±1.05% |
| 47 | `whole-turn-backtrack-guard` | Refuse any step onto a tile the unit already stood on this turn, closing three-hop loops too. | 1 | off | +5 | +11 | +6 | 16.77% (n=103,069) | 16.55% (n=89,105) | 0.22% | +12 [-4, +28] | 92.9% | -0.10 (z -0.48) ~ | +0.18% ±0.61% | +0.20% ±0.94% |
| 48 | `district-planning` | Plan a city's districts, their plots and tile purchases jointly, reserving plots in rings one to three. | 1 | **on** | -30 | +8 | +33 | 16.78% (n=26,056) | 16.56% (n=26,834) | 0.21% | +11 [-21, +44] | 75.0% | +0.24 (z +1.06) ~ | -0.21% ±0.69% | -0.60% ±0.99% |
| 49 | `amenity-district-path` | Price an amenity district by the building it will hold, and a regional amenity building by every city it reaches. | 1 | **on** | +17 | -3 | -7 | 16.76% (n=109,149) | 16.55% (n=83,025) | 0.21% | +11 [-5, +27] | 91.1% | -0.00 (z -0.00) ~ | +0.14% ±0.74% | +0.16% ±1.05% |
| 50 | `religion-sues-peace` | Have a Religion strategy offer peace to every at-war major so its missionaries can reach their cities. | 1 | **on** | +8 | +30 | +54 | 16.77% (n=99,651) | 16.56% (n=92,523) | 0.21% | +15 [-7, +37] | 91.2% | +0.27 (z +1.07) ~ | -0.45% ±0.77% | -0.30% ±1.06% |
| 51 | `lane-culture-spending` | Run the Culture lane's Faith purchases, Naturalists and Rock Bands, for an empire racing Culture under an Expansion plan. | 1 | **on** | -7 | +25 | +2 | 16.76% (n=53,674) | 16.56% (n=46,460) | 0.20% | +10 [-12, +33] | 81.1% | +0.04 (z +0.15) ~ | +0.69% ±0.77% | +0.67% ±1.16% |
| 52 | `strategic-wonders` | Price a wonder's effects in the victory lane's currency and build the ones that lane needs. | 1 | off | -13 | +32 | +9 | 16.77% (n=93,545) | 16.57% (n=98,629) | 0.19% | +10 [-6, +26] | 88.9% | -0.25 (z -1.10) ~ | -0.27% ±0.65% | -0.55% ±0.94% |
| 53 | `blind-objective-strength` | Price a fogged objective city from its last sighting instead of treating unseen ground as empty. | 1 | off | +68 | -41 | +9 | 16.77% (n=93,198) | 16.57% (n=98,976) | 0.19% | +12 [-16, +40] | 79.6% | +0.31 (z +1.37) ~ | -0.38% ±0.60% | -0.97% ±0.83% |
| 54 | `lane-policy-deck` | Choose policy cards for the victory the empire is racing while its plan is still Expansion. | 1 | **on** | -16 | -11 | +5 | 16.76% (n=49,871) | 16.58% (n=50,263) | 0.18% | +8 [-14, +31] | 77.1% | -0.04 (z -0.19) ~ | -0.99% ±0.75% | -1.09% ±1.03% |
| 55 | `apostle-promotion-by-role` | Promote an Apostle for the job the empire needs rather than the largest number on the card. | 1 | **on** | -4 | +67 | -29 | 16.74% (n=109,425) | 16.56% (n=82,749) | 0.18% | +12 [-18, +41] | 78.0% | -0.14 (z -0.51) ~ | +0.41% ±0.73% | +0.75% ±1.05% |
| 56 | `religious-units-heal-first` | Let a wounded spreader in its own Holy Site's heal ring hold and heal instead of spending a weak charge. | 1 | **on** | +14 | +24 | -33 | 16.75% (n=53,567) | 16.57% (n=46,567) | 0.18% | +10 [-12, +32] | 80.5% | -0.74 (z -2.68) hurts * | -0.65% ±0.78% | -0.37% ±1.13% |
| 57 | `garrison-under-fire` | Treat a city that is losing hitpoints as besieged even when fog hides every attacker. | 1 | off | -29 | +3 | -29 | 16.75% (n=93,426) | 16.59% (n=98,748) | 0.17% | +7 [-22, +36] | 67.6% | -0.23 (z -1.03) ~ | -0.16% ±0.65% | -0.40% ±0.95% |
| 58 | `settler-guard-holds` | Count a stacked guard as protection only when it can hold, and make it stay with its settler. | 1 | off | +22 | +36 | +26 | 16.75% (n=93,330) | 16.59% (n=98,844) | 0.16% | +7 [-9, +23] | 80.8% | +0.48 (z +2.08) helps * | -0.66% ±0.65% | -0.94% ±0.99% |
| 59 | `come-ashore` | Keep land units out of the water: no water exploration goals, and disembark units already at sea. | 1 | off | +26 | +38 | -28 | 16.74% (n=102,963) | 16.58% (n=89,211) | 0.16% | +9 [-10, +28] | 82.6% | +0.07 (z +0.29) ~ | +0.05% ±0.64% | -0.06% ±0.93% |
| 60 | `lane-great-people` | Rank Great Person classes and project points by the victory the empire is racing, even during a war. | 1 | **on** | -11 | +1 | -28 | 16.74% (n=53,652) | 16.58% (n=46,482) | 0.16% | +7 [-16, +30] | 72.7% | -0.03 (z -0.12) ~ | +0.47% ±0.74% | +0.44% ±1.13% |
| 61 | `early-contact-window` | Buy the second and third Scout early, before Early Empire closes borders and city-states become unreachable. | 1 | **on** | -11 | +14 | -4 | 16.74% (n=53,593) | 16.59% (n=46,541) | 0.15% | +7 [-15, +30] | 73.9% | -0.14 (z -0.54) ~ | +1.40% ±0.72% | +1.31% ±1.06% |
| 62 | `pillage-to-heal` | Let a unit at or below 65 health pillage a healing improvement on or beside its tile before retreating. | 1 | off | +36 | -23 | – | 16.77% (n=2,677) | 16.63% (n=7,787) | 0.14% | +15 [-137, +167] | 57.5% | +0.02 (z +0.11) ~ | +0.75% ±0.90% | +1.68% ±1.19% |
| 63 | `research-tier-premium` | Scale a missing Campus building's debt by its own science yield, so Universities and Labs outrank Libraries. | 1 | off | -4 | +10 | -28 | 16.74% (n=47,572) | 16.60% (n=52,562) | 0.13% | +6 [-17, +28] | 69.1% | +0.09 (z +0.36) ~ | -0.87% ±0.60% | -1.25% ±0.85% |
| 64 | `inquisition-on-threat` | Let a founder under conversion pressure buy one Apostle to launch the Inquisition after its Missionaries. | 1 | **on** | -6 | +19 | -14 | 16.72% (n=86,856) | 16.59% (n=60,426) | 0.13% | +9 [-9, +27] | 83.7% | +0.39 (z +1.46) ~ | -0.98% ±0.73% | -1.16% ±1.02% |
| 65 | `unit-objective-memory` | Let a unit remember its campaign objective, dangerous approaches and a short retreat commitment across turns. | 1 | **on** | +16 | -18 | +1 | 16.72% (n=30,014) | 16.60% (n=22,876) | 0.12% | +6 [-27, +39] | 64.9% | -0.19 (z -0.71) ~ | +0.85% ±0.75% | +1.14% ±1.10% |
| 66 | `enhancer-for-the-corps` | Choose the enhancer beliefs that multiply religious spread while the corps has a job to do. | 1 | off | -10 | +35 | +6 | 16.73% (n=47,375) | 16.61% (n=52,759) | 0.11% | +6 [-17, +28] | 69.4% | -0.06 (z -0.25) ~ | -0.02% ±0.64% | +0.04% ±0.93% |
| 67 | `campus-adjacency-threshold` | Credit a Campus plot that reaches the Rationalism adjacency threshold with the science bonus crossing it unlocks. | 1 | off | +34 | +33 | -14 | 16.72% (n=47,363) | 16.62% (n=52,771) | 0.11% | +12 [-24, +49] | 74.5% | +0.13 (z +0.56) ~ | -0.74% ±0.62% | -1.30% ±0.90% |
| 68 | `missionary-evades-raiders` | Keep religious units out of every tile a visible barbarian raider can reach next turn. | 1 | **on** | -12 | -6 | +30 | 16.72% (n=6,961) | 16.62% (n=7,769) | 0.10% | +6 [-61, +72] | 56.6% | +0.38 (z +1.65) ~ | +1.01% ±0.63% | +0.63% ±0.84% |
| 69 | `power-the-laboratory` | Credit a power plant the powered yields it switches on, above all the Research Lab's extra science. | 1 | off | +10 | +12 | +15 | 16.72% (n=47,534) | 16.62% (n=52,600) | 0.10% | +4 [-18, +26] | 63.2% | +0.16 (z +0.69) ~ | +1.12% ±0.72% | +1.09% ±1.05% |
| 70 | `army-target-weighs-enemy` | Raise the wartime army target when the enemy outweighs us, instead of counting only our own cities. | 1 | off | -35 | +30 | +2 | 16.71% (n=103,009) | 16.62% (n=89,165) | 0.10% | +4 [-17, +25] | 64.7% | -0.00 (z -0.01) ~ | +0.74% ±0.75% | +1.06% ±0.96% |
| 71 | `lane-space-race` | Open the Spaceport and launch pass for an empire racing Science even while its plan is still Expansion. | 1 | off | +53 | +8 | -15 | 16.72% (n=47,588) | 16.62% (n=52,546) | 0.09% | +7 [-24, +39] | 67.6% | -0.12 (z -0.51) ~ | +0.46% ±0.70% | +0.47% ±1.01% |
| 72 | `settler-target-hysteresis` | Keep a settler target dropped for danger out of the ranking for several turns instead of re-picking it immediately. | 1 | off | -10 | +39 | +39 | 16.71% (n=93,500) | 16.63% (n=98,674) | 0.08% | +4 [-13, +22] | 68.9% | +0.17 (z +0.75) ~ | +0.23% ±0.70% | -0.09% ±1.00% |
| 73 | `amenity-project-preemption` | In a severe empire-wide Amenity crisis, pause one repeatable project for the amenity repair chain and slot Liberalism. | 1 | off | +67 | +24 | +3 | 16.70% (n=93,495) | 16.64% (n=98,679) | 0.06% | +11 [-18, +40] | 77.2% | +0.05 (z +0.21) ~ | +0.18% ±0.65% | -0.27% ±0.99% |
| 74 | `coordinated-finish` | Let a force finish a defender together with a friendly volley, without reopening the closed war-half bundle. | 1 | off | -17 | +41 | -22 | 16.70% (n=23,833) | 16.64% (n=29,057) | 0.05% | +5 [-51, +62] | 56.9% | -0.37 (z -1.63) ~ | +0.38% ±0.66% | +0.37% ±0.88% |
| 75 | `district-coverage` | Rank each district family by how much of the empire still lacks it, so Theater Squares get built. | 1 | off | +13 | -26 | +34 | 16.68% (n=93,412) | 16.66% (n=98,762) | 0.02% | +1 [-19, +20] | 53.3% | +0.44 (z +1.90) ~ | +0.22% ±0.68% | +0.30% ±0.99% |
| 76 | `blind-objective-units` | Price the enemy units remembered near an unseen objective instead of reading a fogged approach as empty. | 1 | off | +31 | +21 | -62 | 16.67% (n=93,299) | 16.66% (n=98,875) | 0.01% | +0 [-16, +17] | 51.5% | -0.39 (z -1.64) ~ | +0.54% ±0.65% | +0.22% ±0.87% |
| 77 | `shoot-and-scoot` | Let a ranged unit inside melee reach step to a safer firing tile and shoot the threatening body. | 1 | off | -15 | +11 | – | 16.67% (n=2,621) | 16.66% (n=7,843) | 0.01% | +0 [-82, +82] | 50.2% | -0.18 (z -0.83) ~ | -0.08% ±0.88% | -0.20% ±1.19% |
| 78 | `theology-for-founders` | Have a founder research Theology next, after its first government, so it can build a Temple. | 1 | **on** | -44 | -3 | -10 | 16.67% (n=77,233) | 16.67% (n=70,049) | 0.00% | -0 [-19, +18] | 48.6% | +0.07 (z +0.27) ~ | -0.00% ±0.74% | -0.09% ±1.02% |
| 79 | `civilian-rescue` | Walk onto any capturable civilian within reach, and always take back a Settler the barbarians hold. | 1 | **on** | -6 | +49 | -5 | 16.66% (n=99,518) | 16.67% (n=92,656) | -0.01% | -1 [-17, +15] | 46.4% | -0.20 (z -0.75) ~ | +0.14% ±0.76% | +0.14% ±1.11% |
| 80 | `builder-barbarian-safety` | Make a Builder retreat from, and never step into, a tile a visible barbarian can capture next turn. | 1 | off | -67 | +11 | -23 | 16.65% (n=65,124) | 16.68% (n=70,158) | -0.03% | -9 [-43, +24] | 29.4% | -0.10 (z -0.40) ~ | -0.41% ±0.68% | -0.64% ±0.97% |
| 81 | `holy-site-where-the-threat-is` | Build a Holy Site in the city losing its religious majority so defenders can be bought there directly. | 1 | off | +7 | -15 | +4 | 16.64% (n=47,574) | 16.69% (n=52,560) | -0.04% | -4 [-26, +18] | 36.7% | -0.03 (z -0.11) ~ | -0.05% ±0.62% | +0.03% ±0.87% |
| 82 | `religious-defence-scales` | Size the defensive Missionary corps by cities actually under conversion pressure, up to four, instead of two. | 1 | **on** | -38 | -12 | +20 | 16.64% (n=49,691) | 16.69% (n=50,443) | -0.05% | -3 [-26, +19] | 38.8% | +0.16 (z +0.74) ~ | +0.06% ±0.68% | +0.20% ±1.02% |
| 83 | `housing-research` | Aim research at the technology that raises the housing ceiling while housing is throttling growth. | 1 | off | -16 | -33 | +11 | 16.64% (n=93,424) | 16.69% (n=98,750) | -0.06% | -3 [-24, +18] | 38.3% | +0.21 (z +0.94) ~ | -0.74% ±0.66% | -0.79% ±0.95% |
| 84 | `siege-commitment` | Keep the campaign aimed at a city it has already damaged instead of re-targeting a fresh one each turn. | 1 | off | -33 | -8 | +22 | 16.64% (n=93,502) | 16.69% (n=98,672) | -0.06% | -3 [-19, +13] | 35.7% | +0.15 (z +0.64) ~ | -0.20% ±0.66% | -0.31% ±0.97% |
| 85 | `naval-recon` | Buy one ship for a fleetless empire with unexplored water off its coast and send it exploring. | 1 | off | +3 | -10 | -16 | 16.63% (n=93,713) | 16.70% (n=98,461) | -0.07% | -4 [-20, +12] | 31.2% | -0.11 (z -0.48) ~ | -0.23% ±0.69% | -0.75% ±1.02% |
| 86 | `one-shot-recovery` | Withdraw a unit that one enemy blow could kill to safe healing ground, and leave when threatened again. | 1 | off | +30 | -13 | -48 | 16.63% (n=47,438) | 16.70% (n=52,696) | -0.08% | -5 [-34, +23] | 35.3% | -0.62 (z -2.76) hurts * | -0.39% ±0.64% | -0.82% ±0.95% |
| 87 | `joint-tactics` | Plan an engagement's attacks jointly across all units by search instead of one unit at a time in class order. | 1 | off | – | – | – | 16.61% (n=46,020) | 16.72% (n=46,020) | -0.10% | -5 [-28, +17] | 32.6% | +0.25 (z +3.84) helps * | +27.29% ±0.47% | +27.69% ±0.79% |
| 88 | `guru-heals-the-corps` | Let a founder defending its own cities buy one Guru, the only unit that heals religious units. | 1 | off | +8 | +36 | -68 | 16.61% (n=47,392) | 16.72% (n=52,742) | -0.11% | -5 [-58, +48] | 43.4% | -0.34 (z -1.50) ~ | -0.53% ±0.69% | -0.63% ±0.98% |
| 89 | `siege-is-progress` | Count damage dealt to an enemy city or its walls as campaign progress, so a winning siege is never stalled. | 1 | off | -1 | +8 | -5 | 16.60% (n=93,497) | 16.73% (n=98,677) | -0.13% | -8 [-30, +14] | 24.4% | -0.37 (z -1.66) ~ | +0.36% ±0.64% | +0.23% ±0.95% |
| 90 | `deals-at-the-ceiling` | Price a trade quote at the counterparty's walk-away point less two Gold, falling back to the midpoint if refused. | 1 | off | -5 | -1 | – | 16.55% (n=2,622) | 16.70% (n=7,842) | -0.15% | -8 [-90, +74] | 42.6% | +0.09 (z +0.42) ~ | -1.03% ±0.87% | -1.88% ±1.25% |
| 91 | `city-campaign` | Appraise weaker neighbours, plan to take one to three holdable cities the army can afford, and launch when staged. | 1 | off | -3 | – | – | 16.53% (n=1,113) | 16.71% (n=3,363) | -0.18% | -9 [-136, +118] | 44.5% | +0.04 (z +0.15) ~ | +0.92% ±0.97% | +1.48% ±1.41% |
| 92 | `home-defense` | Let hostile units inside our own territory claim defenders before the offensive campaign takes them. | 1 | off | -3 | +11 | -22 | 16.57% (n=93,816) | 16.76% (n=98,358) | -0.18% | -10 [-25, +6] | 11.6% | -0.19 (z -0.83) ~ | +0.04% ±0.65% | +1.03% ±0.99% |
| 93 | `spread-campaign-persists` | Keep a spread campaign on the offensive between waves once it has converted a foreign city. | 1 | off | -39 | +16 | +23 | 16.52% (n=47,476) | 16.80% (n=52,658) | -0.29% | -15 [-40, +10] | 12.6% | +0.04 (z +0.16) ~ | -0.94% ±0.63% | -0.66% ±0.93% |
| 94 | `deals-for-our-gain` | Pick the trade quote with the best net value to us instead of the most balanced exchange. | 1 | off | -32 | +6 | – | 16.27% (n=2,655) | 16.80% (n=7,809) | -0.53% | -30 [-127, +68] | 27.7% | -0.26 (z -1.17) ~ | -1.15% ±0.87% | -1.94% ±1.14% |
| 95 | `campaign-pillage` | Let a soldier at war pillage the tile it stands on with movement its march does not use. | 1 | off | -12 | – | – | 16.21% (n=1,178) | 16.83% (n=3,298) | -0.61% | -31 [-154, +92] | 31.2% | -0.29 (z -1.24) ~ | +1.83% ±1.02% | +2.83% ±1.41% |
| 96 | `lane-commit` | From mid-game commit an adaptive seat to the victory lane it leads the field in, instead of re-picking each turn. | 1 | off | -21 | -6 | – | 16.17% (n=2,622) | 16.83% (n=7,842) | -0.66% | -34 [-116, +47] | 20.3% | +0.12 (z +0.56) ~ | -0.70% ±0.88% | -0.65% ±1.24% |
| 97 | `no-free-passage` | Stop bundling free one-way Open Borders into friendship and alliance proposals; sell passage through the quote lane. | 1 | off | +12 | -36 | – | 16.05% (n=2,641) | 16.87% (n=7,823) | -0.82% | -37 [-162, +88] | 28.3% | -0.38 (z -1.78) ~ | -0.09% ±0.87% | -0.21% ±1.18% |
| 98 | `pass-picket` | Station an idle recon unit on the chokepoint tile of the land route toward a neighbour, or watch their border. | 1 | off | -20 | – | – | 15.82% (n=1,068) | 16.93% (n=3,408) | -1.11% | -55 [-181, +71] | 19.4% | +0.18 (z +0.76) ~ | +0.30% ±0.93% | +0.35% ±1.35% |
| 99 | `zoc-screen` | Stand an idle melee unit where its zone of control shields our shooters and wounded from the most enemy reaches. | 1 | off | -19 | -26 | – | 15.75% (n=2,641) | 16.98% (n=7,823) | -1.22% | -61 [-142, +19] | 6.8% | -0.36 (z -1.66) ~ | +1.52% ±0.87% | +2.33% ±1.21% |
| 100 | `settler-screen` | Block a seen rival Settler with up to four nearby units standing on its likeliest paths to slow its founding. | 1 | off | -48 | – | – | 14.77% (n=1,124) | 17.30% (n=3,352) | -2.53% | -127 [-247, -6] | 2.0% | -0.24 (z -0.98) ~ | -0.84% ±0.98% | -0.73% ±1.45% |
| 101 | `fog-honest` | Plan the whole turn against a fog-redacted world and replay only the resulting orders on the real game. | 1 | off | -77 | -95 | -145 | v1 9.97% (n=2,296) · v2 3.35% (n=2,331) | v1 17.90% (n=12,434) · v2 19.17% (n=12,399) | -7.93% | -409 [-478, -339] | 0.0% | -1.27 (z -5.47) hurts * | -1.05% ±0.75% | -1.20% ±1.16% |
| 102 | `fog-honest-2` | Version 2 of fog-honest: the same redacted planning plus one re-plan from the real board when an order is refused. | 1 | off | -181 | -187 | -275 | v1 9.97% (n=2,296) · v2 3.35% (n=2,331) | v1 17.90% (n=12,434) · v2 19.17% (n=12,399) | -15.82% | -835 [-909, -760] | 0.0% | -4.32 (z -18.92) hurts * | +5.82% ±0.86% | +6.94% ±1.21% |
...
| `diplomatic-lane-forecast` | off (unmeasured) | Score the Diplomacy lane by when twenty Diplomatic Victory Points arrive along the Congress calendar, not by how many are banked. | 1 |
...
| `naval-threat-triage` | off (unmeasured) | Ignore nearby barbarian ships that cannot land a meaningful blow, while still allowing ranged shots at them. | 1 |
...
| `science-victory-drive` | **on** (unmeasured) | When the empire leads the field in science, beeline the space-race chain, build launch-city production and race two pads early. | 1 |
| `surprise-war-mobilization` | off (unmeasured) | Convert the first six Standard-speed turns after a surprise war is declared against us into a bounded defensive mobilization. | 1 |
...
|---|---:|---:|---:|---|
| `wonder-ring-settle-value` | +119 | 17.86% | 15.42% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `priced-tile-purchase` | +110 | 17.77% | 15.50% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `governor-expansion-lane` | +69 | 17.36% | 15.97% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `escort-unstick-2` | +68 | 17.35% | 16.45% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `siege-tracks-wall` | +67 | 17.34% | 16.01% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `condemn-under-congress` | +60 | 17.27% | 16.08% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `fortify-idle-units` | +60 | 17.26% | 16.09% | `2026-08-24-standard-continuous-4266-total-seats.json` |
...
| `fifteenth-citizen` | +53 | 17.20% | 16.15% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `housing-districts` | +52 | 17.19% | 16.14% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `district-lookahead-settle` | +44 | 17.11% | 16.25% | `2026-08-24-standard-continuous-4266-total-seats.json` |
...
| `endgame-war-runway` | +27 | 16.93% | 16.39% | `2026-08-24-standard-continuous-4266-total-seats.json` |
...
| `culture-coverage` | +7 | 16.73% | 16.61% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `ranged-line-of-sight` | +4 | 16.71% | 16.63% | `2026-08-22-p10-native-6p-allseats-17574-pairs-ended-early.json` |
| `barbarian-hunt` | +0 | 16.67% | 16.67% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `recon-flight` | -1 | 16.66% | 16.67% | `2026-08-22-p10-native-6p-allseats-17574-pairs-ended-early.json` |
| `campus-finishes-first` | -2 | 16.64% | 16.69% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `coupled-expansion` | -2 | 16.65% | 16.68% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `settle-plan-ahead` | -2 | 16.64% | 16.69% | `2026-08-24-standard-continuous-4266-total-seats.json` |
...
| `congress-counter-votes` | -10 | 16.57% | 16.76% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `idle-walkers-close-the-pipeline` | -10 | 16.56% | 16.77% | `2026-08-22-p10-native-6p-allseats-17574-pairs-ended-early.json` |
| `envoy-infrastructure` | -11 | 16.55% | 16.79% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `district-building-chain` | -12 | 16.54% | 16.79% | `2026-08-24-standard-continuous-4266-total-seats.json` |
...
| `lane-congress-favor` | -50 | 16.17% | 17.15% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `war-patience` | -50 | 16.16% | 17.18% | `2026-08-24-standard-continuous-4266-total-seats.json` |
...
| `tactical-strategy` | -54 | 16.13% | 17.19% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `builder-worked-tile-priority` | -69 | 15.97% | 17.33% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `contact-posture` | -70 | 15.96% | 17.34% | `2026-08-24-standard-continuous-4266-total-seats.json` |
...
| `congress-banks-decided` | -110 | 15.57% | 17.77% | `2026-08-24-standard-continuous-4266-total-seats.json` |
...
| `naval-production-policy` | -129 | 15.38% | 17.99% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `governor-victory-lanes` | -173 | 14.94% | 18.44% | `2026-08-24-standard-continuous-4266-total-seats.json` |
| `builder-reward-survey` | -186 | 14.80% | 18.57% | `2026-08-24-standard-continuous-4266-total-seats.json` |
