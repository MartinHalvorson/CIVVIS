...
| 66 | `settler-target-hysteresis` | Keep a settler target dropped for danger out of the ranking for several turns instead of re-picking it immediately. | 1 | off | 75.1% | +13 | -10 | +39 | v1 16.73% (n=98,720) | v1 16.61% (n=119,188) | 0.12% | +0.03% ±0.85% | -0.07% ±1.13% |
...
| 71 | `amenity-project-preemption` | In a severe empire-wide Amenity crisis, pause one repeatable project for the amenity repair chain and slot Liberalism. | 1 | off | 80.8% | +7 | +67 | +24 | v1 16.72% (n=98,776) | v1 16.63% (n=119,132) | 0.09% | +2.66% ±0.98% | +2.24% ±1.27% |
...
| 73 | `guru-heals-the-corps` | Let a founder defending its own cities buy one Guru, the only unit that heals religious units. | 1 | off | 69.9% | +4 | +8 | +36 | v1 16.69% (n=52,750) | v1 16.65% (n=73,118) | 0.05% | +0.18% ±0.88% | +0.21% ±1.18% |
...
| 83 | `naval-recon` | Buy one ship for a fleetless empire with unexplored water off its coast and send it exploring. | 1 | off | 40.9% | +5 | +3 | -10 | v1 16.66% (n=99,024) | v1 16.68% (n=118,884) | -0.02% | -0.46% ±0.87% | -0.72% ±1.15% |
