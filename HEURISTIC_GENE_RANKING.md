...
**Default on:** both newest columns >0; or avg >+15 with neither <−10; sole reading >+20; pooled *Diff* <0 vetoes. The newest displayed batch is an authoritative source.
...
| 13 | `unit-cost-efficiency` | Credit strength-per-production and the civ's own unique unit in the military production arm. | — | off | +9 | +24 | +6 | 16.98% (n=44,706) | 16.36% (n=45,084) | 0.62% | +31 [+7, +56] | 99.4% | +0.06 (z +0.40) ~ | +0.05% ±0.38% | -0.22% ±0.65% |
...
| 20 | `unit-objective-memory` | Let a unit retain its campaign objective and a short, threat-driven retreat across turns. | — | off | +5 | +20 | -5 | 16.88% (n=44,781) | 16.45% (n=45,009) | 0.43% | +22 [-4, +47] | 95.2% | -0.06 (z -0.42) ~ | -0.08% ±0.38% | -0.58% ±0.67% |
...
| 24 | `camp-party` | The peacetime camp party. | — | off | +14 | +4 | +2 | 16.84% (n=114,458) | 16.50% (n=114,616) | 0.34% | +19 [-0, +37] | 97.3% | -0.07 (z -0.47) ~ | +0.39% ±0.39% | +0.81% ±0.70% |
...
| 34 | `slot-kind-tiebreak` | Break a production cost tie by which great-work slots can be filled. | — | off | +13 | +10 | -1 | 16.78% (n=114,161) | 16.55% (n=114,913) | 0.23% | +11 [-4, +25] | 92.5% | -0.21 (z -1.37) ~ | -0.45% ±0.39% | -0.60% ±0.70% |
| 35 | `promote-when-wounded` |  | — | off | +4 | +10 | -4 | 16.78% (n=45,059) | 16.55% (n=44,731) | 0.22% | +11 [-13, +36] | 81.6% | +0.05 (z +0.30) ~ | +0.00% ±0.37% | +0.06% ±0.67% |
...
| 41 | `religion-sues-peace` | A Religion strategy offers peace to unblock its spread lane. | — | off | +2 | +6 | +12 | 16.75% (n=114,307) | 16.59% (n=114,767) | 0.16% | +8 [-7, +22] | 85.4% | -0.00 (z -0.02) ~ | +0.21% ±0.36% | +0.47% ±0.64% |
| 42 | `lane-great-people` | Rank Great Person classes, and the Great Person points a project earns, by the victory the empire is actually racing rather than by a war it is fighting. | — | off | +17 | +1 | -9 | 16.74% (n=68,375) | 16.59% (n=68,659) | 0.15% | +7 [-12, +26] | 75.3% | -0.18 (z -1.18) ~ | +0.45% ±0.37% | +0.57% ±0.67% |
...
| 57 | `holy-site-where-the-threat-is` | Put a Holy Site in the city that is actually losing its majority, so its defender can be bought there instead of walking from the Holy City. | 1 | off | +10 | +6 | +3 | v1 16.70% (n=68,350) | v1 16.64% (n=68,684) | 0.06% | +2 [-17, +20] | 56.3% | -0.22 (z -1.44) ~ | -0.03% ±0.37% | -0.02% ±0.66% |
...
| 60 | `settler-target-hysteresis` | Keep a settler target dropped for danger out of the next picks for a few turns. | 1 | off | +8 | +2 | +15 | v1 16.69% (n=114,493) | v1 16.64% (n=114,581) | 0.05% | +2 [-13, +16] | 59.5% | -0.11 (z -0.72) ~ | -0.73% ±0.39% | -0.82% ±0.71% |
| 61 | `campus-adjacency-threshold` | A Campus plot that clears the multiplier's adjacency threshold is credited what crossing it unlocks. | 1 | off | +11 | +2 | +10 | v1 16.69% (n=68,216) | v1 16.64% (n=68,818) | 0.05% | +1 [-18, +20] | 53.6% | +0.24 (z +1.58) ~ | +0.02% ±0.36% | -0.36% ±0.64% |
| 62 | `settler-guard-holds` | A stacked guard holds with its settler, and only a guard that can hold counts as protection. | 1 | off | +12 | -7 | +12 | v1 16.68% (n=114,550) | v1 16.65% (n=114,524) | 0.04% | +1 [-13, +16] | 57.6% | -0.02 (z -0.12) ~ | +0.07% ±0.38% | -0.55% ±0.68% |
| 63 | `naval-recon` | Buy one ship for an empire that has none while unexplored water lies off its coast, and send it exploring. | 1 | off | +9 | +12 | -14 | v1 16.68% (n=114,596) | v1 16.65% (n=114,478) | 0.02% | +0 [-15, +15] | 51.2% | -0.20 (z -1.31) ~ | +0.08% ±0.37% | -0.10% ±0.64% |
| 64 | `power-the-laboratory` | A power plant is credited the yields it switches on in its city. | 1 | off | +7 | -2 | +7 | v1 16.68% (n=68,683) | v1 16.66% (n=68,351) | 0.02% | +0 [-19, +19] | 51.2% | +0.22 (z +1.41) ~ | -0.25% ±0.37% | -0.34% ±0.67% |
...
| 66 | `guru-heals-the-corps` | Let a founder that is defending its own cities hold one Guru, the only field heal a religious corps has. | 1 | off | +12 | +3 | +16 | v1 16.67% (n=68,424) | v1 16.66% (n=68,610) | 0.01% | +3 [-26, +31] | 57.1% | +0.11 (z +0.69) ~ | +0.15% ±0.37% | +0.30% ±0.66% |
...
| 73 | `district-coverage` | Rank district families by how much of the empire still lacks them. | 1 | off | +7 | -7 | +13 | v1 16.65% (n=114,531) | v1 16.68% (n=114,543) | -0.02% | -1 [-17, +15] | 43.8% | +0.19 (z +1.25) ~ | +0.38% ±0.36% | +0.50% ±0.64% |
...
| 77 | `siege-is-progress` | A SIEGE THAT IS WINNING IS NOT A STALLED WAR. | 1 | off | +11 | +13 | -26 | v1 16.64% (n=114,486) | v1 16.70% (n=114,588) | -0.06% | -7 [-31, +17] | 29.0% | -0.05 (z -0.33) ~ | +0.10% ±0.38% | +0.12% ±0.68% |
...
|---|---:|---:|---|
| `columns` **(in force)** | 36 | 0 | the operator's threshold rule, exactly as it ships: both win columns positive, or their average above +15 with neither below −10, or one column above +20 — and off whatever they say when the pooled *Diff* is negative |
| `posterior-veto` | 37 | 1 | the same columns, with an error bar on the veto: it fires only when the posterior's 95% interval lies **wholly below zero**, instead of on the bare sign of a difference that carries no error at all |
| `posterior` | 37 | 1 | the pooled estimate decides wherever its interval excludes zero, and `posterior-veto` decides where it straddles |
...
|---|---|---|---|---:|---:|---:|
| `siege-commitment` | off | **on** | **on** | -2 [-18, +14] | 40.5% | -0.04% |

### What the posterior can decide at all

Of 117 priced genes the interval clears zero for **21 upward** and **6 downward**; **90 sit inside the interval either way** and are the boundary set below. A straddling interval is not a null — it is the instrument saying it cannot tell, which is exactly what a fixed ±15 bar cannot say.
...
```sh
gene_screen --genes camp-party,unit-cost-efficiency,barbarian-hunt,governor-victory-lanes,governor-every-lane,escort-unstick-2,fortify-idle-units,tactical-strategy
```
...
**Batch provenance.** The newest displayed batch is the completed current-standard 6-major Continents screen (74×46, nine city-states, Online speed through turn 250, all six victory lanes, shuffled civilizations and best-genome baseline). It is also an authoritative ledger source, so its completed seats enter the deployment default calculation. Older displayed batches remain visible for trend context.
