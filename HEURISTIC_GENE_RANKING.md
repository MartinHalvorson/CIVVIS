...
|---:|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 1 | `air-surge` | Beeline Advanced Flight, build an Aerodrome and bombers, and take the appointed city with cavalry behind them. | — | **on** | +30 | +25 | +34 | 17.30% (n=75,719) | 15.50% (n=40,969) | 1.80% | +97 [+76, +119] | 100.0% | +0.38 (z +3.26) helps * | +0.52% ±0.31% | +0.47% ±0.47% |
| 2 | `great-person-housing` | Reserve a city to build whatever unblocks an earned Great Person, selling duplicate works to make room. | — | **on** | +29 | +52 | +40 | 17.30% (n=93,222) | 15.66% (n=58,614) | 1.64% | +88 [+69, +106] | 100.0% | +0.47 (z +3.98) helps * | +0.41% ±0.29% | +0.57% ±0.45% |
| 3 | `wide-map-capacity` | Price the city ceiling off the passable land actually visible, at one city per 45 tiles, capped at twelve. | — | **on** | +41 | +23 | +26 | 17.17% (n=121,713) | 15.96% (n=87,015) | 1.21% | +64 [+38, +90] | 100.0% | +0.29 (z +2.44) helps * | +0.28% ±0.29% | +0.21% ±0.44% |
| 4 | `one-war-at-a-time` | Fight one campaign front at a time, seeking peace with every other major and once the front turns against us. | — | off | +21 | – | – | 17.49% (n=1,498) | 16.39% (n=4,490) | 1.10% | +55 [-54, +163] | 83.9% | -0.13 (z -0.59) ~ | +0.14% ±0.87% | +0.79% ±1.14% |
| 5 | `raid-pillage-prizes` | Count a neighbour's unpillaged improvements within reach as raid prizes and send raiders to pillage them. | — | **on** | +11 | +35 | +35 | 17.09% (n=93,221) | 15.99% (n=58,615) | 1.10% | +59 [+37, +81] | 100.0% | +0.42 (z +3.59) helps * | -0.31% ±0.31% | -0.28% ±0.46% |
| 6 | `price-the-suzerainty` | Credit the envoy scorer with the resources, bonuses and points a suzerainty pays, amortised over envoys still needed. | — | **on** | -1 | +8 | +30 | 17.13% (n=37,448) | 16.13% (n=31,996) | 0.99% | +51 [+23, +80] | 100.0% | +0.38 (z +3.68) helps * | +0.06% ±0.26% | +0.28% ±0.41% |
| 7 | `recon-replacement` | Rebuild the recon arm when every scout is gone and unexplored ground remains to chart. | — | **on** | +35 | +27 | +24 | 17.08% (n=121,681) | 16.09% (n=87,047) | 0.99% | +52 [+36, +68] | 100.0% | +0.17 (z +1.41) ~ | +0.23% ±0.30% | +0.08% ±0.46% |
| 8 | `opportunistic-war` | Open a surprise war on a neighbour whose Settlers, Builders or tiles lie exposed nearby, then sue for peace. | — | **on** | +35 | +23 | +27 | 17.05% (n=93,215) | 16.06% (n=58,621) | 0.98% | +52 [+33, +71] | 100.0% | +0.49 (z +4.24) helps * | -0.15% ±0.28% | -0.15% ±0.44% |
| 9 | `maintenance-aware-deck` | Subtract the unit-maintenance bill inside the policy counterfactual so maintenance-discount cards score above zero. | — | **on** | -22 | -2 | +22 | 17.07% (n=37,270) | 16.20% (n=32,174) | 0.87% | +34 [-8, +77] | 94.4% | +0.33 (z +3.11) helps * | +0.58% ±0.26% | +0.84% ±0.41% |
| 10 | `engine-faith-price` | Read Faith purchase prices from the engine at the game's speed and discounts, instead of a Standard-speed literal. | — | **on** | +28 | -20 | +5 | 17.04% (n=37,410) | 16.23% (n=32,034) | 0.81% | +36 [-7, +79] | 95.0% | -0.06 (z -0.59) ~ | -0.28% ±0.25% | -0.42% ±0.38% |
| 11 | `missionary-last-charge-explores` | Let a Missionary on its last charge explore nearby fog for a few turns before spending it. | — | **on** | +20 | +12 | – | 17.13% (n=3,696) | 16.41% (n=6,558) | 0.72% | +39 [-40, +117] | 83.1% | -0.22 (z -1.01) ~ | -0.37% ±0.60% | +0.23% ±0.85% |
| 12 | `escort-unstick` | Release a settler's linked escort after two turns without progress so the settler marches on by itself. | 1 | **on** | +46 | -25 | +12 | v1 16.99% (n=103,891) · v2 16.67% (n=17,695) | v1 16.35% (n=104,837) · v2 16.67% (n=51,749) | 0.65% | +31 [+9, +53] | 99.7% | +0.10 (z +0.99) ~ | +0.00% ±0.30% | +0.12% ±0.46% |
| 13 | `loyalty-rate-alarm` | Rank loyalty emergencies by turns until the city flips rather than by its current loyalty level. | — | **on** | +18 | +11 | -11 | 16.93% (n=121,487) | 16.30% (n=87,241) | 0.64% | +34 [+14, +53] | 100.0% | +0.14 (z +1.14) ~ | +0.03% ±0.30% | -0.23% ±0.46% |
| 14 | `settle-sooner` | Price a Settler's walk per turn, rising the longer it has walked, so it settles sooner. | — | **on** | -3 | +56 | +6 | 16.91% (n=93,409) | 16.28% (n=58,427) | 0.63% | +34 [+15, +53] | 100.0% | +0.01 (z +0.11) ~ | +0.47% ±0.30% | +0.74% ±0.46% |
| 15 | `war-economy` | Route an adaptive plan that switched to Conquest through the war production path instead of the basic governor. | — | **on** | -12 | +41 | +32 | 16.92% (n=121,873) | 16.31% (n=86,855) | 0.61% | +27 [-50, +104] | 75.4% | +0.82 (z +6.74) helps * | +0.93% ±0.30% | +1.07% ±0.46% |
| 16 | `shoot-and-scoot` | Let a ranged unit inside melee reach step to a safer firing tile and shoot the threatening body. | — | off | +11 | – | – | 17.10% (n=1,532) | 16.52% (n=4,456) | 0.58% | +29 [-79, +137] | 70.2% | -0.18 (z -0.83) ~ | -0.08% ±0.88% | -0.20% ±1.19% |
| 17 | `buildings-before-projects` | Make a repeatable district project wait behind the science and production buildings the city can already build. | — | **on** | +4 | +27 | +10 | 16.90% (n=121,900) | 16.34% (n=86,828) | 0.56% | +29 [+12, +47] | 100.0% | +0.09 (z +0.75) ~ | +0.14% ±0.30% | +0.37% ±0.47% |
| 18 | `district-planning` | Plan a city's districts, their plots and tile purchases jointly, reserving plots in rings one to three. | — | **on** | +8 | +33 | +26 | 16.96% (n=33,313) | 16.40% (n=36,131) | 0.56% | +28 [+0, +56] | 97.6% | +0.17 (z +1.62) ~ | -0.11% ±0.25% | -0.06% ±0.38% |
| 19 | `barbarian-scouts-are-scouts` | Stop pricing a barbarian Scout as a threat, since it never attacks or captures; settlers and scouts ignore it. | — | **on** | +25 | -15 | +14 | 16.89% (n=121,784) | 16.35% (n=86,944) | 0.54% | +30 [+12, +47] | 99.9% | +0.30 (z +2.46) helps * | +0.29% ±0.30% | +0.59% ±0.46% |
| 20 | `bounded-recovery` | Let the defensive Recovery posture expire after a turn limit instead of trapping the empire in it permanently. | — | **on** | -14 | +8 | +8 | 16.89% (n=121,637) | 16.35% (n=87,091) | 0.54% | +29 [+13, +44] | 100.0% | +0.11 (z +0.92) ~ | -0.10% ±0.30% | +0.05% ±0.46% |
| 21 | `holy-lane-parity` | Price the Religion lane's Holy Site at what the Culture lane pays for its Theater Square. | — | **on** | +18 | -47 | -5 | 16.86% (n=106,445) | 16.38% (n=71,791) | 0.48% | +20 [-15, +54] | 86.6% | -0.05 (z -0.42) ~ | -0.21% ±0.28% | -0.29% ±0.42% |
| 22 | `pantheon-board` | Choose the pantheon by what it would pay on the tiles the empire owns, not from a fixed order. | — | off | +83 | -19 | +14 | 16.91% (n=33,102) | 16.44% (n=36,342) | 0.47% | +43 [-28, +114] | 88.4% | +0.06 (z +0.60) ~ | +0.02% ±0.26% | -0.02% ±0.40% |
| 23 | `religious-veto-defence` | Scale religious defence with a rival's progress toward religious victory, and walk the Inquisitor to the heresy. | — | off | +8 | – | – | 16.97% (n=1,538) | 16.56% (n=4,450) | 0.41% | +20 [-89, +130] | 64.3% | +0.56 (z +2.46) helps * | +1.25% ±0.87% | +2.13% ±1.12% |
| 24 | `camp-party` | In peacetime let the whole army answer home threats, ranking a nearby barbarian camp above countryside raiders. | — | **on** | +20 | -8 | +13 | 16.87% (n=106,872) | 16.46% (n=101,856) | 0.41% | +22 [+3, +41] | 98.8% | +0.06 (z +0.56) ~ | +0.22% ±0.25% | +0.68% ±0.40% |
| 25 | `settlement-gap-target` | Make the settlement-gap redirect and the Settler ranking read the same city target as the baseline cascade. | — | **on** | +11 | +29 | +11 | 16.88% (n=33,286) | 16.47% (n=36,158) | 0.41% | +21 [-7, +49] | 92.8% | +0.24 (z +2.35) helps * | +0.24% ±0.26% | +0.29% ±0.40% |
| 26 | `score-horizon` | Skip a space race or Manhattan Project that cannot finish before the turn limit ends the game. | — | **on** | +30 | +28 | +15 | 16.83% (n=121,717) | 16.43% (n=87,011) | 0.40% | +21 [+5, +37] | 99.5% | +0.06 (z +0.46) ~ | -0.13% ±0.29% | -0.17% ±0.45% |
| 27 | `missionary-evades-raiders` | Keep religious units out of every tile a visible barbarian raider can reach next turn. | — | **on** | -6 | +30 | – | 16.91% (n=3,636) | 16.53% (n=6,618) | 0.38% | +20 [-59, +98] | 69.1% | +0.38 (z +1.65) ~ | +1.01% ±0.63% | +0.63% ±0.84% |
| 28 | `founder-temple` | Have a founder outside the Religion lane still build the Shrine and Temple an Apostle needs. | — | **on** | +36 | -51 | +19 | 16.81% (n=99,460) | 16.44% (n=64,376) | 0.37% | +24 [-2, +49] | 96.6% | +0.24 (z +1.98) ~ | +0.21% ±0.30% | +0.47% ±0.48% |
| 29 | `recorded-tactical-step` | Record each tactical step so a unit moved twice in one turn cannot return to the tile it just left. | — | **on** | +38 | +22 | +4 | 16.82% (n=121,588) | 16.46% (n=87,140) | 0.36% | +19 [+3, +35] | 99.0% | +0.02 (z +0.18) ~ | +0.06% ±0.29% | +0.22% ±0.46% |
| 30 | `barbarian-bargain` | Price a fight against a barbarian below a fight against a major, since barbarians carry no war costs. | — | **on** | +24 | +17 | +5 | 16.80% (n=93,378) | 16.45% (n=58,458) | 0.35% | +18 [-1, +37] | 96.9% | -0.18 (z -1.48) ~ | -0.31% ±0.29% | -0.50% ±0.45% |
| 31 | `idle-faith-patronage` | Let a seat with no religion and 600+ banked Faith patronize Great People whatever the points shortfall. | — | **on** | -7 | -4 | -13 | 16.80% (n=99,169) | 16.46% (n=64,667) | 0.34% | +20 [+3, +36] | 99.1% | -0.09 (z -0.76) ~ | -0.19% ±0.28% | -0.52% ±0.43% |
| 32 | `deals-for-our-gain` | Pick the trade quote with the best net value to us instead of the most balanced exchange. | — | off | +6 | – | – | 16.91% (n=1,526) | 16.58% (n=4,462) | 0.32% | +16 [-92, +124] | 61.5% | -0.26 (z -1.17) ~ | -1.15% ±0.87% | -1.94% ±1.14% |
| 33 | `peacetime-deterrence` | Let the strongest met major raise the army target in peacetime, so deterrence exists before any declaration. | — | **on** | +26 | -5 | -3 | 16.80% (n=121,644) | 16.48% (n=87,084) | 0.32% | +17 [+1, +33] | 98.1% | +0.02 (z +0.19) ~ | -0.35% ±0.30% | -0.25% ±0.46% |
| 34 | `promote-when-wounded` | Defer a unit's promotion until it is wounded enough to use the promotion's heal instead of wasting it. | — | **on** | +38 | -10 | +11 | 16.81% (n=37,294) | 16.50% (n=32,150) | 0.31% | +17 [-12, +45] | 87.4% | +0.15 (z +1.39) ~ | -0.26% ±0.26% | -0.60% ±0.40% |
| 35 | `religious-defence-scales` | Size the defensive Missionary corps by cities actually under conversion pressure, up to four, instead of two. | — | **on** | -12 | +20 | +41 | 16.82% (n=57,012) | 16.52% (n=59,676) | 0.31% | +20 [-18, +58] | 85.0% | +0.25 (z +2.37) helps * | +0.25% ±0.26% | +0.50% ±0.40% |
| 36 | `slot-kind-tiebreak` | Break a production cost tie between museums by which great-work slots the empire can actually fill. | — | **on** | +17 | +59 | +13 | 16.81% (n=106,805) | 16.52% (n=101,923) | 0.29% | +16 [-2, +34] | 95.5% | -0.00 (z -0.01) ~ | +0.06% ±0.26% | -0.17% ±0.39% |
| 37 | `lane-space-race` | Open the Spaceport and launch pass for an empire racing Science even while its plan is still Expansion. | — | off | +8 | -15 | +40 | 16.81% (n=56,890) | 16.53% (n=59,798) | 0.29% | +17 [-19, +54] | 82.5% | +0.19 (z +1.83) ~ | +0.06% ±0.25% | +0.12% ±0.40% |
| 38 | `unit-cost-efficiency` | Credit strength per production and the civilization's own unique unit when pricing military production. | — | **on** | +1 | -4 | +8 | 16.80% (n=37,153) | 16.52% (n=32,291) | 0.28% | +14 [-14, +43] | 83.8% | +0.21 (z +2.02) helps * | +0.10% ±0.25% | +0.15% ±0.38% |
| 39 | `unit-objective-memory` | Let a unit remember its campaign objective, dangerous approaches and a short retreat commitment across turns. | — | **on** | -18 | +1 | +18 | 16.79% (n=37,172) | 16.52% (n=32,272) | 0.27% | +14 [-14, +42] | 83.5% | +0.07 (z +0.64) ~ | +0.11% ±0.26% | +0.34% ±0.42% |
| 40 | `competition-victory-points` | Price first place in a scored competition by the Diplomatic Victory Points it pays. | — | **on** | +26 | -7 | +0 | 16.80% (n=60,933) | 16.53% (n=55,755) | 0.27% | +13 [-8, +34] | 88.7% | +0.05 (z +0.44) ~ | -0.19% ±0.25% | -0.33% ±0.39% |
| 41 | `stranded-settler-discount` | Discount a Settler that has stopped walking from the expansion gate, and found where it stands when stalled. | — | off | +19 | -3 | +12 | 16.80% (n=102,891) | 16.53% (n=105,837) | 0.27% | +13 [-3, +28] | 94.9% | +0.07 (z +0.68) ~ | +0.29% ±0.26% | +0.24% ±0.40% |
| 42 | `one-launch-pad` | Let only one city at a time claim the 3,000-point first Spaceport bonus, instead of every city at once. | — | **on** | +21 | +28 | +3 | 16.79% (n=106,824) | 16.53% (n=101,904) | 0.26% | +13 [-2, +28] | 94.9% | +0.11 (z +1.04) ~ | -0.16% ±0.25% | -0.20% ±0.38% |
| 43 | `lane-policy-deck` | Choose policy cards for the victory the empire is racing while its plan is still Expansion. | — | **on** | -11 | +5 | +11 | 16.80% (n=57,044) | 16.54% (n=59,644) | 0.26% | +12 [-9, +33] | 87.1% | +0.00 (z +0.00) ~ | +0.53% ±0.26% | +0.62% ±0.40% |
| 44 | `culture-building-debt` | Make a Theater Square owe its Amphitheater, Museum and Broadcast Center the way a Campus owes its buildings. | — | **on** | -1 | +12 | -19 | 16.75% (n=75,762) | 16.51% (n=40,926) | 0.24% | +10 [-20, +40] | 73.7% | -0.07 (z -0.60) ~ | +0.26% ±0.31% | +0.60% ±0.50% |
| 45 | `come-ashore` | Keep land units out of the water: no water exploration goals, and disembark units already at sea. | — | off | +38 | -28 | +24 | 16.77% (n=117,716) | 16.54% (n=91,012) | 0.23% | +14 [-8, +35] | 89.2% | +0.19 (z +1.61) ~ | -0.07% ±0.29% | +0.05% ±0.43% |
| 46 | `war-reinforcement` | Keep marching newly built rear units to the campaign objective after war is declared, not only before. | — | **on** | -37 | -10 | -2 | 16.76% (n=121,717) | 16.54% (n=87,011) | 0.22% | +9 [-12, +30] | 81.2% | +0.05 (z +0.42) ~ | +0.89% ±0.30% | +1.68% ±0.48% |
| 47 | `science-multiplier-payoff` | Credit a Campus building the science its city's multipliers will actually pay, not its raw spec yield. | — | **on** | +1 | +20 | +12 | 16.77% (n=56,970) | 16.57% (n=59,718) | 0.21% | +9 [-12, +29] | 80.0% | -0.20 (z -1.90) ~ | +0.23% ±0.25% | +0.13% ±0.39% |
| 48 | `settler-threat-detour` | Send a Settler to the best safe alternative site when a visible threat blocks its route. | — | **on** | +5 | +6 | -31 | 16.74% (n=93,431) | 16.54% (n=58,405) | 0.20% | +4 [-33, +42] | 59.0% | -0.19 (z -1.58) ~ | +0.38% ±0.30% | +0.27% ±0.46% |
| 49 | `relief-targets-the-siege` | Send a relief force at the besiegers actually damaging the city, not the enemy nearest the force. | — | **on** | +11 | +22 | +0 | 16.75% (n=121,697) | 16.55% (n=87,031) | 0.20% | +10 [-6, +26] | 89.9% | +0.04 (z +0.32) ~ | +0.11% ±0.30% | +0.43% ±0.48% |
| 50 | `settler-guard-holds` | Count a stacked guard as protection only when it can hold, and make it stay with its settler. | — | off | +36 | +26 | +14 | 16.76% (n=102,729) | 16.57% (n=105,999) | 0.19% | +8 [-7, +23] | 85.4% | +0.05 (z +0.47) ~ | +0.05% ±0.26% | +0.06% ±0.38% |
| 51 | `strike-opening` | Credit a movement tile for the attack it opens next, not only charge it for the threat it accepts. | — | **on** | +22 | -10 | -8 | 16.74% (n=121,660) | 16.56% (n=87,068) | 0.18% | +10 [-5, +26] | 90.1% | -0.07 (z -0.60) ~ | +0.46% ±0.29% | +0.44% ±0.45% |
| 52 | `early-contact-window` | Buy the second and third Scout early, before Early Empire closes borders and city-states become unreachable. | — | **on** | +14 | -4 | +5 | 16.75% (n=60,832) | 16.57% (n=55,856) | 0.18% | +9 [-12, +29] | 79.5% | -0.11 (z -1.07) ~ | -0.13% ±0.26% | -0.42% ±0.41% |
| 53 | `amenity-district-path` | Price an amenity district by the building it will hold, and a regional amenity building by every city it reaches. | — | **on** | -3 | -7 | +0 | 16.74% (n=121,504) | 16.56% (n=87,224) | 0.18% | +10 [-6, +26] | 88.9% | +0.14 (z +1.13) ~ | +0.32% ±0.30% | +0.30% ±0.49% |
| 54 | `barbarian-ranged-answer` | Build a ranged defender, not a melee one, when the barbarian ring around a city is mostly shooters. | — | off | +15 | -9 | +2 | 16.74% (n=89,233) | 16.56% (n=62,603) | 0.18% | +10 [-8, +29] | 86.1% | +0.00 (z +0.01) ~ | +0.00% ±0.30% | -0.24% ±0.45% |
| 55 | `apostle-promotion-by-role` | Promote an Apostle for the job the empire needs rather than the largest number on the card. | — | **on** | +67 | -29 | +1 | 16.74% (n=121,867) | 16.56% (n=86,861) | 0.18% | +11 [-16, +39] | 79.1% | +0.02 (z +0.20) ~ | -1.00% ±0.29% | -1.21% ±0.44% |
| 56 | `whole-turn-backtrack-guard` | Refuse any step onto a tile the unit already stood on this turn, closing three-hop loops too. | — | off | +11 | +6 | -6 | 16.74% (n=117,837) | 16.57% (n=90,891) | 0.17% | +10 [-6, +26] | 89.6% | +0.00 (z +0.01) ~ | +0.08% ±0.32% | +0.18% ±0.50% |
| 57 | `religion-sues-peace` | Have a Religion strategy offer peace to every at-war major so its missionaries can reach their cities. | — | **on** | +30 | +54 | -3 | 16.75% (n=106,705) | 16.58% (n=102,023) | 0.17% | +12 [-8, +33] | 88.1% | -0.01 (z -0.12) ~ | -0.15% ±0.25% | -0.45% ±0.37% |
| 58 | `coordinated-finish` | Let a force finish a defender together with a friendly volley, without the rest of the tactical-strategy bundle. | — | off | +41 | -22 | +6 | 16.75% (n=33,354) | 16.59% (n=36,090) | 0.16% | +11 [-28, +50] | 71.1% | -0.04 (z -0.34) ~ | -0.15% ±0.26% | +0.07% ±0.39% |
| 59 | `lane-culture-spending` | Run the Culture lane's Faith purchases, Naturalists and Rock Bands, for an empire racing Culture under an Expansion plan. | — | **on** | +25 | +2 | -3 | 16.74% (n=60,748) | 16.59% (n=55,940) | 0.16% | +8 [-13, +29] | 77.4% | -0.15 (z -1.44) ~ | -0.43% ±0.27% | -0.58% ±0.41% |
| 60 | `garrison-under-fire` | Treat a city that is losing hitpoints as besieged even when fog hides every attacker. | — | off | +3 | -29 | -6 | 16.74% (n=102,837) | 16.59% (n=105,891) | 0.15% | +8 [-18, +34] | 72.9% | +0.02 (z +0.18) ~ | -0.16% ±0.25% | -0.17% ±0.38% |
| 61 | `strategic-wonders` | Price a wonder's effects in the victory lane's currency and build the ones that lane needs. | — | off | +32 | +9 | -9 | 16.74% (n=102,850) | 16.59% (n=105,878) | 0.15% | +8 [-7, +23] | 84.6% | +0.04 (z +0.43) ~ | +0.19% ±0.25% | +0.50% ±0.39% |
| 62 | `inquisition-on-threat` | Let a founder under conversion pressure buy one Apostle to launch the Inquisition after its Missionaries. | — | **on** | +19 | -14 | +3 | 16.72% (n=99,301) | 16.58% (n=64,535) | 0.14% | +9 [-8, +27] | 85.5% | -0.02 (z -0.18) ~ | +0.44% ±0.30% | +0.36% ±0.45% |
| 63 | `wonder-ring-settle-value` | Credit a settle site for the modeled appeal and yields of a revealed natural wonder's neighbouring tiles. | — | off | -7 | +61 | +2 | 16.72% (n=117,825) | 16.60% (n=90,903) | 0.12% | +7 [-11, +24] | 76.9% | +0.04 (z +0.29) ~ | -0.52% ±0.30% | -0.78% ±0.46% |
| 64 | `research-tier-premium` | Scale a missing Campus building's debt by its own science yield, so Universities and Labs outrank Libraries. | — | off | +10 | -28 | -2 | 16.72% (n=56,964) | 16.62% (n=59,724) | 0.10% | +4 [-16, +25] | 65.9% | -0.07 (z -0.72) ~ | +0.02% ±0.26% | -0.11% ±0.40% |
| 65 | `siege-tracks-wall` | Size the siege train by the wall at the target city instead of always asking for one siege unit. | — | off | -1 | +33 | -10 | 16.72% (n=102,911) | 16.62% (n=105,817) | 0.10% | +7 [-13, +26] | 74.6% | -0.24 (z -2.28) hurts * | -0.26% ±0.25% | -0.62% ±0.39% |
| 66 | `siege-commitment` | Keep the campaign aimed at a city it has already damaged instead of re-targeting a fresh one each turn. | — | off | -8 | +22 | +27 | 16.71% (n=102,990) | 16.63% (n=105,738) | 0.08% | +4 [-14, +21] | 66.2% | +0.09 (z +0.86) ~ | +0.23% ±0.25% | +0.48% ±0.39% |
| 67 | `enhancer-for-the-corps` | Choose the enhancer beliefs that multiply religious spread while the corps has a job to do. | — | off | +35 | +6 | -4 | 16.71% (n=56,814) | 16.63% (n=59,874) | 0.08% | +4 [-16, +25] | 65.6% | -0.03 (z -0.24) ~ | -0.21% ±0.24% | -0.15% ±0.38% |
| 68 | `campus-adjacency-threshold` | Credit a Campus plot that reaches the Rationalism adjacency threshold with the science bonus crossing it unlocks. | — | off | +33 | -14 | +3 | 16.70% (n=56,751) | 16.63% (n=59,937) | 0.07% | +4 [-22, +30] | 62.4% | +0.09 (z +0.88) ~ | +0.45% ±0.26% | +0.85% ±0.40% |
| 69 | `blind-objective-strength` | Price a fogged objective city from its last sighting instead of treating unseen ground as empty. | — | off | -41 | +9 | -14 | 16.70% (n=102,586) | 16.64% (n=106,142) | 0.06% | +2 [-20, +24] | 57.6% | -0.08 (z -0.73) ~ | -0.16% ±0.26% | -0.51% ±0.40% |
| 70 | `theology-for-founders` | Have a founder research Theology next, after its first government, so it can build a Temple. | — | **on** | -3 | -10 | +0 | 16.69% (n=84,426) | 16.64% (n=79,410) | 0.05% | +2 [-14, +19] | 61.0% | +0.00 (z +0.04) ~ | +0.17% ±0.24% | +0.25% ±0.36% |
| 71 | `settler-target-hysteresis` | Keep a settler target dropped for danger out of the ranking for several turns instead of re-picking it immediately. | — | off | +39 | +39 | -9 | 16.69% (n=102,874) | 16.64% (n=105,854) | 0.05% | +3 [-14, +20] | 63.2% | +0.01 (z +0.05) ~ | +0.61% ±0.26% | +1.27% ±0.41% |
| 72 | `army-target-weighs-enemy` | Raise the wartime army target when the enemy outweighs us, instead of counting only our own cities. | — | off | +30 | +2 | -18 | 16.69% (n=117,630) | 16.64% (n=91,098) | 0.04% | +1 [-19, +22] | 55.5% | -0.07 (z -0.61) ~ | +0.07% ±0.29% | +0.10% ±0.44% |
| 73 | `fifteenth-citizen` | Credit growth in a Campus city near the Rationalism population gate with the science bonus crossing it unlocks. | — | off | +16 | +26 | +15 | 16.68% (n=56,983) | 16.65% (n=59,705) | 0.03% | +1 [-20, +21] | 52.6% | +0.02 (z +0.15) ~ | +0.07% ±0.25% | +0.31% ±0.39% |
| 74 | `lane-great-people` | Rank Great Person classes and project points by the victory the empire is racing, even during a war. | — | **on** | +1 | -28 | -19 | 16.68% (n=60,823) | 16.66% (n=55,865) | 0.02% | -3 [-33, +27] | 42.8% | -0.18 (z -1.79) ~ | -0.13% ±0.25% | -0.19% ±0.39% |
| 75 | `wonder-score-tally` | Let any civilization build wonders on merit by pricing the fifteen score points a finished wonder pays. | — | off | +3 | +13 | -3 | 16.68% (n=14,014) | 16.66% (n=17,270) | 0.02% | +1 [-41, +43] | 51.7% | -0.04 (z -0.43) ~ | +0.53% ±0.26% | +0.72% ±0.42% |
| 76 | `district-coverage` | Rank each district family by how much of the empire still lacks it, so Theater Squares get built. | — | off | -26 | +34 | +2 | 16.67% (n=102,818) | 16.66% (n=105,910) | 0.01% | +1 [-17, +19] | 52.2% | +0.11 (z +1.01) ~ | +0.24% ±0.26% | +0.47% ±0.40% |
| 77 | `builder-barbarian-safety` | Make a Builder retreat from, and never step into, a tile a visible barbarian can capture next turn. | — | off | +11 | -23 | -7 | 16.67% (n=74,769) | 16.66% (n=77,067) | 0.01% | +0 [-17, +18] | 52.1% | -0.05 (z -0.48) ~ | -0.14% ±0.27% | -0.34% ±0.40% |
| 78 | `escort-unstick-2` | Version 2 of escort-unstick: release a stalled settler's escort after two turns unless a visible barbarian raider can reach it. | 1 | off | -41 | +16 | +23 | v1 16.99% (n=103,891) · v2 16.67% (n=17,695) | v1 16.35% (n=104,837) · v2 16.67% (n=51,749) | -0.00% | -2 [-66, +63] | 47.8% | +0.18 (z +1.48) ~ | +0.14% ±0.36% | +0.35% ±0.56% |
| 79 | `condemn-under-congress` | Condemn a heretic whose religion the World Congress condemned, not only one belonging to a war enemy. | — | off | -10 | +30 | +15 | 16.67% (n=57,022) | 16.67% (n=59,666) | -0.00% | -1 [-21, +20] | 47.4% | +0.01 (z +0.07) ~ | +0.33% ±0.25% | +0.43% ±0.40% |
| 80 | `blind-objective-units` | Price the enemy units remembered near an unseen objective instead of reading a fogged approach as empty. | — | off | +21 | -62 | +3 | 16.66% (n=102,672) | 16.67% (n=106,056) | -0.01% | -0 [-15, +15] | 47.7% | +0.00 (z +0.04) ~ | -0.04% ±0.25% | -0.21% ±0.38% |
| 81 | `amenity-project-preemption` | In a severe empire-wide Amenity crisis, pause one repeatable project for the amenity repair chain and slot Liberalism. | — | off | +24 | +3 | -2 | 16.66% (n=102,864) | 16.67% (n=105,864) | -0.01% | +1 [-19, +21] | 52.2% | -0.08 (z -0.79) ~ | +0.16% ±0.26% | +0.54% ±0.41% |
| 82 | `campus-finishes-first` | Scale the Campus coverage bonus by how complete the empire's existing Campuses are, so Labs come before new Campuses. | — | off | -17 | -1 | +10 | 16.66% (n=56,814) | 16.68% (n=59,874) | -0.02% | -1 [-21, +20] | 47.9% | +0.19 (z +1.82) ~ | +0.07% ±0.26% | +0.19% ±0.41% |
| 83 | `endgame-war-runway` | Refuse a fresh direct war declaration once the endgame reserve leaves too few turns to capture a city. | — | off | -3 | +14 | +3 | 16.64% (n=103,025) | 16.69% (n=105,703) | -0.05% | -3 [-19, +12] | 33.1% | -0.10 (z -0.94) ~ | +0.27% ±0.26% | +0.78% ±0.41% |
| 84 | `religious-units-heal-first` | Let a wounded spreader in its own Holy Site's heal ring hold and heal instead of spending a weak charge. | — | **on** | +24 | -33 | -27 | 16.64% (n=60,755) | 16.70% (n=55,933) | -0.06% | -7 [-41, +28] | 35.5% | -0.18 (z -1.79) ~ | +0.16% ±0.25% | +0.49% ±0.39% |
| 85 | `civilian-rescue` | Walk onto any capturable civilian within reach, and always take back a Settler the barbarians hold. | — | **on** | +49 | -5 | -17 | 16.63% (n=106,768) | 16.70% (n=101,960) | -0.07% | -3 [-19, +12] | 33.3% | -0.15 (z -1.37) ~ | -0.26% ±0.27% | -0.49% ±0.41% |
| 86 | `guru-heals-the-corps` | Let a founder defending its own cities buy one Guru, the only unit that heals religious units. | — | off | +36 | -68 | +5 | 16.63% (n=56,891) | 16.70% (n=59,797) | -0.07% | -4 [-49, +41] | 43.4% | -0.00 (z -0.03) ~ | +0.34% ±0.26% | +0.59% ±0.39% |
| 87 | `deals-at-the-ceiling` | Price a trade quote at the counterparty's walk-away point less two Gold, falling back to the midpoint if refused. | — | off | -1 | – | – | 16.61% (n=1,517) | 16.69% (n=4,471) | -0.07% | -4 [-114, +106] | 47.4% | +0.09 (z +0.42) ~ | -1.03% ±0.87% | -1.88% ±1.25% |
| 88 | `fortify-idle-units` | Fortify any unit the planner gave nothing to do, not only one in a stand-down window. | — | off | +17 | +29 | -1 | 16.63% (n=33,260) | 16.70% (n=36,184) | -0.08% | -4 [-32, +24] | 39.3% | -0.08 (z -0.80) ~ | +0.08% ±0.26% | -0.08% ±0.39% |
| 89 | `settler-site-agreement` | Ask the walker's own loyalty verdict on the chosen site before building a Settler for it. | — | off | +43 | -24 | -13 | 16.63% (n=102,857) | 16.71% (n=105,871) | -0.08% | -3 [-24, +19] | 40.2% | -0.06 (z -0.53) ~ | -0.06% ±0.25% | +0.03% ±0.40% |
| 90 | `power-the-laboratory` | Credit a power plant the powered yields it switches on, above all the Research Lab's extra science. | — | off | +12 | +15 | -24 | 16.61% (n=57,016) | 16.72% (n=59,672) | -0.10% | -5 [-29, +18] | 32.7% | -0.11 (z -1.06) ~ | +0.13% ±0.26% | +0.44% ±0.41% |
| 91 | `joint-tactics` | Plan an engagement's attacks jointly across all units by search instead of one unit at a time in class order. | — | off | – | – | – | 16.61% (n=46,020) | 16.72% (n=46,020) | -0.10% | -5 [-28, +17] | 32.6% | +0.25 (z +3.84) helps * | +27.29% ±0.47% | +27.69% ±0.79% |
| 92 | `builder-worked-tile-priority` | Prefer Builder jobs on tiles citizens currently work, keeping luxury and strategic resource connections at full priority. | — | off | -8 | -34 | +7 | 16.61% (n=74,594) | 16.72% (n=77,242) | -0.11% | -5 [-27, +17] | 32.5% | +0.08 (z +0.74) ~ | +0.33% ±0.24% | +0.54% ±0.37% |
| 93 | `housing-research` | Aim research at the technology that raises the housing ceiling while housing is throttling growth. | — | off | -33 | +11 | -19 | 16.61% (n=102,757) | 16.72% (n=105,971) | -0.12% | -6 [-27, +15] | 27.5% | -0.19 (z -1.84) ~ | -0.02% ±0.27% | +0.10% ±0.42% |
| 94 | `naval-recon` | Buy one ship for a fleetless empire with unexplored water off its coast and send it exploring. | — | off | -10 | -16 | -13 | 16.61% (n=103,045) | 16.72% (n=105,683) | -0.12% | -6 [-21, +9] | 21.4% | -0.14 (z -1.29) ~ | +0.22% ±0.26% | -0.02% ±0.41% |
| 95 | `housing-districts` | Let the baseline governor build the Aqueduct and Neighborhood districts that raise the housing ceiling. | — | off | -11 | +26 | +11 | 16.59% (n=102,986) | 16.74% (n=105,742) | -0.15% | -8 [-24, +8] | 15.5% | +0.20 (z +1.88) ~ | -0.12% ±0.26% | -0.26% ±0.40% |
| 96 | `siege-is-progress` | Count damage dealt to an enemy city or its walls as campaign progress, so a winning siege is never stalled. | — | off | +8 | -5 | -8 | 16.59% (n=102,825) | 16.74% (n=105,903) | -0.15% | -9 [-29, +12] | 20.2% | +0.08 (z +0.71) ~ | +0.35% ±0.27% | +0.69% ±0.40% |
| 97 | `flip-nearby-city-states` | Add a city-state's proximity and hostile suzerain to the envoy score, amortised over envoys the flip needs. | — | off | -3 | – | – | 16.55% (n=1,462) | 16.70% (n=4,526) | -0.15% | -8 [-119, +104] | 44.7% | +0.01 (z +0.04) ~ | +0.96% ±0.93% | +1.35% ±1.22% |
| 98 | `lane-congress-ballot` | Score the World Congress ballot for the victory the empire is racing while its plan is still Expansion. | — | off | +11 | -23 | -2 | 16.59% (n=57,027) | 16.74% (n=59,661) | -0.15% | -7 [-27, +14] | 26.9% | +0.08 (z +0.75) ~ | -0.52% ±0.27% | -0.77% ±0.42% |
| 99 | `congress-banks-decided` | Cast the free vote on an already-decided resolution's winner to bank the Diplomatic Victory Point for predicting it. | — | off | +27 | -55 | -5 | 16.58% (n=56,859) | 16.75% (n=59,829) | -0.17% | -9 [-35, +17] | 24.2% | +0.07 (z +0.68) ~ | -0.08% ±0.26% | +0.05% ±0.40% |
| 100 | `barbarian-capture-priority` | Capture a visible barbarian-held Settler or Scout within one-turn reach before healing, retreating or any other move. | — | off | +13 | -11 | -13 | 16.58% (n=56,668) | 16.75% (n=60,020) | -0.17% | -8 [-29, +13] | 22.4% | -0.04 (z -0.37) ~ | +0.05% ±0.26% | +0.01% ±0.41% |
| 101 | `home-defense` | Let hostile units inside our own territory claim defenders before the offensive campaign takes them. | — | off | +11 | -22 | -4 | 16.58% (n=103,297) | 16.76% (n=105,431) | -0.18% | -10 [-25, +6] | 10.9% | +0.09 (z +0.91) ~ | -0.13% ±0.26% | -0.02% ±0.40% |
| 102 | `lane-congress-favor` | Stake Favor behind a World Congress ballot for the victory the empire is racing while its plan is Expansion. | — | off | +22 | -25 | -3 | 16.57% (n=56,800) | 16.76% (n=59,888) | -0.19% | -10 [-30, +11] | 17.4% | -0.09 (z -0.83) ~ | +0.37% ±0.25% | +0.53% ±0.38% |
| 103 | `coupled-expansion` | Price a Settler as an investment, subtracting production, population, escort, route and safety costs from the site's payback. | — | off | +40 | -1 | -18 | 16.56% (n=33,371) | 16.77% (n=36,073) | -0.21% | -4 [-47, +38] | 41.8% | -0.15 (z -1.44) ~ | -0.20% ±0.26% | -0.14% ±0.40% |
| 104 | `envoy-infrastructure` | Value the Consulate, Chancery and Diplomatic Quarter by the envoys their influence can produce before the turn limit. | — | off | -43 | -6 | -11 | 16.55% (n=56,861) | 16.78% (n=59,827) | -0.23% | -12 [-33, +10] | 14.2% | -0.03 (z -0.25) ~ | +0.16% ±0.26% | +0.34% ±0.38% |
| 105 | `one-shot-recovery` | Withdraw a unit that one enemy blow could kill to safe healing ground, and leave when threatened again. | — | off | -13 | -48 | -16 | 16.55% (n=56,850) | 16.78% (n=59,838) | -0.23% | -12 [-33, +9] | 14.0% | -0.19 (z -1.75) ~ | -0.16% ±0.26% | -0.38% ±0.41% |
| 106 | `congress-counter-votes` | Back the counter-victory ballot with every Favor the treasury can spare, since a losing vote is refunded. | — | off | -34 | -5 | +12 | 16.55% (n=56,783) | 16.78% (n=59,905) | -0.24% | -12 [-34, +10] | 14.6% | -0.10 (z -0.95) ~ | -0.24% ±0.27% | -0.55% ±0.41% |
| 107 | `war-patience` | Keep fighting a war the empire overwhelmingly outweighs instead of offering peace because it reads as stalled. | — | off | -9 | -25 | -4 | 16.54% (n=102,840) | 16.79% (n=105,888) | -0.24% | -12 [-28, +3] | 5.6% | -0.07 (z -0.66) ~ | -0.07% ±0.26% | -0.14% ±0.40% |
| 108 | `holy-site-where-the-threat-is` | Build a Holy Site in the city losing its religious majority so defenders can be bought there directly. | — | off | -15 | +4 | -27 | 16.54% (n=56,896) | 16.78% (n=59,792) | -0.24% | -14 [-43, +14] | 16.0% | -0.23 (z -2.20) hurts * | -0.15% ±0.26% | -0.17% ±0.40% |
| 109 | `tactical-strategy` | Assign explicit battlefield roles: counter cycle, ranged standoff, siege against walls, escorts and cavalry jobs. | — | off | -10 | -27 | +7 | 16.54% (n=33,397) | 16.78% (n=36,047) | -0.24% | -13 [-41, +15] | 19.0% | +0.02 (z +0.17) ~ | +0.03% ±0.25% | +0.19% ±0.39% |
| 110 | `barbarian-hunt` | Walk onto a visible, undefended barbarian camp one step away and clear it for the gold bounty. | — | off | +21 | +0 | +17 | 16.54% (n=74,469) | 16.79% (n=77,367) | -0.26% | -6 [-49, +37] | 39.3% | +0.10 (z +0.96) ~ | -1.11% ±0.27% | -1.52% ±0.41% |
| 111 | `culture-coverage` | Pay a coverage bonus for a Theater Square in every city that lacks one, as the Campus already gets. | — | off | -2 | +3 | -23 | 16.52% (n=56,764) | 16.80% (n=59,924) | -0.28% | -14 [-35, +7] | 9.0% | -0.05 (z -0.46) ~ | +0.01% ±0.26% | +0.14% ±0.40% |
| 112 | `district-lookahead-settle` | Score a settle site by the districts the lane would actually build there, each on its own plot. | — | off | +6 | +21 | -3 | 16.52% (n=74,414) | 16.81% (n=77,422) | -0.29% | -15 [-36, +6] | 8.5% | +0.04 (z +0.37) ~ | -0.03% ±0.27% | -0.15% ±0.42% |
| 113 | `priced-tile-purchase` | Buy a border plot only when its priced benefit clears its Gold cost by a margin. | — | off | -43 | +57 | -13 | 16.52% (n=74,583) | 16.81% (n=77,253) | -0.29% | -15 [-44, +13] | 14.3% | -0.21 (z -1.94) ~ | -0.34% ±0.25% | +0.08% ±0.39% |
| 114 | `spread-campaign-persists` | Keep a spread campaign on the offensive between waves once it has converted a foreign city. | — | off | +16 | +23 | -15 | 16.52% (n=56,901) | 16.81% (n=59,787) | -0.29% | -15 [-36, +6] | 8.3% | -0.11 (z -1.02) ~ | -0.37% ±0.26% | -0.49% ±0.39% |
| 115 | `district-building-chain` | Make every specialty district owe the buildings inside it, whatever victory lane the empire is playing. | — | off | -20 | -6 | -6 | 16.52% (n=56,725) | 16.81% (n=59,963) | -0.29% | -14 [-35, +7] | 9.6% | -0.04 (z -0.37) ~ | -0.34% ±0.25% | -0.61% ±0.39% |
| 116 | `lane-commit` | From mid-game commit an adaptive seat to the victory lane it leads the field in, instead of re-picking each turn. | — | off | -6 | – | – | 16.42% (n=1,510) | 16.75% (n=4,478) | -0.32% | -16 [-126, +94] | 38.6% | +0.12 (z +0.56) ~ | -0.70% ±0.88% | -0.65% ±1.24% |
| 117 | `settle-plan-ahead` | Rank a settle site by the future city sites it leaves room for as well as its own ground. | — | off | -17 | -1 | +1 | 16.45% (n=33,099) | 16.87% (n=36,345) | -0.42% | -21 [-49, +7] | 6.7% | +0.03 (z +0.25) ~ | +0.46% ±0.26% | +0.73% ±0.39% |
| 118 | `builder-reward-survey` | Price a Builder by surveying the improvement jobs it would actually do, not by a city-count quota. | — | off | -21 | -94 | -23 | 16.10% (n=33,309) | 17.19% (n=36,135) | -1.09% | -66 [-112, -20] | 0.2% | -0.28 (z -2.69) hurts * | +1.59% ±0.26% | +1.76% ±0.40% |
| 119 | `contact-posture` | Let a unit inside enemy reach choose to hold and heal, close on a shooter, or step out of range. | — | off | -17 | -34 | -31 | 16.08% (n=56,753) | 17.22% (n=59,935) | -1.15% | -58 [-78, -37] | 0.0% | -0.24 (z -2.36) hurts * | -0.20% ±0.26% | -0.21% ±0.40% |
| 120 | `pillage-to-heal` | Let a unit at or below 65 health pillage a healing improvement on or beside its tile before retreating. | — | off | -23 | – | – | 15.79% (n=1,545) | 16.97% (n=4,443) | -1.18% | -59 [-165, +47] | 13.8% | +0.02 (z +0.11) ~ | +0.75% ±0.90% | +1.68% ±1.19% |
| 121 | `zoc-screen` | Stand an idle melee unit where its zone of control shields our shooters and wounded from the most enemy reaches. | — | off | -26 | – | – | 15.61% (n=1,505) | 17.02% (n=4,483) | -1.41% | -70 [-176, +35] | 9.6% | -0.36 (z -1.66) ~ | +1.52% ±0.87% | +2.33% ±1.21% |
| 122 | `naval-production-policy` | Slot the naval-production policy card while a coastal empire wants hulls it does not have. | — | off | -80 | -65 | -66 | 15.73% (n=33,235) | 17.52% (n=36,209) | -1.79% | -121 [-189, -53] | 0.0% | -0.60 (z -5.71) hurts * | -0.14% ±0.25% | -0.41% ±0.37% |
| 123 | `no-free-passage` | Stop bundling free one-way Open Borders into friendship and alliance proposals; sell passage through the quote lane. | — | off | -36 | – | – | 15.25% (n=1,534) | 17.15% (n=4,454) | -1.90% | -95 [-199, +9] | 3.7% | -0.38 (z -1.78) ~ | -0.09% ±0.87% | -0.21% ±1.18% |
| 124 | `fog-honest` | Plan the whole turn against a fog-redacted world and replay only the resulting orders on the real game. | 1 | off | -95 | -145 | -112 | v1 11.70% (n=7,126) · v2 4.22% (n=7,054) | v1 18.13% (n=24,158) · v2 20.29% (n=24,230) | -6.43% | -366 [-464, -269] | 0.0% | -1.11 (z -9.73) hurts * | +0.65% ±0.30% | +1.60% ±0.45% |
| 125 | `fog-honest-2` | Version 2 of fog-honest: the same redacted planning plus one re-plan from the real board when an order is refused. | 1 | off | -187 | -275 | -308 | v1 11.70% (n=7,126) · v2 4.22% (n=7,054) | v1 18.13% (n=24,158) · v2 20.29% (n=24,230) | -16.06% | -820 [-885, -755] | 0.0% | -4.58 (z -48.06) hurts * | +5.28% ±0.34% | +5.99% ±0.51% |
