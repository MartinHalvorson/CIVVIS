...
| 117 | `pillage-to-heal` | Let a unit at or below 65 health pillage a healing improvement on or beside its tile before retreating. | — | off | -23 | – | – | 15.79% (n=1,545) | 16.97% (n=4,443) | -1.18% | -59 [-165, +47] | 13.8% | +0.02 (z +0.11) ~ | +0.75% ±0.90% | +1.68% ±1.19% |
| 118 | `zoc-screen` | Stand an idle melee unit where its zone of control shields our shooters and wounded from the most enemy reaches. | — | off | -26 | – | – | 15.61% (n=1,505) | 17.02% (n=4,483) | -1.41% | -70 [-176, +35] | 9.6% | -0.36 (z -1.66) ~ | +1.52% ±0.87% | +2.33% ±1.21% |
| 119 | `no-free-passage` | Stop bundling free one-way Open Borders into friendship and alliance proposals; sell passage through the quote lane. | — | off | -36 | – | – | 15.25% (n=1,534) | 17.15% (n=4,454) | -1.90% | -95 [-199, +9] | 3.7% | -0.38 (z -1.78) ~ | -0.09% ±0.87% | -0.21% ±1.18% |
| 120 | `fog-honest` | Plan the whole turn against a fog-redacted world and replay only the resulting orders on the real game. | 1 | off | -95 | -145 | -112 | v1 11.70% (n=7,126) · v2 4.22% (n=7,054) | v1 18.13% (n=24,158) · v2 20.29% (n=24,230) | -6.43% | -366 [-464, -269] | 0.0% | -1.11 (z -9.73) hurts * | +0.65% ±0.30% | +1.60% ±0.45% |
| 121 | `fog-honest-2` | Version 2 of fog-honest: the same redacted planning plus one re-plan from the real board when an order is refused. | 1 | off | -187 | -275 | -308 | v1 11.70% (n=7,126) · v2 4.22% (n=7,054) | v1 18.13% (n=24,158) · v2 20.29% (n=24,230) | -16.06% | -820 [-885, -755] | 0.0% | -4.58 (z -48.06) hurts * | +5.28% ±0.34% | +5.99% ±0.51% |
