...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(-12), Some(-35), Some(9)]),
    ("air-surge", [Some(3), Some(-3), Some(13)]),
    ("air-surge-2", [Some(15), Some(-24), Some(2)]),
    ("amani-follows-suzerainty", [Some(-16), Some(-45), Some(-3)]),
    ("amenity-district-path", [Some(0), Some(-12), Some(4)]),
    ("amenity-project-preemption", [Some(12), Some(-18), Some(-2)]),
    ("amenity-project-preemption-2", [Some(-6), Some(29), Some(0)]),
    ("anvil", [Some(-15), Some(24), Some(1)]),
    ("apostle-promotion-by-role", [Some(15), Some(12), Some(-9)]),
    ("army-target-weighs-enemy", [Some(-19), Some(-48), Some(-31)]),
    ("barbarian-bargain", [Some(-2), Some(-32), Some(5)]),
    ("barbarian-ranged-answer", [Some(-1), Some(14), Some(-6)]),
    ("barbarian-scouts-are-scouts", [Some(24), Some(-12), Some(4)]),
    ("barbarian-settler-capture", [Some(36), Some(-42), Some(16)]),
    ("battle-planner", [Some(7), Some(3), Some(20)]),
    ("battle-planner-2", [Some(39), Some(69), Some(22)]),
    ("battle-planner-3", [Some(1), Some(-1), Some(12)]),
    ("blind-objective-strength", [Some(6), Some(4), Some(10)]),
    ("blind-objective-units", [Some(-7), Some(-5), Some(-28)]),
    ("boost-first-research", [Some(0), Some(39), Some(-8)]),
    ("boost-first-research-2", [Some(13), Some(-11), Some(0)]),
    ("boost-unlock-research", [Some(7), Some(23), Some(21)]),
    ("boost-wait-research-2", [Some(-8), Some(-21), Some(7)]),
    ("boosted-bargain-first", [Some(1), Some(11), Some(4)]),
    ("boosted-bargain-first-2", [Some(-1), Some(-58), Some(-11)]),
    ("border-parity", [Some(6), Some(-22), Some(-16)]),
    ("border-parity-2", [Some(-17), Some(46), Some(-1)]),
    ("border-parity-3", [Some(-5), Some(-2), Some(5)]),
    ("bounded-recovery", [Some(1), Some(17), Some(-5)]),
    ("build-what-cards-boost", [Some(0), Some(29), Some(-2)]),
    ("builder-barbarian-safety", [Some(-13), Some(52), Some(-2)]),
    ("builder-supply-floor", [Some(3), Some(23), Some(1)]),
    ("builder-tries-the-next-tile", [Some(-16), Some(10), Some(2)]),
    ("builder-workforce-recovery", [Some(-12), Some(-19), Some(5)]),
    ("builder-workforce-recovery-2", [Some(26), Some(41), Some(8)]),
    ("buildings-before-projects", [Some(12), Some(4), Some(14)]),
    ("buy-what-cards-cannot-boost", [Some(1), Some(-40), Some(-3)]),
    ("camp-party", [Some(-8), Some(-18), Some(11)]),
    ("camp-tile-buyout", [Some(-3), Some(25), Some(-3)]),
    ("campaign-pillage", [Some(4), Some(-20), Some(10)]),
    ("campus-adjacency-threshold", [Some(-21), Some(-27), Some(-6)]),
    ("campus-adjacency-threshold-2", [Some(5), Some(13), Some(1)]),
    ("campus-before-halfway", [Some(-1), Some(-20), Some(-16)]),
    ("campus-through-expansion", [Some(-2), Some(-8), Some(-22)]),
    ("canal-city", [Some(-25), Some(-31), Some(-8)]),
    ("capital-settler-after-completion", [Some(1), Some(68), Some(0)]),
    ("capture-go-or-stand-down", [Some(12), Some(-12), Some(-10)]),
    ("capture-go-or-stand-down-2", [Some(-2), Some(8), Some(10)]),
    ("chain-payback-window", [Some(-1), Some(-56), Some(2)]),
    ("chain-payback-window-2", [Some(-21), Some(34), Some(3)]),
    ("chase-every-boost", [Some(24), Some(42), Some(22)]),
    ("chase-every-boost-2", [Some(-25), Some(-31), Some(-11)]),
    ("cheapest-wonder-first", [Some(7), Some(-19), Some(-20)]),
    ("chokepoint-claim", [Some(-6), Some(-14), Some(11)]),
    ("chokepoint-garrison", [Some(7), Some(12), Some(9)]),
    ("chokepoint-siting", [Some(6), Some(-10), Some(-9)]),
    ("city-campaign", [Some(-36), Some(30), Some(-28)]),
    ("city-campaign-2", [Some(21), Some(14), Some(22)]),
    ("city-target-meets-the-map", [Some(7), Some(1), Some(-2)]),
    ("civilian-out-of-reach", [Some(-12), Some(-48), Some(-17)]),
    ("close-as-a-body", [Some(5), Some(-5), Some(9)]),
    ("coalition-before-war", [Some(1), Some(26), Some(-6)]),
    ("coalition-before-war-2", [Some(-5), Some(-24), Some(7)]),
    ("coalition-before-war-3", [Some(8), Some(-39), Some(8)]),
    ("coastal-city-sites", [Some(5), Some(-21), Some(-4)]),
    ("coastal-city-sites-2", [Some(18), Some(-11), Some(6)]),
    ("come-ashore", [Some(24), Some(11), Some(-13)]),
    ("commitment-owner-acts", [Some(2), Some(4), Some(-9)]),
    ("commitment-patience", [Some(-6), Some(18), Some(-4)]),
    ("competition-victory-points", [Some(11), Some(5), Some(34)]),
    ("congress-counter-leader", [Some(31), Some(3), Some(-5)]),
    ("connect-the-luxury", [Some(23), Some(83), Some(46)]),
    ("contested-land-first", [Some(34), Some(-28), Some(-2)]),
    ("conversion-majority-alarm", [Some(-7), Some(-28), Some(-18)]),
    ("conversion-majority-alarm-2", [Some(-7), Some(-18), Some(-4)]),
    ("coordinated-finish", [Some(-11), Some(-39), Some(20)]),
    ("culture-building-catchup", [Some(-9), Some(-14), Some(-8)]),
    ("culture-building-catchup-2", [Some(-11), Some(7), Some(-5)]),
    ("culture-building-debt", [Some(-1), Some(-31), Some(7)]),
    ("culture-floor", [Some(-21), Some(70), Some(-2)]),
    ("culture-lane-forecast", [Some(-8), Some(19), Some(-2)]),
    ("culture-threat-early", [Some(-2), Some(-39), Some(-14)]),
    ("deals-at-the-ceiling", [Some(-1), Some(-4), Some(10)]),
    ("deals-for-our-gain", [Some(-3), Some(46), Some(-2)]),
    ("defend-where-you-stand", [Some(11), Some(3), Some(1)]),
    ("defensible-sites", [Some(29), Some(-25), Some(20)]),
    ("detour-keeps-the-site-worth", [Some(3), Some(-20), Some(-13)]),
    ("diplomatic-lane-forecast", [Some(17), Some(-33), Some(16)]),
    ("diplomatic-lane-forecast-2", [Some(2), Some(10), Some(-9)]),
    ("district-coverage", [Some(-11), Some(-21), Some(9)]),
    ("district-coverage-2", [Some(9), Some(22), Some(-20)]),
    ("district-planning", [Some(10), Some(9), Some(-10)]),
    ("district-planning-3", [Some(-20), Some(-17), Some(18)]),
    ("domination-city-count", [Some(8), Some(-24), Some(18)]),
    ("doomed-blow-veto", [Some(7), Some(-39), Some(3)]),
    ("doomed-blow-veto-2", [Some(-4), Some(26), Some(23)]),
    ("early-archers", [Some(-5), Some(-13), Some(12)]),
    ("early-contact-window", [Some(-1), Some(-11), Some(-23)]),
    ("early-contact-window-2", [Some(-14), Some(-15), None]),
    ("early-project-restraint", [Some(1), Some(-14), Some(6)]),
    ("early-project-restraint-2", [Some(-8), Some(-14), Some(6)]),
    ("elective-war-in-reach", [Some(2), Some(4), Some(29)]),
    ("elective-war-yields-to-a-lane", [Some(34), Some(47), Some(56)]),
    ("encampment-seals-the-pass", [Some(1), Some(13), Some(1)]),
    ("enemy-of-my-enemy", [Some(-1), Some(14), Some(-22)]),
    ("engine-faith-price", [Some(11), Some(7), Some(36)]),
    ("enhancer-for-the-corps", [Some(7), Some(-19), Some(7)]),
    ("enter-the-prophet-race-2", [Some(-22), Some(-31), Some(-8)]),
    ("envoy-building-dividends", [Some(-2), Some(-1), Some(-6)]),
    ("escort-cap-holds", [Some(10), Some(-11), Some(3)]),
    ("escort-unstick", [Some(46), Some(59), Some(29)]),
    ("eureka-chasing-builder", [Some(-5), Some(8), Some(5)]),
    ("eureka-chasing-builder-2", [Some(16), Some(-23), Some(-6)]),
    ("eureka-chasing-production", [Some(3), Some(11), Some(0)]),
    ("exchange-is-the-engines", [Some(-14), Some(-28), Some(6)]),
    ("exhaustion-loyalty-guard", [Some(-23), Some(5), Some(6)]),
    ("expansion-best-idle-city", [Some(-10), Some(-20), Some(7)]),
    ("expansion-best-idle-city-2", [Some(16), Some(26), Some(-1)]),
    ("expansion-pays-back", [Some(-5), Some(14), Some(-7)]),
    ("expansion-schedule", [Some(31), Some(-52), Some(5)]),
    ("fire-plan", [Some(15), Some(24), Some(-2)]),
    ("first-builder-reserve", [Some(-2), Some(21), Some(18)]),
    ("first-builder-reserve-2", [Some(12), Some(2), Some(-15)]),
    ("first-district-first", [Some(-6), Some(-3), Some(21)]),
    ("first-granary-reserve", [Some(1), Some(14), Some(-10)]),
    ("first-luxury-first", [Some(-4), Some(1), Some(-11)]),
    ("first-research-building-reserve", [Some(-14), Some(-46), Some(5)]),
    ("founder-temple", [Some(15), Some(24), Some(-2)]),
    ("frontier-massing-alarm", [Some(-6), Some(-6), Some(0)]),
    ("garrison-under-fire", [Some(-9), Some(15), Some(-9)]),
    ("gold-income-floor", [Some(20), Some(48), Some(-5)]),
    ("government-capacity-fallback", [Some(-2), Some(34), Some(-24)]),
    ("government-ladder", [Some(-18), Some(36), Some(7)]),
    ("government-ladder-2", [Some(28), Some(-23), Some(4)]),
    ("great-person-housing", [Some(2), Some(2), Some(9)]),
    ("growth-to-settle", [Some(11), Some(-2), Some(8)]),
    ("guru-heals-the-corps-2", [Some(14), Some(67), Some(16)]),
    ("holy-lane-parity", [Some(-7), Some(7), Some(-21)]),
    ("holy-site-where-the-threat-is", [Some(-10), Some(-47), Some(-8)]),
    ("holy-site-where-the-threat-is-2", [Some(-6), Some(21), Some(-8)]),
    ("hostile-memory", [Some(-25), Some(-38), Some(-39)]),
    ("hostile-memory-2", [Some(-18), Some(-54), None]),
    ("housing-research", [Some(-33), Some(7), Some(8)]),
    ("idle-faith-patronage", [Some(-13), Some(-40), Some(22)]),
    ("industrial-chain-debt", [Some(19), Some(45), Some(19)]),
    ("island-exploration", [Some(26), Some(-29), Some(6)]),
    ("lane-culture-spending", [Some(3), Some(11), Some(-2)]),
    ("lane-great-people", [Some(5), Some(12), Some(11)]),
    ("lane-policy-deck", [Some(2), Some(14), Some(-1)]),
    ("lane-release-when-hopeless", [Some(6), Some(26), Some(19)]),
    ("lane-space-race", [Some(12), Some(-13), Some(7)]),
    ("lane-votes-its-favor", [Some(0), Some(-25), Some(-15)]),
    ("liang-follows-builders", [Some(-15), Some(32), Some(17)]),
    ("loyalty-rate-alarm", [Some(26), Some(43), Some(57)]),
    ("magnus-follows-settlers", [Some(-12), Some(-4), Some(13)]),
    ("maintenance-aware-deck", [Some(-4), Some(16), Some(31)]),
    ("missionary-evades-raiders", [Some(2), Some(-10), Some(7)]),
    ("missionary-last-charge-explores", [Some(-6), Some(31), Some(-16)]),
    ("missionary-last-charge-explores-2", [Some(-4), Some(-4), Some(4)]),
    ("modernize-before-spending", [Some(2), Some(52), Some(-16)]),
    ("moksha-defends-the-faithless", [Some(-10), Some(37), Some(0)]),
    ("native-emergency-purchase", [Some(15), Some(13), Some(-6)]),
    ("native-emergency-purchase-2", [Some(-3), Some(-60), Some(-8)]),
    ("naval-recon", [Some(3), Some(1), Some(2)]),
    ("naval-recon-2", [Some(8), Some(-14), Some(14)]),
    ("naval-recon-3", [Some(-9), Some(5), Some(8)]),
    ("naval-threat-triage", [Some(-31), Some(6), Some(2)]),
    ("never-an-empty-queue", [Some(-4), Some(12), Some(15)]),
    ("never-an-empty-queue-2", [Some(-8), Some(-31), Some(17)]),
    ("never-an-empty-queue-3", [Some(16), Some(27), Some(-13)]),
    ("no-free-passage", [Some(14), Some(32), Some(6)]),
    ("objective-board", [Some(29), Some(-69), Some(9)]),
    ("one-launch-pad", [Some(10), Some(-5), Some(4)]),
    ("one-shot-recovery", [Some(16), Some(10), Some(28)]),
    ("one-war-at-a-time", [Some(29), Some(-16), Some(22)]),
    ("opening-warrior-recon-2", [Some(-19), Some(-37), Some(-16)]),
    ("opportunistic-war", [Some(3), Some(-3), Some(-22)]),
    ("opportunistic-war-2", [Some(-17), Some(5), None]),
    ("order-retry", [Some(4), Some(16), Some(-4)]),
    ("overseas-settlement", [Some(-10), Some(28), Some(-13)]),
    ("pantheon-board", [Some(9), Some(-13), Some(14)]),
    ("pass-picket", [Some(18), Some(-20), Some(-1)]),
    ("pass-picket-2", [Some(-10), Some(-31), None]),
    ("peace-when-the-war-does-not-pay", [Some(0), Some(80), Some(15)]),
    ("peacetime-deterrence", [Some(10), Some(23), Some(-22)]),
    ("pingala-follows-research", [Some(-6), Some(2), Some(2)]),
    ("power-the-laboratory", [Some(0), Some(-15), Some(-4)]),
    ("power-the-laboratory-2", [Some(-2), Some(55), Some(-12)]),
    ("price-the-suzerainty", [Some(7), Some(31), Some(-13)]),
    ("promote-when-wounded", [Some(9), Some(-38), Some(0)]),
    ("quest-boost", [Some(-20), Some(-44), Some(19)]),
    ("quest-camp-errand", [Some(-14), Some(-4), Some(4)]),
    ("quest-production", [Some(27), Some(36), Some(6)]),
    ("quest-trade-route", [Some(3), Some(-13), Some(3)]),
    ("raid-pillage-prizes", [Some(-26), Some(-33), Some(-23)]),
    ("rapid-city-expansion-2", [Some(0), Some(21), Some(0)]),
    ("recon-replacement", [Some(7), Some(-21), Some(-3)]),
    ("recorded-tactical-step", [Some(25), Some(39), Some(2)]),
    ("recovery-reads-the-war", [Some(-6), Some(12), Some(-10)]),
    ("recovery-reads-the-war-2", [Some(-2), Some(16), Some(-11)]),
    ("relief-column-marches", [Some(-2), Some(-12), Some(-2)]),
    ("relief-targets-the-siege", [Some(-14), Some(2), Some(-17)]),
    ("religion-race-is-closed", [Some(-29), Some(-14), Some(6)]),
    ("religion-sues-peace", [Some(14), Some(-20), Some(-24)]),
    ("religious-defence-scales", [Some(11), Some(-17), Some(38)]),
    ("religious-units-heal-first", [Some(26), Some(87), Some(-9)]),
    ("religious-veto-defence", [Some(13), Some(42), Some(41)]),
    ("requisitions", [Some(-5), Some(28), Some(-13)]),
    ("research-building-catchup", [Some(-8), Some(-1), Some(-4)]),
    ("research-building-catchup-2", [Some(-5), Some(28), Some(11)]),
    ("research-tier-premium", [Some(-6), Some(27), Some(0)]),
    ("reyna-follows-revenue", [Some(-4), Some(-20), Some(-10)]),
    ("rival-suzerainty-alarm", [Some(2), Some(48), Some(2)]),
    ("route-block-is-a-wait", [Some(1), Some(-15), Some(-12)]),
    ("safest-stand", [Some(13), Some(-5), Some(2)]),
    ("science-building-first", [Some(20), Some(-22), Some(-2)]),
    ("science-chain-alarm", [Some(-19), Some(2), Some(11)]),
    ("science-expansion-phase", [Some(5), Some(35), Some(-7)]),
    ("science-multiplier-payoff", [Some(5), Some(-3), Some(13)]),
    ("science-opening-band", [Some(15), Some(21), Some(10)]),
    ("science-victory-drive", [Some(14), Some(4), Some(-8)]),
    ("science-victory-drive-2", [Some(-7), Some(67), Some(44)]),
    ("scout-first-opening", [Some(-1), Some(-37), Some(23)]),
    ("screen-the-shooters", [Some(-2), Some(52), Some(14)]),
    ("settle-sooner", [Some(20), Some(7), Some(-4)]),
    ("settlement-gap-target", [Some(1), Some(77), Some(-13)]),
    ("settler-backlog-brake", [Some(-27), Some(3), Some(17)]),
    ("settler-backlog-brake-2", [Some(24), Some(28), Some(-5)]),
    ("settler-factory-coordination", [Some(-13), Some(-3), Some(-1)]),
    ("settler-guard-holds", [Some(1), Some(-18), Some(3)]),
    ("settler-guard-holds-2", [Some(15), Some(25), Some(-3)]),
    ("settler-never-idles", [Some(25), Some(12), Some(-3)]),
    ("settler-site-gate", [Some(-4), Some(17), Some(-12)]),
    ("settler-target-floor", [Some(-9), Some(-23), Some(1)]),
    ("settler-target-hysteresis", [Some(12), Some(-28), Some(-6)]),
    ("settler-target-hysteresis-2", [Some(3), Some(16), Some(1)]),
    ("settler-threat-detour", [Some(15), Some(-1), Some(-14)]),
    ("settler-walk-deadline", [Some(24), Some(-7), Some(13)]),
    ("siege-commitment", [Some(16), Some(-3), Some(-2)]),
    ("siege-is-progress-2", [Some(-14), Some(-7), Some(-6)]),
    ("siege-is-progress-3", [Some(-12), Some(16), Some(-10)]),
    ("siege-preempts-the-queue", [Some(-34), Some(-25), Some(-26)]),
    ("siege-train", [Some(-6), Some(-71), Some(13)]),
    ("skip-the-prophet-race-2", [Some(6), Some(-23), Some(10)]),
    ("slot-kind-tiebreak", [Some(23), Some(-25), Some(3)]),
    ("solvency-first-trade-slot", [Some(101), Some(104), Some(89)]),
    ("spaceport-surplus-veto", [Some(-13), Some(-7), Some(-1)]),
    ("standing-still-is-a-risk", [Some(-1), Some(32), Some(20)]),
    ("stranded-settler-discount", [Some(-9), Some(-17), Some(-22)]),
    ("strategic-wonders", [Some(-8), Some(-42), Some(-6)]),
    ("strike-opening", [Some(3), Some(-35), Some(-4)]),
    ("strike-reach", [Some(1), Some(-9), Some(7)]),
    ("surprise-war-mobilization", [Some(2), Some(-29), Some(-12)]),
    ("swap-rotation", [Some(-20), Some(-16), Some(8)]),
    ("swap-rotation-2", [Some(8), Some(21), Some(-7)]),
    ("threatened-city-reserve", [Some(-12), Some(-8), Some(-15)]),
    ("trade-building-before-bankruptcy", [Some(4), Some(0), Some(-8)]),
    ("trade-building-before-bankruptcy-2", [Some(-5), Some(-6), Some(1)]),
    ("trade-route-network", [Some(9), Some(5), Some(-3)]),
    ("treasury-at-work-2", [Some(11), Some(-16), Some(28)]),
    ("unchosen-war-keeps-the-lane", [Some(15), Some(-40), Some(-9)]),
    ("unit-cost-efficiency", [Some(-6), Some(45), Some(16)]),
    ("unit-objective-memory", [Some(-10), Some(-2), Some(7)]),
    ("upgrade-the-garrison", [Some(-19), Some(50), Some(8)]),
    ("veterans-withdraw-early", [Some(-21), Some(27), Some(9)]),
    ("walls-after-districts", [Some(-8), Some(9), Some(11)]),
    ("war-economy", [Some(-3), Some(-35), Some(0)]),
    ("war-needs-a-treasury", [Some(14), Some(-11), Some(27)]),
    ("war-policy-via-board", [Some(24), Some(31), Some(24)]),
    ("war-reinforcement", [Some(6), Some(-12), Some(1)]),
    ("whole-turn-backtrack-guard", [Some(30), Some(-16), Some(3)]),
    ("wide-map-capacity", [Some(28), Some(0), Some(-2)]),
    ("wonder-adjacent-sites-2", [Some(7), Some(9), Some(22)]),
    ("wonder-ring-recon", [Some(-1), Some(-17), Some(-14)]),
    ("wonder-ring-recon-2", [Some(-12), Some(6), Some(9)]),
    ("wonder-score-tally", [Some(-20), Some(16), Some(2)]),
    ("wounded-out-of-reach", [Some(13), Some(-46), Some(0)]),
    ("wounded-out-of-reach-2", [Some(-18), Some(31), None]),
];
