...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(-3), None, None]),
    ("air-surge", [Some(0), Some(-7), Some(7)]),
    ("amenity-district-path", [Some(5), Some(-8), Some(2)]),
    ("amenity-project-preemption", [Some(22), Some(-5), Some(-25)]),
    ("amenity-project-preemption-2", [Some(18), Some(22), Some(29)]),
    ("apostle-promotion-by-role", [Some(15), Some(2), Some(1)]),
    ("army-target-weighs-enemy", [Some(9), Some(12), Some(-4)]),
    ("barbarian-bargain", [Some(38), Some(9), Some(2)]),
    ("barbarian-ranged-answer", [Some(-10), Some(20), Some(23)]),
    ("barbarian-scouts-are-scouts", [Some(5), Some(-2), Some(3)]),
    ("barbarian-settler-capture", [Some(32), Some(44), Some(27)]),
    ("blind-objective-strength", [Some(7), Some(1), Some(-4)]),
    ("blind-objective-units", [Some(-7), Some(11), Some(10)]),
    ("boost-first-research", [Some(-3), Some(-11), Some(5)]),
    ("boost-unlock-research", [Some(-35), Some(3), Some(-10)]),
    ("boost-wait-research", [Some(-18), Some(1), Some(4)]),
    ("boosted-bargain-first", [Some(-14), None, None]),
    ("border-parity", [Some(9), None, None]),
    ("border-parity-2", [Some(-10), None, None]),
    ("bounded-recovery", [Some(-9), Some(11), Some(-17)]),
    ("build-what-cards-boost", [Some(-21), Some(-6), Some(-7)]),
    ("builder-barbarian-safety", [Some(-23), Some(4), Some(9)]),
    ("builder-supply-floor", [Some(0), Some(13), Some(-5)]),
    ("builder-tries-the-next-tile", [Some(15), Some(2), Some(8)]),
    ("buildings-before-projects", [Some(1), Some(6), Some(-16)]),
    ("buy-what-cards-cannot-boost", [Some(4), Some(-6), Some(-20)]),
    ("camp-party", [Some(8), Some(0), Some(6)]),
    ("camp-tile-buyout", [Some(-9), Some(-10), Some(-1)]),
    ("campaign-pillage", [Some(18), Some(7), Some(-5)]),
    ("campus-adjacency-threshold", [Some(5), Some(10), Some(-4)]),
    ("campus-adjacency-threshold-2", [Some(-12), Some(2), Some(-2)]),
    ("canal-city", [Some(-3), Some(-9), Some(5)]),
    ("capture-go-or-stand-down", [Some(11), Some(-2), Some(1)]),
    ("capture-go-or-stand-down-2", [Some(-7), None, None]),
    ("chain-payback-window", [Some(4), Some(-4), Some(-2)]),
    ("chain-payback-window-2", [Some(-9), Some(14), Some(-1)]),
    ("cheapest-wonder-first", [Some(11), None, None]),
    ("chokepoint-claim", [Some(-13), Some(-17), Some(-20)]),
    ("chokepoint-garrison", [Some(-5), Some(-3), Some(-5)]),
    ("chokepoint-siting", [Some(7), Some(7), Some(7)]),
    ("chop-into-the-queue", [Some(-8), Some(-31), Some(-40)]),
    ("city-campaign", [Some(-2), Some(-15), Some(-15)]),
    ("city-target-meets-the-map", [Some(11), Some(-4), Some(-5)]),
    ("civilian-out-of-reach", [Some(-4), Some(23), Some(5)]),
    ("close-as-a-body", [Some(1), Some(-12), Some(6)]),
    ("coalition-before-war", [Some(1), Some(-6), Some(-6)]),
    ("coastal-city-sites", [Some(-10), Some(-4), Some(-1)]),
    ("coastal-city-sites-2", [Some(-16), Some(2), Some(-1)]),
    ("come-ashore", [Some(26), Some(-3), Some(9)]),
    ("commitment-patience", [Some(6), Some(-16), Some(1)]),
    ("competition-victory-points", [Some(-19), Some(11), Some(8)]),
    ("congress-counter-leader", [Some(5), Some(-9), Some(5)]),
    ("connect-the-luxury", [Some(13), None, None]),
    ("contested-land-first", [Some(-10), Some(1), Some(-7)]),
    ("conversion-majority-alarm", [Some(1), Some(12), Some(-2)]),
    ("coordinated-finish", [Some(14), Some(0), Some(-4)]),
    ("culture-building-debt", [Some(-6), Some(3), Some(15)]),
    ("culture-floor", [Some(-8), Some(-13), Some(15)]),
    ("culture-lane-forecast", [Some(12), Some(-14), Some(-10)]),
    ("deals-at-the-ceiling", [Some(-3), Some(11), Some(10)]),
    ("deals-for-our-gain", [Some(-15), Some(6), Some(-1)]),
    ("defend-where-you-stand", [Some(-9), Some(-12), Some(8)]),
    ("defensible-sites", [Some(29), Some(12), Some(41)]),
    ("diplomatic-lane-forecast", [Some(-2), Some(-13), Some(3)]),
    ("district-coverage", [Some(-11), Some(14), Some(-5)]),
    ("district-coverage-2", [Some(-3), Some(-19), Some(3)]),
    ("district-planning", [Some(4), Some(4), Some(15)]),
    ("domination-city-count", [Some(3), Some(-5), Some(12)]),
    ("early-archers", [Some(47), Some(32), Some(3)]),
    ("early-contact-window", [Some(20), Some(-4), Some(10)]),
    ("elective-war-in-reach", [Some(-2), Some(-13), Some(4)]),
    ("elective-war-yields-to-a-lane", [Some(34), Some(23), Some(41)]),
    ("encampment-seals-the-pass", [Some(-3), Some(-4), Some(-12)]),
    ("enemy-of-my-enemy", [Some(-12), Some(-1), Some(12)]),
    ("engine-faith-price", [Some(10), Some(41), Some(32)]),
    ("enhancer-for-the-corps", [Some(-23), Some(20), Some(17)]),
    ("enter-the-prophet-race", [Some(35), Some(-45), Some(-76)]),
    ("escort-cap-holds", [Some(-4), None, None]),
    ("escort-unstick", [Some(24), Some(24), Some(5)]),
    ("eureka-chasing-builder", [Some(-6), Some(-17), Some(-9)]),
    ("eureka-chasing-production", [Some(9), Some(-4), Some(-3)]),
    ("exchange-is-the-engines", [Some(3), Some(2), Some(-1)]),
    ("exhaustion-loyalty-guard", [Some(-5), None, None]),
    ("expansion-pays-back", [Some(-3), Some(-10), Some(11)]),
    ("expansion-schedule", [Some(16), Some(-14), Some(18)]),
    ("fire-plan", [Some(7), Some(-2), Some(-11)]),
    ("first-builder-reserve", [Some(-1), Some(6), Some(-2)]),
    ("first-district-first", [Some(9), None, None]),
    ("first-granary-reserve", [Some(-6), None, None]),
    ("first-luxury-first", [Some(16), None, None]),
    ("first-research-building-reserve", [Some(7), Some(5), Some(-15)]),
    ("flip-nearby-city-states", [Some(11), Some(9), Some(14)]),
    ("founder-temple", [Some(18), Some(19), Some(8)]),
    ("frontier-massing-alarm", [Some(17), Some(3), Some(-3)]),
    ("garrison-under-fire", [Some(-1), Some(-14), Some(-7)]),
    ("gold-for-the-young-city", [Some(12), Some(4), Some(12)]),
    ("gold-income-floor", [Some(-12), Some(3), Some(10)]),
    ("government-capacity-fallback", [Some(12), Some(20), Some(-11)]),
    ("government-ladder", [Some(-6), Some(-3), Some(-5)]),
    ("government-ladder-2", [Some(12), Some(20), Some(15)]),
    ("great-person-housing", [Some(11), Some(24), Some(11)]),
    ("growth-to-settle", [Some(-20), Some(5), Some(12)]),
    ("guru-heals-the-corps-2", [Some(-6), Some(-2), Some(4)]),
    ("holy-lane-parity", [Some(-22), Some(-2), Some(-10)]),
    ("holy-site-where-the-threat-is", [Some(-1), Some(13), Some(-19)]),
    ("holy-site-where-the-threat-is-2", [Some(2), Some(-13), Some(8)]),
    ("hostile-memory", [Some(0), None, None]),
    ("housing-research", [Some(-6), Some(-6), Some(2)]),
    ("idle-faith-patronage", [Some(-3), Some(1), Some(7)]),
    ("improvement-housing-value", [Some(-8), Some(-14), Some(26)]),
    ("island-exploration", [Some(-33), Some(-18), Some(-16)]),
    ("lane-culture-spending", [Some(-18), Some(-4), Some(-12)]),
    ("lane-great-people", [Some(4), Some(4), Some(-8)]),
    ("lane-policy-deck", [Some(-7), Some(13), Some(-11)]),
    ("lane-release-when-hopeless", [Some(0), Some(4), Some(-9)]),
    ("lane-space-race", [Some(-18), Some(1), Some(2)]),
    ("lane-votes-its-favor", [Some(-14), Some(10), Some(16)]),
    ("loyalty-rate-alarm", [Some(26), Some(50), Some(42)]),
    ("maintenance-aware-deck", [Some(20), Some(-5), Some(26)]),
    ("missionary-evades-raiders", [Some(-2), Some(10), Some(-8)]),
    ("missionary-last-charge-explores", [Some(-6), Some(16), Some(-1)]),
    ("moksha-defends-the-faithless", [Some(6), Some(4), Some(-4)]),
    ("native-emergency-purchase", [Some(-12), Some(-9), Some(-11)]),
    ("naval-recon", [Some(1), Some(-7), Some(16)]),
    ("naval-recon-2", [Some(-16), Some(4), Some(-11)]),
    ("naval-threat-triage", [Some(-7), Some(-10), Some(2)]),
    ("never-an-empty-queue", [Some(6), Some(9), Some(-4)]),
    ("never-an-empty-queue-2", [Some(8), Some(-2), Some(5)]),
    ("no-free-passage", [Some(-18), Some(2), Some(-4)]),
    ("one-launch-pad", [Some(-24), Some(6), Some(-19)]),
    ("one-shot-recovery", [Some(3), Some(-13), Some(3)]),
    ("one-war-at-a-time", [Some(-18), Some(-4), Some(-23)]),
    ("opening-warrior-recon", [Some(-27), Some(-23), Some(-36)]),
    ("opportunistic-war", [Some(5), Some(15), Some(1)]),
    ("order-retry", [Some(1), Some(1), Some(-7)]),
    ("overseas-settlement", [Some(16), Some(6), Some(-16)]),
    ("pantheon-board", [Some(-10), Some(8), Some(4)]),
    ("pass-picket", [Some(-9), Some(1), Some(7)]),
    ("peace-when-the-war-does-not-pay", [Some(40), Some(-8), Some(-8)]),
    ("peacetime-deterrence", [Some(4), Some(12), Some(4)]),
    ("power-the-laboratory", [Some(18), Some(-2), Some(4)]),
    ("power-the-laboratory-2", [Some(12), Some(1), Some(-20)]),
    ("price-the-suzerainty", [Some(39), Some(20), Some(14)]),
    ("promote-when-wounded", [Some(3), Some(-17), Some(16)]),
    ("quest-boost", [Some(-18), Some(4), Some(-19)]),
    ("quest-camp-errand", [Some(25), Some(9), Some(-1)]),
    ("quest-production", [Some(-13), Some(-10), Some(-5)]),
    ("quest-trade-route", [Some(-7), Some(2), Some(10)]),
    ("raid-pillage-prizes", [Some(12), Some(3), Some(-5)]),
    ("rapid-city-expansion", [Some(-66), Some(-36), Some(-7)]),
    ("recon-replacement", [Some(10), Some(-7), Some(5)]),
    ("recorded-tactical-step", [Some(-24), Some(-11), Some(12)]),
    ("recovery-reads-the-war", [Some(-30), Some(-20), Some(-3)]),
    ("relief-column-marches", [Some(-6), Some(2), Some(13)]),
    ("relief-targets-the-siege", [Some(19), Some(4), Some(-4)]),
    ("religion-race-is-closed", [Some(13), Some(8), Some(-9)]),
    ("religion-sues-peace", [Some(-3), Some(22), Some(-7)]),
    ("religious-defence-scales", [Some(10), Some(-13), Some(1)]),
    ("religious-units-heal-first", [Some(-7), Some(9), Some(-5)]),
    ("religious-veto-defence", [Some(33), Some(12), Some(15)]),
    ("research-tier-premium", [Some(4), Some(-6), Some(0)]),
    ("rival-suzerainty-alarm", [Some(14), Some(0), Some(-2)]),
    ("science-building-first", [Some(-9), Some(-8), Some(4)]),
    ("science-chain-alarm", [Some(-20), Some(-6), Some(4)]),
    ("science-expansion-phase", [Some(4), None, None]),
    ("science-multiplier-payoff", [Some(3), Some(-7), Some(1)]),
    ("science-opening-band", [Some(6), None, None]),
    ("science-victory-drive", [Some(13), Some(23), Some(13)]),
    ("score-horizon", [Some(-18), Some(-19), Some(8)]),
    ("screen-the-shooters", [Some(13), Some(2), Some(10)]),
    ("settle-sooner", [Some(-4), Some(-11), Some(9)]),
    ("settlement-gap-target", [Some(0), Some(23), Some(-8)]),
    ("settler-backlog-brake", [Some(-12), None, None]),
    ("settler-factory-coordination", [Some(-11), Some(6), Some(-2)]),
    ("settler-guard-holds", [Some(5), Some(13), Some(21)]),
    ("settler-guard-holds-2", [Some(-6), Some(-12), Some(-27)]),
    ("settler-never-idles", [Some(-23), Some(7), Some(8)]),
    ("settler-screen", [Some(-13), Some(4), Some(5)]),
    ("settler-second-look", [Some(2), Some(-16), Some(-15)]),
    ("settler-target-hysteresis", [Some(-2), Some(-9), Some(-2)]),
    ("settler-target-hysteresis-2", [Some(-2), Some(20), Some(-2)]),
    ("settler-threat-detour", [Some(-11), Some(4), Some(5)]),
    ("siege-commitment", [Some(1), Some(9), Some(0)]),
    ("siege-is-progress-2", [Some(8), Some(-3), Some(5)]),
    ("skip-the-prophet-race", [Some(-95), Some(5), Some(9)]),
    ("slot-kind-tiebreak", [Some(-14), Some(1), Some(4)]),
    ("solvency-first-trade-slot", [Some(128), Some(140), Some(134)]),
    ("solvency-first-trade-slot-2", [Some(-49), Some(-55), Some(-39)]),
    ("stranded-settler-discount", [Some(6), Some(9), Some(9)]),
    ("strategic-wonders", [Some(3), Some(8), Some(-5)]),
    ("strike-opening", [Some(5), Some(-4), Some(-22)]),
    ("surprise-war-mobilization", [Some(3), Some(3), Some(-2)]),
    ("swap-rotation", [Some(8), Some(9), Some(7)]),
    ("threatened-city-reserve", [Some(-26), Some(2), Some(-5)]),
    ("treasury-at-work", [Some(-6), Some(11), Some(-2)]),
    ("treasury-at-work-2", [Some(13), Some(0), Some(9)]),
    ("unchosen-war-keeps-the-lane", [Some(11), Some(16), Some(-2)]),
    ("unit-cost-efficiency", [Some(-14), Some(2), Some(10)]),
    ("unit-objective-memory", [Some(28), Some(12), Some(-11)]),
    ("upgrade-the-garrison", [Some(-18), Some(10), Some(-9)]),
    ("walls-after-districts", [Some(5), None, None]),
    ("war-economy", [Some(-10), Some(10), Some(-4)]),
    ("war-needs-a-treasury", [Some(-15), Some(8), Some(-16)]),
    ("war-reinforcement", [Some(-3), Some(-3), Some(3)]),
    ("whole-turn-backtrack-guard", [Some(-21), Some(19), Some(2)]),
    ("wide-map-capacity", [Some(22), Some(25), Some(23)]),
    ("wonder-adjacent-sites", [Some(10), Some(-13), Some(2)]),
    ("wonder-adjacent-sites-2", [Some(21), Some(-2), Some(7)]),
    ("wonder-ring-recon", [Some(-2), Some(-4), Some(14)]),
    ("wonder-score-tally", [Some(29), Some(-2), Some(-13)]),
];
