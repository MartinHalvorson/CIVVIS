...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(-13), Some(-12), Some(-35)]),
    ("air-surge", [Some(-8), Some(3), Some(-3)]),
    ("air-surge-2", [Some(8), Some(15), Some(-24)]),
    ("amani-follows-suzerainty", [Some(-1), Some(-16), Some(-45)]),
    ("amenity-district-path", [Some(14), Some(0), Some(-12)]),
    ("amenity-project-preemption", [Some(17), Some(12), Some(-18)]),
    ("amenity-project-preemption-2", [Some(-3), Some(-6), Some(29)]),
    ("anvil", [Some(10), Some(-15), Some(24)]),
    ("apostle-promotion-by-role", [Some(13), Some(15), Some(12)]),
    ("army-target-weighs-enemy", [Some(18), Some(-19), Some(-48)]),
    ("barbarian-bargain", [Some(10), Some(-2), Some(-32)]),
    ("barbarian-ranged-answer", [Some(8), Some(-1), Some(14)]),
    ("barbarian-scouts-are-scouts", [Some(-9), Some(24), Some(-12)]),
    ("barbarian-settler-capture", [Some(9), Some(36), Some(-42)]),
    ("battle-planner", [Some(5), Some(7), Some(3)]),
    ("battle-planner-2", [Some(32), Some(39), Some(69)]),
    ("battle-planner-3", [Some(-6), Some(1), Some(-1)]),
    ("blind-objective-strength", [Some(0), Some(6), Some(4)]),
    ("blind-objective-units", [Some(-4), Some(-7), Some(-5)]),
    ("boost-first-research", [Some(1), Some(0), Some(39)]),
    ("boost-first-research-2", [Some(-13), Some(13), Some(-11)]),
    ("boost-planner", [Some(-4), None, None]),
    ("boost-unlock-research", [Some(-19), Some(7), Some(23)]),
    ("boost-wait-research-2", [Some(-15), Some(-8), Some(-21)]),
    ("boosted-bargain-first", [Some(-11), Some(1), Some(11)]),
    ("boosted-bargain-first-2", [Some(12), Some(-1), Some(-58)]),
    ("border-parity", [Some(3), Some(6), Some(-22)]),
    ("border-parity-2", [Some(-5), Some(-17), Some(46)]),
    ("border-parity-3", [Some(-2), Some(-5), Some(-2)]),
    ("bounded-recovery", [Some(-7), Some(1), Some(17)]),
    ("build-what-cards-boost", [Some(-3), Some(0), Some(29)]),
    ("builder-barbarian-safety", [Some(7), Some(-13), Some(52)]),
    ("builder-supply-floor", [Some(7), Some(3), Some(23)]),
    ("builder-tries-the-next-tile", [Some(11), Some(-16), Some(10)]),
    ("builder-workforce-recovery", [Some(21), Some(-12), Some(-19)]),
    ("builder-workforce-recovery-2", [Some(-5), Some(26), Some(41)]),
    ("buildings-before-projects", [Some(0), Some(12), Some(4)]),
    ("buy-what-cards-cannot-boost", [Some(-5), Some(1), Some(-40)]),
    ("camp-party", [Some(-2), Some(-8), Some(-18)]),
    ("camp-tile-buyout", [Some(-3), Some(-3), Some(25)]),
    ("campaign-pillage", [Some(3), Some(4), Some(-20)]),
    ("campus-adjacency-threshold", [Some(-3), Some(-21), Some(-27)]),
    ("campus-adjacency-threshold-2", [Some(-4), Some(5), Some(13)]),
    ("campus-before-halfway", [Some(5), Some(-1), Some(-20)]),
    ("campus-through-expansion", [Some(19), Some(-2), Some(-8)]),
    ("canal-city", [Some(0), Some(-25), Some(-31)]),
    ("capital-settler-after-completion", [Some(0), Some(1), Some(68)]),
    ("capture-go-or-stand-down", [Some(-4), Some(12), Some(-12)]),
    ("capture-go-or-stand-down-2", [Some(2), Some(-2), Some(8)]),
    ("chain-payback-window", [Some(5), Some(-1), Some(-56)]),
    ("chain-payback-window-2", [Some(-2), Some(-21), Some(34)]),
    ("chase-every-boost", [Some(-8), Some(24), Some(42)]),
    ("chase-every-boost-2", [Some(3), Some(-25), Some(-31)]),
    ("cheapest-wonder-first", [Some(-19), Some(7), Some(-19)]),
    ("chokepoint-claim", [Some(-11), Some(-6), Some(-14)]),
    ("chokepoint-garrison", [Some(13), Some(7), Some(12)]),
    ("chokepoint-siting", [Some(4), Some(6), Some(-10)]),
    ("city-campaign", [Some(-35), Some(-36), Some(30)]),
    ("city-campaign-2", [Some(26), Some(21), Some(14)]),
    ("city-target-meets-the-map", [Some(8), Some(7), Some(1)]),
    ("civilian-out-of-reach", [Some(-26), Some(-12), Some(-48)]),
    ("close-as-a-body", [Some(5), Some(5), Some(-5)]),
    ("coalition-before-war", [Some(-1), Some(1), Some(26)]),
    ("coalition-before-war-2", [Some(-2), Some(-5), Some(-24)]),
    ("coalition-before-war-3", [Some(-2), Some(8), Some(-39)]),
    ("coastal-city-sites", [Some(5), Some(5), Some(-21)]),
    ("coastal-city-sites-2", [Some(-4), Some(18), Some(-11)]),
    ("come-ashore", [Some(2), Some(24), Some(11)]),
    ("commitment-owner-acts", [Some(-1), Some(2), Some(4)]),
    ("commitment-patience", [Some(5), Some(-6), Some(18)]),
    ("competition-victory-points", [Some(12), Some(11), Some(5)]),
    ("congress-counter-leader", [Some(-7), Some(31), Some(3)]),
    ("connect-the-luxury", [Some(35), Some(23), Some(83)]),
    ("contested-land-first", [Some(6), Some(34), Some(-28)]),
    ("conversion-majority-alarm", [Some(-2), Some(-7), Some(-28)]),
    ("conversion-majority-alarm-2", [Some(6), Some(-7), Some(-18)]),
    ("coordinated-finish", [Some(18), Some(-11), Some(-39)]),
    ("culture-building-catchup", [Some(-14), Some(-9), Some(-14)]),
    ("culture-building-catchup-2", [Some(3), Some(-11), Some(7)]),
    ("culture-building-debt", [Some(-8), Some(-1), Some(-31)]),
    ("culture-floor", [Some(-2), Some(-21), Some(70)]),
    ("culture-lane-forecast", [Some(6), Some(-8), Some(19)]),
    ("culture-threat-early", [Some(-19), Some(-2), Some(-39)]),
    ("deals-at-the-ceiling", [Some(6), Some(-1), Some(-4)]),
    ("deals-for-our-gain", [Some(3), Some(-3), Some(46)]),
    ("defend-where-you-stand", [Some(-5), Some(11), Some(3)]),
    ("defensible-sites", [Some(40), Some(29), Some(-25)]),
    ("detour-keeps-the-site-worth", [Some(-1), Some(3), Some(-20)]),
    ("diplomatic-lane-forecast", [Some(12), Some(17), Some(-33)]),
    ("diplomatic-lane-forecast-2", [Some(-11), Some(2), Some(10)]),
    ("district-coverage", [Some(2), Some(-11), Some(-21)]),
    ("district-coverage-2", [Some(4), Some(9), Some(22)]),
    ("district-planning", [Some(8), Some(10), Some(9)]),
    ("district-planning-3", [Some(-8), Some(-20), Some(-17)]),
    ("domination-city-count", [Some(20), Some(8), Some(-24)]),
    ("doomed-blow-veto", [Some(-9), Some(7), Some(-39)]),
    ("doomed-blow-veto-2", [Some(4), Some(-4), Some(26)]),
    ("early-archers", [Some(-4), Some(-5), Some(-13)]),
    ("early-conquest-opening", [Some(-5), None, None]),
    ("early-contact-window", [Some(5), Some(-1), Some(-11)]),
    ("early-contact-window-2", [Some(3), Some(-14), Some(-15)]),
    ("early-project-restraint", [Some(-32), Some(1), Some(-14)]),
    ("early-project-restraint-2", [Some(29), Some(-8), Some(-14)]),
    ("elective-war-in-reach", [Some(14), Some(2), Some(4)]),
    ("elective-war-yields-to-a-lane", [Some(31), Some(34), Some(47)]),
    ("encampment-seals-the-pass", [Some(-10), Some(1), Some(13)]),
    ("enemy-of-my-enemy", [Some(-11), Some(-1), Some(14)]),
    ("engine-faith-price", [Some(27), Some(11), Some(7)]),
    ("enhancer-for-the-corps", [Some(-8), Some(7), Some(-19)]),
    ("enter-the-prophet-race-2", [Some(-20), Some(-22), Some(-31)]),
    ("envoy-building-dividends", [Some(-5), Some(-2), Some(-1)]),
    ("escort-cap-holds", [Some(-18), Some(10), Some(-11)]),
    ("escort-unstick", [Some(38), Some(46), Some(59)]),
    ("eureka-chasing-builder", [Some(-6), Some(-5), Some(8)]),
    ("eureka-chasing-builder-2", [Some(10), Some(16), Some(-23)]),
    ("eureka-chasing-production", [Some(-2), Some(3), Some(11)]),
    ("exchange-is-the-engines", [Some(-9), Some(-14), Some(-28)]),
    ("exhaustion-loyalty-guard", [Some(-10), Some(-23), Some(5)]),
    ("expansion-best-idle-city", [Some(1), Some(-10), Some(-20)]),
    ("expansion-best-idle-city-2", [Some(3), Some(16), Some(26)]),
    ("expansion-pays-back", [Some(3), Some(-5), Some(14)]),
    ("expansion-scales-with-difficulty", [Some(7), None, None]),
    ("expansion-schedule", [Some(7), Some(31), Some(-52)]),
    ("fire-plan", [Some(9), Some(15), Some(24)]),
    ("first-builder-reserve", [Some(-19), Some(-2), Some(21)]),
    ("first-builder-reserve-2", [Some(15), Some(12), Some(2)]),
    ("first-district-first", [Some(-11), Some(-6), Some(-3)]),
    ("first-granary-reserve", [Some(2), Some(1), Some(14)]),
    ("first-luxury-first", [Some(-11), Some(-4), Some(1)]),
    ("first-research-building-reserve", [Some(0), Some(-14), Some(-46)]),
    ("founder-temple", [Some(-8), Some(15), Some(24)]),
    ("frontier-massing-alarm", [Some(-13), Some(-6), Some(-6)]),
    ("garrison-under-fire", [Some(7), Some(-9), Some(15)]),
    ("gold-income-floor", [Some(-16), Some(20), Some(48)]),
    ("government-capacity-fallback", [Some(10), Some(-2), Some(34)]),
    ("government-ladder", [Some(-12), Some(-18), Some(36)]),
    ("government-ladder-2", [Some(17), Some(28), Some(-23)]),
    ("great-person-housing", [Some(-8), Some(2), Some(2)]),
    ("growth-to-settle", [Some(10), Some(11), Some(-2)]),
    ("guru-heals-the-corps-2", [Some(-5), Some(14), Some(67)]),
    ("holy-lane-parity", [Some(6), Some(-7), Some(7)]),
    ("holy-site-where-the-threat-is", [Some(3), Some(-10), Some(-47)]),
    ("holy-site-where-the-threat-is-2", [Some(4), Some(-6), Some(21)]),
    ("hostile-memory", [Some(-4), Some(-25), Some(-38)]),
    ("hostile-memory-2", [Some(-12), Some(-18), Some(-54)]),
    ("housing-research", [Some(-7), Some(-33), Some(7)]),
    ("idle-faith-patronage", [Some(4), Some(-13), Some(-40)]),
    ("industrial-chain-debt", [Some(1), Some(19), Some(45)]),
    ("island-exploration", [Some(-15), Some(26), Some(-29)]),
    ("lane-culture-spending", [Some(-3), Some(3), Some(11)]),
    ("lane-great-people", [Some(14), Some(5), Some(12)]),
    ("lane-policy-deck", [Some(4), Some(2), Some(14)]),
    ("lane-release-when-hopeless", [Some(-7), Some(6), Some(26)]),
    ("lane-space-race", [Some(6), Some(12), Some(-13)]),
    ("lane-votes-its-favor", [Some(-1), Some(0), Some(-25)]),
    ("liang-follows-builders", [Some(-2), Some(-15), Some(32)]),
    ("loyalty-rate-alarm", [Some(43), Some(26), Some(43)]),
    ("magnus-follows-settlers", [Some(-7), Some(-12), Some(-4)]),
    ("maintenance-aware-deck", [Some(6), Some(-4), Some(16)]),
    ("missionary-evades-raiders", [Some(-9), Some(2), Some(-10)]),
    ("missionary-last-charge-explores", [Some(-24), Some(-6), Some(31)]),
    ("missionary-last-charge-explores-2", [Some(29), Some(-4), Some(-4)]),
    ("modernize-before-spending", [Some(-2), Some(2), Some(52)]),
    ("moksha-defends-the-faithless", [Some(9), Some(-10), Some(37)]),
    ("native-emergency-purchase", [Some(-13), Some(15), Some(13)]),
    ("native-emergency-purchase-2", [Some(3), Some(-3), Some(-60)]),
    ("naval-recon", [Some(1), Some(3), Some(1)]),
    ("naval-recon-2", [Some(-4), Some(8), Some(-14)]),
    ("naval-recon-3", [Some(13), Some(-9), Some(5)]),
    ("naval-threat-triage", [Some(-2), Some(-31), Some(6)]),
    ("never-an-empty-queue", [Some(5), Some(-4), Some(12)]),
    ("never-an-empty-queue-2", [Some(-9), Some(-8), Some(-31)]),
    ("never-an-empty-queue-3", [Some(6), Some(16), Some(27)]),
    ("no-free-passage", [Some(-3), Some(14), Some(32)]),
    ("objective-board", [Some(19), Some(29), Some(-69)]),
    ("one-launch-pad", [Some(-6), Some(10), Some(-5)]),
    ("one-shot-recovery", [Some(5), Some(16), Some(10)]),
    ("one-war-at-a-time", [Some(8), Some(29), Some(-16)]),
    ("opening-warrior-recon-2", [Some(13), Some(-19), Some(-37)]),
    ("opportunistic-war", [Some(-17), Some(3), Some(-3)]),
    ("opportunistic-war-2", [Some(5), Some(-17), Some(5)]),
    ("order-retry", [Some(5), Some(4), Some(16)]),
    ("overseas-settlement", [Some(-3), Some(-10), Some(28)]),
    ("pantheon-board", [Some(0), Some(9), Some(-13)]),
    ("pass-picket", [Some(2), Some(18), Some(-20)]),
    ("pass-picket-2", [Some(-5), Some(-10), Some(-31)]),
    ("peace-when-the-war-does-not-pay", [Some(5), Some(0), Some(80)]),
    ("peacetime-deterrence", [Some(-7), Some(10), Some(23)]),
    ("pingala-follows-research", [Some(4), Some(-6), Some(2)]),
    ("power-the-laboratory", [Some(5), Some(0), Some(-15)]),
    ("power-the-laboratory-2", [Some(3), Some(-2), Some(55)]),
    ("price-the-suzerainty", [Some(-7), Some(7), Some(31)]),
    ("promote-when-wounded", [Some(10), Some(9), Some(-38)]),
    ("quest-boost", [Some(-1), Some(-20), Some(-44)]),
    ("quest-camp-errand", [Some(-7), Some(-14), Some(-4)]),
    ("quest-production", [Some(8), Some(27), Some(36)]),
    ("quest-trade-route", [Some(2), Some(3), Some(-13)]),
    ("raid-pillage-prizes", [Some(-11), Some(-26), Some(-33)]),
    ("rapid-city-expansion-2", [Some(8), Some(0), Some(21)]),
    ("recon-replacement", [Some(-13), Some(7), Some(-21)]),
    ("recorded-tactical-step", [Some(-17), Some(25), Some(39)]),
    ("recovery-reads-the-war", [Some(15), Some(-6), Some(12)]),
    ("recovery-reads-the-war-2", [Some(2), Some(-2), Some(16)]),
    ("relief-column-marches", [Some(-14), Some(-2), Some(-12)]),
    ("relief-targets-the-siege", [Some(-14), Some(-14), Some(2)]),
    ("religion-race-is-closed", [Some(3), Some(-29), Some(-14)]),
    ("religion-sues-peace", [Some(10), Some(14), Some(-20)]),
    ("religious-defence-scales", [Some(5), Some(11), Some(-17)]),
    ("religious-units-heal-first", [Some(11), Some(26), Some(87)]),
    ("religious-veto-defence", [Some(41), Some(13), Some(42)]),
    ("requisitions", [Some(-53), Some(-5), Some(28)]),
    ("research-alliance-first", [Some(21), None, None]),
    ("research-building-catchup", [Some(7), Some(-8), Some(-1)]),
    ("research-building-catchup-2", [Some(-4), Some(-5), Some(28)]),
    ("research-tier-premium", [Some(10), Some(-6), Some(27)]),
    ("reyna-follows-revenue", [Some(-18), Some(-4), Some(-20)]),
    ("rival-suzerainty-alarm", [Some(2), Some(2), Some(48)]),
    ("route-block-is-a-wait", [Some(-7), Some(1), Some(-15)]),
    ("safest-stand", [Some(-11), Some(13), Some(-5)]),
    ("science-building-first", [Some(32), Some(20), Some(-22)]),
    ("science-chain-alarm", [Some(-2), Some(-19), Some(2)]),
    ("science-denial-war", [Some(-5), None, None]),
    ("science-expansion-phase", [Some(3), Some(5), Some(35)]),
    ("science-multiplier-payoff", [Some(-8), Some(5), Some(-3)]),
    ("science-opening-band", [Some(-1), Some(15), Some(21)]),
    ("science-threat-denial", [Some(-1), None, None]),
    ("science-victory-drive", [Some(12), Some(14), Some(4)]),
    ("science-victory-drive-2", [Some(1), Some(-7), Some(67)]),
    ("scout-first-opening", [Some(7), Some(-1), Some(-37)]),
    ("screen-the-shooters", [Some(9), Some(-2), Some(52)]),
    ("settle-sooner", [Some(-12), Some(20), Some(7)]),
    ("settlement-gap-target", [Some(10), Some(1), Some(77)]),
    ("settler-backlog-brake", [Some(-8), Some(-27), Some(3)]),
    ("settler-backlog-brake-2", [Some(20), Some(24), Some(28)]),
    ("settler-factory-coordination", [Some(5), Some(-13), Some(-3)]),
    ("settler-guard-holds", [Some(4), Some(1), Some(-18)]),
    ("settler-guard-holds-2", [Some(-12), Some(15), Some(25)]),
    ("settler-never-idles", [Some(20), Some(25), Some(12)]),
    ("settler-site-gate", [Some(9), Some(-4), Some(17)]),
    ("settler-target-floor", [Some(9), Some(-9), Some(-23)]),
    ("settler-target-hysteresis", [Some(-6), Some(12), Some(-28)]),
    ("settler-target-hysteresis-2", [Some(-4), Some(3), Some(16)]),
    ("settler-threat-detour", [Some(-7), Some(15), Some(-1)]),
    ("settler-walk-deadline", [Some(18), Some(24), Some(-7)]),
    ("siege-commitment", [Some(-21), Some(16), Some(-3)]),
    ("siege-is-progress-2", [Some(-13), Some(-14), Some(-7)]),
    ("siege-is-progress-3", [Some(6), Some(-12), Some(16)]),
    ("siege-preempts-the-queue", [Some(-6), Some(-34), Some(-25)]),
    ("siege-train", [Some(4), Some(-6), Some(-71)]),
    ("skip-the-prophet-race-2", [Some(-13), Some(6), Some(-23)]),
    ("slot-kind-tiebreak", [Some(8), Some(23), Some(-25)]),
    ("solvency-first-trade-slot", [Some(92), Some(101), Some(104)]),
    ("spaceport-surplus-veto", [Some(14), Some(-13), Some(-7)]),
    ("standing-still-is-a-risk", [Some(5), Some(-1), Some(32)]),
    ("stranded-settler-discount", [Some(12), Some(-9), Some(-17)]),
    ("strategic-wonders", [Some(-9), Some(-8), Some(-42)]),
    ("strike-opening", [Some(14), Some(3), Some(-35)]),
    ("strike-reach", [Some(6), Some(1), Some(-9)]),
    ("surprise-war-mobilization", [Some(-12), Some(2), Some(-29)]),
    ("swap-rotation", [Some(-9), Some(-20), Some(-16)]),
    ("swap-rotation-2", [Some(0), Some(8), Some(21)]),
    ("threatened-city-reserve", [Some(7), Some(-12), Some(-8)]),
    ("trade-building-before-bankruptcy", [Some(-13), Some(4), Some(0)]),
    ("trade-building-before-bankruptcy-2", [Some(4), Some(-5), Some(-6)]),
    ("trade-route-network", [Some(6), Some(9), Some(5)]),
    ("treasury-at-work-2", [Some(8), Some(11), Some(-16)]),
    ("unchosen-war-keeps-the-lane", [Some(16), Some(15), Some(-40)]),
    ("unit-cost-efficiency", [Some(1), Some(-6), Some(45)]),
    ("unit-objective-memory", [Some(-6), Some(-10), Some(-2)]),
    ("upgrade-the-garrison", [Some(7), Some(-19), Some(50)]),
    ("veterans-withdraw-early", [Some(-9), Some(-21), Some(27)]),
    ("walls-after-districts", [Some(7), Some(-8), Some(9)]),
    ("war-economy", [Some(4), Some(-3), Some(-35)]),
    ("war-needs-a-treasury", [Some(5), Some(14), Some(-11)]),
    ("war-policy-via-board", [Some(1), Some(24), Some(31)]),
    ("war-reinforcement", [Some(19), Some(6), Some(-12)]),
    ("whole-turn-backtrack-guard", [Some(-3), Some(30), Some(-16)]),
    ("wide-map-capacity", [Some(17), Some(28), Some(0)]),
    ("wonder-adjacent-sites-2", [Some(19), Some(7), Some(9)]),
    ("wonder-ring-recon", [Some(-9), Some(-1), Some(-17)]),
    ("wonder-ring-recon-2", [Some(3), Some(-12), Some(6)]),
    ("wonder-score-tally", [Some(16), Some(-20), Some(16)]),
    ("wounded-out-of-reach", [Some(-12), Some(13), Some(-46)]),
    ("wounded-out-of-reach-2", [Some(-4), Some(-18), Some(31)]),
];
