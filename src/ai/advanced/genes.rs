...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("air-surge", [Some(30), Some(5), Some(14)]),
    ("amenity-district-path", [Some(-9), Some(5), Some(-10)]),
    ("amenity-project-preemption", [Some(-20), Some(23), Some(-1)]),
    ("amenity-project-preemption-2", [Some(16), Some(-13), None]),
    ("apostle-promotion-by-role", [Some(18), Some(12), Some(6)]),
    ("army-target-weighs-enemy", [Some(5), Some(9), Some(31)]),
    ("barbarian-bargain", [Some(24), Some(8), Some(20)]),
    ("barbarian-ranged-answer", [Some(-5), Some(10), Some(0)]),
    ("barbarian-scouts-are-scouts", [Some(28), Some(-13), Some(18)]),
    ("blind-objective-strength", [Some(1), Some(-11), Some(-12)]),
    ("blind-objective-units", [Some(-10), Some(18), Some(4)]),
    ("boost-first-research", [Some(-3), None, None]),
    ("boost-unlock-research", [Some(-16), None, None]),
    ("boost-wait-research", [Some(9), None, None]),
    ("bounded-recovery", [Some(-14), Some(-25), Some(-1)]),
    ("build-what-cards-boost", [Some(-5), None, None]),
    ("builder-barbarian-safety", [Some(-2), Some(3), Some(-1)]),
    ("builder-supply-floor", [Some(15), Some(-5), None]),
    ("builder-tries-the-next-tile", [Some(-1), Some(-26), Some(13)]),
    ("buildings-before-projects", [Some(13), Some(1), Some(8)]),
    ("buy-what-cards-cannot-boost", [Some(22), None, None]),
    ("camp-party", [Some(4), Some(25), Some(2)]),
    ("camp-tile-buyout", [Some(-2), Some(-4), None]),
    ("campaign-pillage", [Some(0), Some(20), Some(13)]),
    ("campus-adjacency-threshold", [Some(-3), Some(14), Some(0)]),
    ("campus-adjacency-threshold-2", [Some(-2), Some(3), None]),
    ("canal-city", [Some(-15), None, None]),
    ("chain-payback-window", [Some(-10), Some(11), None]),
    ("chain-payback-window-2", [Some(7), Some(-5), None]),
    ("chokepoint-claim", [Some(16), None, None]),
    ("chokepoint-garrison", [Some(-10), None, None]),
    ("chokepoint-siting", [Some(-16), None, None]),
    ("chop-into-the-queue", [Some(-9), Some(-18), None]),
    ("city-campaign", [Some(-12), Some(-11), Some(-13)]),
    ("civilian-out-of-reach", [Some(-5), Some(39), None]),
    ("coalition-before-war", [Some(16), Some(25), None]),
    ("come-ashore", [Some(7), Some(-4), Some(-12)]),
    ("competition-victory-points", [Some(-9), Some(14), Some(16)]),
    ("congress-counter-leader", [Some(-4), Some(0), Some(14)]),
    ("contested-land-first", [Some(-10), Some(-6), None]),
    ("conversion-majority-alarm", [Some(-9), Some(10), Some(-24)]),
    ("coordinated-finish", [Some(-18), Some(12), Some(-11)]),
    ("culture-building-debt", [Some(-11), Some(1), Some(19)]),
    ("culture-lane-forecast", [Some(-10), Some(-7), Some(-10)]),
    ("deals-at-the-ceiling", [Some(5), Some(11), Some(-2)]),
    ("deals-for-our-gain", [Some(21), Some(-10), Some(10)]),
    ("defensible-sites", [Some(25), Some(26), Some(-6)]),
    ("diplomatic-lane-forecast", [Some(-10), Some(-17), Some(-33)]),
    ("district-coverage", [Some(-4), Some(14), Some(12)]),
    ("district-coverage-2", [Some(-5), Some(-2), None]),
    ("district-planning", [Some(25), Some(2), Some(13)]),
    ("domination-city-count", [Some(-17), Some(-8), Some(7)]),
    ("early-contact-window", [Some(10), Some(17), Some(2)]),
    ("elective-war-in-reach", [Some(-5), Some(5), Some(22)]),
    ("elective-war-yields-to-a-lane", [Some(16), Some(49), None]),
    ("encampment-seals-the-pass", [Some(3), None, None]),
    ("enemy-of-my-enemy", [Some(-9), Some(-18), None]),
    ("engine-faith-price", [Some(18), Some(37), Some(17)]),
    ("enhancer-for-the-corps", [Some(5), Some(-3), Some(-4)]),
    ("escort-unstick", [Some(-6), Some(16), Some(6)]),
    ("eureka-chasing-builder", [Some(1), Some(-9), None]),
    ("eureka-chasing-production", [Some(-10), Some(-10), None]),
    ("expansion-pays-back", [Some(-23), Some(-8), Some(-20)]),
    ("expansion-schedule", [Some(1), Some(11), Some(-5)]),
    ("first-builder-reserve", [Some(-12), Some(3), None]),
    ("first-research-building-reserve", [Some(-17), Some(-21), None]),
    ("flip-nearby-city-states", [Some(-3), Some(-9), Some(28)]),
    ("founder-temple", [Some(1), Some(8), Some(6)]),
    ("frontier-massing-alarm", [Some(16), Some(2), Some(26)]),
    ("garrison-under-fire", [Some(14), Some(-8), Some(-14)]),
    ("gold-for-the-young-city", [Some(10), None, None]),
    ("government-ladder", [Some(-4), Some(20), None]),
    ("great-person-housing", [Some(13), Some(34), Some(7)]),
    ("growth-to-settle", [Some(-1), Some(-25), Some(-16)]),
    ("guru-heals-the-corps-2", [Some(-18), Some(18), None]),
    ("holy-lane-parity", [Some(14), Some(0), Some(4)]),
    ("holy-site-where-the-threat-is", [Some(-2), Some(-12), Some(-22)]),
    ("holy-site-where-the-threat-is-2", [Some(11), Some(5), None]),
    ("housing-research", [Some(1), Some(-19), Some(-11)]),
    ("idle-faith-patronage", [Some(1), Some(-18), Some(17)]),
    ("improvement-housing-value", [Some(-6), Some(-2), None]),
    ("lane-culture-spending", [Some(-18), Some(-10), Some(-7)]),
    ("lane-great-people", [Some(-8), Some(22), Some(21)]),
    ("lane-policy-deck", [Some(-4), Some(22), Some(-3)]),
    ("lane-space-race", [Some(-19), Some(17), Some(8)]),
    ("loyalty-rate-alarm", [Some(53), Some(31), Some(-4)]),
    ("maintenance-aware-deck", [Some(8), Some(28), Some(-4)]),
    ("missionary-evades-raiders", [Some(12), Some(16), Some(2)]),
    ("missionary-last-charge-explores", [Some(-19), Some(-10), Some(4)]),
    ("native-emergency-purchase", [Some(6), None, None]),
    ("naval-recon", [Some(-8), Some(-15), Some(10)]),
    ("naval-recon-2", [Some(-10), Some(-3), None]),
    ("naval-threat-triage", [Some(7), Some(18), Some(-3)]),
    ("never-an-empty-queue", [Some(17), Some(14), None]),
    ("never-an-empty-queue-2", [Some(-8), Some(-16), None]),
    ("no-free-passage", [Some(11), Some(-15), Some(4)]),
    ("one-launch-pad", [Some(29), Some(15), Some(-12)]),
    ("one-shot-recovery", [Some(-8), Some(6), Some(-4)]),
    ("one-war-at-a-time", [Some(-25), Some(5), Some(7)]),
    ("opening-warrior-recon", [Some(-33), Some(-24), None]),
    ("opportunistic-war", [Some(22), Some(38), Some(36)]),
    ("order-retry", [Some(-4), Some(-4), Some(-7)]),
    ("pantheon-board", [Some(4), Some(4), Some(20)]),
    ("pass-picket", [Some(-14), Some(3), Some(-11)]),
    ("peacetime-deterrence", [Some(10), Some(4), Some(-7)]),
    ("power-the-laboratory", [Some(9), Some(-8), Some(-5)]),
    ("power-the-laboratory-2", [Some(8), Some(-1), None]),
    ("price-the-suzerainty", [Some(31), Some(24), Some(32)]),
    ("promote-when-wounded", [Some(30), Some(2), Some(8)]),
    ("quest-boost", [Some(1), None, None]),
    ("quest-camp-errand", [Some(-6), None, None]),
    ("quest-production", [Some(3), None, None]),
    ("quest-trade-route", [Some(21), None, None]),
    ("raid-pillage-prizes", [Some(-1), Some(-17), Some(23)]),
    ("rapid-city-expansion", [Some(-137), Some(-81), None]),
    ("recon-replacement", [Some(6), Some(13), Some(-3)]),
    ("recorded-tactical-step", [Some(-13), Some(-5), Some(11)]),
    ("recovery-reads-the-war", [Some(-12), Some(-16), None]),
    ("relief-targets-the-siege", [Some(8), Some(0), Some(1)]),
    ("religion-sues-peace", [Some(5), Some(-8), Some(-29)]),
    ("religious-defence-scales", [Some(-4), Some(-18), Some(-13)]),
    ("religious-units-heal-first", [Some(2), Some(2), Some(-3)]),
    ("religious-veto-defence", [Some(23), Some(27), Some(3)]),
    ("research-tier-premium", [Some(34), Some(15), Some(8)]),
    ("rival-suzerainty-alarm", [Some(-11), Some(6), Some(-16)]),
    ("science-building-first", [Some(-18), None, None]),
    ("science-chain-alarm", [Some(7), Some(0), Some(5)]),
    ("science-multiplier-payoff", [Some(-3), Some(-1), Some(10)]),
    ("science-victory-drive", [Some(41), Some(40), Some(16)]),
    ("score-horizon", [Some(-11), Some(-4), Some(-9)]),
    ("settle-sooner", [Some(22), Some(3), Some(13)]),
    ("settlement-gap-target", [Some(4), Some(12), Some(22)]),
    ("settler-factory-coordination", [Some(10), Some(-12), Some(-13)]),
    ("settler-guard-holds", [Some(1), Some(0), Some(7)]),
    ("settler-guard-holds-2", [Some(-2), Some(-12), None]),
    ("settler-screen", [Some(1), Some(4), Some(5)]),
    ("settler-second-look", [Some(0), Some(4), None]),
    ("settler-target-hysteresis", [Some(13), Some(21), Some(6)]),
    ("settler-target-hysteresis-2", [Some(6), Some(15), None]),
    ("settler-threat-detour", [Some(16), Some(-1), Some(-10)]),
    ("siege-commitment", [Some(-16), Some(-10), Some(-19)]),
    ("siege-is-progress-2", [Some(4), Some(-6), None]),
    ("skip-the-prophet-race", [Some(-148), None, None]),
    ("slot-kind-tiebreak", [Some(4), Some(-12), Some(22)]),
    ("solvency-first-trade-slot", [Some(99), Some(143), Some(89)]),
    ("solvency-first-trade-slot-2", [Some(-22), Some(-44), None]),
    ("stranded-settler-discount", [Some(17), Some(2), Some(-17)]),
    ("strategic-wonders", [Some(4), Some(0), Some(-6)]),
    ("strike-opening", [Some(-9), Some(0), Some(7)]),
    ("surprise-war-mobilization", [Some(-5), Some(15), Some(4)]),
    ("unchosen-war-keeps-the-lane", [Some(6), Some(-1), Some(-9)]),
    ("unit-cost-efficiency", [Some(25), Some(-3), Some(2)]),
    ("unit-objective-memory", [Some(2), Some(7), Some(26)]),
    ("upgrade-the-garrison", [Some(7), Some(-6), None]),
    ("war-economy", [Some(-2), Some(8), Some(18)]),
    ("war-reinforcement", [Some(13), Some(11), Some(20)]),
    ("whole-turn-backtrack-guard", [Some(4), Some(-19), Some(1)]),
    ("wide-map-capacity", [Some(40), Some(28), Some(17)]),
    ("wonder-adjacent-sites", [Some(6), Some(4), None]),
    ("wonder-adjacent-sites-2", [Some(-3), Some(-6), None]),
    ("wonder-ring-recon", [Some(-6), Some(4), None]),
    ("wonder-score-tally", [Some(14), Some(9), Some(6)]),
];
