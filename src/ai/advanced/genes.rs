...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(4), Some(-9), Some(-6)]),
    ("air-surge", [Some(23), Some(4), Some(26)]),
    ("air-surge-2", [Some(-3), Some(7), None]),
    ("amenity-district-path", [Some(10), Some(-17), Some(6)]),
    ("amenity-project-preemption", [Some(10), Some(0), Some(-18)]),
    ("amenity-project-preemption-2", [Some(3), Some(7), Some(-2)]),
    ("anvil", [Some(-6), None, None]),
    ("apostle-promotion-by-role", [Some(18), Some(16), Some(14)]),
    ("army-target-weighs-enemy", [Some(-9), Some(26), Some(-7)]),
    ("barbarian-bargain", [Some(1), Some(-19), Some(22)]),
    ("barbarian-ranged-answer", [Some(-1), Some(34), Some(-15)]),
    ("barbarian-scouts-are-scouts", [Some(-2), Some(-13), Some(10)]),
    ("barbarian-settler-capture", [Some(16), Some(40), Some(27)]),
    ("battle-planner", [Some(-3), Some(56), None]),
    ("battle-planner-2", [Some(6), None, None]),
    ("battle-planner-3", [Some(25), None, None]),
    ("blind-objective-strength", [Some(-1), Some(-31), Some(11)]),
    ("blind-objective-units", [Some(-11), Some(-2), Some(3)]),
    ("boost-first-research", [Some(5), Some(-9), Some(5)]),
    ("boost-unlock-research", [Some(-8), Some(-10), Some(13)]),
    ("boost-wait-research", [Some(-6), Some(-8), Some(-4)]),
    ("boost-wait-research-2", [Some(29), Some(1), None]),
    ("boosted-bargain-first", [Some(-5), Some(-14), Some(-19)]),
    ("boosted-bargain-first-2", [Some(9), None, None]),
    ("border-parity", [Some(1), Some(-25), Some(-2)]),
    ("border-parity-2", [Some(18), Some(5), Some(-12)]),
    ("border-parity-3", [Some(19), None, None]),
    ("bounded-recovery", [Some(24), Some(-2), Some(0)]),
    ("build-what-cards-boost", [Some(-19), Some(-10), Some(3)]),
    ("builder-barbarian-safety", [Some(46), Some(9), Some(-18)]),
    ("builder-supply-floor", [Some(19), Some(-1), Some(0)]),
    ("builder-tries-the-next-tile", [Some(-7), Some(5), Some(-4)]),
    ("buildings-before-projects", [Some(-16), Some(-10), Some(6)]),
    ("buy-what-cards-cannot-boost", [Some(14), Some(8), Some(-15)]),
    ("camp-party", [Some(11), Some(22), Some(1)]),
    ("camp-tile-buyout", [Some(-13), Some(14), Some(-2)]),
    ("campaign-pillage", [Some(23), Some(15), Some(7)]),
    ("campus-adjacency-threshold", [Some(-15), Some(-11), Some(-8)]),
    ("campus-adjacency-threshold-2", [Some(-2), Some(-10), Some(-7)]),
    ("campus-through-expansion", [Some(-25), Some(3), None]),
    ("canal-city", [Some(-22), Some(10), Some(12)]),
    ("capital-settler-after-completion", [Some(-6), Some(-10), Some(-2)]),
    ("capture-go-or-stand-down", [Some(-37), Some(1), Some(7)]),
    ("capture-go-or-stand-down-2", [Some(27), Some(24), Some(-1)]),
    ("chain-payback-window", [Some(-29), Some(-3), Some(-3)]),
    ("chain-payback-window-2", [Some(18), Some(-11), Some(5)]),
    ("chase-every-boost", [Some(-18), Some(-26), None]),
    ("cheapest-wonder-first", [Some(5), Some(-3), Some(-11)]),
    ("chokepoint-claim", [Some(-10), Some(-23), Some(4)]),
    ("chokepoint-garrison", [Some(5), Some(23), Some(-22)]),
    ("chokepoint-siting", [Some(-3), Some(-4), Some(12)]),
    ("chop-into-the-queue", [Some(-3), Some(-23), Some(-19)]),
    ("city-campaign", [Some(-27), Some(-38), Some(-31)]),
    ("city-target-meets-the-map", [Some(0), Some(34), Some(-14)]),
    ("civilian-out-of-reach", [Some(-12), Some(-39), Some(14)]),
    ("close-as-a-body", [Some(16), Some(3), Some(17)]),
    ("coalition-before-war", [Some(-14), Some(-4), Some(28)]),
    ("coalition-before-war-2", [Some(26), Some(-18), None]),
    ("coastal-city-sites", [Some(-6), Some(-9), Some(7)]),
    ("coastal-city-sites-2", [Some(-8), Some(-27), Some(-14)]),
    ("come-ashore", [Some(-4), Some(-2), Some(-24)]),
    ("commitment-owner-acts", [Some(26), Some(-10), None]),
    ("commitment-patience", [Some(-14), Some(-13), Some(0)]),
    ("competition-victory-points", [Some(-13), Some(20), Some(0)]),
    ("congress-counter-leader", [Some(-13), Some(-27), Some(4)]),
    ("connect-the-luxury", [Some(42), Some(30), Some(28)]),
    ("contested-land-first", [Some(12), Some(-15), Some(1)]),
    ("conversion-majority-alarm", [Some(-1), Some(-4), Some(-13)]),
    ("conversion-majority-alarm-2", [Some(21), None, None]),
    ("coordinated-finish", [Some(3), Some(21), Some(-4)]),
    ("culture-building-debt", [Some(-16), Some(6), Some(-2)]),
    ("culture-floor", [Some(8), Some(-8), Some(-10)]),
    ("culture-lane-forecast", [Some(-8), Some(-5), Some(0)]),
    ("deals-at-the-ceiling", [Some(-5), Some(20), Some(5)]),
    ("deals-for-our-gain", [Some(3), Some(43), Some(-2)]),
    ("defend-where-you-stand", [Some(6), Some(24), Some(1)]),
    ("defensible-sites", [Some(7), Some(40), Some(7)]),
    ("diplomatic-lane-forecast", [Some(25), Some(1), Some(19)]),
    ("diplomatic-lane-forecast-2", [Some(11), None, None]),
    ("district-coverage", [Some(-23), Some(6), Some(1)]),
    ("district-coverage-2", [Some(-8), Some(10), Some(5)]),
    ("district-planning", [Some(27), Some(10), Some(20)]),
    ("district-planning-2", [Some(1), Some(-11), Some(-39)]),
    ("district-planning-3", [Some(-18), None, None]),
    ("domination-city-count", [Some(24), Some(-3), Some(5)]),
    ("early-archers", [Some(11), Some(2), Some(19)]),
    ("early-contact-window", [Some(-23), Some(-10), Some(-2)]),
    ("early-project-restraint", [Some(-3), Some(-26), Some(7)]),
    ("early-project-restraint-2", [Some(-25), None, None]),
    ("elective-war-in-reach", [Some(10), Some(21), Some(7)]),
    ("elective-war-yields-to-a-lane", [Some(31), Some(52), Some(29)]),
    ("encampment-seals-the-pass", [Some(-12), Some(33), Some(-16)]),
    ("enemy-of-my-enemy", [Some(1), Some(-15), Some(3)]),
    ("engine-faith-price", [Some(-12), Some(51), Some(33)]),
    ("enhancer-for-the-corps", [Some(12), Some(-8), Some(-26)]),
    ("enter-the-prophet-race", [Some(7), Some(-6), Some(15)]),
    ("enter-the-prophet-race-2", [Some(44), None, None]),
    ("escort-cap-holds", [Some(2), Some(-4), Some(-6)]),
    ("escort-unstick", [Some(23), Some(-8), Some(1)]),
    ("eureka-chasing-builder", [Some(13), Some(-5), Some(-6)]),
    ("eureka-chasing-builder-2", [Some(-25), None, None]),
    ("eureka-chasing-production", [Some(18), Some(-12), Some(2)]),
    ("exchange-is-the-engines", [Some(-14), Some(24), Some(12)]),
    ("exhaustion-loyalty-guard", [Some(-36), Some(11), Some(12)]),
    ("expansion-pays-back", [Some(19), Some(8), Some(1)]),
    ("expansion-schedule", [Some(3), Some(30), Some(-11)]),
    ("fire-plan", [Some(1), Some(19), Some(10)]),
    ("first-builder-reserve", [Some(23), Some(-4), Some(-1)]),
    ("first-builder-reserve-2", [Some(-10), Some(-11), None]),
    ("first-district-first", [Some(-17), Some(-55), Some(-10)]),
    ("first-granary-reserve", [Some(3), Some(11), Some(11)]),
    ("first-luxury-first", [Some(20), Some(-19), Some(9)]),
    ("first-research-building-reserve", [Some(-47), Some(-28), Some(7)]),
    ("flip-nearby-city-states", [Some(-19), Some(-22), Some(7)]),
    ("founder-temple", [Some(17), Some(42), Some(-7)]),
    ("frontier-massing-alarm", [Some(-4), Some(-2), Some(23)]),
    ("garrison-under-fire", [Some(-30), Some(-19), Some(1)]),
    ("gold-for-the-young-city", [Some(-10), Some(7), Some(-6)]),
    ("gold-income-floor", [Some(31), Some(11), Some(-17)]),
    ("government-capacity-fallback", [Some(-4), Some(21), Some(3)]),
    ("government-ladder", [Some(-15), Some(-25), Some(2)]),
    ("government-ladder-2", [Some(8), Some(26), Some(1)]),
    ("great-person-housing", [Some(16), Some(23), Some(-5)]),
    ("growth-to-settle", [Some(-8), Some(0), Some(0)]),
    ("guru-heals-the-corps-2", [Some(-12), Some(17), Some(-14)]),
    ("holy-lane-parity", [Some(-6), Some(33), Some(14)]),
    ("holy-site-where-the-threat-is", [Some(-31), Some(-7), Some(-12)]),
    ("holy-site-where-the-threat-is-2", [Some(6), Some(-6), Some(10)]),
    ("hostile-memory", [Some(-29), Some(-9), Some(5)]),
    ("housing-research", [Some(2), Some(12), Some(-13)]),
    ("idle-faith-patronage", [Some(-34), Some(-4), Some(11)]),
    ("improvement-housing-value", [Some(-18), Some(-24), Some(-6)]),
    ("industrial-chain-debt", [Some(24), Some(1), None]),
    ("island-exploration", [Some(-22), Some(15), Some(4)]),
    ("lane-culture-spending", [Some(25), Some(-19), Some(1)]),
    ("lane-great-people", [Some(-15), Some(11), Some(5)]),
    ("lane-policy-deck", [Some(1), Some(-5), Some(0)]),
    ("lane-release-when-hopeless", [Some(-20), Some(-19), Some(6)]),
    ("lane-space-race", [Some(17), Some(0), Some(7)]),
    ("lane-votes-its-favor", [Some(-3), Some(-21), Some(4)]),
    ("loyalty-rate-alarm", [Some(8), Some(-7), Some(10)]),
    ("maintenance-aware-deck", [Some(5), Some(-11), Some(-12)]),
    ("missionary-evades-raiders", [Some(34), Some(1), Some(-28)]),
    ("missionary-last-charge-explores", [Some(18), Some(-30), Some(2)]),
    ("modernize-before-spending", [Some(4), None, None]),
    ("moksha-defends-the-faithless", [Some(-9), Some(-9), Some(-11)]),
    ("native-emergency-purchase", [Some(-5), Some(-29), Some(-10)]),
    ("naval-recon", [Some(8), Some(-8), Some(-5)]),
    ("naval-recon-2", [Some(16), Some(0), Some(9)]),
    ("naval-recon-3", [Some(1), Some(-2), None]),
    ("naval-threat-triage", [Some(6), Some(1), Some(-6)]),
    ("never-an-empty-queue", [Some(13), Some(-11), Some(13)]),
    ("never-an-empty-queue-2", [Some(-5), Some(9), Some(-12)]),
    ("never-an-empty-queue-3", [Some(7), Some(-21), None]),
    ("no-free-passage", [Some(-10), Some(-16), Some(-28)]),
    ("objective-board", [Some(-17), None, None]),
    ("one-launch-pad", [Some(-4), Some(27), Some(7)]),
    ("one-shot-recovery", [Some(-11), Some(-28), Some(-16)]),
    ("one-war-at-a-time", [Some(-1), Some(-9), Some(17)]),
    ("opening-warrior-recon", [Some(-12), Some(3), Some(-47)]),
    ("opening-warrior-recon-2", [Some(-1), None, None]),
    ("opportunistic-war", [Some(-15), Some(19), Some(0)]),
    ("order-retry", [Some(12), Some(-1), Some(-2)]),
    ("overseas-settlement", [Some(0), Some(5), Some(8)]),
    ("pantheon-board", [Some(20), Some(-5), Some(16)]),
    ("pass-picket", [Some(-14), Some(-10), Some(10)]),
    ("peace-when-the-war-does-not-pay", [Some(-17), Some(-15), Some(-8)]),
    ("peacetime-deterrence", [Some(15), Some(12), Some(15)]),
    ("power-the-laboratory", [Some(-12), Some(-2), Some(-19)]),
    ("power-the-laboratory-2", [Some(14), Some(-7), Some(11)]),
    ("price-the-suzerainty", [Some(35), Some(17), Some(23)]),
    ("promote-when-wounded", [Some(1), Some(-1), Some(1)]),
    ("quest-boost", [Some(10), Some(1), Some(6)]),
    ("quest-camp-errand", [Some(32), Some(-9), Some(-8)]),
    ("quest-production", [Some(-6), Some(-11), Some(-6)]),
    ("quest-trade-route", [Some(19), Some(6), Some(8)]),
    ("raid-pillage-prizes", [Some(8), Some(-21), Some(-13)]),
    ("rapid-city-expansion", [Some(-173), Some(-64), Some(-171)]),
    ("rapid-city-expansion-2", [Some(139), Some(27), None]),
    ("recon-replacement", [Some(-18), Some(5), Some(-1)]),
    ("recorded-tactical-step", [Some(10), Some(12), Some(32)]),
    ("recovery-reads-the-war", [Some(9), Some(-9), Some(9)]),
    ("relief-column-marches", [Some(-17), Some(7), Some(15)]),
    ("relief-targets-the-siege", [Some(-6), Some(-20), Some(-5)]),
    ("religion-race-is-closed", [Some(11), Some(5), Some(-3)]),
    ("religion-sues-peace", [Some(13), Some(6), Some(-11)]),
    ("religious-defence-scales", [Some(-14), Some(15), Some(-2)]),
    ("religious-units-heal-first", [Some(4), Some(21), Some(-11)]),
    ("religious-veto-defence", [Some(31), Some(51), Some(19)]),
    ("requisitions", [Some(-9), None, None]),
    ("research-tier-premium", [Some(26), Some(-39), Some(-2)]),
    ("rival-suzerainty-alarm", [Some(-11), Some(15), Some(-11)]),
    ("science-building-first", [Some(3), Some(-3), Some(10)]),
    ("science-chain-alarm", [Some(6), Some(9), Some(10)]),
    ("science-expansion-phase", [Some(2), Some(-12), Some(2)]),
    ("science-multiplier-payoff", [Some(-14), Some(-9), Some(1)]),
    ("science-opening-band", [Some(7), Some(17), Some(-11)]),
    ("science-victory-drive", [Some(-9), Some(-22), Some(-13)]),
    ("science-victory-drive-2", [Some(-1), Some(-1), Some(33)]),
    ("score-horizon", [Some(-26), Some(19), Some(-15)]),
    ("screen-the-shooters", [Some(-10), Some(-3), Some(5)]),
    ("settle-sooner", [Some(1), Some(17), Some(9)]),
    ("settlement-gap-target", [Some(-13), Some(36), Some(-1)]),
    ("settler-backlog-brake", [Some(24), Some(-2), Some(-14)]),
    ("settler-factory-coordination", [Some(-8), Some(4), Some(-6)]),
    ("settler-guard-holds", [Some(2), Some(-5), Some(2)]),
    ("settler-guard-holds-2", [Some(6), Some(10), Some(4)]),
    ("settler-never-idles", [Some(25), Some(8), Some(-14)]),
    ("settler-screen", [Some(-9), Some(24), Some(18)]),
    ("settler-second-look", [Some(-25), Some(14), Some(26)]),
    ("settler-site-gate", [Some(-13), Some(0), None]),
    ("settler-target-floor", [Some(-4), Some(8), None]),
    ("settler-target-hysteresis", [Some(-7), Some(-8), Some(7)]),
    ("settler-target-hysteresis-2", [Some(16), Some(19), Some(2)]),
    ("settler-threat-detour", [Some(37), Some(8), Some(-1)]),
    ("settler-walk-deadline", [Some(16), Some(-2), None]),
    ("siege-commitment", [Some(-7), Some(-16), Some(-23)]),
    ("siege-is-progress-2", [Some(13), Some(11), Some(-2)]),
    ("siege-preempts-the-queue", [Some(-37), Some(-2), None]),
    ("siege-train", [Some(-39), None, None]),
    ("skip-the-prophet-race", [Some(-105), Some(-45), Some(-50)]),
    ("skip-the-prophet-race-2", [Some(85), Some(16), None]),
    ("slot-kind-tiebreak", [Some(-11), Some(24), Some(8)]),
    ("solvency-first-trade-slot", [Some(54), Some(45), Some(104)]),
    ("spaceport-surplus-veto", [Some(-23), Some(-18), Some(12)]),
    ("stranded-settler-discount", [Some(19), Some(14), Some(-1)]),
    ("strategic-wonders", [Some(-26), Some(14), Some(-6)]),
    ("strike-opening", [Some(10), Some(19), Some(25)]),
    ("surprise-war-mobilization", [Some(-1), Some(25), Some(-11)]),
    ("swap-rotation", [Some(-3), Some(-37), Some(9)]),
    ("threatened-city-reserve", [Some(-29), Some(17), Some(-10)]),
    ("trade-route-network", [Some(-10), Some(22), None]),
    ("treasury-at-work", [Some(4), Some(-11), Some(-3)]),
    ("treasury-at-work-2", [Some(20), Some(21), Some(37)]),
    ("unchosen-war-keeps-the-lane", [Some(58), Some(3), Some(6)]),
    ("unit-cost-efficiency", [Some(3), Some(38), Some(10)]),
    ("unit-objective-memory", [Some(-15), Some(-19), Some(11)]),
    ("upgrade-the-garrison", [Some(-6), Some(-23), Some(-13)]),
    ("veterans-withdraw-early", [Some(18), None, None]),
    ("walls-after-districts", [Some(23), Some(-12), Some(13)]),
    ("war-economy", [Some(-3), Some(-2), Some(7)]),
    ("war-needs-a-treasury", [Some(21), Some(-11), Some(6)]),
    ("war-policy-via-board", [Some(-1), None, None]),
    ("war-reinforcement", [Some(-38), Some(-8), Some(-3)]),
    ("whole-turn-backtrack-guard", [Some(-2), Some(-31), Some(5)]),
    ("wide-map-capacity", [Some(27), Some(28), Some(14)]),
    ("wonder-adjacent-sites", [Some(16), Some(-3), Some(8)]),
    ("wonder-adjacent-sites-2", [Some(5), Some(9), Some(-19)]),
    ("wonder-ring-recon", [Some(10), Some(-11), Some(-3)]),
    ("wonder-score-tally", [Some(9), Some(23), Some(-25)]),
    ("wounded-out-of-reach", [Some(-7), Some(26), None]),
];
