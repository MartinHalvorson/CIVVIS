...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("air-surge", [Some(-5), Some(0), Some(-10)]),
    ("amenity-district-path", [Some(16), Some(-15), Some(-9)]),
    ("amenity-project-preemption", [Some(22), Some(30), Some(20)]),
    ("amenity-project-preemption-2", [Some(-8), Some(-34), Some(-14)]),
    ("apostle-promotion-by-role", [Some(-2), Some(-9), Some(6)]),
    ("army-target-weighs-enemy", [Some(-12), Some(0), Some(-4)]),
    ("barbarian-bargain", [Some(0), Some(14), Some(19)]),
    ("barbarian-ranged-answer", [Some(27), Some(8), Some(10)]),
    ("barbarian-scouts-are-scouts", [Some(4), Some(34), Some(8)]),
    ("barbarian-settler-capture", [Some(37), Some(51), Some(23)]),
    ("blind-objective-strength", [Some(-33), Some(8), Some(30)]),
    ("blind-objective-units", [Some(33), Some(-4), Some(-16)]),
    ("boost-first-research", [Some(0), Some(-13), Some(-16)]),
    ("boost-unlock-research", [Some(-26), Some(-25), Some(-43)]),
    ("boost-wait-research", [Some(-17), Some(3), Some(-3)]),
    ("bounded-recovery", [Some(-2), Some(8), Some(26)]),
    ("build-what-cards-boost", [Some(-3), Some(-21), Some(-20)]),
    ("builder-barbarian-safety", [Some(21), Some(-17), Some(3)]),
    ("builder-supply-floor", [Some(-3), Some(-10), Some(0)]),
    ("builder-tries-the-next-tile", [Some(-29), Some(-4), Some(12)]),
    ("buildings-before-projects", [Some(-3), Some(16), Some(-7)]),
    ("buy-what-cards-cannot-boost", [Some(-25), Some(-2), Some(9)]),
    ("camp-party", [Some(29), Some(8), Some(2)]),
    ("camp-tile-buyout", [Some(25), Some(6), Some(8)]),
    ("campaign-pillage", [Some(8), Some(-19), Some(-20)]),
    ("campus-adjacency-threshold", [Some(16), Some(-2), Some(9)]),
    ("campus-adjacency-threshold-2", [Some(-6), Some(-2), Some(-15)]),
    ("canal-city", [Some(-10), Some(17), Some(8)]),
    ("capture-go-or-stand-down", [Some(0), None, None]),
    ("chain-payback-window", [Some(8), Some(3), Some(-2)]),
    ("chain-payback-window-2", [Some(-9), Some(13), Some(18)]),
    ("chokepoint-claim", [Some(-12), Some(2), Some(12)]),
    ("chokepoint-garrison", [Some(5), Some(-7), Some(11)]),
    ("chokepoint-siting", [Some(9), Some(12), Some(-15)]),
    ("chop-into-the-queue", [Some(12), Some(-28), Some(11)]),
    ("city-campaign", [Some(4), Some(-41), Some(1)]),
    ("city-target-meets-the-map", [Some(0), Some(1), Some(-5)]),
    ("civilian-out-of-reach", [Some(-28), Some(29), Some(20)]),
    ("close-as-a-body", [Some(23), Some(21), Some(-1)]),
    ("coalition-before-war", [Some(-16), Some(12), Some(2)]),
    ("coastal-city-sites", [Some(-26), Some(-4), Some(23)]),
    ("coastal-city-sites-2", [Some(22), Some(-7), Some(0)]),
    ("come-ashore", [Some(26), Some(5), Some(22)]),
    ("commitment-patience", [Some(0), None, None]),
    ("competition-victory-points", [Some(4), Some(10), Some(-12)]),
    ("congress-counter-leader", [Some(9), Some(-7), Some(-6)]),
    ("contested-land-first", [Some(8), Some(6), Some(25)]),
    ("conversion-majority-alarm", [Some(-12), Some(0), Some(13)]),
    ("coordinated-finish", [Some(1), Some(-5), Some(-5)]),
    ("culture-building-debt", [Some(11), Some(-24), Some(0)]),
    ("culture-floor", [Some(4), Some(-4), None]),
    ("culture-lane-forecast", [Some(-9), Some(-11), Some(-11)]),
    ("deals-at-the-ceiling", [Some(-15), Some(14), Some(-2)]),
    ("deals-for-our-gain", [Some(-18), Some(-12), Some(-1)]),
    ("defend-where-you-stand", [Some(14), Some(15), None]),
    ("defensible-sites", [Some(43), Some(32), Some(19)]),
    ("diplomatic-lane-forecast", [Some(-24), Some(-4), Some(-21)]),
    ("district-coverage", [Some(-25), Some(36), Some(14)]),
    ("district-coverage-2", [Some(-5), Some(-9), Some(-4)]),
    ("district-planning", [Some(3), Some(4), Some(16)]),
    ("domination-city-count", [Some(1), Some(-9), Some(12)]),
    ("early-archers", [Some(10), Some(18), None]),
    ("early-contact-window", [Some(-8), Some(9), Some(-1)]),
    ("elective-war-in-reach", [Some(-3), Some(4), Some(10)]),
    ("elective-war-yields-to-a-lane", [Some(42), Some(26), Some(28)]),
    ("encampment-seals-the-pass", [Some(-8), Some(-3), Some(-1)]),
    ("enemy-of-my-enemy", [Some(-16), Some(-1), Some(29)]),
    ("engine-faith-price", [Some(0), Some(22), Some(-15)]),
    ("enhancer-for-the-corps", [Some(-1), Some(26), Some(20)]),
    ("enter-the-prophet-race", [Some(-22), None, None]),
    ("escort-unstick", [Some(42), Some(20), Some(-13)]),
    ("eureka-chasing-builder", [Some(5), Some(-5), Some(-16)]),
    ("eureka-chasing-production", [Some(24), Some(-9), Some(-34)]),
    ("exchange-is-the-engines", [Some(9), Some(21), None]),
    ("expansion-pays-back", [Some(0), Some(8), Some(10)]),
    ("expansion-schedule", [Some(12), Some(15), Some(-7)]),
    ("fire-plan", [Some(22), Some(-9), Some(-5)]),
    ("first-builder-reserve", [Some(40), Some(-18), Some(-25)]),
    ("first-research-building-reserve", [Some(-2), Some(0), Some(-5)]),
    ("flip-nearby-city-states", [Some(4), Some(8), Some(10)]),
    ("founder-temple", [Some(14), Some(-7), Some(22)]),
    ("frontier-massing-alarm", [Some(3), Some(-2), Some(-15)]),
    ("garrison-under-fire", [Some(4), Some(21), Some(-11)]),
    ("gold-for-the-young-city", [Some(-14), Some(10), Some(11)]),
    ("gold-income-floor", [Some(-9), Some(14), None]),
    ("government-capacity-fallback", [Some(5), Some(3), Some(-13)]),
    ("government-ladder", [Some(4), Some(-20), Some(-13)]),
    ("government-ladder-2", [Some(-19), Some(10), Some(-21)]),
    ("great-person-housing", [Some(4), Some(13), Some(-4)]),
    ("growth-to-settle", [Some(-18), Some(0), Some(-21)]),
    ("guru-heals-the-corps-2", [Some(-23), Some(5), Some(39)]),
    ("holy-lane-parity", [Some(-3), Some(12), Some(-21)]),
    ("holy-site-where-the-threat-is", [Some(-13), Some(33), Some(27)]),
    ("holy-site-where-the-threat-is-2", [Some(17), Some(-12), Some(-15)]),
    ("housing-research", [Some(0), Some(-1), Some(3)]),
    ("idle-faith-patronage", [Some(21), Some(28), Some(9)]),
    ("improvement-housing-value", [Some(-30), Some(18), Some(-14)]),
    ("island-exploration", [Some(-31), None, None]),
    ("lane-culture-spending", [Some(-9), Some(-2), Some(-21)]),
    ("lane-great-people", [Some(-5), Some(21), Some(24)]),
    ("lane-policy-deck", [Some(-20), Some(8), Some(5)]),
    ("lane-release-when-hopeless", [Some(-11), Some(24), Some(-4)]),
    ("lane-space-race", [Some(-4), Some(-5), Some(2)]),
    ("lane-votes-its-favor", [Some(-13), Some(16), Some(-19)]),
    ("loyalty-rate-alarm", [Some(40), Some(38), Some(9)]),
    ("maintenance-aware-deck", [Some(10), Some(24), Some(10)]),
    ("missionary-evades-raiders", [Some(43), Some(25), Some(-4)]),
    ("missionary-last-charge-explores", [Some(7), Some(9), Some(10)]),
    ("moksha-defends-the-faithless", [Some(18), Some(1), Some(-27)]),
    ("native-emergency-purchase", [Some(2), Some(-15), Some(4)]),
    ("naval-recon", [Some(-1), Some(-22), Some(-11)]),
    ("naval-recon-2", [Some(-2), Some(-3), Some(7)]),
    ("naval-threat-triage", [Some(-8), Some(3), Some(14)]),
    ("never-an-empty-queue", [Some(12), Some(20), Some(-34)]),
    ("never-an-empty-queue-2", [Some(5), Some(-29), Some(21)]),
    ("no-free-passage", [Some(-24), Some(13), Some(-18)]),
    ("one-launch-pad", [Some(-13), Some(0), Some(-13)]),
    ("one-shot-recovery", [Some(-3), Some(8), Some(18)]),
    ("one-war-at-a-time", [Some(-3), Some(-1), Some(11)]),
    ("opening-warrior-recon", [Some(-42), Some(-35), Some(-31)]),
    ("opportunistic-war", [Some(18), Some(2), Some(11)]),
    ("order-retry", [Some(8), Some(0), Some(18)]),
    ("overseas-settlement", [Some(-8), None, None]),
    ("pantheon-board", [Some(8), Some(-17), Some(7)]),
    ("pass-picket", [Some(22), Some(-14), Some(-8)]),
    ("peace-when-the-war-does-not-pay", [Some(-8), Some(9), Some(6)]),
    ("peacetime-deterrence", [Some(-9), Some(3), Some(14)]),
    ("power-the-laboratory", [Some(-12), Some(4), Some(20)]),
    ("power-the-laboratory-2", [Some(0), Some(6), Some(7)]),
    ("price-the-suzerainty", [Some(5), Some(-9), Some(12)]),
    ("promote-when-wounded", [Some(23), Some(-1), Some(4)]),
    ("quest-boost", [Some(-7), Some(15), Some(11)]),
    ("quest-camp-errand", [Some(24), Some(-5), Some(2)]),
    ("quest-production", [Some(7), Some(24), Some(21)]),
    ("quest-trade-route", [Some(-9), Some(6), Some(13)]),
    ("raid-pillage-prizes", [Some(16), Some(8), Some(-3)]),
    ("rapid-city-expansion", [Some(-21), Some(-122), Some(-94)]),
    ("recon-replacement", [Some(0), Some(6), Some(8)]),
    ("recorded-tactical-step", [Some(0), Some(-17), Some(-9)]),
    ("recovery-reads-the-war", [Some(6), Some(-3), Some(0)]),
    ("relief-column-marches", [Some(-8), None, None]),
    ("relief-targets-the-siege", [Some(-9), Some(-7), Some(8)]),
    ("religion-race-is-closed", [Some(-33), Some(22), Some(5)]),
    ("religion-sues-peace", [Some(-12), Some(-6), Some(-12)]),
    ("religious-defence-scales", [Some(-13), Some(14), Some(-6)]),
    ("religious-units-heal-first", [Some(18), Some(-11), Some(8)]),
    ("religious-veto-defence", [Some(14), Some(8), Some(20)]),
    ("research-tier-premium", [Some(-16), Some(-13), Some(-25)]),
    ("rival-suzerainty-alarm", [Some(-3), Some(-19), Some(5)]),
    ("science-building-first", [Some(-23), Some(-29), Some(-22)]),
    ("science-chain-alarm", [Some(25), Some(9), Some(8)]),
    ("science-multiplier-payoff", [Some(13), Some(5), Some(1)]),
    ("science-victory-drive", [Some(18), Some(52), Some(0)]),
    ("score-horizon", [Some(7), Some(19), Some(-7)]),
    ("screen-the-shooters", [Some(-17), Some(-4), Some(-5)]),
    ("settle-sooner", [Some(6), Some(36), Some(1)]),
    ("settlement-gap-target", [Some(-10), Some(9), Some(0)]),
    ("settler-factory-coordination", [Some(-25), Some(2), Some(-3)]),
    ("settler-guard-holds", [Some(-7), Some(-2), Some(20)]),
    ("settler-guard-holds-2", [Some(5), Some(-1), Some(-9)]),
    ("settler-never-idles", [Some(33), None, None]),
    ("settler-screen", [Some(20), Some(3), Some(2)]),
    ("settler-second-look", [Some(-6), Some(-14), Some(-48)]),
    ("settler-target-hysteresis", [Some(-16), Some(-15), Some(-3)]),
    ("settler-target-hysteresis-2", [Some(3), Some(12), Some(-15)]),
    ("settler-threat-detour", [Some(-14), Some(-16), Some(15)]),
    ("siege-commitment", [Some(12), Some(16), Some(-19)]),
    ("siege-is-progress-2", [Some(-5), Some(10), Some(-11)]),
    ("skip-the-prophet-race", [Some(-25), Some(-130), Some(-119)]),
    ("slot-kind-tiebreak", [Some(13), Some(9), Some(-7)]),
    ("solvency-first-trade-slot", [Some(108), Some(133), Some(100)]),
    ("solvency-first-trade-slot-2", [Some(-22), Some(-46), Some(-25)]),
    ("stranded-settler-discount", [Some(0), Some(-5), Some(-23)]),
    ("strategic-wonders", [Some(-18), Some(-5), Some(2)]),
    ("strike-opening", [Some(-7), Some(-14), Some(12)]),
    ("surprise-war-mobilization", [Some(2), Some(-18), Some(7)]),
    ("swap-rotation", [Some(1), Some(-10), None]),
    ("threatened-city-reserve", [Some(-15), None, None]),
    ("treasury-at-work", [Some(2), Some(6), Some(12)]),
    ("treasury-at-work-2", [Some(36), Some(7), Some(13)]),
    ("unchosen-war-keeps-the-lane", [Some(-4), Some(-1), Some(6)]),
    ("unit-cost-efficiency", [Some(8), Some(-5), Some(7)]),
    ("unit-objective-memory", [Some(-27), Some(-6), Some(-5)]),
    ("upgrade-the-garrison", [Some(15), Some(16), Some(1)]),
    ("war-economy", [Some(-6), Some(2), Some(-11)]),
    ("war-needs-a-treasury", [Some(-16), Some(6), Some(14)]),
    ("war-reinforcement", [Some(3), Some(-1), Some(10)]),
    ("whole-turn-backtrack-guard", [Some(1), Some(12), Some(18)]),
    ("wide-map-capacity", [Some(15), Some(41), Some(16)]),
    ("wonder-adjacent-sites", [Some(4), Some(-9), Some(-8)]),
    ("wonder-adjacent-sites-2", [Some(4), Some(6), Some(-2)]),
    ("wonder-ring-recon", [Some(17), Some(-12), Some(3)]),
    ("wonder-score-tally", [Some(3), Some(-7), Some(-6)]),
];
