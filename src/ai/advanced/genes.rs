...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("air-surge", [Some(-7), Some(7), Some(-5)]),
    ("amenity-district-path", [Some(-8), Some(2), Some(16)]),
    ("amenity-project-preemption", [Some(-5), Some(-25), Some(22)]),
    ("amenity-project-preemption-2", [Some(22), Some(29), Some(-8)]),
    ("apostle-promotion-by-role", [Some(2), Some(1), Some(-2)]),
    ("army-target-weighs-enemy", [Some(12), Some(-4), Some(-12)]),
    ("barbarian-bargain", [Some(9), Some(2), Some(0)]),
    ("barbarian-ranged-answer", [Some(20), Some(23), Some(27)]),
    ("barbarian-scouts-are-scouts", [Some(-2), Some(3), Some(4)]),
    ("barbarian-settler-capture", [Some(44), Some(27), Some(37)]),
    ("blind-objective-strength", [Some(1), Some(-4), Some(-33)]),
    ("blind-objective-units", [Some(11), Some(10), Some(33)]),
    ("boost-first-research", [Some(-11), Some(5), Some(0)]),
    ("boost-unlock-research", [Some(3), Some(-10), Some(-26)]),
    ("boost-wait-research", [Some(1), Some(4), Some(-17)]),
    ("bounded-recovery", [Some(11), Some(-17), Some(-2)]),
    ("build-what-cards-boost", [Some(-6), Some(-7), Some(-3)]),
    ("builder-barbarian-safety", [Some(4), Some(9), Some(21)]),
    ("builder-supply-floor", [Some(13), Some(-5), Some(-3)]),
    ("builder-tries-the-next-tile", [Some(2), Some(8), Some(-29)]),
    ("buildings-before-projects", [Some(6), Some(-16), Some(-3)]),
    ("buy-what-cards-cannot-boost", [Some(-6), Some(-20), Some(-25)]),
    ("camp-party", [Some(0), Some(6), Some(29)]),
    ("camp-tile-buyout", [Some(-10), Some(-1), Some(25)]),
    ("campaign-pillage", [Some(7), Some(-5), Some(8)]),
    ("campus-adjacency-threshold", [Some(10), Some(-4), Some(16)]),
    ("campus-adjacency-threshold-2", [Some(2), Some(-2), Some(-6)]),
    ("canal-city", [Some(-9), Some(5), Some(-10)]),
    ("capture-go-or-stand-down", [Some(-2), Some(1), Some(0)]),
    ("chain-payback-window", [Some(-4), Some(-2), Some(8)]),
    ("chain-payback-window-2", [Some(14), Some(-1), Some(-9)]),
    ("chokepoint-claim", [Some(-17), Some(-20), Some(-12)]),
    ("chokepoint-garrison", [Some(-3), Some(-5), Some(5)]),
    ("chokepoint-siting", [Some(7), Some(7), Some(9)]),
    ("chop-into-the-queue", [Some(-31), Some(-40), Some(12)]),
    ("city-campaign", [Some(-15), Some(-15), Some(4)]),
    ("city-target-meets-the-map", [Some(-4), Some(-5), Some(0)]),
    ("civilian-out-of-reach", [Some(23), Some(5), Some(-28)]),
    ("close-as-a-body", [Some(-12), Some(6), Some(23)]),
    ("coalition-before-war", [Some(-6), Some(-6), Some(-16)]),
    ("coastal-city-sites", [Some(-4), Some(-1), Some(-26)]),
    ("coastal-city-sites-2", [Some(2), Some(-1), Some(22)]),
    ("come-ashore", [Some(-3), Some(9), Some(26)]),
    ("commitment-patience", [Some(-16), Some(1), Some(0)]),
    ("competition-victory-points", [Some(11), Some(8), Some(4)]),
    ("congress-counter-leader", [Some(-9), Some(5), Some(9)]),
    ("contested-land-first", [Some(1), Some(-7), Some(8)]),
    ("conversion-majority-alarm", [Some(12), Some(-2), Some(-12)]),
    ("coordinated-finish", [Some(0), Some(-4), Some(1)]),
    ("culture-building-debt", [Some(3), Some(15), Some(11)]),
    ("culture-floor", [Some(-13), Some(15), Some(4)]),
    ("culture-lane-forecast", [Some(-14), Some(-10), Some(-9)]),
    ("deals-at-the-ceiling", [Some(11), Some(10), Some(-15)]),
    ("deals-for-our-gain", [Some(6), Some(-1), Some(-18)]),
    ("defend-where-you-stand", [Some(-12), Some(8), Some(14)]),
    ("defensible-sites", [Some(12), Some(41), Some(43)]),
    ("diplomatic-lane-forecast", [Some(-13), Some(3), Some(-24)]),
    ("district-coverage", [Some(14), Some(-5), Some(-25)]),
    ("district-coverage-2", [Some(-19), Some(3), Some(-5)]),
    ("district-planning", [Some(4), Some(15), Some(3)]),
    ("domination-city-count", [Some(-5), Some(12), Some(1)]),
    ("early-archers", [Some(32), Some(3), Some(10)]),
    ("early-contact-window", [Some(-4), Some(10), Some(-8)]),
    ("elective-war-in-reach", [Some(-13), Some(4), Some(-3)]),
    ("elective-war-yields-to-a-lane", [Some(23), Some(41), Some(42)]),
    ("encampment-seals-the-pass", [Some(-4), Some(-12), Some(-8)]),
    ("enemy-of-my-enemy", [Some(-1), Some(12), Some(-16)]),
    ("engine-faith-price", [Some(41), Some(32), Some(0)]),
    ("enhancer-for-the-corps", [Some(20), Some(17), Some(-1)]),
    ("enter-the-prophet-race", [Some(-45), Some(-76), Some(-22)]),
    ("escort-unstick", [Some(24), Some(5), Some(42)]),
    ("eureka-chasing-builder", [Some(-17), Some(-9), Some(5)]),
    ("eureka-chasing-production", [Some(-4), Some(-3), Some(24)]),
    ("exchange-is-the-engines", [Some(2), Some(-1), Some(9)]),
    ("expansion-pays-back", [Some(-10), Some(11), Some(0)]),
    ("expansion-schedule", [Some(-14), Some(18), Some(12)]),
    ("fire-plan", [Some(-2), Some(-11), Some(22)]),
    ("first-builder-reserve", [Some(6), Some(-2), Some(40)]),
    ("first-research-building-reserve", [Some(5), Some(-15), Some(-2)]),
    ("flip-nearby-city-states", [Some(9), Some(14), Some(4)]),
    ("founder-temple", [Some(19), Some(8), Some(14)]),
    ("frontier-massing-alarm", [Some(3), Some(-3), Some(3)]),
    ("garrison-under-fire", [Some(-14), Some(-7), Some(4)]),
    ("gold-for-the-young-city", [Some(4), Some(12), Some(-14)]),
    ("gold-income-floor", [Some(3), Some(10), Some(-9)]),
    ("government-capacity-fallback", [Some(20), Some(-11), Some(5)]),
    ("government-ladder", [Some(-3), Some(-5), Some(4)]),
    ("government-ladder-2", [Some(20), Some(15), Some(-19)]),
    ("great-person-housing", [Some(24), Some(11), Some(4)]),
    ("growth-to-settle", [Some(5), Some(12), Some(-18)]),
    ("guru-heals-the-corps-2", [Some(-2), Some(4), Some(-23)]),
    ("holy-lane-parity", [Some(-2), Some(-10), Some(-3)]),
    ("holy-site-where-the-threat-is", [Some(13), Some(-19), Some(-13)]),
    ("holy-site-where-the-threat-is-2", [Some(-13), Some(8), Some(17)]),
    ("housing-research", [Some(-6), Some(2), Some(0)]),
    ("idle-faith-patronage", [Some(1), Some(7), Some(21)]),
    ("improvement-housing-value", [Some(-14), Some(26), Some(-30)]),
    ("island-exploration", [Some(-18), Some(-16), Some(-31)]),
    ("lane-culture-spending", [Some(-4), Some(-12), Some(-9)]),
    ("lane-great-people", [Some(4), Some(-8), Some(-5)]),
    ("lane-policy-deck", [Some(13), Some(-11), Some(-20)]),
    ("lane-release-when-hopeless", [Some(4), Some(-9), Some(-11)]),
    ("lane-space-race", [Some(1), Some(2), Some(-4)]),
    ("lane-votes-its-favor", [Some(10), Some(16), Some(-13)]),
    ("loyalty-rate-alarm", [Some(50), Some(42), Some(40)]),
    ("maintenance-aware-deck", [Some(-5), Some(26), Some(10)]),
    ("missionary-evades-raiders", [Some(10), Some(-8), Some(43)]),
    ("missionary-last-charge-explores", [Some(16), Some(-1), Some(7)]),
    ("moksha-defends-the-faithless", [Some(4), Some(-4), Some(18)]),
    ("native-emergency-purchase", [Some(-9), Some(-11), Some(2)]),
    ("naval-recon", [Some(-7), Some(16), Some(-1)]),
    ("naval-recon-2", [Some(4), Some(-11), Some(-2)]),
    ("naval-threat-triage", [Some(-10), Some(2), Some(-8)]),
    ("never-an-empty-queue", [Some(9), Some(-4), Some(12)]),
    ("never-an-empty-queue-2", [Some(-2), Some(5), Some(5)]),
    ("no-free-passage", [Some(2), Some(-4), Some(-24)]),
    ("one-launch-pad", [Some(6), Some(-19), Some(-13)]),
    ("one-shot-recovery", [Some(-13), Some(3), Some(-3)]),
    ("one-war-at-a-time", [Some(-4), Some(-23), Some(-3)]),
    ("opening-warrior-recon", [Some(-23), Some(-36), Some(-42)]),
    ("opportunistic-war", [Some(15), Some(1), Some(18)]),
    ("order-retry", [Some(1), Some(-7), Some(8)]),
    ("overseas-settlement", [Some(6), Some(-16), Some(-8)]),
    ("pantheon-board", [Some(8), Some(4), Some(8)]),
    ("pass-picket", [Some(1), Some(7), Some(22)]),
    ("peace-when-the-war-does-not-pay", [Some(-8), Some(-8), Some(-8)]),
    ("peacetime-deterrence", [Some(12), Some(4), Some(-9)]),
    ("power-the-laboratory", [Some(-2), Some(4), Some(-12)]),
    ("power-the-laboratory-2", [Some(1), Some(-20), Some(0)]),
    ("price-the-suzerainty", [Some(20), Some(14), Some(5)]),
    ("promote-when-wounded", [Some(-17), Some(16), Some(23)]),
    ("quest-boost", [Some(4), Some(-19), Some(-7)]),
    ("quest-camp-errand", [Some(9), Some(-1), Some(24)]),
    ("quest-production", [Some(-10), Some(-5), Some(7)]),
    ("quest-trade-route", [Some(2), Some(10), Some(-9)]),
    ("raid-pillage-prizes", [Some(3), Some(-5), Some(16)]),
    ("rapid-city-expansion", [Some(-36), Some(-7), Some(-21)]),
    ("recon-replacement", [Some(-7), Some(5), Some(0)]),
    ("recorded-tactical-step", [Some(-11), Some(12), Some(0)]),
    ("recovery-reads-the-war", [Some(-20), Some(-3), Some(6)]),
    ("relief-column-marches", [Some(2), Some(13), Some(-8)]),
    ("relief-targets-the-siege", [Some(4), Some(-4), Some(-9)]),
    ("religion-race-is-closed", [Some(8), Some(-9), Some(-33)]),
    ("religion-sues-peace", [Some(22), Some(-7), Some(-12)]),
    ("religious-defence-scales", [Some(-13), Some(1), Some(-13)]),
    ("religious-units-heal-first", [Some(9), Some(-5), Some(18)]),
    ("religious-veto-defence", [Some(12), Some(15), Some(14)]),
    ("research-tier-premium", [Some(-6), Some(0), Some(-16)]),
    ("rival-suzerainty-alarm", [Some(0), Some(-2), Some(-3)]),
    ("science-building-first", [Some(-8), Some(4), Some(-23)]),
    ("science-chain-alarm", [Some(-6), Some(4), Some(25)]),
    ("science-multiplier-payoff", [Some(-7), Some(1), Some(13)]),
    ("science-victory-drive", [Some(23), Some(13), Some(18)]),
    ("score-horizon", [Some(-19), Some(8), Some(7)]),
    ("screen-the-shooters", [Some(2), Some(10), Some(-17)]),
    ("settle-sooner", [Some(-11), Some(9), Some(6)]),
    ("settlement-gap-target", [Some(23), Some(-8), Some(-10)]),
    ("settler-factory-coordination", [Some(6), Some(-2), Some(-25)]),
    ("settler-guard-holds", [Some(13), Some(21), Some(-7)]),
    ("settler-guard-holds-2", [Some(-12), Some(-27), Some(5)]),
    ("settler-never-idles", [Some(7), Some(8), Some(33)]),
    ("settler-screen", [Some(4), Some(5), Some(20)]),
    ("settler-second-look", [Some(-16), Some(-15), Some(-6)]),
    ("settler-target-hysteresis", [Some(-9), Some(-2), Some(-16)]),
    ("settler-target-hysteresis-2", [Some(20), Some(-2), Some(3)]),
    ("settler-threat-detour", [Some(4), Some(5), Some(-14)]),
    ("siege-commitment", [Some(9), Some(0), Some(12)]),
    ("siege-is-progress-2", [Some(-3), Some(5), Some(-5)]),
    ("skip-the-prophet-race", [Some(5), Some(9), Some(-25)]),
    ("slot-kind-tiebreak", [Some(1), Some(4), Some(13)]),
    ("solvency-first-trade-slot", [Some(140), Some(134), Some(108)]),
    ("solvency-first-trade-slot-2", [Some(-55), Some(-39), Some(-22)]),
    ("stranded-settler-discount", [Some(9), Some(9), Some(0)]),
    ("strategic-wonders", [Some(8), Some(-5), Some(-18)]),
    ("strike-opening", [Some(-4), Some(-22), Some(-7)]),
    ("surprise-war-mobilization", [Some(3), Some(-2), Some(2)]),
    ("swap-rotation", [Some(9), Some(7), Some(1)]),
    ("threatened-city-reserve", [Some(2), Some(-5), Some(-15)]),
    ("treasury-at-work", [Some(11), Some(-2), Some(2)]),
    ("treasury-at-work-2", [Some(0), Some(9), Some(36)]),
    ("unchosen-war-keeps-the-lane", [Some(16), Some(-2), Some(-4)]),
    ("unit-cost-efficiency", [Some(2), Some(10), Some(8)]),
    ("unit-objective-memory", [Some(12), Some(-11), Some(-27)]),
    ("upgrade-the-garrison", [Some(10), Some(-9), Some(15)]),
    ("war-economy", [Some(10), Some(-4), Some(-6)]),
    ("war-needs-a-treasury", [Some(8), Some(-16), Some(-16)]),
    ("war-reinforcement", [Some(-3), Some(3), Some(3)]),
    ("whole-turn-backtrack-guard", [Some(19), Some(2), Some(1)]),
    ("wide-map-capacity", [Some(25), Some(23), Some(15)]),
    ("wonder-adjacent-sites", [Some(-13), Some(2), Some(4)]),
    ("wonder-adjacent-sites-2", [Some(-2), Some(7), Some(4)]),
    ("wonder-ring-recon", [Some(-4), Some(14), Some(17)]),
    ("wonder-score-tally", [Some(-2), Some(-13), Some(3)]),
];
