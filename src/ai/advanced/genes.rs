...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("air-surge", [Some(7), Some(-5), Some(0)]),
    ("amenity-district-path", [Some(2), Some(16), Some(-15)]),
    ("amenity-project-preemption", [Some(-25), Some(22), Some(30)]),
    ("amenity-project-preemption-2", [Some(29), Some(-8), Some(-34)]),
    ("apostle-promotion-by-role", [Some(1), Some(-2), Some(-9)]),
    ("army-target-weighs-enemy", [Some(-4), Some(-12), Some(0)]),
    ("barbarian-bargain", [Some(2), Some(0), Some(14)]),
    ("barbarian-ranged-answer", [Some(23), Some(27), Some(8)]),
    ("barbarian-scouts-are-scouts", [Some(3), Some(4), Some(34)]),
    ("barbarian-settler-capture", [Some(27), Some(37), Some(51)]),
    ("blind-objective-strength", [Some(-4), Some(-33), Some(8)]),
    ("blind-objective-units", [Some(10), Some(33), Some(-4)]),
    ("boost-first-research", [Some(5), Some(0), Some(-13)]),
    ("boost-unlock-research", [Some(-10), Some(-26), Some(-25)]),
    ("boost-wait-research", [Some(4), Some(-17), Some(3)]),
    ("bounded-recovery", [Some(-17), Some(-2), Some(8)]),
    ("build-what-cards-boost", [Some(-7), Some(-3), Some(-21)]),
    ("builder-barbarian-safety", [Some(9), Some(21), Some(-17)]),
    ("builder-supply-floor", [Some(-5), Some(-3), Some(-10)]),
    ("builder-tries-the-next-tile", [Some(8), Some(-29), Some(-4)]),
    ("buildings-before-projects", [Some(-16), Some(-3), Some(16)]),
    ("buy-what-cards-cannot-boost", [Some(-20), Some(-25), Some(-2)]),
    ("camp-party", [Some(6), Some(29), Some(8)]),
    ("camp-tile-buyout", [Some(-1), Some(25), Some(6)]),
    ("campaign-pillage", [Some(-5), Some(8), Some(-19)]),
    ("campus-adjacency-threshold", [Some(-4), Some(16), Some(-2)]),
    ("campus-adjacency-threshold-2", [Some(-2), Some(-6), Some(-2)]),
    ("canal-city", [Some(5), Some(-10), Some(17)]),
    ("capture-go-or-stand-down", [Some(1), Some(0), None]),
    ("chain-payback-window", [Some(-2), Some(8), Some(3)]),
    ("chain-payback-window-2", [Some(-1), Some(-9), Some(13)]),
    ("chokepoint-claim", [Some(-20), Some(-12), Some(2)]),
    ("chokepoint-garrison", [Some(-5), Some(5), Some(-7)]),
    ("chokepoint-siting", [Some(7), Some(9), Some(12)]),
    ("chop-into-the-queue", [Some(-40), Some(12), Some(-28)]),
    ("city-campaign", [Some(-15), Some(4), Some(-41)]),
    ("city-target-meets-the-map", [Some(-5), Some(0), Some(1)]),
    ("civilian-out-of-reach", [Some(5), Some(-28), Some(29)]),
    ("close-as-a-body", [Some(6), Some(23), Some(21)]),
    ("coalition-before-war", [Some(-6), Some(-16), Some(12)]),
    ("coastal-city-sites", [Some(-1), Some(-26), Some(-4)]),
    ("coastal-city-sites-2", [Some(-1), Some(22), Some(-7)]),
    ("come-ashore", [Some(9), Some(26), Some(5)]),
    ("commitment-patience", [Some(1), Some(0), None]),
    ("competition-victory-points", [Some(8), Some(4), Some(10)]),
    ("congress-counter-leader", [Some(5), Some(9), Some(-7)]),
    ("contested-land-first", [Some(-7), Some(8), Some(6)]),
    ("conversion-majority-alarm", [Some(-2), Some(-12), Some(0)]),
    ("coordinated-finish", [Some(-4), Some(1), Some(-5)]),
    ("culture-building-debt", [Some(15), Some(11), Some(-24)]),
    ("culture-floor", [Some(15), Some(4), Some(-4)]),
    ("culture-lane-forecast", [Some(-10), Some(-9), Some(-11)]),
    ("deals-at-the-ceiling", [Some(10), Some(-15), Some(14)]),
    ("deals-for-our-gain", [Some(-1), Some(-18), Some(-12)]),
    ("defend-where-you-stand", [Some(8), Some(14), Some(15)]),
    ("defensible-sites", [Some(41), Some(43), Some(32)]),
    ("diplomatic-lane-forecast", [Some(3), Some(-24), Some(-4)]),
    ("district-coverage", [Some(-5), Some(-25), Some(36)]),
    ("district-coverage-2", [Some(3), Some(-5), Some(-9)]),
    ("district-planning", [Some(15), Some(3), Some(4)]),
    ("domination-city-count", [Some(12), Some(1), Some(-9)]),
    ("early-archers", [Some(3), Some(10), Some(18)]),
    ("early-contact-window", [Some(10), Some(-8), Some(9)]),
    ("elective-war-in-reach", [Some(4), Some(-3), Some(4)]),
    ("elective-war-yields-to-a-lane", [Some(41), Some(42), Some(26)]),
    ("encampment-seals-the-pass", [Some(-12), Some(-8), Some(-3)]),
    ("enemy-of-my-enemy", [Some(12), Some(-16), Some(-1)]),
    ("engine-faith-price", [Some(32), Some(0), Some(22)]),
    ("enhancer-for-the-corps", [Some(17), Some(-1), Some(26)]),
    ("enter-the-prophet-race", [Some(-76), Some(-22), None]),
    ("escort-unstick", [Some(5), Some(42), Some(20)]),
    ("eureka-chasing-builder", [Some(-9), Some(5), Some(-5)]),
    ("eureka-chasing-production", [Some(-3), Some(24), Some(-9)]),
    ("exchange-is-the-engines", [Some(-1), Some(9), Some(21)]),
    ("expansion-pays-back", [Some(11), Some(0), Some(8)]),
    ("expansion-schedule", [Some(18), Some(12), Some(15)]),
    ("fire-plan", [Some(-11), Some(22), Some(-9)]),
    ("first-builder-reserve", [Some(-2), Some(40), Some(-18)]),
    ("first-research-building-reserve", [Some(-15), Some(-2), Some(0)]),
    ("flip-nearby-city-states", [Some(14), Some(4), Some(8)]),
    ("founder-temple", [Some(8), Some(14), Some(-7)]),
    ("frontier-massing-alarm", [Some(-3), Some(3), Some(-2)]),
    ("garrison-under-fire", [Some(-7), Some(4), Some(21)]),
    ("gold-for-the-young-city", [Some(12), Some(-14), Some(10)]),
    ("gold-income-floor", [Some(10), Some(-9), Some(14)]),
    ("government-capacity-fallback", [Some(-11), Some(5), Some(3)]),
    ("government-ladder", [Some(-5), Some(4), Some(-20)]),
    ("government-ladder-2", [Some(15), Some(-19), Some(10)]),
    ("great-person-housing", [Some(11), Some(4), Some(13)]),
    ("growth-to-settle", [Some(12), Some(-18), Some(0)]),
    ("guru-heals-the-corps-2", [Some(4), Some(-23), Some(5)]),
    ("holy-lane-parity", [Some(-10), Some(-3), Some(12)]),
    ("holy-site-where-the-threat-is", [Some(-19), Some(-13), Some(33)]),
    ("holy-site-where-the-threat-is-2", [Some(8), Some(17), Some(-12)]),
    ("housing-research", [Some(2), Some(0), Some(-1)]),
    ("idle-faith-patronage", [Some(7), Some(21), Some(28)]),
    ("improvement-housing-value", [Some(26), Some(-30), Some(18)]),
    ("island-exploration", [Some(-16), Some(-31), None]),
    ("lane-culture-spending", [Some(-12), Some(-9), Some(-2)]),
    ("lane-great-people", [Some(-8), Some(-5), Some(21)]),
    ("lane-policy-deck", [Some(-11), Some(-20), Some(8)]),
    ("lane-release-when-hopeless", [Some(-9), Some(-11), Some(24)]),
    ("lane-space-race", [Some(2), Some(-4), Some(-5)]),
    ("lane-votes-its-favor", [Some(16), Some(-13), Some(16)]),
    ("loyalty-rate-alarm", [Some(42), Some(40), Some(38)]),
    ("maintenance-aware-deck", [Some(26), Some(10), Some(24)]),
    ("missionary-evades-raiders", [Some(-8), Some(43), Some(25)]),
    ("missionary-last-charge-explores", [Some(-1), Some(7), Some(9)]),
    ("moksha-defends-the-faithless", [Some(-4), Some(18), Some(1)]),
    ("native-emergency-purchase", [Some(-11), Some(2), Some(-15)]),
    ("naval-recon", [Some(16), Some(-1), Some(-22)]),
    ("naval-recon-2", [Some(-11), Some(-2), Some(-3)]),
    ("naval-threat-triage", [Some(2), Some(-8), Some(3)]),
    ("never-an-empty-queue", [Some(-4), Some(12), Some(20)]),
    ("never-an-empty-queue-2", [Some(5), Some(5), Some(-29)]),
    ("no-free-passage", [Some(-4), Some(-24), Some(13)]),
    ("one-launch-pad", [Some(-19), Some(-13), Some(0)]),
    ("one-shot-recovery", [Some(3), Some(-3), Some(8)]),
    ("one-war-at-a-time", [Some(-23), Some(-3), Some(-1)]),
    ("opening-warrior-recon", [Some(-36), Some(-42), Some(-35)]),
    ("opportunistic-war", [Some(1), Some(18), Some(2)]),
    ("order-retry", [Some(-7), Some(8), Some(0)]),
    ("overseas-settlement", [Some(-16), Some(-8), None]),
    ("pantheon-board", [Some(4), Some(8), Some(-17)]),
    ("pass-picket", [Some(7), Some(22), Some(-14)]),
    ("peace-when-the-war-does-not-pay", [Some(-8), Some(-8), Some(9)]),
    ("peacetime-deterrence", [Some(4), Some(-9), Some(3)]),
    ("power-the-laboratory", [Some(4), Some(-12), Some(4)]),
    ("power-the-laboratory-2", [Some(-20), Some(0), Some(6)]),
    ("price-the-suzerainty", [Some(14), Some(5), Some(-9)]),
    ("promote-when-wounded", [Some(16), Some(23), Some(-1)]),
    ("quest-boost", [Some(-19), Some(-7), Some(15)]),
    ("quest-camp-errand", [Some(-1), Some(24), Some(-5)]),
    ("quest-production", [Some(-5), Some(7), Some(24)]),
    ("quest-trade-route", [Some(10), Some(-9), Some(6)]),
    ("raid-pillage-prizes", [Some(-5), Some(16), Some(8)]),
    ("rapid-city-expansion", [Some(-7), Some(-21), Some(-122)]),
    ("recon-replacement", [Some(5), Some(0), Some(6)]),
    ("recorded-tactical-step", [Some(12), Some(0), Some(-17)]),
    ("recovery-reads-the-war", [Some(-3), Some(6), Some(-3)]),
    ("relief-column-marches", [Some(13), Some(-8), None]),
    ("relief-targets-the-siege", [Some(-4), Some(-9), Some(-7)]),
    ("religion-race-is-closed", [Some(-9), Some(-33), Some(22)]),
    ("religion-sues-peace", [Some(-7), Some(-12), Some(-6)]),
    ("religious-defence-scales", [Some(1), Some(-13), Some(14)]),
    ("religious-units-heal-first", [Some(-5), Some(18), Some(-11)]),
    ("religious-veto-defence", [Some(15), Some(14), Some(8)]),
    ("research-tier-premium", [Some(0), Some(-16), Some(-13)]),
    ("rival-suzerainty-alarm", [Some(-2), Some(-3), Some(-19)]),
    ("science-building-first", [Some(4), Some(-23), Some(-29)]),
    ("science-chain-alarm", [Some(4), Some(25), Some(9)]),
    ("science-multiplier-payoff", [Some(1), Some(13), Some(5)]),
    ("science-victory-drive", [Some(13), Some(18), Some(52)]),
    ("score-horizon", [Some(8), Some(7), Some(19)]),
    ("screen-the-shooters", [Some(10), Some(-17), Some(-4)]),
    ("settle-sooner", [Some(9), Some(6), Some(36)]),
    ("settlement-gap-target", [Some(-8), Some(-10), Some(9)]),
    ("settler-factory-coordination", [Some(-2), Some(-25), Some(2)]),
    ("settler-guard-holds", [Some(21), Some(-7), Some(-2)]),
    ("settler-guard-holds-2", [Some(-27), Some(5), Some(-1)]),
    ("settler-never-idles", [Some(8), Some(33), None]),
    ("settler-screen", [Some(5), Some(20), Some(3)]),
    ("settler-second-look", [Some(-15), Some(-6), Some(-14)]),
    ("settler-target-hysteresis", [Some(-2), Some(-16), Some(-15)]),
    ("settler-target-hysteresis-2", [Some(-2), Some(3), Some(12)]),
    ("settler-threat-detour", [Some(5), Some(-14), Some(-16)]),
    ("siege-commitment", [Some(0), Some(12), Some(16)]),
    ("siege-is-progress-2", [Some(5), Some(-5), Some(10)]),
    ("skip-the-prophet-race", [Some(9), Some(-25), Some(-130)]),
    ("slot-kind-tiebreak", [Some(4), Some(13), Some(9)]),
    ("solvency-first-trade-slot", [Some(134), Some(108), Some(133)]),
    ("solvency-first-trade-slot-2", [Some(-39), Some(-22), Some(-46)]),
    ("stranded-settler-discount", [Some(9), Some(0), Some(-5)]),
    ("strategic-wonders", [Some(-5), Some(-18), Some(-5)]),
    ("strike-opening", [Some(-22), Some(-7), Some(-14)]),
    ("surprise-war-mobilization", [Some(-2), Some(2), Some(-18)]),
    ("swap-rotation", [Some(7), Some(1), Some(-10)]),
    ("threatened-city-reserve", [Some(-5), Some(-15), None]),
    ("treasury-at-work", [Some(-2), Some(2), Some(6)]),
    ("treasury-at-work-2", [Some(9), Some(36), Some(7)]),
    ("unchosen-war-keeps-the-lane", [Some(-2), Some(-4), Some(-1)]),
    ("unit-cost-efficiency", [Some(10), Some(8), Some(-5)]),
    ("unit-objective-memory", [Some(-11), Some(-27), Some(-6)]),
    ("upgrade-the-garrison", [Some(-9), Some(15), Some(16)]),
    ("war-economy", [Some(-4), Some(-6), Some(2)]),
    ("war-needs-a-treasury", [Some(-16), Some(-16), Some(6)]),
    ("war-reinforcement", [Some(3), Some(3), Some(-1)]),
    ("whole-turn-backtrack-guard", [Some(2), Some(1), Some(12)]),
    ("wide-map-capacity", [Some(23), Some(15), Some(41)]),
    ("wonder-adjacent-sites", [Some(2), Some(4), Some(-9)]),
    ("wonder-adjacent-sites-2", [Some(7), Some(4), Some(6)]),
    ("wonder-ring-recon", [Some(14), Some(17), Some(-12)]),
    ("wonder-score-tally", [Some(-13), Some(3), Some(-7)]),
];
