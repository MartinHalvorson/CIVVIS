...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(17), Some(19), Some(4)]),
    ("air-surge", [Some(11), Some(17), Some(23)]),
    ("air-surge-2", [Some(6), Some(-15), Some(-3)]),
    ("amenity-district-path", [Some(8), Some(11), Some(10)]),
    ("amenity-project-preemption", [Some(14), Some(2), Some(10)]),
    ("amenity-project-preemption-2", [Some(-3), Some(-5), Some(3)]),
    ("anvil", [Some(3), Some(-3), Some(-6)]),
    ("apostle-promotion-by-role", [Some(-17), Some(-12), Some(18)]),
    ("army-target-weighs-enemy", [Some(-12), Some(-5), Some(-9)]),
    ("barbarian-bargain", [Some(-7), Some(21), Some(1)]),
    ("barbarian-ranged-answer", [Some(15), Some(-16), Some(-1)]),
    ("barbarian-scouts-are-scouts", [Some(11), Some(6), Some(-2)]),
    ("barbarian-settler-capture", [Some(19), Some(19), Some(16)]),
    ("battle-planner", [Some(7), Some(16), Some(-3)]),
    ("battle-planner-2", [Some(35), Some(25), Some(6)]),
    ("battle-planner-3", [Some(24), Some(8), Some(25)]),
    ("blind-objective-strength", [Some(-15), Some(20), Some(-1)]),
    ("blind-objective-units", [Some(-3), Some(-20), Some(-11)]),
    ("boost-first-research", [Some(17), Some(-9), Some(5)]),
    ("boost-unlock-research", [Some(2), Some(7), Some(-8)]),
    ("boost-wait-research", [Some(-9), Some(-14), Some(-6)]),
    ("boost-wait-research-2", [Some(-10), Some(-14), Some(29)]),
    ("boosted-bargain-first", [Some(-25), Some(12), Some(-5)]),
    ("boosted-bargain-first-2", [Some(3), Some(17), Some(9)]),
    ("border-parity", [Some(-1), Some(-9), Some(1)]),
    ("border-parity-2", [Some(-12), Some(-25), Some(18)]),
    ("border-parity-3", [Some(6), Some(13), Some(19)]),
    ("bounded-recovery", [Some(-4), Some(-11), Some(24)]),
    ("build-what-cards-boost", [Some(1), Some(-5), Some(-19)]),
    ("builder-barbarian-safety", [Some(7), Some(-20), Some(46)]),
    ("builder-supply-floor", [Some(-1), Some(-24), Some(19)]),
    ("builder-tries-the-next-tile", [Some(-5), Some(-6), Some(-7)]),
    ("buildings-before-projects", [Some(6), Some(-5), Some(-16)]),
    ("buy-what-cards-cannot-boost", [Some(-4), Some(3), Some(14)]),
    ("camp-party", [Some(32), Some(8), Some(11)]),
    ("camp-tile-buyout", [Some(9), Some(-1), Some(-13)]),
    ("campaign-pillage", [Some(-9), Some(12), Some(23)]),
    ("campus-adjacency-threshold", [Some(11), Some(-8), Some(-15)]),
    ("campus-adjacency-threshold-2", [Some(3), Some(-1), Some(-2)]),
    ("campus-through-expansion", [Some(-13), Some(10), Some(-25)]),
    ("canal-city", [Some(3), Some(18), Some(-22)]),
    ("capital-settler-after-completion", [Some(0), Some(5), Some(-6)]),
    ("capture-go-or-stand-down", [Some(-8), Some(10), Some(-37)]),
    ("capture-go-or-stand-down-2", [Some(-2), Some(9), Some(27)]),
    ("chain-payback-window", [Some(-6), Some(13), Some(-29)]),
    ("chain-payback-window-2", [Some(5), Some(-17), Some(18)]),
    ("chase-every-boost", [Some(2), Some(-10), Some(-18)]),
    ("chase-every-boost-2", [Some(9), Some(4), None]),
    ("cheapest-wonder-first", [Some(5), Some(9), Some(5)]),
    ("chokepoint-claim", [Some(2), Some(0), Some(-10)]),
    ("chokepoint-garrison", [Some(-7), Some(4), Some(5)]),
    ("chokepoint-siting", [Some(3), Some(-6), Some(-3)]),
    ("chop-into-the-queue", [Some(-14), Some(11), Some(-3)]),
    ("city-campaign", [Some(-27), Some(-3), Some(-27)]),
    ("city-campaign-2", [Some(0), Some(16), None]),
    ("city-target-meets-the-map", [Some(-6), Some(-6), Some(0)]),
    ("civilian-out-of-reach", [Some(-4), Some(-8), Some(-12)]),
    ("close-as-a-body", [Some(-25), Some(-14), Some(16)]),
    ("coalition-before-war", [Some(8), Some(13), Some(-14)]),
    ("coalition-before-war-2", [Some(-5), Some(11), Some(26)]),
    ("coalition-before-war-3", [Some(-2), Some(-6), None]),
    ("coastal-city-sites", [Some(6), Some(16), Some(-6)]),
    ("coastal-city-sites-2", [Some(6), Some(3), Some(-8)]),
    ("come-ashore", [Some(9), Some(13), Some(-4)]),
    ("commitment-owner-acts", [Some(-9), Some(26), Some(26)]),
    ("commitment-patience", [Some(10), Some(22), Some(-14)]),
    ("competition-victory-points", [Some(1), Some(-16), Some(-13)]),
    ("congress-counter-leader", [Some(-12), Some(12), Some(-13)]),
    ("connect-the-luxury", [Some(-2), Some(-4), Some(42)]),
    ("contested-land-first", [Some(16), Some(10), Some(12)]),
    ("conversion-majority-alarm", [Some(2), Some(17), Some(-1)]),
    ("conversion-majority-alarm-2", [Some(13), Some(-11), Some(21)]),
    ("coordinated-finish", [Some(19), Some(-11), Some(3)]),
    ("culture-building-debt", [Some(7), Some(6), Some(-16)]),
    ("culture-floor", [Some(5), Some(15), Some(8)]),
    ("culture-lane-forecast", [Some(2), Some(-2), Some(-8)]),
    ("deals-at-the-ceiling", [Some(26), Some(10), Some(-5)]),
    ("deals-for-our-gain", [Some(-4), Some(-10), Some(3)]),
    ("defend-where-you-stand", [Some(-7), Some(3), Some(6)]),
    ("defensible-sites", [Some(22), Some(33), Some(7)]),
    ("diplomatic-lane-forecast", [Some(18), Some(-6), Some(25)]),
    ("diplomatic-lane-forecast-2", [Some(-30), Some(15), Some(11)]),
    ("district-coverage", [Some(-2), Some(-19), Some(-23)]),
    ("district-coverage-2", [Some(-3), Some(-6), Some(-8)]),
    ("district-planning", [Some(-1), Some(1), Some(27)]),
    ("district-planning-2", [Some(-1), Some(10), Some(1)]),
    ("district-planning-3", [Some(-2), Some(-2), Some(-18)]),
    ("domination-city-count", [Some(-15), Some(-2), Some(24)]),
    ("doomed-blow-veto", [Some(-3), None, None]),
    ("early-archers", [Some(-7), Some(-23), Some(11)]),
    ("early-contact-window", [Some(2), Some(-4), Some(-23)]),
    ("early-project-restraint", [Some(3), Some(7), Some(-3)]),
    ("early-project-restraint-2", [Some(4), Some(-14), Some(-25)]),
    ("elective-war-in-reach", [Some(0), Some(-18), Some(10)]),
    ("elective-war-yields-to-a-lane", [Some(39), Some(51), Some(31)]),
    ("encampment-seals-the-pass", [Some(16), Some(17), Some(-12)]),
    ("enemy-of-my-enemy", [Some(15), Some(-16), Some(1)]),
    ("engine-faith-price", [Some(0), Some(11), Some(-12)]),
    ("enhancer-for-the-corps", [Some(6), Some(-5), Some(12)]),
    ("enter-the-prophet-race", [Some(-11), Some(-13), Some(7)]),
    ("enter-the-prophet-race-2", [Some(22), Some(35), Some(44)]),
    ("escort-cap-holds", [Some(9), Some(20), Some(2)]),
    ("escort-unstick", [Some(19), Some(38), Some(23)]),
    ("eureka-chasing-builder", [Some(12), Some(25), Some(13)]),
    ("eureka-chasing-builder-2", [Some(-3), Some(6), Some(-25)]),
    ("eureka-chasing-production", [Some(-9), Some(-14), Some(18)]),
    ("exchange-is-the-engines", [Some(-19), Some(-17), Some(-14)]),
    ("exhaustion-loyalty-guard", [Some(-1), Some(6), Some(-36)]),
    ("expansion-pays-back", [Some(-6), Some(-5), Some(19)]),
    ("expansion-schedule", [Some(11), Some(6), Some(3)]),
    ("fire-plan", [Some(1), Some(-14), Some(1)]),
    ("first-builder-reserve", [Some(0), Some(-8), Some(23)]),
    ("first-builder-reserve-2", [Some(6), Some(17), Some(-10)]),
    ("first-district-first", [Some(6), Some(-20), Some(-17)]),
    ("first-granary-reserve", [Some(-24), Some(14), Some(3)]),
    ("first-luxury-first", [Some(-2), Some(3), Some(20)]),
    ("first-research-building-reserve", [Some(-4), Some(1), Some(-47)]),
    ("flip-nearby-city-states", [Some(13), Some(11), Some(-19)]),
    ("founder-temple", [Some(-7), Some(11), Some(17)]),
    ("frontier-massing-alarm", [Some(-3), Some(-2), Some(-4)]),
    ("garrison-under-fire", [Some(1), Some(-4), Some(-30)]),
    ("gold-for-the-young-city", [Some(0), Some(4), Some(-10)]),
    ("gold-income-floor", [Some(-17), Some(16), Some(31)]),
    ("government-capacity-fallback", [Some(6), Some(-14), Some(-4)]),
    ("government-ladder", [Some(-15), Some(-25), Some(-15)]),
    ("government-ladder-2", [Some(10), Some(32), Some(8)]),
    ("great-person-housing", [Some(-9), Some(9), Some(16)]),
    ("growth-to-settle", [Some(-6), Some(-12), Some(-8)]),
    ("guru-heals-the-corps-2", [Some(27), Some(-6), Some(-12)]),
    ("holy-lane-parity", [Some(-15), Some(12), Some(-6)]),
    ("holy-site-where-the-threat-is", [Some(-8), Some(-3), Some(-31)]),
    ("holy-site-where-the-threat-is-2", [Some(-17), Some(17), Some(6)]),
    ("hostile-memory", [Some(-11), Some(-9), Some(-29)]),
    ("housing-research", [Some(4), Some(-13), Some(2)]),
    ("idle-faith-patronage", [Some(-11), Some(18), Some(-34)]),
    ("improvement-housing-value", [Some(-21), Some(-29), Some(-18)]),
    ("industrial-chain-debt", [Some(16), Some(-22), Some(24)]),
    ("island-exploration", [Some(-2), Some(1), Some(-22)]),
    ("lane-culture-spending", [Some(-8), Some(22), Some(25)]),
    ("lane-great-people", [Some(-3), Some(-4), Some(-15)]),
    ("lane-policy-deck", [Some(0), Some(-5), Some(1)]),
    ("lane-release-when-hopeless", [Some(-10), Some(1), Some(-20)]),
    ("lane-space-race", [Some(7), Some(15), Some(17)]),
    ("lane-votes-its-favor", [Some(12), Some(-4), Some(-3)]),
    ("loyalty-rate-alarm", [Some(61), Some(47), Some(8)]),
    ("maintenance-aware-deck", [Some(8), Some(7), Some(5)]),
    ("missionary-evades-raiders", [Some(18), Some(-9), Some(34)]),
    ("missionary-last-charge-explores", [Some(-1), Some(2), Some(18)]),
    ("modernize-before-spending", [Some(-6), Some(-7), Some(4)]),
    ("moksha-defends-the-faithless", [Some(-13), Some(0), Some(-9)]),
    ("native-emergency-purchase", [Some(-13), Some(-10), Some(-5)]),
    ("native-emergency-purchase-2", [Some(15), Some(15), None]),
    ("naval-recon", [Some(8), Some(-1), Some(8)]),
    ("naval-recon-2", [Some(12), Some(26), Some(16)]),
    ("naval-recon-3", [Some(-4), Some(-14), Some(1)]),
    ("naval-threat-triage", [Some(18), Some(1), Some(6)]),
    ("never-an-empty-queue", [Some(5), Some(-30), Some(13)]),
    ("never-an-empty-queue-2", [Some(2), Some(-3), Some(-5)]),
    ("never-an-empty-queue-3", [Some(1), Some(0), Some(7)]),
    ("no-free-passage", [Some(-7), Some(-3), Some(-10)]),
    ("objective-board", [Some(-27), Some(-5), Some(-17)]),
    ("one-launch-pad", [Some(-4), Some(-28), Some(-4)]),
    ("one-shot-recovery", [Some(-25), Some(8), Some(-11)]),
    ("one-war-at-a-time", [Some(6), Some(-10), Some(-1)]),
    ("opening-warrior-recon", [Some(-28), Some(-3), Some(-12)]),
    ("opening-warrior-recon-2", [Some(33), Some(10), Some(-1)]),
    ("opportunistic-war", [Some(-20), Some(2), Some(-15)]),
    ("order-retry", [Some(9), Some(-35), Some(12)]),
    ("overseas-settlement", [Some(3), Some(20), Some(0)]),
    ("pantheon-board", [Some(6), Some(12), Some(20)]),
    ("pass-picket", [Some(-16), Some(3), Some(-14)]),
    ("peace-when-the-war-does-not-pay", [Some(10), Some(-17), Some(-17)]),
    ("peacetime-deterrence", [Some(-22), Some(11), Some(15)]),
    ("power-the-laboratory", [Some(2), Some(3), Some(-12)]),
    ("power-the-laboratory-2", [Some(3), Some(-15), Some(14)]),
    ("price-the-suzerainty", [Some(3), Some(38), Some(35)]),
    ("promote-when-wounded", [Some(7), Some(0), Some(1)]),
    ("quest-boost", [Some(9), Some(13), Some(10)]),
    ("quest-camp-errand", [Some(20), Some(-33), Some(32)]),
    ("quest-production", [Some(-8), Some(5), Some(-6)]),
    ("quest-trade-route", [Some(8), Some(-9), Some(19)]),
    ("raid-pillage-prizes", [Some(-14), Some(3), Some(8)]),
    ("rapid-city-expansion", [Some(-166), Some(-158), Some(-173)]),
    ("rapid-city-expansion-2", [Some(98), Some(115), Some(139)]),
    ("recon-replacement", [Some(17), Some(5), Some(-18)]),
    ("recorded-tactical-step", [Some(-10), Some(18), Some(10)]),
    ("recovery-reads-the-war", [Some(-3), Some(-23), Some(9)]),
    ("recovery-reads-the-war-2", [Some(11), Some(12), None]),
    ("relief-column-marches", [Some(-7), Some(10), Some(-17)]),
    ("relief-targets-the-siege", [Some(-6), Some(6), Some(-6)]),
    ("religion-race-is-closed", [Some(-4), Some(3), Some(11)]),
    ("religion-sues-peace", [Some(8), Some(-2), Some(13)]),
    ("religious-defence-scales", [Some(3), Some(3), Some(-14)]),
    ("religious-units-heal-first", [Some(16), Some(-16), Some(4)]),
    ("religious-veto-defence", [Some(26), Some(-11), Some(31)]),
    ("requisitions", [Some(-5), Some(-2), Some(-9)]),
    ("research-tier-premium", [Some(-11), Some(10), Some(26)]),
    ("rival-suzerainty-alarm", [Some(0), Some(-13), Some(-11)]),
    ("safest-stand", [Some(21), None, None]),
    ("science-building-first", [Some(0), Some(5), Some(3)]),
    ("science-chain-alarm", [Some(1), Some(8), Some(6)]),
    ("science-expansion-phase", [Some(8), Some(3), Some(2)]),
    ("science-multiplier-payoff", [Some(18), Some(-4), Some(-14)]),
    ("science-opening-band", [Some(29), Some(14), Some(7)]),
    ("science-victory-drive", [Some(7), Some(-34), Some(-9)]),
    ("science-victory-drive-2", [Some(38), Some(44), Some(-1)]),
    ("score-horizon", [Some(-5), Some(-1), Some(-26)]),
    ("screen-the-shooters", [Some(11), Some(-25), Some(-10)]),
    ("settle-sooner", [Some(6), Some(-16), Some(1)]),
    ("settlement-gap-target", [Some(-14), Some(-3), Some(-13)]),
    ("settler-backlog-brake", [Some(-6), Some(-17), Some(24)]),
    ("settler-backlog-brake-2", [Some(8), None, None]),
    ("settler-factory-coordination", [Some(-4), Some(2), Some(-8)]),
    ("settler-guard-holds", [Some(-10), Some(-1), Some(2)]),
    ("settler-guard-holds-2", [Some(1), Some(-8), Some(6)]),
    ("settler-never-idles", [Some(24), Some(24), Some(25)]),
    ("settler-screen", [Some(29), Some(17), Some(-9)]),
    ("settler-second-look", [Some(-6), Some(-3), Some(-25)]),
    ("settler-site-gate", [Some(14), Some(-14), Some(-13)]),
    ("settler-target-floor", [Some(-3), Some(-7), Some(-4)]),
    ("settler-target-hysteresis", [Some(4), Some(1), Some(-7)]),
    ("settler-target-hysteresis-2", [Some(-5), Some(1), Some(16)]),
    ("settler-threat-detour", [Some(0), Some(9), Some(37)]),
    ("settler-walk-deadline", [Some(17), Some(26), Some(16)]),
    ("siege-commitment", [Some(17), Some(0), Some(-7)]),
    ("siege-is-progress-2", [Some(3), Some(-6), Some(13)]),
    ("siege-is-progress-3", [Some(9), Some(18), None]),
    ("siege-preempts-the-queue", [Some(-2), Some(-27), Some(-37)]),
    ("siege-train", [Some(16), Some(4), Some(-39)]),
    ("skip-the-prophet-race", [Some(4), Some(-25), Some(-105)]),
    ("skip-the-prophet-race-2", [Some(13), Some(3), Some(85)]),
    ("slot-kind-tiebreak", [Some(5), Some(-10), Some(-11)]),
    ("solvency-first-trade-slot", [Some(66), Some(82), Some(54)]),
    ("spaceport-surplus-veto", [Some(5), Some(4), Some(-23)]),
    ("stranded-settler-discount", [Some(21), Some(23), Some(19)]),
    ("strategic-wonders", [Some(-13), Some(-15), Some(-26)]),
    ("strike-opening", [Some(-9), Some(12), Some(10)]),
    ("strike-reach", [Some(-10), None, None]),
    ("surprise-war-mobilization", [Some(18), Some(-13), Some(-1)]),
    ("swap-rotation", [Some(15), Some(6), Some(-3)]),
    ("swap-rotation-2", [Some(15), None, None]),
    ("threatened-city-reserve", [Some(-11), Some(-21), Some(-29)]),
    ("trade-route-network", [Some(2), Some(13), Some(-10)]),
    ("treasury-at-work", [Some(17), Some(4), Some(4)]),
    ("treasury-at-work-2", [Some(8), Some(24), Some(20)]),
    ("unchosen-war-keeps-the-lane", [Some(-18), Some(10), Some(58)]),
    ("unit-cost-efficiency", [Some(-8), Some(-1), Some(3)]),
    ("unit-objective-memory", [Some(-14), Some(4), Some(-15)]),
    ("upgrade-the-garrison", [Some(-6), Some(0), Some(-6)]),
    ("veterans-withdraw-early", [Some(0), Some(4), Some(18)]),
    ("walls-after-districts", [Some(12), Some(-17), Some(23)]),
    ("war-economy", [Some(9), Some(23), Some(-3)]),
    ("war-needs-a-treasury", [Some(-10), Some(0), Some(21)]),
    ("war-policy-via-board", [Some(15), Some(4), Some(-1)]),
    ("war-reinforcement", [Some(-10), Some(19), Some(-38)]),
    ("whole-turn-backtrack-guard", [Some(-14), Some(17), Some(-2)]),
    ("wide-map-capacity", [Some(33), Some(9), Some(27)]),
    ("wonder-adjacent-sites", [Some(38), Some(37), Some(16)]),
    ("wonder-adjacent-sites-2", [Some(-26), Some(-36), Some(5)]),
    ("wonder-ring-recon", [Some(5), Some(2), Some(10)]),
    ("wonder-score-tally", [Some(-1), Some(-1), Some(9)]),
    ("wounded-out-of-reach", [Some(5), Some(-8), Some(-7)]),
];
