...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("air-surge", [Some(5), Some(14), Some(33)]),
    ("amenity-district-path", [Some(5), Some(-10), Some(-4)]),
    ("amenity-project-preemption", [Some(23), Some(-1), Some(7)]),
    ("amenity-project-preemption-2", [Some(-13), None, None]),
    ("apostle-promotion-by-role", [Some(12), Some(6), Some(-4)]),
    ("army-target-weighs-enemy", [Some(9), Some(31), Some(19)]),
    ("barbarian-bargain", [Some(8), Some(20), Some(1)]),
    ("barbarian-ranged-answer", [Some(10), Some(0), Some(9)]),
    ("barbarian-scouts-are-scouts", [Some(-13), Some(18), Some(16)]),
    ("blind-objective-strength", [Some(-11), Some(-12), Some(-9)]),
    ("blind-objective-units", [Some(18), Some(4), Some(-8)]),
    ("bounded-recovery", [Some(-25), Some(-1), Some(-7)]),
    ("builder-barbarian-safety", [Some(3), Some(-1), Some(-9)]),
    ("builder-supply-floor", [Some(-5), None, None]),
    ("builder-tries-the-next-tile", [Some(-26), Some(13), None]),
    ("buildings-before-projects", [Some(1), Some(8), Some(5)]),
    ("camp-party", [Some(25), Some(2), Some(-4)]),
    ("camp-tile-buyout", [Some(-4), None, None]),
    ("campaign-pillage", [Some(20), Some(13), Some(-4)]),
    ("campus-adjacency-threshold", [Some(14), Some(0), Some(-5)]),
    ("campus-adjacency-threshold-2", [Some(3), None, None]),
    ("chain-payback-window", [Some(11), None, None]),
    ("chain-payback-window-2", [Some(-5), None, None]),
    ("chop-into-the-queue", [Some(-18), None, None]),
    ("city-campaign", [Some(-11), Some(-13), Some(-4)]),
    ("civilian-out-of-reach", [Some(39), None, None]),
    ("coalition-before-war", [Some(25), None, None]),
    ("come-ashore", [Some(-4), Some(-12), Some(-4)]),
    ("competition-victory-points", [Some(14), Some(16), Some(4)]),
    ("congress-counter-leader", [Some(0), Some(14), None]),
    ("contested-land-first", [Some(-6), None, None]),
    ("conversion-majority-alarm", [Some(10), Some(-24), None]),
    ("coordinated-finish", [Some(12), Some(-11), Some(-4)]),
    ("culture-building-debt", [Some(1), Some(19), Some(-14)]),
    ("culture-lane-forecast", [Some(-7), Some(-10), None]),
    ("deals-at-the-ceiling", [Some(11), Some(-2), Some(-5)]),
    ("deals-for-our-gain", [Some(-10), Some(10), Some(10)]),
    ("defensible-sites", [Some(26), Some(-6), None]),
    ("diplomatic-lane-forecast", [Some(-17), Some(-33), Some(7)]),
    ("district-coverage", [Some(14), Some(12), Some(-7)]),
    ("district-coverage-2", [Some(-2), None, None]),
    ("district-planning", [Some(2), Some(13), Some(-5)]),
    ("domination-city-count", [Some(-8), Some(7), None]),
    ("early-contact-window", [Some(17), Some(2), Some(8)]),
    ("elective-war-in-reach", [Some(5), Some(22), None]),
    ("elective-war-yields-to-a-lane", [Some(49), None, None]),
    ("enemy-of-my-enemy", [Some(-18), None, None]),
    ("engine-faith-price", [Some(37), Some(17), Some(13)]),
    ("enhancer-for-the-corps", [Some(-3), Some(-4), Some(8)]),
    ("escort-unstick", [Some(16), Some(6), Some(5)]),
    ("eureka-chasing-builder", [Some(-9), None, None]),
    ("eureka-chasing-production", [Some(-10), None, None]),
    ("expansion-pays-back", [Some(-8), Some(-20), None]),
    ("expansion-schedule", [Some(11), Some(-5), None]),
    ("first-builder-reserve", [Some(3), None, None]),
    ("first-research-building-reserve", [Some(-21), None, None]),
    ("flip-nearby-city-states", [Some(-9), Some(28), Some(31)]),
    ("founder-temple", [Some(8), Some(6), Some(14)]),
    ("frontier-massing-alarm", [Some(2), Some(26), None]),
    ("garrison-under-fire", [Some(-8), Some(-14), Some(4)]),
    ("government-ladder", [Some(20), None, None]),
    ("great-person-housing", [Some(34), Some(7), Some(37)]),
    ("growth-to-settle", [Some(-25), Some(-16), None]),
    ("guru-heals-the-corps-2", [Some(18), None, None]),
    ("holy-lane-parity", [Some(0), Some(4), Some(-11)]),
    ("holy-site-where-the-threat-is", [Some(-12), Some(-22), Some(0)]),
    ("holy-site-where-the-threat-is-2", [Some(5), None, None]),
    ("housing-research", [Some(-19), Some(-11), Some(-5)]),
    ("idle-faith-patronage", [Some(-18), Some(17), Some(17)]),
    ("improvement-housing-value", [Some(-2), None, None]),
    ("lane-culture-spending", [Some(-10), Some(-7), Some(0)]),
    ("lane-great-people", [Some(22), Some(21), Some(2)]),
    ("lane-policy-deck", [Some(22), Some(-3), Some(8)]),
    ("lane-space-race", [Some(17), Some(8), Some(6)]),
    ("loyalty-rate-alarm", [Some(31), Some(-4), Some(4)]),
    ("maintenance-aware-deck", [Some(28), Some(-4), Some(23)]),
    ("missionary-evades-raiders", [Some(16), Some(2), Some(4)]),
    ("missionary-last-charge-explores", [Some(-10), Some(4), Some(3)]),
    ("naval-recon", [Some(-15), Some(10), Some(5)]),
    ("naval-recon-2", [Some(-3), None, None]),
    ("naval-threat-triage", [Some(18), Some(-3), Some(5)]),
    ("never-an-empty-queue", [Some(14), None, None]),
    ("never-an-empty-queue-2", [Some(-16), None, None]),
    ("no-free-passage", [Some(-15), Some(4), Some(5)]),
    ("one-launch-pad", [Some(15), Some(-12), Some(-7)]),
    ("one-shot-recovery", [Some(6), Some(-4), Some(-8)]),
    ("one-war-at-a-time", [Some(5), Some(7), Some(12)]),
    ("opening-warrior-recon", [Some(-24), None, None]),
    ("opportunistic-war", [Some(38), Some(36), Some(46)]),
    ("order-retry", [Some(-4), Some(-7), None]),
    ("pantheon-board", [Some(4), Some(20), Some(-3)]),
    ("pass-picket", [Some(3), Some(-11), Some(5)]),
    ("peacetime-deterrence", [Some(4), Some(-7), Some(16)]),
    ("power-the-laboratory", [Some(-8), Some(-5), Some(-6)]),
    ("power-the-laboratory-2", [Some(-1), None, None]),
    ("price-the-suzerainty", [Some(24), Some(32), Some(7)]),
    ("promote-when-wounded", [Some(2), Some(8), Some(-10)]),
    ("raid-pillage-prizes", [Some(-17), Some(23), Some(18)]),
    ("rapid-city-expansion", [Some(-81), None, None]),
    ("recon-replacement", [Some(13), Some(-3), Some(-11)]),
    ("recorded-tactical-step", [Some(-5), Some(11), Some(3)]),
    ("recovery-reads-the-war", [Some(-16), None, None]),
    ("relief-targets-the-siege", [Some(0), Some(1), Some(-15)]),
    ("religion-sues-peace", [Some(-8), Some(-29), Some(1)]),
    ("religious-defence-scales", [Some(-18), Some(-13), Some(4)]),
    ("religious-units-heal-first", [Some(2), Some(-3), Some(3)]),
    ("religious-veto-defence", [Some(27), Some(3), Some(24)]),
    ("research-tier-premium", [Some(15), Some(8), Some(9)]),
    ("rival-suzerainty-alarm", [Some(6), Some(-16), None]),
    ("science-chain-alarm", [Some(0), Some(5), None]),
    ("science-multiplier-payoff", [Some(-1), Some(10), Some(-12)]),
    ("science-victory-drive", [Some(40), Some(16), Some(8)]),
    ("score-horizon", [Some(-4), Some(-9), Some(7)]),
    ("settle-sooner", [Some(3), Some(13), Some(20)]),
    ("settlement-gap-target", [Some(12), Some(22), Some(8)]),
    ("settler-factory-coordination", [Some(-12), Some(-13), Some(3)]),
    ("settler-guard-holds", [Some(0), Some(7), Some(-4)]),
    ("settler-guard-holds-2", [Some(-12), None, None]),
    ("settler-screen", [Some(4), Some(5), Some(11)]),
    ("settler-second-look", [Some(4), None, None]),
    ("settler-target-hysteresis", [Some(21), Some(6), Some(13)]),
    ("settler-target-hysteresis-2", [Some(15), None, None]),
    ("settler-threat-detour", [Some(-1), Some(-10), Some(-4)]),
    ("siege-commitment", [Some(-10), Some(-19), Some(-2)]),
    ("siege-is-progress-2", [Some(-6), None, None]),
    ("slot-kind-tiebreak", [Some(-12), Some(22), Some(6)]),
    ("solvency-first-trade-slot", [Some(143), Some(89), Some(125)]),
    ("solvency-first-trade-slot-2", [Some(-44), None, None]),
    ("stranded-settler-discount", [Some(2), Some(-17), Some(-2)]),
    ("strategic-wonders", [Some(0), Some(-6), Some(-2)]),
    ("strike-opening", [Some(0), Some(7), Some(8)]),
    ("surprise-war-mobilization", [Some(15), Some(4), Some(-1)]),
    ("unchosen-war-keeps-the-lane", [Some(-1), Some(-9), None]),
    ("unit-cost-efficiency", [Some(-3), Some(2), Some(-3)]),
    ("unit-objective-memory", [Some(7), Some(26), Some(3)]),
    ("upgrade-the-garrison", [Some(-6), None, None]),
    ("war-economy", [Some(8), Some(18), Some(-8)]),
    ("war-reinforcement", [Some(11), Some(20), Some(-6)]),
    ("whole-turn-backtrack-guard", [Some(-19), Some(1), Some(-4)]),
    ("wide-map-capacity", [Some(28), Some(17), Some(16)]),
    ("wonder-adjacent-sites", [Some(4), None, None]),
    ("wonder-adjacent-sites-2", [Some(-6), None, None]),
    ("wonder-ring-recon", [Some(4), None, None]),
    ("wonder-score-tally", [Some(9), Some(6), Some(0)]),
];
