...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("air-surge", [Some(-10), Some(15), Some(5)]),
    ("amenity-district-path", [Some(-9), Some(13), Some(-19)]),
    ("amenity-project-preemption", [Some(20), Some(-34), Some(53)]),
    ("amenity-project-preemption-2", [Some(-14), Some(19), Some(-8)]),
    ("apostle-promotion-by-role", [Some(6), Some(-24), Some(-8)]),
    ("army-target-weighs-enemy", [Some(-4), Some(26), Some(-12)]),
    ("barbarian-bargain", [Some(19), Some(11), Some(14)]),
    ("barbarian-ranged-answer", [Some(10), Some(7), Some(-12)]),
    ("barbarian-scouts-are-scouts", [Some(8), Some(26), Some(1)]),
    ("barbarian-settler-capture", [Some(23), None, None]),
    ("blind-objective-strength", [Some(30), Some(-28), Some(6)]),
    ("blind-objective-units", [Some(-16), Some(-14), Some(17)]),
    ("boost-first-research", [Some(-16), Some(-35), Some(-1)]),
    ("boost-unlock-research", [Some(-43), Some(-30), Some(-34)]),
    ("boost-wait-research", [Some(-3), Some(20), Some(-3)]),
    ("bounded-recovery", [Some(26), Some(-21), Some(1)]),
    ("build-what-cards-boost", [Some(-20), Some(-27), Some(14)]),
    ("builder-barbarian-safety", [Some(3), Some(-1), Some(1)]),
    ("builder-supply-floor", [Some(0), Some(-1), Some(25)]),
    ("builder-tries-the-next-tile", [Some(12), Some(-14), Some(2)]),
    ("buildings-before-projects", [Some(-7), Some(12), Some(1)]),
    ("buy-what-cards-cannot-boost", [Some(9), Some(-9), Some(3)]),
    ("camp-party", [Some(2), Some(-1), Some(-40)]),
    ("camp-tile-buyout", [Some(8), Some(4), Some(-6)]),
    ("campaign-pillage", [Some(-20), Some(-12), Some(-5)]),
    ("campus-adjacency-threshold", [Some(9), Some(17), Some(2)]),
    ("campus-adjacency-threshold-2", [Some(-15), Some(-5), Some(1)]),
    ("canal-city", [Some(8), Some(10), Some(1)]),
    ("chain-payback-window", [Some(-2), Some(8), Some(-5)]),
    ("chain-payback-window-2", [Some(18), Some(-1), Some(-9)]),
    ("chokepoint-claim", [Some(12), Some(-5), Some(1)]),
    ("chokepoint-garrison", [Some(11), Some(-18), Some(14)]),
    ("chokepoint-siting", [Some(-15), Some(-14), Some(-12)]),
    ("chop-into-the-queue", [Some(11), Some(7), Some(-6)]),
    ("city-campaign", [Some(1), Some(-18), Some(-5)]),
    ("city-target-meets-the-map", [Some(-5), Some(-6), None]),
    ("civilian-out-of-reach", [Some(20), Some(31), Some(18)]),
    ("close-as-a-body", [Some(-1), None, None]),
    ("coalition-before-war", [Some(2), Some(31), Some(14)]),
    ("coastal-city-sites", [Some(23), None, None]),
    ("coastal-city-sites-2", [Some(0), None, None]),
    ("come-ashore", [Some(22), Some(10), Some(-40)]),
    ("competition-victory-points", [Some(-12), Some(-17), Some(3)]),
    ("congress-counter-leader", [Some(-6), Some(25), Some(-11)]),
    ("contested-land-first", [Some(25), Some(24), Some(5)]),
    ("conversion-majority-alarm", [Some(13), Some(12), Some(-5)]),
    ("coordinated-finish", [Some(-5), Some(-20), Some(-2)]),
    ("culture-building-debt", [Some(0), Some(24), Some(-6)]),
    ("culture-lane-forecast", [Some(-11), Some(10), Some(10)]),
    ("deals-at-the-ceiling", [Some(-2), Some(18), Some(-2)]),
    ("deals-for-our-gain", [Some(-1), Some(-8), Some(16)]),
    ("defensible-sites", [Some(19), Some(17), Some(34)]),
    ("diplomatic-lane-forecast", [Some(-21), Some(-21), Some(6)]),
    ("district-coverage", [Some(14), Some(-8), Some(-4)]),
    ("district-coverage-2", [Some(-4), Some(-1), Some(-18)]),
    ("district-planning", [Some(16), Some(-30), Some(-7)]),
    ("domination-city-count", [Some(12), Some(0), Some(1)]),
    ("early-contact-window", [Some(-1), Some(-29), Some(-8)]),
    ("elective-war-in-reach", [Some(10), Some(-1), Some(7)]),
    ("elective-war-yields-to-a-lane", [Some(28), Some(23), Some(49)]),
    ("encampment-seals-the-pass", [Some(-1), Some(-5), Some(1)]),
    ("enemy-of-my-enemy", [Some(29), Some(13), Some(5)]),
    ("engine-faith-price", [Some(-15), Some(59), Some(20)]),
    ("enhancer-for-the-corps", [Some(20), Some(-11), Some(8)]),
    ("escort-unstick", [Some(-13), Some(25), Some(-3)]),
    ("eureka-chasing-builder", [Some(-16), Some(-17), Some(-22)]),
    ("eureka-chasing-production", [Some(-34), Some(25), Some(-20)]),
    ("expansion-pays-back", [Some(10), Some(17), Some(-7)]),
    ("expansion-schedule", [Some(-7), Some(18), Some(-13)]),
    ("fire-plan", [Some(-5), None, None]),
    ("first-builder-reserve", [Some(-25), Some(-14), Some(5)]),
    ("first-research-building-reserve", [Some(-5), Some(-1), Some(0)]),
    ("flip-nearby-city-states", [Some(10), Some(-4), Some(0)]),
    ("founder-temple", [Some(22), Some(-5), Some(-3)]),
    ("frontier-massing-alarm", [Some(-15), Some(-2), Some(-5)]),
    ("garrison-under-fire", [Some(-11), Some(17), Some(-12)]),
    ("gold-for-the-young-city", [Some(11), Some(-6), Some(5)]),
    ("government-capacity-fallback", [Some(-13), Some(5), None]),
    ("government-ladder", [Some(-13), Some(3), Some(-21)]),
    ("government-ladder-2", [Some(-21), Some(-16), None]),
    ("great-person-housing", [Some(-4), Some(11), Some(32)]),
    ("growth-to-settle", [Some(-21), Some(16), Some(3)]),
    ("guru-heals-the-corps-2", [Some(39), Some(27), Some(12)]),
    ("holy-lane-parity", [Some(-21), Some(-38), Some(-11)]),
    ("holy-site-where-the-threat-is", [Some(27), Some(-7), Some(12)]),
    ("holy-site-where-the-threat-is-2", [Some(-15), Some(15), Some(1)]),
    ("housing-research", [Some(3), Some(-19), Some(-38)]),
    ("idle-faith-patronage", [Some(9), Some(-23), Some(8)]),
    ("improvement-housing-value", [Some(-14), Some(-6), Some(-16)]),
    ("lane-culture-spending", [Some(-21), Some(-12), Some(-31)]),
    ("lane-great-people", [Some(24), Some(-14), Some(-10)]),
    ("lane-policy-deck", [Some(5), Some(-7), Some(-19)]),
    ("lane-release-when-hopeless", [Some(-4), Some(-14), None]),
    ("lane-space-race", [Some(2), Some(-5), Some(5)]),
    ("lane-votes-its-favor", [Some(-19), Some(-15), None]),
    ("loyalty-rate-alarm", [Some(9), Some(42), Some(21)]),
    ("maintenance-aware-deck", [Some(10), Some(12), Some(7)]),
    ("missionary-evades-raiders", [Some(-4), Some(48), Some(8)]),
    ("missionary-last-charge-explores", [Some(10), Some(2), Some(4)]),
    ("moksha-defends-the-faithless", [Some(-27), Some(25), None]),
    ("native-emergency-purchase", [Some(4), Some(-19), Some(3)]),
    ("naval-recon", [Some(-11), Some(8), Some(52)]),
    ("naval-recon-2", [Some(7), Some(-6), Some(-26)]),
    ("naval-threat-triage", [Some(14), Some(9), Some(27)]),
    ("never-an-empty-queue", [Some(-34), Some(-19), Some(-2)]),
    ("never-an-empty-queue-2", [Some(21), Some(19), Some(6)]),
    ("no-free-passage", [Some(-18), Some(29), Some(-7)]),
    ("one-launch-pad", [Some(-13), Some(22), Some(10)]),
    ("one-shot-recovery", [Some(18), Some(37), Some(-29)]),
    ("one-war-at-a-time", [Some(11), Some(29), Some(-22)]),
    ("opening-warrior-recon", [Some(-31), Some(-5), Some(-33)]),
    ("opportunistic-war", [Some(11), Some(14), Some(12)]),
    ("order-retry", [Some(18), Some(11), Some(-5)]),
    ("pantheon-board", [Some(7), Some(-11), Some(2)]),
    ("pass-picket", [Some(-8), Some(-20), Some(14)]),
    ("peace-when-the-war-does-not-pay", [Some(6), Some(23), None]),
    ("peacetime-deterrence", [Some(14), Some(21), Some(-25)]),
    ("power-the-laboratory", [Some(20), Some(-22), Some(4)]),
    ("power-the-laboratory-2", [Some(7), Some(2), Some(-8)]),
    ("price-the-suzerainty", [Some(12), Some(26), Some(22)]),
    ("promote-when-wounded", [Some(4), Some(18), Some(-13)]),
    ("quest-boost", [Some(11), Some(-14), Some(15)]),
    ("quest-camp-errand", [Some(2), Some(-8), Some(-13)]),
    ("quest-production", [Some(21), Some(7), Some(-5)]),
    ("quest-trade-route", [Some(13), Some(11), Some(15)]),
    ("raid-pillage-prizes", [Some(-3), Some(14), Some(-26)]),
    ("rapid-city-expansion", [Some(-94), Some(-81), Some(-112)]),
    ("recon-replacement", [Some(8), Some(11), Some(8)]),
    ("recorded-tactical-step", [Some(-9), Some(-12), Some(15)]),
    ("recovery-reads-the-war", [Some(0), Some(-15), Some(11)]),
    ("relief-targets-the-siege", [Some(8), Some(45), Some(11)]),
    ("religion-race-is-closed", [Some(5), Some(11), None]),
    ("religion-sues-peace", [Some(-12), Some(-16), Some(-4)]),
    ("religious-defence-scales", [Some(-6), Some(-2), Some(-17)]),
    ("religious-units-heal-first", [Some(8), Some(0), Some(21)]),
    ("religious-veto-defence", [Some(20), Some(10), Some(30)]),
    ("research-tier-premium", [Some(-25), Some(42), Some(-7)]),
    ("rival-suzerainty-alarm", [Some(5), Some(32), Some(30)]),
    ("science-building-first", [Some(-22), Some(1), Some(3)]),
    ("science-chain-alarm", [Some(8), Some(-6), Some(12)]),
    ("science-multiplier-payoff", [Some(1), Some(11), Some(-8)]),
    ("science-victory-drive", [Some(0), Some(9), Some(16)]),
    ("score-horizon", [Some(-7), Some(12), Some(-5)]),
    ("screen-the-shooters", [Some(-5), None, None]),
    ("settle-sooner", [Some(1), Some(4), Some(6)]),
    ("settlement-gap-target", [Some(0), Some(-5), Some(-4)]),
    ("settler-factory-coordination", [Some(-3), Some(-6), Some(-34)]),
    ("settler-guard-holds", [Some(20), Some(15), Some(-24)]),
    ("settler-guard-holds-2", [Some(-9), Some(14), Some(19)]),
    ("settler-screen", [Some(2), Some(0), Some(-4)]),
    ("settler-second-look", [Some(-48), Some(-4), Some(-15)]),
    ("settler-target-hysteresis", [Some(-3), Some(-6), Some(2)]),
    ("settler-target-hysteresis-2", [Some(-15), Some(10), Some(20)]),
    ("settler-threat-detour", [Some(15), Some(21), Some(18)]),
    ("siege-commitment", [Some(-19), Some(21), Some(-3)]),
    ("siege-is-progress-2", [Some(-11), Some(5), Some(-17)]),
    ("skip-the-prophet-race", [Some(-119), Some(-136), Some(-129)]),
    ("slot-kind-tiebreak", [Some(-7), Some(9), Some(27)]),
    ("solvency-first-trade-slot", [Some(100), Some(136), Some(121)]),
    ("solvency-first-trade-slot-2", [Some(-25), Some(-58), Some(-31)]),
    ("stranded-settler-discount", [Some(-23), Some(-2), Some(38)]),
    ("strategic-wonders", [Some(2), Some(-17), Some(1)]),
    ("strike-opening", [Some(12), Some(-3), Some(15)]),
    ("surprise-war-mobilization", [Some(7), Some(1), Some(0)]),
    ("treasury-at-work", [Some(12), Some(2), None]),
    ("treasury-at-work-2", [Some(13), Some(-3), None]),
    ("unchosen-war-keeps-the-lane", [Some(6), Some(22), Some(7)]),
    ("unit-cost-efficiency", [Some(7), Some(-3), Some(3)]),
    ("unit-objective-memory", [Some(-5), Some(1), Some(19)]),
    ("upgrade-the-garrison", [Some(1), Some(0), Some(-10)]),
    ("war-economy", [Some(-11), Some(10), Some(-8)]),
    ("war-needs-a-treasury", [Some(14), Some(-36), None]),
    ("war-reinforcement", [Some(10), Some(-12), Some(5)]),
    ("whole-turn-backtrack-guard", [Some(18), Some(4), Some(11)]),
    ("wide-map-capacity", [Some(16), Some(35), Some(40)]),
    ("wonder-adjacent-sites", [Some(-8), Some(0), Some(8)]),
    ("wonder-adjacent-sites-2", [Some(-2), Some(-7), Some(-10)]),
    ("wonder-ring-recon", [Some(3), Some(0), Some(0)]),
    ("wonder-score-tally", [Some(-6), Some(40), Some(6)]),
];
