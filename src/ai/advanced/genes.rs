...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(-23), Some(16), Some(2)]),
    ("air-surge", [Some(2), Some(-19), Some(-2)]),
    ("air-surge-2", [Some(51), Some(-7), Some(17)]),
    ("amenity-district-path", [Some(12), Some(4), Some(-2)]),
    ("amenity-project-preemption", [Some(-19), Some(-7), Some(26)]),
    ("amenity-project-preemption-2", [Some(36), Some(13), Some(6)]),
    ("anvil", [Some(-37), Some(-5), Some(14)]),
    ("apostle-promotion-by-role", [Some(3), Some(1), Some(5)]),
    ("army-target-weighs-enemy", [Some(-39), Some(-2), Some(31)]),
    ("barbarian-bargain", [Some(-64), Some(31), Some(13)]),
    ("barbarian-ranged-answer", [Some(-26), Some(0), Some(0)]),
    ("barbarian-scouts-are-scouts", [Some(-58), Some(25), Some(-3)]),
    ("barbarian-settler-capture", [Some(35), Some(27), Some(28)]),
    ("battle-planner", [Some(8), Some(-3), Some(5)]),
    ("battle-planner-2", [Some(28), Some(35), Some(25)]),
    ("battle-planner-3", [Some(-20), Some(17), Some(18)]),
    ("blind-objective-strength", [Some(-34), Some(0), Some(-9)]),
    ("blind-objective-units", [Some(-15), Some(-17), Some(-13)]),
    ("boost-first-research", [Some(32), Some(-27), Some(-12)]),
    ("boost-unlock-research", [Some(16), Some(26), Some(10)]),
    ("boost-wait-research", [Some(-14), Some(-27), Some(7)]),
    ("boost-wait-research-2", [Some(50), Some(17), Some(3)]),
    ("boosted-bargain-first", [Some(-10), Some(-9), Some(-21)]),
    ("boosted-bargain-first-2", [Some(-1), Some(5), Some(11)]),
    ("border-parity", [Some(-6), Some(-5), Some(2)]),
    ("border-parity-2", [Some(16), Some(-6), Some(-10)]),
    ("border-parity-3", [Some(-17), Some(6), Some(-10)]),
    ("bounded-recovery", [Some(45), Some(10), Some(0)]),
    ("build-what-cards-boost", [Some(-9), Some(-15), Some(6)]),
    ("builder-barbarian-safety", [Some(-54), Some(12), Some(7)]),
    ("builder-supply-floor", [Some(-9), Some(13), Some(0)]),
    ("builder-tries-the-next-tile", [Some(39), Some(-19), Some(-16)]),
    ("buildings-before-projects", [Some(85), Some(9), Some(7)]),
    ("buy-what-cards-cannot-boost", [Some(32), Some(-14), Some(-6)]),
    ("camp-party", [Some(20), Some(32), Some(23)]),
    ("camp-tile-buyout", [Some(-27), Some(-26), Some(-1)]),
    ("campaign-pillage", [Some(-15), Some(6), Some(-28)]),
    ("campus-adjacency-threshold", [Some(1), Some(8), Some(5)]),
    ("campus-adjacency-threshold-2", [Some(3), Some(-14), Some(-1)]),
    ("campus-through-expansion", [Some(30), Some(-8), Some(-8)]),
    ("canal-city", [Some(-15), Some(-2), Some(-6)]),
    ("capital-settler-after-completion", [Some(12), Some(-11), Some(-3)]),
    ("capture-go-or-stand-down", [Some(-22), Some(-3), Some(5)]),
    ("capture-go-or-stand-down-2", [Some(-42), Some(-13), Some(1)]),
    ("chain-payback-window", [Some(35), Some(-9), Some(-28)]),
    ("chain-payback-window-2", [Some(37), Some(12), Some(38)]),
    ("chase-every-boost", [Some(-7), Some(0), Some(2)]),
    ("chase-every-boost-2", [Some(5), Some(4), Some(13)]),
    ("cheapest-wonder-first", [Some(56), Some(-1), Some(-14)]),
    ("chokepoint-claim", [Some(5), Some(2), Some(-12)]),
    ("chokepoint-garrison", [Some(5), Some(-4), Some(-8)]),
    ("chokepoint-siting", [Some(22), Some(6), Some(23)]),
    ("chop-into-the-queue", [Some(-22), Some(-11), Some(-21)]),
    ("city-campaign", [Some(-45), Some(-7), Some(-7)]),
    ("city-campaign-2", [Some(-21), Some(-11), Some(-1)]),
    ("city-target-meets-the-map", [Some(71), Some(10), Some(-13)]),
    ("civilian-out-of-reach", [Some(-9), Some(7), Some(-2)]),
    ("close-as-a-body", [Some(49), Some(-25), Some(-2)]),
    ("coalition-before-war", [Some(-6), Some(-12), Some(-5)]),
    ("coalition-before-war-2", [Some(-47), Some(3), Some(-1)]),
    ("coalition-before-war-3", [Some(10), Some(1), Some(7)]),
    ("coastal-city-sites", [Some(-43), Some(0), Some(-8)]),
    ("coastal-city-sites-2", [Some(58), Some(-7), Some(25)]),
    ("come-ashore", [Some(14), Some(-1), Some(15)]),
    ("commitment-owner-acts", [Some(-44), Some(-6), Some(-6)]),
    ("commitment-patience", [Some(41), Some(-16), Some(-18)]),
    ("competition-victory-points", [Some(24), Some(16), Some(-5)]),
    ("congress-counter-leader", [Some(20), Some(-11), Some(10)]),
    ("connect-the-luxury", [Some(-7), Some(20), Some(50)]),
    ("contested-land-first", [Some(5), Some(1), Some(1)]),
    ("contested-suzerainty-brake", [Some(-56), Some(-11), Some(-22)]),
    ("conversion-majority-alarm", [Some(51), Some(30), Some(3)]),
    ("conversion-majority-alarm-2", [Some(-41), Some(8), Some(15)]),
    ("coordinated-finish", [Some(7), Some(9), Some(2)]),
    ("culture-building-debt", [Some(-22), Some(6), Some(5)]),
    ("culture-floor", [Some(46), Some(-11), Some(17)]),
    ("culture-lane-forecast", [Some(-46), Some(-4), Some(-12)]),
    ("deals-at-the-ceiling", [Some(11), Some(4), Some(29)]),
    ("deals-for-our-gain", [Some(-3), Some(3), Some(14)]),
    ("defend-where-you-stand", [Some(-75), Some(-6), Some(25)]),
    ("defensible-sites", [Some(46), Some(41), Some(11)]),
    ("detour-keeps-the-site-worth", [Some(48), Some(1), Some(9)]),
    ("diplomatic-lane-forecast", [Some(10), Some(-9), Some(-32)]),
    ("diplomatic-lane-forecast-2", [Some(-27), Some(0), Some(3)]),
    ("district-coverage", [Some(-5), Some(-18), Some(-6)]),
    ("district-coverage-2", [Some(49), Some(-6), Some(2)]),
    ("district-planning", [Some(59), Some(10), Some(3)]),
    ("district-planning-2", [Some(-70), Some(-16), Some(3)]),
    ("district-planning-3", [Some(-12), Some(-1), Some(-11)]),
    ("domination-city-count", [Some(19), Some(-12), Some(42)]),
    ("doomed-blow-veto", [Some(-14), Some(-14), Some(5)]),
    ("early-archers", [Some(15), Some(12), Some(-11)]),
    ("early-contact-window", [Some(62), Some(2), Some(-8)]),
    ("early-project-restraint", [Some(-22), Some(6), Some(9)]),
    ("early-project-restraint-2", [Some(20), Some(-6), Some(-15)]),
    ("elective-war-in-reach", [Some(-3), Some(-14), Some(-2)]),
    ("elective-war-yields-to-a-lane", [Some(74), Some(40), Some(30)]),
    ("encampment-seals-the-pass", [Some(-6), Some(-16), Some(17)]),
    ("enemy-of-my-enemy", [Some(20), Some(4), Some(-2)]),
    ("engine-faith-price", [Some(48), Some(17), Some(13)]),
    ("enhancer-for-the-corps", [Some(25), Some(1), Some(-6)]),
    ("enter-the-prophet-race", [Some(41), Some(-54), Some(-13)]),
    ("enter-the-prophet-race-2", [Some(-55), Some(53), Some(20)]),
    ("escort-cap-holds", [Some(-29), Some(17), Some(21)]),
    ("escort-unstick", [Some(36), Some(16), Some(12)]),
    ("eureka-chasing-builder", [Some(30), Some(1), Some(-8)]),
    ("eureka-chasing-builder-2", [Some(6), Some(2), Some(17)]),
    ("eureka-chasing-production", [Some(-33), Some(11), Some(5)]),
    ("exchange-is-the-engines", [Some(-12), Some(-6), Some(6)]),
    ("exhaustion-loyalty-guard", [Some(31), Some(-13), Some(-15)]),
    ("expansion-pays-back", [Some(55), Some(-8), Some(11)]),
    ("expansion-schedule", [Some(-35), Some(-1), Some(40)]),
    ("fire-plan", [Some(-5), Some(-9), Some(5)]),
    ("first-builder-reserve", [Some(-10), Some(21), Some(37)]),
    ("first-builder-reserve-2", [Some(-25), Some(9), Some(-39)]),
    ("first-district-first", [Some(39), Some(-2), Some(-8)]),
    ("first-granary-reserve", [Some(-39), Some(-1), Some(-31)]),
    ("first-luxury-first", [Some(3), Some(7), Some(2)]),
    ("first-research-building-reserve", [Some(6), Some(-10), Some(4)]),
    ("flip-nearby-city-states", [Some(13), Some(-16), Some(-7)]),
    ("founder-temple", [Some(-7), Some(9), Some(7)]),
    ("frontier-massing-alarm", [Some(-44), Some(-10), Some(7)]),
    ("garrison-under-fire", [Some(-1), Some(-6), Some(-23)]),
    ("gold-for-the-young-city", [Some(16), Some(-16), Some(4)]),
    ("gold-income-floor", [Some(21), Some(20), Some(-11)]),
    ("government-capacity-fallback", [Some(2), Some(-4), Some(7)]),
    ("government-ladder", [Some(-11), Some(7), Some(23)]),
    ("government-ladder-2", [Some(54), Some(14), Some(-8)]),
    ("great-person-housing", [Some(52), Some(9), Some(0)]),
    ("growth-to-settle", [Some(-24), Some(7), Some(6)]),
    ("guru-heals-the-corps-2", [Some(28), Some(-6), Some(-2)]),
    ("holy-lane-parity", [Some(0), Some(2), Some(-2)]),
    ("holy-site-where-the-threat-is", [Some(-37), Some(1), Some(25)]),
    ("holy-site-where-the-threat-is-2", [Some(7), Some(-9), Some(-5)]),
    ("hostile-memory", [Some(-45), Some(-9), Some(-38)]),
    ("housing-research", [Some(72), Some(-22), Some(12)]),
    ("idle-faith-patronage", [Some(13), Some(6), Some(12)]),
    ("improvement-housing-value", [Some(-10), Some(-11), Some(-21)]),
    ("industrial-chain-debt", [Some(7), Some(6), Some(9)]),
    ("island-exploration", [Some(-51), Some(4), Some(-14)]),
    ("lane-culture-spending", [Some(26), Some(-1), Some(-15)]),
    ("lane-great-people", [Some(15), Some(28), Some(12)]),
    ("lane-policy-deck", [Some(-12), Some(11), Some(17)]),
    ("lane-release-when-hopeless", [Some(52), Some(5), Some(-2)]),
    ("lane-space-race", [Some(41), Some(8), Some(37)]),
    ("lane-votes-its-favor", [Some(-27), Some(17), Some(6)]),
    ("loyalty-rate-alarm", [Some(52), Some(42), Some(47)]),
    ("maintenance-aware-deck", [Some(-35), Some(21), Some(24)]),
    ("missionary-evades-raiders", [Some(24), Some(-6), Some(-7)]),
    ("missionary-last-charge-explores", [Some(20), Some(2), Some(-16)]),
    ("missionary-last-charge-explores-2", [Some(-16), Some(15), Some(-11)]),
    ("modernize-before-spending", [Some(17), Some(-4), Some(2)]),
    ("moksha-defends-the-faithless", [Some(14), Some(10), Some(-12)]),
    ("native-emergency-purchase", [Some(73), Some(0), Some(17)]),
    ("native-emergency-purchase-2", [Some(-12), Some(2), Some(17)]),
    ("naval-recon", [Some(11), Some(23), Some(2)]),
    ("naval-recon-2", [Some(-26), Some(-5), Some(-3)]),
    ("naval-recon-3", [Some(26), Some(11), Some(-4)]),
    ("naval-threat-triage", [Some(-17), Some(16), Some(18)]),
    ("never-an-empty-queue", [Some(22), Some(17), Some(5)]),
    ("never-an-empty-queue-2", [Some(-24), Some(-5), Some(-14)]),
    ("never-an-empty-queue-3", [Some(34), Some(-10), Some(6)]),
    ("no-free-passage", [Some(-7), Some(15), Some(-2)]),
    ("objective-board", [Some(24), Some(-5), Some(4)]),
    ("one-launch-pad", [Some(25), Some(3), Some(-6)]),
    ("one-shot-recovery", [Some(24), Some(3), Some(-1)]),
    ("one-war-at-a-time", [Some(11), Some(-6), Some(-4)]),
    ("opening-warrior-recon", [Some(13), Some(-38), Some(-24)]),
    ("opening-warrior-recon-2", [Some(16), Some(26), Some(9)]),
    ("opportunistic-war", [Some(9), Some(-8), Some(16)]),
    ("order-retry", [Some(-5), Some(5), Some(10)]),
    ("overseas-settlement", [Some(-33), Some(-8), Some(-17)]),
    ("pantheon-board", [Some(-9), Some(9), Some(18)]),
    ("pass-picket", [Some(42), Some(4), Some(-7)]),
    ("peace-when-the-war-does-not-pay", [Some(5), Some(-17), Some(-15)]),
    ("peacetime-deterrence", [Some(-1), Some(-8), Some(-3)]),
    ("power-the-laboratory", [Some(-28), Some(-14), Some(-9)]),
    ("power-the-laboratory-2", [Some(-1), Some(-4), Some(-19)]),
    ("price-the-suzerainty", [Some(-51), Some(19), Some(9)]),
    ("promote-when-wounded", [Some(-30), Some(31), Some(5)]),
    ("quest-boost", [Some(53), Some(2), Some(7)]),
    ("quest-camp-errand", [Some(29), Some(3), Some(7)]),
    ("quest-production", [Some(7), Some(6), Some(4)]),
    ("quest-trade-route", [Some(-6), Some(1), Some(16)]),
    ("raid-pillage-prizes", [Some(-15), Some(-26), Some(2)]),
    ("rapid-city-expansion", [Some(-209), Some(-120), Some(-180)]),
    ("rapid-city-expansion-2", [Some(148), Some(67), Some(134)]),
    ("recon-replacement", [Some(-35), Some(-11), Some(-8)]),
    ("recorded-tactical-step", [Some(-27), Some(-20), Some(3)]),
    ("recovery-reads-the-war", [Some(10), Some(-1), Some(-7)]),
    ("recovery-reads-the-war-2", [Some(7), Some(-3), Some(11)]),
    ("relief-column-marches", [Some(33), Some(2), Some(-14)]),
    ("relief-targets-the-siege", [Some(3), Some(-6), Some(-3)]),
    ("religion-race-is-closed", [Some(10), Some(5), Some(15)]),
    ("religion-sues-peace", [Some(6), Some(1), Some(9)]),
    ("religious-defence-scales", [Some(-23), Some(-18), Some(10)]),
    ("religious-units-heal-first", [Some(-47), Some(-9), Some(7)]),
    ("religious-veto-defence", [Some(56), Some(39), Some(30)]),
    ("requisitions", [Some(-72), Some(-17), Some(-9)]),
    ("research-tier-premium", [Some(6), Some(-11), Some(1)]),
    ("rival-suzerainty-alarm", [Some(-32), Some(4), Some(-10)]),
    ("route-block-is-a-wait", [Some(35), Some(6), Some(6)]),
    ("safest-stand", [Some(25), Some(8), Some(-14)]),
    ("science-building-first", [Some(37), Some(13), Some(29)]),
    ("science-chain-alarm", [Some(-41), Some(6), Some(13)]),
    ("science-expansion-phase", [Some(21), Some(12), Some(19)]),
    ("science-multiplier-payoff", [Some(35), Some(5), Some(11)]),
    ("science-opening-band", [Some(7), Some(-9), Some(0)]),
    ("science-victory-drive", [Some(-24), Some(35), Some(8)]),
    ("science-victory-drive-2", [Some(40), Some(13), Some(42)]),
    ("score-horizon", [Some(-50), Some(-25), Some(-16)]),
    ("screen-the-shooters", [Some(-9), Some(9), Some(9)]),
    ("settle-sooner", [Some(52), Some(-7), Some(-29)]),
    ("settlement-gap-target", [Some(-46), Some(-7), Some(-13)]),
    ("settler-backlog-brake", [Some(15), Some(17), Some(7)]),
    ("settler-backlog-brake-2", [Some(1), Some(-11), Some(19)]),
    ("settler-factory-coordination", [Some(-51), Some(2), Some(5)]),
    ("settler-guard-holds", [Some(-39), Some(10), Some(22)]),
    ("settler-guard-holds-2", [Some(18), Some(1), Some(-10)]),
    ("settler-never-idles", [Some(1), Some(16), Some(7)]),
    ("settler-screen", [Some(-5), Some(-26), Some(2)]),
    ("settler-second-look", [Some(-27), Some(-13), Some(19)]),
    ("settler-site-gate", [Some(41), Some(-4), Some(11)]),
    ("settler-target-floor", [Some(48), Some(6), Some(32)]),
    ("settler-target-hysteresis", [Some(11), Some(-18), Some(15)]),
    ("settler-target-hysteresis-2", [Some(1), Some(3), Some(-19)]),
    ("settler-threat-detour", [Some(-45), Some(7), Some(-19)]),
    ("settler-walk-deadline", [Some(5), Some(32), Some(-6)]),
    ("siege-commitment", [Some(19), Some(-10), Some(-11)]),
    ("siege-is-progress-2", [Some(60), Some(9), Some(5)]),
    ("siege-is-progress-3", [Some(-61), Some(0), Some(12)]),
    ("siege-preempts-the-queue", [Some(45), Some(8), Some(-27)]),
    ("siege-train", [Some(15), Some(-23), Some(13)]),
    ("skip-the-prophet-race", [Some(-41), Some(-24), Some(-11)]),
    ("skip-the-prophet-race-2", [Some(30), Some(20), Some(-6)]),
    ("slot-kind-tiebreak", [Some(3), Some(-4), Some(2)]),
    ("solvency-first-trade-slot", [Some(84), Some(77), Some(59)]),
    ("spaceport-surplus-veto", [Some(-49), Some(2), Some(-13)]),
    ("standing-still-is-a-risk", [Some(39), Some(4), Some(1)]),
    ("stranded-settler-discount", [Some(6), Some(27), Some(-9)]),
    ("strategic-wonders", [Some(-16), Some(3), Some(-22)]),
    ("strike-opening", [Some(6), Some(-2), Some(-5)]),
    ("strike-reach", [Some(61), Some(-6), Some(-4)]),
    ("surprise-war-mobilization", [Some(31), Some(-17), Some(-6)]),
    ("swap-rotation", [Some(-18), Some(8), Some(-3)]),
    ("swap-rotation-2", [Some(14), Some(-3), Some(3)]),
    ("threatened-city-reserve", [Some(-25), Some(3), Some(3)]),
    ("trade-route-network", [Some(-18), Some(-3), Some(-1)]),
    ("treasury-at-work", [Some(-8), Some(-4), Some(5)]),
    ("treasury-at-work-2", [Some(65), Some(36), Some(32)]),
    ("unchosen-war-keeps-the-lane", [Some(23), Some(15), Some(-2)]),
    ("unit-cost-efficiency", [Some(17), Some(15), Some(-9)]),
    ("unit-objective-memory", [Some(44), Some(15), Some(-16)]),
    ("upgrade-the-garrison", [Some(-5), Some(-7), Some(8)]),
    ("veterans-withdraw-early", [Some(-37), Some(12), Some(16)]),
    ("walls-after-districts", [Some(-28), Some(4), Some(36)]),
    ("war-economy", [Some(3), Some(-17), Some(0)]),
    ("war-needs-a-treasury", [Some(-52), Some(9), Some(-38)]),
    ("war-policy-via-board", [Some(45), Some(10), Some(0)]),
    ("war-reinforcement", [Some(5), Some(-7), Some(-24)]),
    ("whole-turn-backtrack-guard", [Some(0), Some(-23), Some(17)]),
    ("wide-map-capacity", [Some(65), Some(17), Some(20)]),
    ("wonder-adjacent-sites", [Some(-19), Some(-19), Some(15)]),
    ("wonder-adjacent-sites-2", [Some(43), Some(17), Some(-19)]),
    ("wonder-ring-recon", [Some(-26), Some(3), Some(-18)]),
    ("wonder-ring-recon-2", [Some(9), Some(17), Some(-16)]),
    ("wonder-score-tally", [Some(66), Some(-1), Some(9)]),
    ("wounded-out-of-reach", [Some(49), Some(-19), Some(6)]),
];
...
pub(super) const VERDICTS: &[GeneVerdict] = &[
    ...
    GeneVerdict { tag: "settler-guard-holds", verdict: Verdict::Unresolved, default_on: true, wins_last_10k: Some(25), wins_prior_10k: Some(-8), win_diff_pp: Some(0.080401), posterior_pp: Some(3.289281), posterior_se_pp: Some(8.232809), family_wise: false, screen: Some(Measure { pairs: 19080, win_delta_pp: 0.489, win_z: 1.285, share_delta_pp: 0.061, share_z: 0.783, source: "2026-08-24-standard-continuous-38160-total-seats.json" }) },
