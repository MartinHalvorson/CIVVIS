...
pub(super) const DEPLOYMENT_GENOME: &[&str] = &[
    ...
    "battle-planner-2",
    "boost-unlock-research",
    "boost-wait-research-2",
    "boosted-bargain-first-2",
    "border-parity-2",
    ...
    "enter-the-prophet-race-2",
    "envoy-building-dividends",
    "escort-cap-holds",
    "escort-unstick",
    "eureka-chasing-builder",
    "eureka-chasing-production",
    "expansion-best-idle-city",
    "expansion-schedule",
    "fire-plan",
...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(9), Some(26), Some(-11)]),
    ("air-surge", [Some(13), Some(4), Some(28)]),
    ("air-surge-2", [Some(2), Some(1), Some(-6)]),
    ("amani-follows-suzerainty", [Some(-3), None, None]),
    ("amenity-district-path", [Some(4), Some(-29), Some(5)]),
    ("amenity-project-preemption", [Some(-2), Some(11), Some(16)]),
    ("amenity-project-preemption-2", [Some(0), Some(-25), Some(-15)]),
    ("anvil", [Some(1), Some(-27), Some(0)]),
    ("apostle-promotion-by-role", [Some(-9), Some(28), Some(-1)]),
    ("army-target-weighs-enemy", [Some(-31), Some(-2), Some(3)]),
    ("barbarian-bargain", [Some(5), Some(4), Some(12)]),
    ("barbarian-ranged-answer", [Some(-6), Some(16), Some(-16)]),
    ("barbarian-scouts-are-scouts", [Some(4), Some(12), Some(20)]),
    ("barbarian-settler-capture", [Some(16), Some(28), Some(25)]),
    ("battle-planner", [Some(20), Some(0), Some(7)]),
    ("battle-planner-2", [Some(22), Some(45), Some(39)]),
    ("battle-planner-3", [Some(12), Some(-9), Some(25)]),
    ("blind-objective-strength", [Some(10), Some(-18), Some(2)]),
    ("blind-objective-units", [Some(-28), Some(9), Some(0)]),
    ("boost-first-research", [Some(-8), Some(-7), Some(8)]),
    ("boost-first-research-2", [Some(0), None, None]),
    ("boost-unlock-research", [Some(21), Some(15), Some(6)]),
    ("boost-wait-research-2", [Some(7), Some(16), Some(2)]),
    ("boosted-bargain-first", [Some(4), Some(-33), Some(-17)]),
    ("boosted-bargain-first-2", [Some(-11), Some(21), Some(16)]),
    ("border-parity", [Some(-16), Some(-6), Some(5)]),
    ("border-parity-2", [Some(-1), Some(23), Some(3)]),
    ("border-parity-3", [Some(5), Some(-2), Some(8)]),
    ("bounded-recovery", [Some(-5), Some(-17), Some(-14)]),
    ("build-what-cards-boost", [Some(-2), Some(-9), Some(-5)]),
    ("builder-barbarian-safety", [Some(-2), Some(-14), Some(5)]),
    ("builder-supply-floor", [Some(1), Some(-18), Some(17)]),
    ("builder-tries-the-next-tile", [Some(2), Some(-22), Some(13)]),
    ("builder-workforce-recovery", [Some(5), None, None]),
    ("builder-workforce-recovery-2", [Some(8), None, None]),
    ("buildings-before-projects", [Some(14), Some(-13), Some(22)]),
    ("buy-what-cards-cannot-boost", [Some(-3), Some(15), Some(-4)]),
    ("camp-party", [Some(11), Some(-30), Some(10)]),
    ("camp-tile-buyout", [Some(-3), Some(-34), Some(16)]),
    ("campaign-pillage", [Some(10), Some(-2), Some(11)]),
    ("campus-adjacency-threshold", [Some(-6), Some(26), Some(-29)]),
    ("campus-adjacency-threshold-2", [Some(1), Some(-2), Some(25)]),
    ("campus-before-halfway", [Some(-16), Some(13), None]),
    ("campus-through-expansion", [Some(-22), Some(8), Some(-15)]),
    ("canal-city", [Some(-8), Some(8), Some(12)]),
    ("capital-settler-after-completion", [Some(0), Some(47), Some(9)]),
    ("capture-go-or-stand-down", [Some(-10), Some(-28), Some(-1)]),
    ("capture-go-or-stand-down-2", [Some(10), Some(9), Some(-1)]),
    ("chain-payback-window", [Some(2), Some(15), Some(-12)]),
    ("chain-payback-window-2", [Some(3), Some(-11), Some(0)]),
    ("chase-every-boost", [Some(22), Some(2), Some(8)]),
    ("chase-every-boost-2", [Some(-11), Some(-3), Some(-26)]),
    ("cheapest-wonder-first", [Some(-20), Some(-12), Some(-6)]),
    ("chokepoint-claim", [Some(11), Some(31), Some(3)]),
    ("chokepoint-garrison", [Some(9), Some(2), Some(-9)]),
    ("chokepoint-siting", [Some(-9), Some(2), Some(9)]),
    ("city-campaign", [Some(-28), Some(-3), Some(-19)]),
    ("city-campaign-2", [Some(22), Some(3), Some(11)]),
    ("city-target-meets-the-map", [Some(-2), Some(2), Some(7)]),
    ("civilian-out-of-reach", [Some(-17), Some(-34), Some(4)]),
    ("close-as-a-body", [Some(9), Some(12), Some(11)]),
    ("coalition-before-war", [Some(-6), Some(2), Some(0)]),
    ("coalition-before-war-2", [Some(7), Some(-7), Some(-19)]),
    ("coalition-before-war-3", [Some(8), Some(-7), Some(6)]),
    ("coastal-city-sites", [Some(-4), Some(7), Some(2)]),
    ("coastal-city-sites-2", [Some(6), Some(-8), Some(-14)]),
    ("come-ashore", [Some(-13), Some(-25), Some(-3)]),
    ("commitment-owner-acts", [Some(-9), Some(14), Some(9)]),
    ("commitment-patience", [Some(-4), Some(22), Some(21)]),
    ("competition-victory-points", [Some(34), Some(12), Some(5)]),
    ("congress-counter-leader", [Some(-5), Some(-11), Some(2)]),
    ("connect-the-luxury", [Some(46), Some(43), Some(24)]),
    ("contested-land-first", [Some(-2), Some(2), Some(20)]),
    ("conversion-majority-alarm", [Some(-18), Some(-13), Some(0)]),
    ("conversion-majority-alarm-2", [Some(-4), Some(4), Some(3)]),
    ("coordinated-finish", [Some(20), Some(-7), Some(-5)]),
    ("culture-building-catchup", [Some(-8), None, None]),
    ("culture-building-catchup-2", [Some(-5), None, None]),
    ("culture-building-debt", [Some(7), Some(-2), Some(-9)]),
    ("culture-floor", [Some(-2), Some(18), Some(1)]),
    ("culture-lane-forecast", [Some(-2), Some(1), Some(14)]),
    ("culture-threat-early", [Some(-14), None, None]),
    ("deals-at-the-ceiling", [Some(10), Some(-10), Some(-3)]),
    ("deals-for-our-gain", [Some(-2), Some(3), Some(-11)]),
    ("defend-where-you-stand", [Some(1), Some(5), Some(8)]),
    ("defensible-sites", [Some(20), Some(10), Some(45)]),
    ("detour-keeps-the-site-worth", [Some(-13), Some(-16), Some(8)]),
    ("diplomatic-lane-forecast", [Some(16), Some(1), Some(-3)]),
    ("diplomatic-lane-forecast-2", [Some(-9), Some(-14), Some(-4)]),
    ("district-coverage", [Some(9), Some(9), Some(12)]),
    ("district-coverage-2", [Some(-20), Some(4), Some(-7)]),
    ("district-planning", [Some(-10), Some(30), Some(-10)]),
    ("district-planning-3", [Some(18), Some(-13), Some(-3)]),
    ("domination-city-count", [Some(18), Some(17), Some(7)]),
    ("doomed-blow-veto", [Some(3), Some(-29), Some(7)]),
    ("doomed-blow-veto-2", [Some(23), None, None]),
    ("early-archers", [Some(12), Some(-19), Some(19)]),
    ("early-contact-window", [Some(-23), Some(13), Some(6)]),
    ("early-project-restraint", [Some(6), Some(-12), Some(3)]),
    ("early-project-restraint-2", [Some(6), Some(11), Some(-3)]),
    ("elective-war-in-reach", [Some(29), Some(-13), Some(-6)]),
    ("elective-war-yields-to-a-lane", [Some(56), Some(53), Some(46)]),
    ("encampment-seals-the-pass", [Some(1), Some(-13), Some(-2)]),
    ("enemy-of-my-enemy", [Some(-22), Some(-12), Some(11)]),
    ("engine-faith-price", [Some(36), Some(19), Some(45)]),
    ("enhancer-for-the-corps", [Some(7), Some(8), Some(11)]),
    ("enter-the-prophet-race-2", [Some(-8), Some(36), Some(30)]),
    ("envoy-building-dividends", [Some(-6), Some(10), None]),
    ("escort-cap-holds", [Some(3), Some(21), Some(-8)]),
    ("escort-unstick", [Some(29), Some(27), Some(27)]),
    ("eureka-chasing-builder", [Some(5), Some(-1), Some(10)]),
    ("eureka-chasing-builder-2", [Some(-6), Some(-13), Some(-4)]),
    ("eureka-chasing-production", [Some(0), Some(27), Some(22)]),
    ("exchange-is-the-engines", [Some(6), Some(-20), Some(-14)]),
    ("exhaustion-loyalty-guard", [Some(6), Some(-19), Some(11)]),
    ("expansion-best-idle-city", [Some(7), None, None]),
    ("expansion-best-idle-city-2", [Some(-1), None, None]),
    ("expansion-pays-back", [Some(-7), Some(-10), Some(-19)]),
    ("expansion-schedule", [Some(5), Some(2), Some(27)]),
    ("fire-plan", [Some(-2), Some(31), Some(19)]),
    ("first-builder-reserve", [Some(18), Some(2), Some(-9)]),
    ("first-builder-reserve-2", [Some(-15), Some(8), Some(5)]),
    ("first-district-first", [Some(21), Some(9), Some(-27)]),
    ("first-granary-reserve", [Some(-10), Some(13), Some(-3)]),
    ("first-luxury-first", [Some(-11), Some(-15), Some(23)]),
    ("first-research-building-reserve", [Some(5), Some(11), Some(-6)]),
    ("founder-temple", [Some(-2), Some(1), Some(19)]),
    ("frontier-massing-alarm", [Some(0), Some(3), Some(13)]),
    ("garrison-under-fire", [Some(-9), Some(-10), Some(3)]),
    ("gold-income-floor", [Some(-5), Some(-1), Some(-5)]),
    ("government-capacity-fallback", [Some(-24), Some(18), Some(12)]),
    ("government-ladder", [Some(7), Some(10), Some(10)]),
    ("government-ladder-2", [Some(4), Some(-2), Some(-1)]),
    ("great-person-housing", [Some(9), Some(1), Some(1)]),
    ("growth-to-settle", [Some(8), Some(9), Some(-11)]),
    ("guru-heals-the-corps-2", [Some(16), Some(0), Some(-2)]),
    ("holy-lane-parity", [Some(-21), Some(9), Some(-2)]),
    ("holy-site-where-the-threat-is", [Some(-8), Some(-16), Some(19)]),
    ("holy-site-where-the-threat-is-2", [Some(-8), Some(-3), Some(-12)]),
    ("hostile-memory", [Some(-39), Some(-49), Some(-29)]),
    ("housing-research", [Some(8), Some(9), Some(-5)]),
    ("idle-faith-patronage", [Some(22), Some(-9), Some(-15)]),
    ("industrial-chain-debt", [Some(19), Some(-5), Some(9)]),
    ("island-exploration", [Some(6), Some(-9), Some(-14)]),
    ("lane-culture-spending", [Some(-2), Some(-30), Some(-8)]),
    ("lane-great-people", [Some(11), Some(18), Some(0)]),
    ("lane-policy-deck", [Some(-1), Some(-4), Some(-18)]),
    ("lane-release-when-hopeless", [Some(19), Some(22), Some(-23)]),
    ("lane-space-race", [Some(7), Some(3), Some(15)]),
    ("lane-votes-its-favor", [Some(-15), Some(-9), Some(-8)]),
    ("liang-follows-builders", [Some(17), None, None]),
    ("loyalty-rate-alarm", [Some(57), Some(48), Some(44)]),
    ("magnus-follows-settlers", [Some(13), None, None]),
    ("maintenance-aware-deck", [Some(31), Some(17), Some(28)]),
    ("missionary-evades-raiders", [Some(7), Some(10), Some(-3)]),
    ("missionary-last-charge-explores", [Some(-16), Some(-16), Some(-10)]),
    ("missionary-last-charge-explores-2", [Some(4), Some(9), Some(12)]),
    ("modernize-before-spending", [Some(-16), Some(-35), Some(-10)]),
    ("moksha-defends-the-faithless", [Some(0), Some(9), Some(-28)]),
    ("native-emergency-purchase", [Some(-6), Some(-11), Some(-12)]),
    ("native-emergency-purchase-2", [Some(-8), Some(-11), Some(-6)]),
    ("naval-recon", [Some(2), Some(-22), Some(19)]),
    ("naval-recon-2", [Some(14), Some(-1), Some(-15)]),
    ("naval-recon-3", [Some(8), Some(24), Some(-8)]),
    ("naval-threat-triage", [Some(2), Some(-4), Some(-6)]),
    ("never-an-empty-queue", [Some(15), Some(-22), Some(-6)]),
    ("never-an-empty-queue-2", [Some(17), Some(23), Some(10)]),
    ("never-an-empty-queue-3", [Some(-13), Some(-17), Some(0)]),
    ("no-free-passage", [Some(6), Some(15), Some(-15)]),
    ("objective-board", [Some(9), Some(-1), Some(-1)]),
    ("one-launch-pad", [Some(4), Some(-17), Some(-4)]),
    ("one-shot-recovery", [Some(28), Some(0), Some(-3)]),
    ("one-war-at-a-time", [Some(22), Some(-12), Some(-12)]),
    ("opening-warrior-recon-2", [Some(-16), Some(11), Some(28)]),
    ("opportunistic-war", [Some(-22), Some(-6), Some(-25)]),
    ("order-retry", [Some(-4), Some(-14), Some(-8)]),
    ("overseas-settlement", [Some(-13), Some(1), Some(8)]),
    ("pantheon-board", [Some(14), Some(12), Some(8)]),
    ("pass-picket", [Some(-1), Some(0), Some(13)]),
    ("peace-when-the-war-does-not-pay", [Some(15), Some(-6), Some(-22)]),
    ("peacetime-deterrence", [Some(-22), Some(-6), Some(12)]),
    ("pingala-follows-research", [Some(2), None, None]),
    ("power-the-laboratory", [Some(-4), Some(-10), Some(21)]),
    ("power-the-laboratory-2", [Some(-12), Some(-8), Some(-11)]),
    ("price-the-suzerainty", [Some(-13), Some(16), Some(5)]),
    ("promote-when-wounded", [Some(0), Some(-6), Some(11)]),
    ("quest-boost", [Some(19), Some(-7), Some(-21)]),
    ("quest-camp-errand", [Some(4), Some(19), Some(13)]),
    ("quest-production", [Some(6), Some(-8), Some(13)]),
    ("quest-trade-route", [Some(3), Some(22), Some(24)]),
    ("raid-pillage-prizes", [Some(-23), Some(3), Some(-9)]),
    ("rapid-city-expansion-2", [Some(0), Some(118), Some(105)]),
    ("recon-replacement", [Some(-3), Some(-18), Some(-3)]),
    ("recorded-tactical-step", [Some(2), Some(-5), Some(-2)]),
    ("recovery-reads-the-war", [Some(-10), Some(-10), Some(-1)]),
    ("recovery-reads-the-war-2", [Some(-11), Some(-1), Some(-1)]),
    ("relief-column-marches", [Some(-2), Some(5), Some(-5)]),
    ("relief-targets-the-siege", [Some(-17), Some(-2), Some(-11)]),
    ("religion-race-is-closed", [Some(6), Some(10), Some(-20)]),
    ("religion-sues-peace", [Some(-24), Some(-7), Some(-1)]),
    ("religious-defence-scales", [Some(38), Some(23), Some(7)]),
    ("religious-units-heal-first", [Some(-9), Some(0), Some(10)]),
    ("religious-veto-defence", [Some(41), Some(5), Some(5)]),
    ("requisitions", [Some(-13), Some(-24), Some(-29)]),
    ("research-building-catchup", [Some(-4), None, None]),
    ("research-building-catchup-2", [Some(11), None, None]),
    ("research-tier-premium", [Some(0), Some(-6), Some(15)]),
    ("reyna-follows-revenue", [Some(-10), None, None]),
    ("rival-suzerainty-alarm", [Some(2), Some(-13), Some(-4)]),
    ("route-block-is-a-wait", [Some(-12), Some(34), Some(-24)]),
    ("safest-stand", [Some(2), Some(8), Some(3)]),
    ("science-building-first", [Some(-2), Some(28), Some(3)]),
    ("science-chain-alarm", [Some(11), Some(-5), Some(-20)]),
    ("science-expansion-phase", [Some(-7), Some(5), Some(8)]),
    ("science-multiplier-payoff", [Some(13), Some(16), Some(4)]),
    ("science-opening-band", [Some(10), Some(19), Some(-31)]),
    ("science-victory-drive", [Some(-8), Some(35), Some(6)]),
    ("science-victory-drive-2", [Some(44), Some(43), Some(28)]),
    ("scout-first-opening", [Some(23), None, None]),
    ("screen-the-shooters", [Some(14), Some(30), Some(11)]),
    ("settle-sooner", [Some(-4), Some(-10), Some(-7)]),
    ("settlement-gap-target", [Some(-13), Some(24), Some(10)]),
    ("settler-backlog-brake", [Some(17), Some(26), Some(-12)]),
    ("settler-backlog-brake-2", [Some(-5), Some(-22), Some(5)]),
    ("settler-factory-coordination", [Some(-1), Some(9), Some(-4)]),
    ("settler-guard-holds", [Some(3), Some(-11), Some(-15)]),
    ("settler-guard-holds-2", [Some(-3), Some(26), Some(18)]),
    ("settler-never-idles", [Some(-3), Some(14), Some(18)]),
    ("settler-site-gate", [Some(-12), Some(16), Some(-5)]),
    ("settler-target-floor", [Some(1), Some(4), Some(8)]),
    ("settler-target-hysteresis", [Some(-6), Some(10), Some(1)]),
    ("settler-target-hysteresis-2", [Some(1), Some(-4), Some(12)]),
    ("settler-threat-detour", [Some(-14), Some(12), Some(3)]),
    ("settler-walk-deadline", [Some(13), Some(-6), Some(2)]),
    ("siege-commitment", [Some(-2), Some(-10), Some(5)]),
    ("siege-is-progress-2", [Some(-6), Some(1), Some(-6)]),
    ("siege-is-progress-3", [Some(-10), Some(8), Some(-8)]),
    ("siege-preempts-the-queue", [Some(-26), Some(-3), Some(-30)]),
    ("siege-train", [Some(13), Some(35), Some(6)]),
    ("skip-the-prophet-race-2", [Some(10), Some(-3), Some(2)]),
    ("slot-kind-tiebreak", [Some(3), Some(-3), Some(-4)]),
    ("solvency-first-trade-slot", [Some(89), Some(81), Some(58)]),
    ("spaceport-surplus-veto", [Some(-1), Some(-17), Some(-6)]),
    ("standing-still-is-a-risk", [Some(20), Some(7), Some(8)]),
    ("stranded-settler-discount", [Some(-22), Some(11), Some(-5)]),
    ("strategic-wonders", [Some(-6), Some(-10), Some(16)]),
    ("strike-opening", [Some(-4), Some(-21), Some(-4)]),
    ("strike-reach", [Some(7), Some(-18), Some(-31)]),
    ("surprise-war-mobilization", [Some(-12), Some(-10), Some(-3)]),
    ("swap-rotation", [Some(8), Some(11), Some(-15)]),
    ("swap-rotation-2", [Some(-7), Some(7), Some(-13)]),
    ("threatened-city-reserve", [Some(-15), Some(5), Some(15)]),
    ("trade-building-before-bankruptcy", [Some(-8), None, None]),
    ("trade-building-before-bankruptcy-2", [Some(1), None, None]),
    ("trade-route-network", [Some(-3), Some(14), Some(31)]),
    ("treasury-at-work-2", [Some(28), Some(13), Some(55)]),
    ("unchosen-war-keeps-the-lane", [Some(-9), Some(-4), Some(3)]),
    ("unit-cost-efficiency", [Some(16), Some(8), Some(0)]),
    ("unit-objective-memory", [Some(7), Some(4), Some(3)]),
    ("upgrade-the-garrison", [Some(8), Some(15), Some(-14)]),
    ("veterans-withdraw-early", [Some(9), Some(-12), Some(-3)]),
    ("walls-after-districts", [Some(11), Some(-4), Some(7)]),
    ("war-economy", [Some(0), Some(16), Some(-5)]),
    ("war-needs-a-treasury", [Some(27), Some(-9), Some(11)]),
    ("war-policy-via-board", [Some(24), Some(0), Some(16)]),
    ("war-reinforcement", [Some(1), Some(-22), Some(-25)]),
    ("whole-turn-backtrack-guard", [Some(3), Some(12), Some(-5)]),
    ("wide-map-capacity", [Some(-2), Some(38), Some(39)]),
    ("wonder-adjacent-sites-2", [Some(22), Some(1), Some(-3)]),
    ("wonder-ring-recon", [Some(-14), Some(-12), Some(3)]),
    ("wonder-ring-recon-2", [Some(9), Some(-3), Some(-15)]),
    ("wonder-score-tally", [Some(2), Some(-10), Some(16)]),
    ("wounded-out-of-reach", [Some(0), Some(8), Some(15)]),
];
...
pub(super) const VERDICTS: &[GeneVerdict] = &[
    ...
    GeneVerdict { tag: "district-coverage", verdict: Verdict::Helps, default_on: true, wins_last_10k: Some(14), wins_prior_10k: Some(-22), win_diff_pp: Some(0.008266), posterior_pp: Some(0.19452), posterior_se_pp: Some(10.3006), family_wise: false, screen: Some(Measure { pairs: 19080, win_delta_pp: 0.28, win_z: 0.736, share_delta_pp: 0.166, share_z: 2.158, source: "2026-08-24-standard-continuous-38160-total-seats.json" }) },
    GeneVerdict { tag: "district-planning", verdict: Verdict::Unresolved, default_on: false, wins_last_10k: Some(12), wins_prior_10k: None, win_diff_pp: Some(0.244584), posterior_pp: Some(12.229214), posterior_se_pp: Some(18.957561), family_wise: false, screen: Some(Measure { pairs: 19080, win_delta_pp: 0.245, win_z: 0.645, share_delta_pp: 0.145, share_z: 1.843, source: "2026-08-24-standard-continuous-38160-total-seats.json" }) },
    ...
    GeneVerdict { tag: "settle-sooner", verdict: Verdict::Unresolved, default_on: false, wins_last_10k: Some(19), wins_prior_10k: Some(28), win_diff_pp: Some(0.654906), posterior_pp: Some(34.563276), posterior_se_pp: Some(10.399355), family_wise: false, screen: Some(Measure { pairs: 19080, win_delta_pp: 0.764, win_z: 1.748, share_delta_pp: 0.123, share_z: 1.352, source: "2026-08-24-standard-continuous-38160-total-seats.json" }) },
    ...
    GeneVerdict { tag: "war-reinforcement", verdict: Verdict::Unresolved, default_on: false, wins_last_10k: Some(0), wins_prior_10k: Some(34), win_diff_pp: Some(0.326817), posterior_pp: Some(16.756373), posterior_se_pp: Some(10.360862), family_wise: false, screen: Some(Measure { pairs: 19080, win_delta_pp: 0.005, win_z: 0.011, share_delta_pp: -0.048, share_z: -0.536, source: "2026-08-24-standard-continuous-38160-total-seats.json" }) },
