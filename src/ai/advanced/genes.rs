...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(0), Some(21), Some(-3)]),
    ("air-surge", [Some(30), Some(16), Some(0)]),
    ("amenity-district-path", [Some(9), Some(4), Some(5)]),
    ("amenity-project-preemption", [Some(24), Some(7), Some(22)]),
    ("amenity-project-preemption-2", [Some(-14), Some(-2), Some(18)]),
    ("apostle-promotion-by-role", [Some(7), Some(6), Some(15)]),
    ("army-target-weighs-enemy", [Some(1), Some(20), Some(9)]),
    ("barbarian-bargain", [Some(14), Some(-16), Some(38)]),
    ("barbarian-ranged-answer", [Some(20), Some(5), Some(-10)]),
    ("barbarian-scouts-are-scouts", [Some(11), Some(-2), Some(5)]),
    ("barbarian-settler-capture", [Some(34), Some(34), Some(32)]),
    ("blind-objective-strength", [Some(9), Some(16), Some(7)]),
    ("blind-objective-units", [Some(0), Some(4), Some(-7)]),
    ("boost-first-research", [Some(-12), Some(-3), Some(-3)]),
    ("boost-unlock-research", [Some(1), Some(-38), Some(-35)]),
    ("boost-wait-research", [Some(-23), Some(-19), Some(-18)]),
    ("boosted-bargain-first", [Some(9), Some(-21), Some(-14)]),
    ("border-parity", [Some(-5), Some(-10), Some(9)]),
    ("border-parity-2", [Some(-13), Some(-12), Some(-10)]),
    ("bounded-recovery", [Some(10), Some(4), Some(-9)]),
    ("build-what-cards-boost", [Some(-9), Some(31), Some(-21)]),
    ("builder-barbarian-safety", [Some(1), Some(9), Some(-23)]),
    ("builder-supply-floor", [Some(-26), Some(-9), Some(0)]),
    ("builder-tries-the-next-tile", [Some(-3), Some(-7), Some(15)]),
    ("buildings-before-projects", [Some(19), Some(0), Some(1)]),
    ("buy-what-cards-cannot-boost", [Some(-7), Some(21), Some(4)]),
    ("camp-party", [Some(-14), Some(-4), Some(8)]),
    ("camp-tile-buyout", [Some(19), Some(-5), Some(-9)]),
    ("campaign-pillage", [Some(-14), Some(-1), Some(18)]),
    ("campus-adjacency-threshold", [Some(-25), Some(19), Some(5)]),
    ("campus-adjacency-threshold-2", [Some(13), Some(-5), Some(-12)]),
    ("canal-city", [Some(5), Some(9), Some(-3)]),
    ("capital-settler-after-completion", [Some(-16), None, None]),
    ("capture-go-or-stand-down", [Some(-1), Some(-8), Some(11)]),
    ("capture-go-or-stand-down-2", [Some(8), Some(1), Some(-7)]),
    ("chain-payback-window", [Some(-5), Some(-1), Some(4)]),
    ("chain-payback-window-2", [Some(-19), Some(6), Some(-9)]),
    ("cheapest-wonder-first", [Some(-11), Some(-4), Some(11)]),
    ("chokepoint-claim", [Some(2), Some(0), Some(-13)]),
    ("chokepoint-garrison", [Some(-6), Some(-7), Some(-5)]),
    ("chokepoint-siting", [Some(-5), Some(24), Some(7)]),
    ("chop-into-the-queue", [Some(-22), Some(-24), Some(-8)]),
    ("city-campaign", [Some(-16), Some(-7), Some(-2)]),
    ("city-target-meets-the-map", [Some(6), Some(2), Some(11)]),
    ("civilian-out-of-reach", [Some(2), Some(4), Some(-4)]),
    ("close-as-a-body", [Some(-5), Some(12), Some(1)]),
    ("coalition-before-war", [Some(-5), Some(13), Some(1)]),
    ("coastal-city-sites", [Some(9), Some(-6), Some(-10)]),
    ("coastal-city-sites-2", [Some(-1), Some(-3), Some(-16)]),
    ("come-ashore", [Some(10), Some(1), Some(26)]),
    ("commitment-patience", [Some(1), Some(2), Some(6)]),
    ("competition-victory-points", [Some(36), Some(7), Some(-19)]),
    ("congress-counter-leader", [Some(-11), Some(27), Some(5)]),
    ("connect-the-luxury", [Some(29), Some(27), Some(13)]),
    ("contested-land-first", [Some(4), Some(-2), Some(-10)]),
    ("conversion-majority-alarm", [Some(-9), Some(-2), Some(1)]),
    ("coordinated-finish", [Some(-7), Some(0), Some(14)]),
    ("culture-building-debt", [Some(-22), Some(4), Some(-6)]),
    ("culture-floor", [Some(4), Some(-15), Some(-8)]),
    ("culture-lane-forecast", [Some(24), Some(-3), Some(12)]),
    ("deals-at-the-ceiling", [Some(23), Some(8), Some(-3)]),
    ("deals-for-our-gain", [Some(-12), Some(8), Some(-15)]),
    ("defend-where-you-stand", [Some(-4), Some(7), Some(-9)]),
    ("defensible-sites", [Some(24), Some(26), Some(29)]),
    ("diplomatic-lane-forecast", [Some(-14), Some(-13), Some(-2)]),
    ("district-coverage", [Some(-7), Some(13), Some(-11)]),
    ("district-coverage-2", [Some(-2), Some(-6), Some(-3)]),
    ("district-planning", [Some(0), Some(14), Some(4)]),
    ("domination-city-count", [Some(20), Some(17), Some(3)]),
    ("early-archers", [Some(18), Some(29), Some(47)]),
    ("early-contact-window", [Some(17), Some(-18), Some(20)]),
    ("early-project-restraint", [Some(-10), None, None]),
    ("elective-war-in-reach", [Some(6), Some(3), Some(-2)]),
    ("elective-war-yields-to-a-lane", [Some(32), Some(27), Some(34)]),
    ("encampment-seals-the-pass", [Some(13), Some(10), Some(-3)]),
    ("enemy-of-my-enemy", [Some(15), Some(-5), Some(-12)]),
    ("engine-faith-price", [Some(17), Some(41), Some(10)]),
    ("enhancer-for-the-corps", [Some(-15), Some(-5), Some(-23)]),
    ("enter-the-prophet-race", [Some(35), Some(16), Some(35)]),
    ("escort-cap-holds", [Some(-9), Some(-13), Some(-4)]),
    ("escort-unstick", [Some(19), Some(6), Some(24)]),
    ("eureka-chasing-builder", [Some(-16), Some(-32), Some(-6)]),
    ("eureka-chasing-production", [Some(19), Some(-8), Some(9)]),
    ("exchange-is-the-engines", [Some(13), Some(-1), Some(3)]),
    ("exhaustion-loyalty-guard", [Some(2), Some(-11), Some(-5)]),
    ("expansion-pays-back", [Some(-10), Some(-5), Some(-3)]),
    ("expansion-schedule", [Some(8), Some(3), Some(16)]),
    ("fire-plan", [Some(-10), Some(-10), Some(7)]),
    ("first-builder-reserve", [Some(-18), Some(-6), Some(-1)]),
    ("first-district-first", [Some(-8), Some(7), Some(9)]),
    ("first-granary-reserve", [Some(-5), Some(13), Some(-6)]),
    ("first-luxury-first", [Some(1), Some(5), Some(16)]),
    ("first-research-building-reserve", [Some(7), Some(-3), Some(7)]),
    ("flip-nearby-city-states", [Some(-6), Some(-15), Some(11)]),
    ("founder-temple", [Some(18), Some(-24), Some(18)]),
    ("frontier-massing-alarm", [Some(-12), Some(0), Some(17)]),
    ("garrison-under-fire", [Some(-8), Some(-8), Some(-1)]),
    ("gold-for-the-young-city", [Some(8), Some(-6), Some(12)]),
    ("gold-income-floor", [Some(-15), Some(-1), Some(-12)]),
    ("government-capacity-fallback", [Some(-13), Some(3), Some(12)]),
    ("government-ladder", [Some(-25), Some(-16), Some(-6)]),
    ("government-ladder-2", [Some(36), Some(27), Some(12)]),
    ("great-person-housing", [Some(22), Some(20), Some(11)]),
    ("growth-to-settle", [Some(0), Some(20), Some(-20)]),
    ("guru-heals-the-corps-2", [Some(12), Some(-2), Some(-6)]),
    ("holy-lane-parity", [Some(3), Some(0), Some(-22)]),
    ("holy-site-where-the-threat-is", [Some(12), Some(-7), Some(-1)]),
    ("holy-site-where-the-threat-is-2", [Some(-10), Some(8), Some(2)]),
    ("hostile-memory", [Some(-5), Some(-7), Some(0)]),
    ("housing-research", [Some(2), Some(-7), Some(-6)]),
    ("idle-faith-patronage", [Some(9), Some(1), Some(-3)]),
    ("improvement-housing-value", [Some(-12), Some(-5), Some(-8)]),
    ("island-exploration", [Some(0), Some(-8), Some(-33)]),
    ("lane-culture-spending", [Some(22), Some(9), Some(-18)]),
    ("lane-great-people", [Some(-7), Some(-11), Some(4)]),
    ("lane-policy-deck", [Some(-1), Some(-20), Some(-7)]),
    ("lane-release-when-hopeless", [Some(-28), Some(6), Some(0)]),
    ("lane-space-race", [Some(-12), Some(11), Some(-18)]),
    ("lane-votes-its-favor", [Some(1), Some(5), Some(-14)]),
    ("loyalty-rate-alarm", [Some(54), Some(42), Some(26)]),
    ("maintenance-aware-deck", [Some(35), Some(12), Some(20)]),
    ("missionary-evades-raiders", [Some(21), Some(32), Some(-2)]),
    ("missionary-last-charge-explores", [Some(16), Some(-10), Some(-6)]),
    ("moksha-defends-the-faithless", [Some(-24), Some(-11), Some(6)]),
    ("native-emergency-purchase", [Some(2), Some(9), Some(-12)]),
    ("naval-recon", [Some(9), Some(-1), Some(1)]),
    ("naval-recon-2", [Some(-10), Some(13), Some(-16)]),
    ("naval-threat-triage", [Some(1), Some(5), Some(-7)]),
    ("never-an-empty-queue", [Some(-18), Some(-8), Some(6)]),
    ("never-an-empty-queue-2", [Some(-11), Some(0), Some(8)]),
    ("no-free-passage", [Some(-2), Some(14), Some(-18)]),
    ("one-launch-pad", [Some(-7), Some(-4), Some(-24)]),
    ("one-shot-recovery", [Some(-14), Some(14), Some(3)]),
    ("one-war-at-a-time", [Some(7), Some(-1), Some(-18)]),
    ("opening-warrior-recon", [Some(-27), Some(-17), Some(-27)]),
    ("opportunistic-war", [Some(0), Some(8), Some(5)]),
    ("order-retry", [Some(-14), Some(-17), Some(1)]),
    ("overseas-settlement", [Some(-7), Some(12), Some(16)]),
    ("pantheon-board", [Some(6), Some(31), Some(-10)]),
    ("pass-picket", [Some(0), Some(0), Some(-9)]),
    ("peace-when-the-war-does-not-pay", [Some(25), Some(-7), Some(40)]),
    ("peacetime-deterrence", [Some(10), Some(0), Some(4)]),
    ("power-the-laboratory", [Some(-8), Some(-8), Some(18)]),
    ("power-the-laboratory-2", [Some(-7), Some(-3), Some(12)]),
    ("price-the-suzerainty", [Some(1), Some(20), Some(39)]),
    ("promote-when-wounded", [Some(0), Some(7), Some(3)]),
    ("quest-boost", [Some(-13), Some(-8), Some(-18)]),
    ("quest-camp-errand", [Some(11), Some(-18), Some(25)]),
    ("quest-production", [Some(-25), Some(-2), Some(-13)]),
    ("quest-trade-route", [Some(19), Some(-4), Some(-7)]),
    ("raid-pillage-prizes", [Some(-7), Some(0), Some(12)]),
    ("rapid-city-expansion", [Some(-104), Some(-83), Some(-66)]),
    ("recon-replacement", [Some(-4), Some(2), Some(10)]),
    ("recorded-tactical-step", [Some(25), Some(-5), Some(-24)]),
    ("recovery-reads-the-war", [Some(-26), Some(3), Some(-30)]),
    ("relief-column-marches", [Some(12), Some(10), Some(-6)]),
    ("relief-targets-the-siege", [Some(13), Some(-2), Some(19)]),
    ("religion-race-is-closed", [Some(21), Some(-15), Some(13)]),
    ("religion-sues-peace", [Some(-8), Some(5), Some(-3)]),
    ("religious-defence-scales", [Some(-5), Some(18), Some(10)]),
    ("religious-units-heal-first", [Some(-26), Some(-4), Some(-7)]),
    ("religious-veto-defence", [Some(12), Some(42), Some(33)]),
    ("research-tier-premium", [Some(3), Some(-6), Some(4)]),
    ("rival-suzerainty-alarm", [Some(-4), Some(-10), Some(14)]),
    ("science-building-first", [Some(28), Some(-2), Some(-9)]),
    ("science-chain-alarm", [Some(12), Some(1), Some(-20)]),
    ("science-expansion-phase", [Some(-1), Some(-3), Some(4)]),
    ("science-multiplier-payoff", [Some(1), Some(-10), Some(3)]),
    ("science-opening-band", [Some(12), Some(-5), Some(6)]),
    ("science-victory-drive", [Some(16), Some(18), Some(13)]),
    ("science-victory-drive-2", [Some(12), None, None]),
    ("score-horizon", [Some(-27), Some(2), Some(-18)]),
    ("screen-the-shooters", [Some(18), Some(-13), Some(13)]),
    ("settle-sooner", [Some(18), Some(-5), Some(-4)]),
    ("settlement-gap-target", [Some(12), Some(9), Some(0)]),
    ("settler-backlog-brake", [Some(0), Some(5), Some(-12)]),
    ("settler-factory-coordination", [Some(-21), Some(-26), Some(-11)]),
    ("settler-guard-holds", [Some(-31), Some(4), Some(5)]),
    ("settler-guard-holds-2", [Some(6), Some(-8), Some(-6)]),
    ("settler-never-idles", [Some(27), Some(3), Some(-23)]),
    ("settler-screen", [Some(7), Some(0), Some(-13)]),
    ("settler-second-look", [Some(4), Some(-4), Some(2)]),
    ("settler-target-hysteresis", [Some(-2), Some(-2), Some(-2)]),
    ("settler-target-hysteresis-2", [Some(0), Some(2), Some(-2)]),
    ("settler-threat-detour", [Some(1), Some(-11), Some(-11)]),
    ("siege-commitment", [Some(-26), Some(-6), Some(1)]),
    ("siege-is-progress-2", [Some(-16), Some(-3), Some(8)]),
    ...
    ("surprise-war-mobilization", [Some(-4), Some(7), Some(3)]),
    ("swap-rotation", [Some(-2), Some(-3), Some(8)]),
    ("threatened-city-reserve", [Some(10), Some(3), Some(-26)]),
    ("treasury-at-work", [Some(-1), Some(8), Some(-6)]),
    ("treasury-at-work-2", [Some(4), Some(17), Some(13)]),
    ("unchosen-war-keeps-the-lane", [Some(8), Some(-9), Some(11)]),
    ("unit-cost-efficiency", [Some(-17), Some(9), Some(-14)]),
    ("unit-objective-memory", [Some(14), Some(16), Some(28)]),
    ("upgrade-the-garrison", [Some(7), Some(-5), Some(-18)]),
    ("walls-after-districts", [Some(-9), Some(-1), Some(5)]),
    ("war-economy", [Some(-8), Some(21), Some(-10)]),
    ("war-needs-a-treasury", [Some(15), Some(19), Some(-15)]),
    ("war-reinforcement", [Some(8), Some(26), Some(-3)]),
    ("whole-turn-backtrack-guard", [Some(0), Some(-7), Some(-21)]),
    ("wide-map-capacity", [Some(30), Some(52), Some(22)]),
    ("wonder-adjacent-sites", [Some(15), Some(29), Some(10)]),
    ("wonder-adjacent-sites-2", [Some(-12), Some(-17), Some(21)]),
    ("wonder-ring-recon", [Some(-2), Some(-8), Some(-2)]),
    ("wonder-score-tally", [Some(3), Some(-5), Some(29)]),
];
