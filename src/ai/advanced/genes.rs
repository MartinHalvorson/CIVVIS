...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [None, Some(-20), Some(-11)]),
    ("air-surge", [None, Some(29), Some(18)]),
    ("amenity-district-path", [None, Some(-12), Some(35)]),
    ("amenity-project-preemption", [None, Some(-29), Some(11)]),
    ("amenity-project-preemption-2", [None, Some(25), Some(-17)]),
    ("apostle-promotion-by-role", [None, Some(10), Some(-1)]),
    ("army-target-weighs-enemy", [None, Some(3), Some(19)]),
    ("barbarian-bargain", [None, Some(2), Some(14)]),
    ("barbarian-ranged-answer", [None, Some(-20), Some(-14)]),
    ("barbarian-scouts-are-scouts", [None, Some(-3), Some(-23)]),
    ("barbarian-settler-capture", [None, Some(19), Some(35)]),
    ("blind-objective-strength", [None, Some(12), Some(-19)]),
    ("blind-objective-units", [None, Some(-16), Some(20)]),
    ("boost-first-research", [None, Some(-21), Some(4)]),
    ("boost-unlock-research", [None, Some(8), Some(-23)]),
    ("boost-wait-research", [None, Some(-3), Some(-8)]),
    ("boosted-bargain-first", [None, Some(-20), Some(-39)]),
    ("border-parity", [None, Some(3), Some(9)]),
    ("border-parity-2", [None, Some(-6), Some(-10)]),
    ("bounded-recovery", [None, Some(-19), Some(9)]),
    ("build-what-cards-boost", [None, Some(17), Some(-9)]),
    ("builder-barbarian-safety", [None, Some(-18), Some(-5)]),
    ("builder-supply-floor", [None, Some(8), Some(-17)]),
    ("builder-tries-the-next-tile", [None, Some(24), Some(-23)]),
    ("buildings-before-projects", [None, Some(-16), Some(-26)]),
    ("buy-what-cards-cannot-boost", [None, Some(-1), Some(24)]),
    ("camp-party", [None, Some(-7), Some(-3)]),
    ("camp-tile-buyout", [None, Some(1), Some(-22)]),
    ("campaign-pillage", [None, Some(17), Some(-6)]),
    ("campus-adjacency-threshold", [None, Some(-20), Some(22)]),
    ("campus-adjacency-threshold-2", [None, Some(4), Some(-20)]),
    ("canal-city", [None, Some(24), Some(19)]),
    ("capital-settler-after-completion", [None, Some(26), Some(23)]),
    ("capture-go-or-stand-down", [None, Some(-19), Some(-25)]),
    ("capture-go-or-stand-down-2", [None, Some(-1), Some(25)]),
    ("chain-payback-window", [None, Some(2), Some(-6)]),
    ("chain-payback-window-2", [None, Some(13), Some(-26)]),
    ("cheapest-wonder-first", [None, Some(29), Some(-10)]),
    ("chokepoint-claim", [None, Some(17), Some(-19)]),
    ("chokepoint-garrison", [None, Some(10), Some(-1)]),
    ("chokepoint-siting", [None, Some(19), Some(22)]),
    ("chop-into-the-queue", [None, Some(-15), Some(-17)]),
    ("city-campaign", [None, Some(4), Some(-19)]),
    ("city-target-meets-the-map", [None, Some(26), Some(-14)]),
    ("civilian-out-of-reach", [None, Some(-41), Some(14)]),
    ("close-as-a-body", [None, Some(3), Some(-10)]),
    ("coalition-before-war", [None, Some(-24), Some(-20)]),
    ("coastal-city-sites", [None, Some(-13), Some(-2)]),
    ("coastal-city-sites-2", [None, Some(2), Some(-8)]),
    ("come-ashore", [None, Some(5), Some(-42)]),
    ("commitment-patience", [None, Some(21), Some(26)]),
    ("competition-victory-points", [None, Some(2), Some(12)]),
    ("congress-counter-leader", [None, Some(-23), Some(-23)]),
    ("connect-the-luxury", [None, Some(39), Some(66)]),
    ("contested-land-first", [None, Some(19), Some(41)]),
    ("conversion-majority-alarm", [None, Some(-33), Some(6)]),
    ("coordinated-finish", [None, Some(11), Some(-2)]),
    ("culture-building-debt", [None, Some(13), Some(24)]),
    ("culture-floor", [None, Some(-18), Some(8)]),
    ("culture-lane-forecast", [None, Some(-8), Some(29)]),
    ("deals-at-the-ceiling", [None, Some(-7), Some(7)]),
    ("deals-for-our-gain", [None, Some(-30), Some(-2)]),
    ("defend-where-you-stand", [None, Some(-7), Some(-44)]),
    ("defensible-sites", [None, Some(16), Some(3)]),
    ("diplomatic-lane-forecast", [None, Some(-31), Some(-30)]),
    ("district-coverage", [None, Some(3), Some(-18)]),
    ("district-coverage-2", [None, Some(3), Some(17)]),
    ("district-planning", [None, Some(14), Some(1)]),
    ("domination-city-count", [None, Some(2), Some(26)]),
    ("early-archers", [None, Some(9), Some(-15)]),
    ("early-contact-window", [None, Some(-12), Some(8)]),
    ("early-project-restraint", [None, Some(-10), Some(-9)]),
    ("elective-war-in-reach", [None, Some(16), Some(-5)]),
    ("elective-war-yields-to-a-lane", [None, Some(67), Some(24)]),
    ("encampment-seals-the-pass", [None, Some(-7), Some(18)]),
    ("enemy-of-my-enemy", [None, Some(7), Some(6)]),
    ("engine-faith-price", [None, Some(22), Some(5)]),
    ("enhancer-for-the-corps", [None, Some(-2), Some(14)]),
    ("enter-the-prophet-race", [None, Some(-41), Some(-30)]),
    ("escort-cap-holds", [None, Some(-18), Some(46)]),
    ("escort-unstick", [None, Some(35), Some(-28)]),
    ("eureka-chasing-builder", [None, Some(1), Some(-20)]),
    ("eureka-chasing-production", [None, Some(11), Some(-19)]),
    ("exchange-is-the-engines", [None, Some(13), Some(2)]),
    ("exhaustion-loyalty-guard", [None, Some(5), Some(-7)]),
    ("expansion-pays-back", [None, Some(7), Some(21)]),
    ("expansion-schedule", [None, Some(8), Some(17)]),
    ("fire-plan", [None, Some(18), Some(-6)]),
    ("first-builder-reserve", [None, Some(-14), Some(9)]),
    ("first-district-first", [None, Some(-5), Some(-5)]),
    ("first-granary-reserve", [None, Some(7), Some(-8)]),
    ("first-luxury-first", [None, Some(17), Some(15)]),
    ("first-research-building-reserve", [None, Some(-2), Some(-5)]),
    ("flip-nearby-city-states", [None, Some(3), Some(3)]),
    ("founder-temple", [None, Some(3), Some(17)]),
    ("frontier-massing-alarm", [None, Some(6), Some(0)]),
    ("garrison-under-fire", [None, Some(-28), Some(10)]),
    ("gold-for-the-young-city", [None, Some(-9), Some(30)]),
    ("gold-income-floor", [None, Some(4), Some(18)]),
    ("government-capacity-fallback", [None, Some(-10), Some(-23)]),
    ("government-ladder", [None, Some(-29), Some(-9)]),
    ("government-ladder-2", [None, Some(28), Some(-9)]),
    ("great-person-housing", [None, Some(23), Some(26)]),
    ("growth-to-settle", [None, Some(10), Some(-8)]),
    ("guru-heals-the-corps-2", [None, Some(-4), Some(5)]),
    ("holy-lane-parity", [None, Some(5), Some(4)]),
    ("holy-site-where-the-threat-is", [None, Some(-9), Some(-6)]),
    ("holy-site-where-the-threat-is-2", [None, Some(8), Some(37)]),
    ("hostile-memory", [None, Some(-22), Some(-23)]),
    ("housing-research", [None, Some(-16), Some(8)]),
    ("idle-faith-patronage", [None, Some(6), Some(26)]),
    ("improvement-housing-value", [None, Some(-4), Some(18)]),
    ("island-exploration", [None, Some(-23), Some(46)]),
    ("lane-culture-spending", [None, Some(11), Some(-11)]),
    ("lane-great-people", [None, Some(-4), Some(-24)]),
    ("lane-policy-deck", [None, Some(5), Some(-13)]),
    ("lane-release-when-hopeless", [None, Some(11), Some(3)]),
    ("lane-space-race", [None, Some(7), Some(-13)]),
    ("lane-votes-its-favor", [None, Some(-15), Some(6)]),
    ("loyalty-rate-alarm", [None, Some(39), Some(8)]),
    ("maintenance-aware-deck", [None, Some(-2), Some(25)]),
    ("missionary-evades-raiders", [None, Some(17), Some(10)]),
    ("missionary-last-charge-explores", [None, Some(-5), Some(42)]),
    ("moksha-defends-the-faithless", [None, Some(-7), Some(18)]),
    ("native-emergency-purchase", [None, Some(-38), Some(-33)]),
    ("naval-recon", [Some(-6), Some(1), Some(29)]),
    ("naval-recon-2", [Some(12), Some(-39), Some(-17)]),
    ("naval-recon-3", [Some(-6), None, None]),
    ("naval-threat-triage", [None, Some(-4), Some(14)]),
    ("never-an-empty-queue", [None, Some(-2), Some(-19)]),
    ("never-an-empty-queue-2", [None, Some(-23), Some(-21)]),
    ("no-free-passage", [None, Some(11), Some(-2)]),
    ("one-launch-pad", [None, Some(-13), Some(-2)]),
    ("one-shot-recovery", [None, Some(-7), Some(17)]),
    ("one-war-at-a-time", [None, Some(-1), Some(-1)]),
    ("opening-warrior-recon", [None, Some(-26), Some(4)]),
    ("opportunistic-war", [None, Some(12), Some(18)]),
    ("order-retry", [None, Some(-15), Some(-11)]),
    ("overseas-settlement", [None, Some(7), Some(-20)]),
    ("pantheon-board", [None, Some(18), Some(36)]),
    ("pass-picket", [None, Some(2), Some(14)]),
    ("peace-when-the-war-does-not-pay", [None, Some(19), Some(-27)]),
    ("peacetime-deterrence", [None, Some(27), Some(-37)]),
    ("power-the-laboratory", [None, Some(7), Some(15)]),
    ("power-the-laboratory-2", [None, Some(20), Some(-23)]),
    ("price-the-suzerainty", [None, Some(2), Some(51)]),
    ("promote-when-wounded", [None, Some(9), Some(1)]),
    ("quest-boost", [None, Some(-5), Some(25)]),
    ("quest-camp-errand", [None, Some(-16), Some(-16)]),
    ("quest-production", [None, Some(12), Some(-40)]),
    ("quest-trade-route", [None, Some(8), Some(10)]),
    ("raid-pillage-prizes", [None, Some(-17), Some(7)]),
    ("rapid-city-expansion", [None, Some(-60), Some(-118)]),
    ("recon-replacement", [None, Some(-13), Some(46)]),
    ("recorded-tactical-step", [None, Some(1), Some(45)]),
    ("recovery-reads-the-war", [None, Some(-8), Some(36)]),
    ("relief-column-marches", [None, Some(0), Some(-12)]),
    ("relief-targets-the-siege", [None, Some(-25), Some(-2)]),
    ("religion-race-is-closed", [None, Some(-6), Some(37)]),
    ("religion-sues-peace", [None, Some(-16), Some(17)]),
    ("religious-defence-scales", [None, Some(-7), Some(23)]),
    ("religious-units-heal-first", [None, Some(-14), Some(18)]),
    ("religious-veto-defence", [None, Some(-24), Some(-4)]),
    ("research-tier-premium", [None, Some(-2), Some(-33)]),
    ("rival-suzerainty-alarm", [None, Some(-2), Some(11)]),
    ("science-building-first", [None, Some(13), Some(25)]),
    ("science-chain-alarm", [None, Some(13), Some(10)]),
    ("science-expansion-phase", [None, Some(25), Some(-22)]),
    ("science-multiplier-payoff", [None, Some(8), Some(5)]),
    ("science-opening-band", [None, Some(7), Some(40)]),
    ("science-victory-drive", [None, Some(-4), Some(20)]),
    ("science-victory-drive-2", [None, Some(23), Some(-13)]),
    ("score-horizon", [None, Some(-17), Some(-32)]),
    ("screen-the-shooters", [None, Some(-9), Some(0)]),
    ("settle-sooner", [None, Some(45), Some(29)]),
    ("settlement-gap-target", [None, Some(21), Some(-17)]),
    ("settler-backlog-brake", [None, Some(-14), Some(-12)]),
    ("settler-factory-coordination", [None, Some(-7), Some(7)]),
    ("settler-guard-holds", [None, Some(1), Some(-16)]),
    ("settler-guard-holds-2", [None, Some(6), Some(13)]),
    ("settler-never-idles", [None, Some(7), Some(-27)]),
    ("settler-screen", [None, Some(-29), Some(-29)]),
    ("settler-second-look", [None, Some(-23), Some(28)]),
    ("settler-target-hysteresis", [None, Some(11), Some(-5)]),
    ("settler-target-hysteresis-2", [None, Some(5), Some(-1)]),
    ("settler-threat-detour", [None, Some(14), Some(10)]),
    ("siege-commitment", [None, Some(9), Some(-21)]),
    ("siege-is-progress-2", [None, Some(-1), Some(-19)]),
    ("skip-the-prophet-race", [None, Some(-12), Some(2)]),
    ("slot-kind-tiebreak", [None, Some(21), Some(16)]),
    ("solvency-first-trade-slot", [None, Some(120), Some(108)]),
    ("stranded-settler-discount", [None, Some(-19), Some(-18)]),
    ("strategic-wonders", [None, Some(-10), Some(0)]),
    ("strike-opening", [None, Some(-10), Some(-15)]),
    ("surprise-war-mobilization", [None, Some(-4), Some(18)]),
    ("swap-rotation", [None, Some(-17), Some(-15)]),
    ("threatened-city-reserve", [None, Some(12), Some(-3)]),
    ("treasury-at-work", [None, Some(-9), Some(10)]),
    ("treasury-at-work-2", [None, Some(17), Some(29)]),
    ("unchosen-war-keeps-the-lane", [None, Some(-1), Some(1)]),
    ("unit-cost-efficiency", [None, Some(4), Some(-9)]),
    ("unit-objective-memory", [None, Some(11), Some(-5)]),
    ("upgrade-the-garrison", [None, Some(-7), Some(-33)]),
    ("walls-after-districts", [None, Some(-5), Some(-14)]),
    ("war-economy", [None, Some(23), Some(-1)]),
    ("war-needs-a-treasury", [None, Some(1), Some(-27)]),
    ("war-reinforcement", [None, Some(1), Some(15)]),
    ("whole-turn-backtrack-guard", [None, Some(1), Some(-3)]),
    ("wide-map-capacity", [None, Some(19), Some(21)]),
    ("wonder-adjacent-sites", [None, Some(5), Some(32)]),
    ("wonder-adjacent-sites-2", [None, Some(-11), Some(-6)]),
    ("wonder-ring-recon", [None, Some(-11), Some(5)]),
    ("wonder-score-tally", [None, Some(-13), Some(1)]),
];
