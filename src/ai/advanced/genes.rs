...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(-35), Some(9), Some(26)]),
    ("air-surge", [Some(-3), Some(13), Some(4)]),
    ("air-surge-2", [Some(-24), Some(2), Some(1)]),
    ("amani-follows-suzerainty", [Some(-45), Some(-3), None]),
    ("amenity-district-path", [Some(-12), Some(4), Some(-29)]),
    ("amenity-project-preemption", [Some(-18), Some(-2), Some(11)]),
    ("amenity-project-preemption-2", [Some(29), Some(0), Some(-25)]),
    ("anvil", [Some(24), Some(1), Some(-27)]),
    ("apostle-promotion-by-role", [Some(12), Some(-9), Some(28)]),
    ("army-target-weighs-enemy", [Some(-48), Some(-31), Some(-2)]),
    ("barbarian-bargain", [Some(-32), Some(5), Some(4)]),
    ("barbarian-ranged-answer", [Some(14), Some(-6), Some(16)]),
    ("barbarian-scouts-are-scouts", [Some(-12), Some(4), Some(12)]),
    ("barbarian-settler-capture", [Some(-42), Some(16), Some(28)]),
    ("battle-planner", [Some(3), Some(20), Some(0)]),
    ("battle-planner-2", [Some(69), Some(22), Some(45)]),
    ("battle-planner-3", [Some(-1), Some(12), Some(-9)]),
    ("blind-objective-strength", [Some(4), Some(10), Some(-18)]),
    ("blind-objective-units", [Some(-5), Some(-28), Some(9)]),
    ("boost-first-research", [Some(39), Some(-8), Some(-7)]),
    ("boost-first-research-2", [Some(-11), Some(0), None]),
    ("boost-unlock-research", [Some(23), Some(21), Some(15)]),
    ("boost-wait-research-2", [Some(-21), Some(7), Some(16)]),
    ("boosted-bargain-first", [Some(11), Some(4), Some(-33)]),
    ("boosted-bargain-first-2", [Some(-58), Some(-11), Some(21)]),
    ("border-parity", [Some(-22), Some(-16), Some(-6)]),
    ("border-parity-2", [Some(46), Some(-1), Some(23)]),
    ("border-parity-3", [Some(-2), Some(5), Some(-2)]),
    ("bounded-recovery", [Some(17), Some(-5), Some(-17)]),
    ("build-what-cards-boost", [Some(29), Some(-2), Some(-9)]),
    ("builder-barbarian-safety", [Some(52), Some(-2), Some(-14)]),
    ("builder-supply-floor", [Some(23), Some(1), Some(-18)]),
    ("builder-tries-the-next-tile", [Some(10), Some(2), Some(-22)]),
    ("builder-workforce-recovery", [Some(-19), Some(5), None]),
    ("builder-workforce-recovery-2", [Some(41), Some(8), None]),
    ("buildings-before-projects", [Some(4), Some(14), Some(-13)]),
    ("buy-what-cards-cannot-boost", [Some(-40), Some(-3), Some(15)]),
    ("camp-party", [Some(-18), Some(11), Some(-30)]),
    ("camp-tile-buyout", [Some(25), Some(-3), Some(-34)]),
    ("campaign-pillage", [Some(-20), Some(10), Some(-2)]),
    ("campus-adjacency-threshold", [Some(-27), Some(-6), Some(26)]),
    ("campus-adjacency-threshold-2", [Some(13), Some(1), Some(-2)]),
    ("campus-before-halfway", [Some(-20), Some(-16), Some(13)]),
    ("campus-through-expansion", [Some(-8), Some(-22), Some(8)]),
    ("canal-city", [Some(-31), Some(-8), Some(8)]),
    ("capital-settler-after-completion", [Some(68), Some(0), Some(47)]),
    ("capture-go-or-stand-down", [Some(-12), Some(-10), Some(-28)]),
    ("capture-go-or-stand-down-2", [Some(8), Some(10), Some(9)]),
    ("chain-payback-window", [Some(-56), Some(2), Some(15)]),
    ("chain-payback-window-2", [Some(34), Some(3), Some(-11)]),
    ("chase-every-boost", [Some(42), Some(22), Some(2)]),
    ("chase-every-boost-2", [Some(-31), Some(-11), Some(-3)]),
    ("cheapest-wonder-first", [Some(-19), Some(-20), Some(-12)]),
    ("chokepoint-claim", [Some(-14), Some(11), Some(31)]),
    ("chokepoint-garrison", [Some(12), Some(9), Some(2)]),
    ("chokepoint-siting", [Some(-10), Some(-9), Some(2)]),
    ("city-campaign", [Some(30), Some(-28), Some(-3)]),
    ("city-campaign-2", [Some(14), Some(22), Some(3)]),
    ("city-target-meets-the-map", [Some(1), Some(-2), Some(2)]),
    ("civilian-out-of-reach", [Some(-48), Some(-17), Some(-34)]),
    ("close-as-a-body", [Some(-5), Some(9), Some(12)]),
    ("coalition-before-war", [Some(26), Some(-6), Some(2)]),
    ("coalition-before-war-2", [Some(-24), Some(7), Some(-7)]),
    ("coalition-before-war-3", [Some(-39), Some(8), Some(-7)]),
    ("coastal-city-sites", [Some(-21), Some(-4), Some(7)]),
    ("coastal-city-sites-2", [Some(-11), Some(6), Some(-8)]),
    ("come-ashore", [Some(11), Some(-13), Some(-25)]),
    ("commitment-owner-acts", [Some(4), Some(-9), Some(14)]),
    ("commitment-patience", [Some(18), Some(-4), Some(22)]),
    ("competition-victory-points", [Some(5), Some(34), Some(12)]),
    ("congress-counter-leader", [Some(3), Some(-5), Some(-11)]),
    ("connect-the-luxury", [Some(83), Some(46), Some(43)]),
    ("contested-land-first", [Some(-28), Some(-2), Some(2)]),
    ("conversion-majority-alarm", [Some(-28), Some(-18), Some(-13)]),
    ("conversion-majority-alarm-2", [Some(-18), Some(-4), Some(4)]),
    ("coordinated-finish", [Some(-39), Some(20), Some(-7)]),
    ("culture-building-catchup", [Some(-14), Some(-8), None]),
    ("culture-building-catchup-2", [Some(7), Some(-5), None]),
    ("culture-building-debt", [Some(-31), Some(7), Some(-2)]),
    ("culture-floor", [Some(70), Some(-2), Some(18)]),
    ("culture-lane-forecast", [Some(19), Some(-2), Some(1)]),
    ("culture-threat-early", [Some(-39), Some(-14), None]),
    ("deals-at-the-ceiling", [Some(-4), Some(10), Some(-10)]),
    ("deals-for-our-gain", [Some(46), Some(-2), Some(3)]),
    ("defend-where-you-stand", [Some(3), Some(1), Some(5)]),
    ("defensible-sites", [Some(-25), Some(20), Some(10)]),
    ("detour-keeps-the-site-worth", [Some(-20), Some(-13), Some(-16)]),
    ("diplomatic-lane-forecast", [Some(-33), Some(16), Some(1)]),
    ("diplomatic-lane-forecast-2", [Some(10), Some(-9), Some(-14)]),
    ("district-coverage", [Some(-21), Some(9), Some(9)]),
    ("district-coverage-2", [Some(22), Some(-20), Some(4)]),
    ("district-planning", [Some(9), Some(-10), Some(30)]),
    ("district-planning-3", [Some(-17), Some(18), Some(-13)]),
    ("domination-city-count", [Some(-24), Some(18), Some(17)]),
    ("doomed-blow-veto", [Some(-39), Some(3), Some(-29)]),
    ("doomed-blow-veto-2", [Some(26), Some(23), None]),
    ("early-archers", [Some(-13), Some(12), Some(-19)]),
    ("early-contact-window", [Some(-11), Some(-23), Some(13)]),
    ("early-contact-window-2", [Some(-15), None, None]),
    ("early-project-restraint", [Some(-14), Some(6), Some(-12)]),
    ("early-project-restraint-2", [Some(-14), Some(6), Some(11)]),
    ("elective-war-in-reach", [Some(4), Some(29), Some(-13)]),
    ("elective-war-yields-to-a-lane", [Some(47), Some(56), Some(53)]),
    ("encampment-seals-the-pass", [Some(13), Some(1), Some(-13)]),
    ("enemy-of-my-enemy", [Some(14), Some(-22), Some(-12)]),
    ("engine-faith-price", [Some(7), Some(36), Some(19)]),
    ("enhancer-for-the-corps", [Some(-19), Some(7), Some(8)]),
    ("enter-the-prophet-race-2", [Some(-31), Some(-8), Some(36)]),
    ("envoy-building-dividends", [Some(-1), Some(-6), Some(10)]),
    ("escort-cap-holds", [Some(-11), Some(3), Some(21)]),
    ("escort-unstick", [Some(59), Some(29), Some(27)]),
    ("eureka-chasing-builder", [Some(8), Some(5), Some(-1)]),
    ("eureka-chasing-builder-2", [Some(-23), Some(-6), Some(-13)]),
    ("eureka-chasing-production", [Some(11), Some(0), Some(27)]),
    ("exchange-is-the-engines", [Some(-28), Some(6), Some(-20)]),
    ("exhaustion-loyalty-guard", [Some(5), Some(6), Some(-19)]),
    ("expansion-best-idle-city", [Some(-20), Some(7), None]),
    ("expansion-best-idle-city-2", [Some(26), Some(-1), None]),
    ("expansion-pays-back", [Some(14), Some(-7), Some(-10)]),
    ("expansion-schedule", [Some(-52), Some(5), Some(2)]),
    ("fire-plan", [Some(24), Some(-2), Some(31)]),
    ("first-builder-reserve", [Some(21), Some(18), Some(2)]),
    ("first-builder-reserve-2", [Some(2), Some(-15), Some(8)]),
    ("first-district-first", [Some(-3), Some(21), Some(9)]),
    ("first-granary-reserve", [Some(14), Some(-10), Some(13)]),
    ("first-luxury-first", [Some(1), Some(-11), Some(-15)]),
    ("first-research-building-reserve", [Some(-46), Some(5), Some(11)]),
    ("founder-temple", [Some(24), Some(-2), Some(1)]),
    ("frontier-massing-alarm", [Some(-6), Some(0), Some(3)]),
    ("garrison-under-fire", [Some(15), Some(-9), Some(-10)]),
    ("gold-income-floor", [Some(48), Some(-5), Some(-1)]),
    ("government-capacity-fallback", [Some(34), Some(-24), Some(18)]),
    ("government-ladder", [Some(36), Some(7), Some(10)]),
    ("government-ladder-2", [Some(-23), Some(4), Some(-2)]),
    ("great-person-housing", [Some(2), Some(9), Some(1)]),
    ("growth-to-settle", [Some(-2), Some(8), Some(9)]),
    ("guru-heals-the-corps-2", [Some(67), Some(16), Some(0)]),
    ("holy-lane-parity", [Some(7), Some(-21), Some(9)]),
    ("holy-site-where-the-threat-is", [Some(-47), Some(-8), Some(-16)]),
    ("holy-site-where-the-threat-is-2", [Some(21), Some(-8), Some(-3)]),
    ("hostile-memory", [Some(-38), Some(-39), Some(-49)]),
    ("hostile-memory-2", [Some(-54), None, None]),
    ("housing-research", [Some(7), Some(8), Some(9)]),
    ("idle-faith-patronage", [Some(-40), Some(22), Some(-9)]),
    ("industrial-chain-debt", [Some(45), Some(19), Some(-5)]),
    ("island-exploration", [Some(-29), Some(6), Some(-9)]),
    ("lane-culture-spending", [Some(11), Some(-2), Some(-30)]),
    ("lane-great-people", [Some(12), Some(11), Some(18)]),
    ("lane-policy-deck", [Some(14), Some(-1), Some(-4)]),
    ("lane-release-when-hopeless", [Some(26), Some(19), Some(22)]),
    ("lane-space-race", [Some(-13), Some(7), Some(3)]),
    ("lane-votes-its-favor", [Some(-25), Some(-15), Some(-9)]),
    ("liang-follows-builders", [Some(32), Some(17), None]),
    ("loyalty-rate-alarm", [Some(43), Some(57), Some(48)]),
    ("magnus-follows-settlers", [Some(-4), Some(13), None]),
    ("maintenance-aware-deck", [Some(16), Some(31), Some(17)]),
    ("missionary-evades-raiders", [Some(-10), Some(7), Some(10)]),
    ("missionary-last-charge-explores", [Some(31), Some(-16), Some(-16)]),
    ("missionary-last-charge-explores-2", [Some(-4), Some(4), Some(9)]),
    ("modernize-before-spending", [Some(52), Some(-16), Some(-35)]),
    ("moksha-defends-the-faithless", [Some(37), Some(0), Some(9)]),
    ("native-emergency-purchase", [Some(13), Some(-6), Some(-11)]),
    ("native-emergency-purchase-2", [Some(-60), Some(-8), Some(-11)]),
    ("naval-recon", [Some(1), Some(2), Some(-22)]),
    ("naval-recon-2", [Some(-14), Some(14), Some(-1)]),
    ("naval-recon-3", [Some(5), Some(8), Some(24)]),
    ("naval-threat-triage", [Some(6), Some(2), Some(-4)]),
    ("never-an-empty-queue", [Some(12), Some(15), Some(-22)]),
    ("never-an-empty-queue-2", [Some(-31), Some(17), Some(23)]),
    ("never-an-empty-queue-3", [Some(27), Some(-13), Some(-17)]),
    ("no-free-passage", [Some(32), Some(6), Some(15)]),
    ("objective-board", [Some(-69), Some(9), Some(-1)]),
    ("one-launch-pad", [Some(-5), Some(4), Some(-17)]),
    ("one-shot-recovery", [Some(10), Some(28), Some(0)]),
    ("one-war-at-a-time", [Some(-16), Some(22), Some(-12)]),
    ("opening-warrior-recon-2", [Some(-37), Some(-16), Some(11)]),
    ("opportunistic-war", [Some(-3), Some(-22), Some(-6)]),
    ("opportunistic-war-2", [Some(5), None, None]),
    ("order-retry", [Some(16), Some(-4), Some(-14)]),
    ("overseas-settlement", [Some(28), Some(-13), Some(1)]),
    ("pantheon-board", [Some(-13), Some(14), Some(12)]),
    ("pass-picket", [Some(-20), Some(-1), Some(0)]),
    ("pass-picket-2", [Some(-31), None, None]),
    ("peace-when-the-war-does-not-pay", [Some(80), Some(15), Some(-6)]),
    ("peacetime-deterrence", [Some(23), Some(-22), Some(-6)]),
    ("pingala-follows-research", [Some(2), Some(2), None]),
    ("power-the-laboratory", [Some(-15), Some(-4), Some(-10)]),
    ("power-the-laboratory-2", [Some(55), Some(-12), Some(-8)]),
    ("price-the-suzerainty", [Some(31), Some(-13), Some(16)]),
    ("promote-when-wounded", [Some(-38), Some(0), Some(-6)]),
    ("quest-boost", [Some(-44), Some(19), Some(-7)]),
    ("quest-camp-errand", [Some(-4), Some(4), Some(19)]),
    ("quest-production", [Some(36), Some(6), Some(-8)]),
    ("quest-trade-route", [Some(-13), Some(3), Some(22)]),
    ("raid-pillage-prizes", [Some(-33), Some(-23), Some(3)]),
    ("rapid-city-expansion-2", [Some(21), Some(0), Some(118)]),
    ("recon-replacement", [Some(-21), Some(-3), Some(-18)]),
    ("recorded-tactical-step", [Some(39), Some(2), Some(-5)]),
    ("recovery-reads-the-war", [Some(12), Some(-10), Some(-10)]),
    ("recovery-reads-the-war-2", [Some(16), Some(-11), Some(-1)]),
    ("relief-column-marches", [Some(-12), Some(-2), Some(5)]),
    ("relief-targets-the-siege", [Some(2), Some(-17), Some(-2)]),
    ("religion-race-is-closed", [Some(-14), Some(6), Some(10)]),
    ("religion-sues-peace", [Some(-20), Some(-24), Some(-7)]),
    ("religious-defence-scales", [Some(-17), Some(38), Some(23)]),
    ("religious-units-heal-first", [Some(87), Some(-9), Some(0)]),
    ("religious-veto-defence", [Some(42), Some(41), Some(5)]),
    ("requisitions", [Some(28), Some(-13), Some(-24)]),
    ("research-building-catchup", [Some(-1), Some(-4), None]),
    ("research-building-catchup-2", [Some(28), Some(11), None]),
    ("research-tier-premium", [Some(27), Some(0), Some(-6)]),
    ("reyna-follows-revenue", [Some(-20), Some(-10), None]),
    ("rival-suzerainty-alarm", [Some(48), Some(2), Some(-13)]),
    ("route-block-is-a-wait", [Some(-15), Some(-12), Some(34)]),
    ("safest-stand", [Some(-5), Some(2), Some(8)]),
    ("science-building-first", [Some(-22), Some(-2), Some(28)]),
    ("science-chain-alarm", [Some(2), Some(11), Some(-5)]),
    ("science-expansion-phase", [Some(35), Some(-7), Some(5)]),
    ("science-multiplier-payoff", [Some(-3), Some(13), Some(16)]),
    ("science-opening-band", [Some(21), Some(10), Some(19)]),
    ("science-victory-drive", [Some(4), Some(-8), Some(35)]),
    ("science-victory-drive-2", [Some(67), Some(44), Some(43)]),
    ("scout-first-opening", [Some(-37), Some(23), None]),
    ("screen-the-shooters", [Some(52), Some(14), Some(30)]),
    ("settle-sooner", [Some(7), Some(-4), Some(-10)]),
    ("settlement-gap-target", [Some(77), Some(-13), Some(24)]),
    ("settler-backlog-brake", [Some(3), Some(17), Some(26)]),
    ("settler-backlog-brake-2", [Some(28), Some(-5), Some(-22)]),
    ("settler-factory-coordination", [Some(-3), Some(-1), Some(9)]),
    ("settler-guard-holds", [Some(-18), Some(3), Some(-11)]),
    ("settler-guard-holds-2", [Some(25), Some(-3), Some(26)]),
    ("settler-never-idles", [Some(12), Some(-3), Some(14)]),
    ("settler-site-gate", [Some(17), Some(-12), Some(16)]),
    ("settler-target-floor", [Some(-23), Some(1), Some(4)]),
    ("settler-target-hysteresis", [Some(-28), Some(-6), Some(10)]),
    ("settler-target-hysteresis-2", [Some(16), Some(1), Some(-4)]),
    ("settler-threat-detour", [Some(-1), Some(-14), Some(12)]),
    ("settler-walk-deadline", [Some(-7), Some(13), Some(-6)]),
    ("siege-commitment", [Some(-3), Some(-2), Some(-10)]),
    ("siege-is-progress-2", [Some(-7), Some(-6), Some(1)]),
    ("siege-is-progress-3", [Some(16), Some(-10), Some(8)]),
    ("siege-preempts-the-queue", [Some(-25), Some(-26), Some(-3)]),
    ("siege-train", [Some(-71), Some(13), Some(35)]),
    ("skip-the-prophet-race-2", [Some(-23), Some(10), Some(-3)]),
    ("slot-kind-tiebreak", [Some(-25), Some(3), Some(-3)]),
    ("solvency-first-trade-slot", [Some(104), Some(89), Some(81)]),
    ("spaceport-surplus-veto", [Some(-7), Some(-1), Some(-17)]),
    ("standing-still-is-a-risk", [Some(32), Some(20), Some(7)]),
    ("stranded-settler-discount", [Some(-17), Some(-22), Some(11)]),
    ("strategic-wonders", [Some(-42), Some(-6), Some(-10)]),
    ("strike-opening", [Some(-35), Some(-4), Some(-21)]),
    ("strike-reach", [Some(-9), Some(7), Some(-18)]),
    ("surprise-war-mobilization", [Some(-29), Some(-12), Some(-10)]),
    ("swap-rotation", [Some(-16), Some(8), Some(11)]),
    ("swap-rotation-2", [Some(21), Some(-7), Some(7)]),
    ("threatened-city-reserve", [Some(-8), Some(-15), Some(5)]),
    ("trade-building-before-bankruptcy", [Some(0), Some(-8), None]),
    ("trade-building-before-bankruptcy-2", [Some(-6), Some(1), None]),
    ("trade-route-network", [Some(5), Some(-3), Some(14)]),
    ("treasury-at-work-2", [Some(-16), Some(28), Some(13)]),
    ("unchosen-war-keeps-the-lane", [Some(-40), Some(-9), Some(-4)]),
    ("unit-cost-efficiency", [Some(45), Some(16), Some(8)]),
    ("unit-objective-memory", [Some(-2), Some(7), Some(4)]),
    ("upgrade-the-garrison", [Some(50), Some(8), Some(15)]),
    ("veterans-withdraw-early", [Some(27), Some(9), Some(-12)]),
    ("walls-after-districts", [Some(9), Some(11), Some(-4)]),
    ("war-economy", [Some(-35), Some(0), Some(16)]),
    ("war-needs-a-treasury", [Some(-11), Some(27), Some(-9)]),
    ("war-policy-via-board", [Some(31), Some(24), Some(0)]),
    ("war-reinforcement", [Some(-12), Some(1), Some(-22)]),
    ("whole-turn-backtrack-guard", [Some(-16), Some(3), Some(12)]),
    ("wide-map-capacity", [Some(0), Some(-2), Some(38)]),
    ("wonder-adjacent-sites-2", [Some(9), Some(22), Some(1)]),
    ("wonder-ring-recon", [Some(-17), Some(-14), Some(-12)]),
    ("wonder-ring-recon-2", [Some(6), Some(9), Some(-3)]),
    ("wonder-score-tally", [Some(16), Some(2), Some(-10)]),
    ("wounded-out-of-reach", [Some(-46), Some(0), Some(8)]),
    ("wounded-out-of-reach-2", [Some(31), None, None]),
];
