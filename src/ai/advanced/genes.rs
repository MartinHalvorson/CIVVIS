...
pub(super) const DEPLOYMENT_GENOME: &[&str] = &[
    ...
    "lane-space-race",
    "lane-votes-its-favor",
    "loyalty-rate-alarm",
    "maintenance-aware-deck",
    "missionary-evades-raiders",
    "native-emergency-purchase-2",
    "naval-recon",
    "naval-threat-triage",
...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(7), Some(17), Some(19)]),
    ("air-surge", [Some(-23), Some(11), Some(17)]),
    ("air-surge-2", [Some(-43), Some(6), Some(-15)]),
    ("amenity-district-path", [Some(-29), Some(8), Some(11)]),
    ("amenity-project-preemption", [Some(-10), Some(14), Some(2)]),
    ("amenity-project-preemption-2", [Some(-10), Some(-3), Some(-5)]),
    ("anvil", [Some(-5), Some(3), Some(-3)]),
    ("apostle-promotion-by-role", [Some(-51), Some(-17), Some(-12)]),
    ("army-target-weighs-enemy", [Some(-1), Some(-12), Some(-5)]),
    ("barbarian-bargain", [Some(-12), Some(-7), Some(21)]),
    ("barbarian-ranged-answer", [Some(12), Some(15), Some(-16)]),
    ("barbarian-scouts-are-scouts", [Some(-18), Some(11), Some(6)]),
    ("barbarian-settler-capture", [Some(48), Some(19), Some(19)]),
    ("battle-planner", [Some(24), Some(7), Some(16)]),
    ("battle-planner-2", [Some(-27), Some(35), Some(25)]),
    ("battle-planner-3", [Some(49), Some(24), Some(8)]),
    ("blind-objective-strength", [Some(-21), Some(-15), Some(20)]),
    ("blind-objective-units", [Some(-10), Some(-3), Some(-20)]),
    ("boost-first-research", [Some(-11), Some(17), Some(-9)]),
    ("boost-unlock-research", [Some(-28), Some(2), Some(7)]),
    ("boost-wait-research", [Some(4), Some(-9), Some(-14)]),
    ("boost-wait-research-2", [Some(5), Some(-10), Some(-14)]),
    ("boosted-bargain-first", [Some(-20), Some(-25), Some(12)]),
    ("boosted-bargain-first-2", [Some(-13), Some(3), Some(17)]),
    ("border-parity", [Some(-70), Some(-1), Some(-9)]),
    ("border-parity-2", [Some(3), Some(-12), Some(-25)]),
    ("border-parity-3", [Some(49), Some(6), Some(13)]),
    ("bounded-recovery", [Some(13), Some(-4), Some(-11)]),
    ("build-what-cards-boost", [Some(-19), Some(1), Some(-5)]),
    ("builder-barbarian-safety", [Some(-34), Some(7), Some(-20)]),
    ("builder-supply-floor", [Some(-76), Some(-1), Some(-24)]),
    ("builder-tries-the-next-tile", [Some(35), Some(-5), Some(-6)]),
    ("buildings-before-projects", [Some(28), Some(6), Some(-5)]),
    ("buy-what-cards-cannot-boost", [Some(12), Some(-4), Some(3)]),
    ("camp-party", [Some(-25), Some(32), Some(8)]),
    ("camp-tile-buyout", [Some(-10), Some(9), Some(-1)]),
    ("campaign-pillage", [Some(60), Some(-9), Some(12)]),
    ("campus-adjacency-threshold", [Some(17), Some(11), Some(-8)]),
    ("campus-adjacency-threshold-2", [Some(25), Some(3), Some(-1)]),
    ("campus-through-expansion", [Some(-17), Some(-13), Some(10)]),
    ("canal-city", [Some(-12), Some(3), Some(18)]),
    ("capital-settler-after-completion", [Some(26), Some(0), Some(5)]),
    ("capture-go-or-stand-down", [Some(18), Some(-8), Some(10)]),
    ("capture-go-or-stand-down-2", [Some(-56), Some(-2), Some(9)]),
    ("chain-payback-window", [Some(-7), Some(-6), Some(13)]),
    ("chain-payback-window-2", [Some(-25), Some(5), Some(-17)]),
    ("chase-every-boost", [Some(71), Some(2), Some(-10)]),
    ("chase-every-boost-2", [Some(-38), Some(9), Some(4)]),
    ("cheapest-wonder-first", [Some(43), Some(5), Some(9)]),
    ("chokepoint-claim", [Some(25), Some(2), Some(0)]),
    ("chokepoint-garrison", [Some(-14), Some(-7), Some(4)]),
    ("chokepoint-siting", [Some(21), Some(3), Some(-6)]),
    ("chop-into-the-queue", [Some(-36), Some(-14), Some(11)]),
    ("city-campaign", [Some(-39), Some(-27), Some(-3)]),
    ("city-campaign-2", [Some(59), Some(0), Some(16)]),
    ("city-target-meets-the-map", [Some(5), Some(-6), Some(-6)]),
    ("civilian-out-of-reach", [Some(-43), Some(-4), Some(-8)]),
    ("close-as-a-body", [Some(23), Some(-25), Some(-14)]),
    ("coalition-before-war", [Some(27), Some(8), Some(13)]),
    ("coalition-before-war-2", [Some(26), Some(-5), Some(11)]),
    ("coalition-before-war-3", [Some(-5), Some(-2), Some(-6)]),
    ("coastal-city-sites", [Some(31), Some(6), Some(16)]),
    ("coastal-city-sites-2", [Some(-20), Some(6), Some(3)]),
    ("come-ashore", [Some(41), Some(9), Some(13)]),
    ("commitment-owner-acts", [Some(17), Some(-9), Some(26)]),
    ("commitment-patience", [Some(-37), Some(10), Some(22)]),
    ("competition-victory-points", [Some(-46), Some(1), Some(-16)]),
    ("congress-counter-leader", [Some(28), Some(-12), Some(12)]),
    ("connect-the-luxury", [Some(16), Some(-2), Some(-4)]),
    ("contested-land-first", [Some(51), Some(16), Some(10)]),
    ("contested-suzerainty-brake", [Some(9), None, None]),
    ("conversion-majority-alarm", [Some(24), Some(2), Some(17)]),
    ("conversion-majority-alarm-2", [Some(-21), Some(13), Some(-11)]),
    ("coordinated-finish", [Some(74), Some(19), Some(-11)]),
    ("culture-building-debt", [Some(42), Some(7), Some(6)]),
    ("culture-floor", [Some(-11), Some(5), Some(15)]),
    ("culture-lane-forecast", [Some(13), Some(2), Some(-2)]),
    ("deals-at-the-ceiling", [Some(25), Some(26), Some(10)]),
    ("deals-for-our-gain", [Some(-69), Some(-4), Some(-10)]),
    ("defend-where-you-stand", [Some(6), Some(-7), Some(3)]),
    ("defensible-sites", [Some(27), Some(22), Some(33)]),
    ("detour-keeps-the-site-worth", [Some(11), None, None]),
    ("diplomatic-lane-forecast", [Some(-29), Some(18), Some(-6)]),
    ("diplomatic-lane-forecast-2", [Some(18), Some(-30), Some(15)]),
    ("district-coverage", [Some(-2), Some(-2), Some(-19)]),
    ("district-coverage-2", [Some(-17), Some(-3), Some(-6)]),
    ("district-planning", [Some(5), Some(-1), Some(1)]),
    ("district-planning-2", [Some(-8), Some(-1), Some(10)]),
    ("district-planning-3", [Some(-10), Some(-2), Some(-2)]),
    ("domination-city-count", [Some(19), Some(-15), Some(-2)]),
    ("doomed-blow-veto", [Some(19), Some(-3), None]),
    ("early-archers", [Some(-7), Some(-7), Some(-23)]),
    ("early-contact-window", [Some(-15), Some(2), Some(-4)]),
    ("early-project-restraint", [Some(-1), Some(3), Some(7)]),
    ("early-project-restraint-2", [Some(-6), Some(4), Some(-14)]),
    ("elective-war-in-reach", [Some(21), Some(0), Some(-18)]),
    ("elective-war-yields-to-a-lane", [Some(34), Some(39), Some(51)]),
    ("encampment-seals-the-pass", [Some(42), Some(16), Some(17)]),
    ("enemy-of-my-enemy", [Some(5), Some(15), Some(-16)]),
    ("engine-faith-price", [Some(34), Some(0), Some(11)]),
    ("enhancer-for-the-corps", [Some(8), Some(6), Some(-5)]),
    ("enter-the-prophet-race", [Some(-36), Some(-11), Some(-13)]),
    ("enter-the-prophet-race-2", [Some(-15), Some(22), Some(35)]),
    ("escort-cap-holds", [Some(-21), Some(9), Some(20)]),
    ("escort-unstick", [Some(25), Some(19), Some(38)]),
    ("eureka-chasing-builder", [Some(31), Some(12), Some(25)]),
    ("eureka-chasing-builder-2", [Some(-44), Some(-3), Some(6)]),
    ("eureka-chasing-production", [Some(-3), Some(-9), Some(-14)]),
    ("exchange-is-the-engines", [Some(-35), Some(-19), Some(-17)]),
    ("exhaustion-loyalty-guard", [Some(-1), Some(-1), Some(6)]),
    ("expansion-pays-back", [Some(-24), Some(-6), Some(-5)]),
    ("expansion-schedule", [Some(-28), Some(11), Some(6)]),
    ("fire-plan", [Some(-28), Some(1), Some(-14)]),
    ("first-builder-reserve", [Some(-42), Some(0), Some(-8)]),
    ("first-builder-reserve-2", [Some(31), Some(6), Some(17)]),
    ("first-district-first", [Some(4), Some(6), Some(-20)]),
    ("first-granary-reserve", [Some(61), Some(-24), Some(14)]),
    ("first-luxury-first", [Some(17), Some(-2), Some(3)]),
    ("first-research-building-reserve", [Some(-11), Some(-4), Some(1)]),
    ("flip-nearby-city-states", [Some(-7), Some(13), Some(11)]),
    ("founder-temple", [Some(1), Some(-7), Some(11)]),
    ("frontier-massing-alarm", [Some(49), Some(-3), Some(-2)]),
    ("garrison-under-fire", [Some(45), Some(1), Some(-4)]),
    ("gold-for-the-young-city", [Some(-23), Some(0), Some(4)]),
    ("gold-income-floor", [Some(-7), Some(-17), Some(16)]),
    ("government-capacity-fallback", [Some(29), Some(6), Some(-14)]),
    ("government-ladder", [Some(-20), Some(-15), Some(-25)]),
    ("government-ladder-2", [Some(-29), Some(10), Some(32)]),
    ("great-person-housing", [Some(36), Some(-9), Some(9)]),
    ("growth-to-settle", [Some(-65), Some(-6), Some(-12)]),
    ("guru-heals-the-corps-2", [Some(-9), Some(27), Some(-6)]),
    ("holy-lane-parity", [Some(-18), Some(-15), Some(12)]),
    ("holy-site-where-the-threat-is", [Some(41), Some(-8), Some(-3)]),
    ("holy-site-where-the-threat-is-2", [Some(-4), Some(-17), Some(17)]),
    ("hostile-memory", [Some(-29), Some(-11), Some(-9)]),
    ("housing-research", [Some(-1), Some(4), Some(-13)]),
    ("idle-faith-patronage", [Some(-14), Some(-11), Some(18)]),
    ("improvement-housing-value", [Some(-32), Some(-21), Some(-29)]),
    ("industrial-chain-debt", [Some(-32), Some(16), Some(-22)]),
    ("island-exploration", [Some(8), Some(-2), Some(1)]),
    ("lane-culture-spending", [Some(1), Some(-8), Some(22)]),
    ("lane-great-people", [Some(-11), Some(-3), Some(-4)]),
    ("lane-policy-deck", [Some(-9), Some(0), Some(-5)]),
    ("lane-release-when-hopeless", [Some(-30), Some(-10), Some(1)]),
    ("lane-space-race", [Some(-4), Some(7), Some(15)]),
    ("lane-votes-its-favor", [Some(39), Some(12), Some(-4)]),
    ("loyalty-rate-alarm", [Some(32), Some(61), Some(47)]),
    ("maintenance-aware-deck", [Some(24), Some(8), Some(7)]),
    ("missionary-evades-raiders", [Some(56), Some(18), Some(-9)]),
    ("missionary-last-charge-explores", [Some(-30), Some(-1), Some(2)]),
    ("missionary-last-charge-explores-2", [Some(-2), None, None]),
    ("modernize-before-spending", [Some(36), Some(-6), Some(-7)]),
    ("moksha-defends-the-faithless", [Some(-18), Some(-13), Some(0)]),
    ("native-emergency-purchase", [Some(0), Some(-13), Some(-10)]),
    ("native-emergency-purchase-2", [Some(-6), Some(15), Some(15)]),
    ("naval-recon", [Some(99), Some(8), Some(-1)]),
    ("naval-recon-2", [Some(-31), Some(12), Some(26)]),
    ("naval-recon-3", [Some(-27), Some(-4), Some(-14)]),
    ("naval-threat-triage", [Some(-9), Some(18), Some(1)]),
    ("never-an-empty-queue", [Some(15), Some(5), Some(-30)]),
    ("never-an-empty-queue-2", [Some(17), Some(2), Some(-3)]),
    ("never-an-empty-queue-3", [Some(4), Some(1), Some(0)]),
    ("no-free-passage", [Some(-23), Some(-7), Some(-3)]),
    ("objective-board", [Some(-51), Some(-27), Some(-5)]),
    ("one-launch-pad", [Some(45), Some(-4), Some(-28)]),
    ("one-shot-recovery", [Some(-13), Some(-25), Some(8)]),
    ("one-war-at-a-time", [Some(-14), Some(6), Some(-10)]),
    ("opening-warrior-recon", [Some(-46), Some(-28), Some(-3)]),
    ("opening-warrior-recon-2", [Some(-13), Some(33), Some(10)]),
    ("opportunistic-war", [Some(21), Some(-20), Some(2)]),
    ("order-retry", [Some(-16), Some(9), Some(-35)]),
    ("overseas-settlement", [Some(1), Some(3), Some(20)]),
    ("pantheon-board", [Some(19), Some(6), Some(12)]),
    ("pass-picket", [Some(-41), Some(-16), Some(3)]),
    ("peace-when-the-war-does-not-pay", [Some(-87), Some(10), Some(-17)]),
    ("peacetime-deterrence", [Some(4), Some(-22), Some(11)]),
    ("power-the-laboratory", [Some(-1), Some(2), Some(3)]),
    ("power-the-laboratory-2", [Some(18), Some(3), Some(-15)]),
    ("price-the-suzerainty", [Some(5), Some(3), Some(38)]),
    ("promote-when-wounded", [Some(21), Some(7), Some(0)]),
    ("quest-boost", [Some(-24), Some(9), Some(13)]),
    ("quest-camp-errand", [Some(-24), Some(20), Some(-33)]),
    ("quest-production", [Some(-49), Some(-8), Some(5)]),
    ("quest-trade-route", [Some(25), Some(8), Some(-9)]),
    ("raid-pillage-prizes", [Some(4), Some(-14), Some(3)]),
    ("rapid-city-expansion", [Some(-206), Some(-166), Some(-158)]),
    ("rapid-city-expansion-2", [Some(164), Some(98), Some(115)]),
    ("recon-replacement", [Some(30), Some(17), Some(5)]),
    ("recorded-tactical-step", [Some(-10), Some(-10), Some(18)]),
    ("recovery-reads-the-war", [Some(21), Some(-3), Some(-23)]),
    ("recovery-reads-the-war-2", [Some(-12), Some(11), Some(12)]),
    ("relief-column-marches", [Some(-6), Some(-7), Some(10)]),
    ("relief-targets-the-siege", [Some(20), Some(-6), Some(6)]),
    ("religion-race-is-closed", [Some(3), Some(-4), Some(3)]),
    ("religion-sues-peace", [Some(25), Some(8), Some(-2)]),
    ("religious-defence-scales", [Some(-12), Some(3), Some(3)]),
    ("religious-units-heal-first", [Some(0), Some(16), Some(-16)]),
    ("religious-veto-defence", [Some(-18), Some(26), Some(-11)]),
    ("requisitions", [Some(36), Some(-5), Some(-2)]),
    ("research-tier-premium", [Some(4), Some(-11), Some(10)]),
    ("rival-suzerainty-alarm", [Some(-8), Some(0), Some(-13)]),
    ("route-block-is-a-wait", [Some(-26), None, None]),
    ("safest-stand", [Some(32), Some(21), None]),
    ("science-building-first", [Some(46), Some(0), Some(5)]),
    ("science-chain-alarm", [Some(1), Some(1), Some(8)]),
    ("science-expansion-phase", [Some(-1), Some(8), Some(3)]),
    ("science-multiplier-payoff", [Some(10), Some(18), Some(-4)]),
    ("science-opening-band", [Some(9), Some(29), Some(14)]),
    ("science-victory-drive", [Some(-12), Some(7), Some(-34)]),
    ("science-victory-drive-2", [Some(8), Some(38), Some(44)]),
    ("score-horizon", [Some(-77), Some(-5), Some(-1)]),
    ("screen-the-shooters", [Some(8), Some(11), Some(-25)]),
    ("settle-sooner", [Some(-17), Some(6), Some(-16)]),
    ("settlement-gap-target", [Some(4), Some(-14), Some(-3)]),
    ("settler-backlog-brake", [Some(39), Some(-6), Some(-17)]),
    ("settler-backlog-brake-2", [Some(4), Some(8), None]),
    ("settler-factory-coordination", [Some(-13), Some(-4), Some(2)]),
    ("settler-guard-holds", [Some(-14), Some(-10), Some(-1)]),
    ("settler-guard-holds-2", [Some(16), Some(1), Some(-8)]),
    ("settler-never-idles", [Some(44), Some(24), Some(24)]),
    ("settler-screen", [Some(-27), Some(29), Some(17)]),
    ("settler-second-look", [Some(-25), Some(-6), Some(-3)]),
    ("settler-site-gate", [Some(-23), Some(14), Some(-14)]),
    ("settler-target-floor", [Some(-55), Some(-3), Some(-7)]),
    ("settler-target-hysteresis", [Some(0), Some(4), Some(1)]),
    ("settler-target-hysteresis-2", [Some(-36), Some(-5), Some(1)]),
    ("settler-threat-detour", [Some(50), Some(0), Some(9)]),
    ("settler-walk-deadline", [Some(-2), Some(17), Some(26)]),
    ("siege-commitment", [Some(3), Some(17), Some(0)]),
    ("siege-is-progress-2", [Some(-47), Some(3), Some(-6)]),
    ("siege-is-progress-3", [Some(14), Some(9), Some(18)]),
    ("siege-preempts-the-queue", [Some(-21), Some(-2), Some(-27)]),
    ("siege-train", [Some(30), Some(16), Some(4)]),
    ("skip-the-prophet-race", [Some(-24), Some(4), Some(-25)]),
    ("skip-the-prophet-race-2", [Some(17), Some(13), Some(3)]),
    ("slot-kind-tiebreak", [Some(0), Some(5), Some(-10)]),
    ("solvency-first-trade-slot", [Some(84), Some(66), Some(82)]),
    ("spaceport-surplus-veto", [Some(28), Some(5), Some(4)]),
    ("standing-still-is-a-risk", [Some(-15), None, None]),
    ("stranded-settler-discount", [Some(2), Some(21), Some(23)]),
    ("strategic-wonders", [Some(11), Some(-13), Some(-15)]),
    ("strike-opening", [Some(10), Some(-9), Some(12)]),
    ("strike-reach", [Some(-46), Some(-10), None]),
    ("surprise-war-mobilization", [Some(17), Some(18), Some(-13)]),
    ("swap-rotation", [Some(35), Some(15), Some(6)]),
    ("swap-rotation-2", [Some(-10), Some(15), None]),
    ("threatened-city-reserve", [Some(21), Some(-11), Some(-21)]),
    ("trade-route-network", [Some(3), Some(2), Some(13)]),
    ("treasury-at-work", [Some(15), Some(17), Some(4)]),
    ("treasury-at-work-2", [Some(32), Some(8), Some(24)]),
    ("unchosen-war-keeps-the-lane", [Some(30), Some(-18), Some(10)]),
    ("unit-cost-efficiency", [Some(-63), Some(-8), Some(-1)]),
    ("unit-objective-memory", [Some(-32), Some(-14), Some(4)]),
    ("upgrade-the-garrison", [Some(18), Some(-6), Some(0)]),
    ("veterans-withdraw-early", [Some(-14), Some(0), Some(4)]),
    ("walls-after-districts", [Some(-40), Some(12), Some(-17)]),
    ("war-economy", [Some(-54), Some(9), Some(23)]),
    ("war-needs-a-treasury", [Some(12), Some(-10), Some(0)]),
    ("war-policy-via-board", [Some(15), Some(15), Some(4)]),
    ("war-reinforcement", [Some(-31), Some(-10), Some(19)]),
    ("whole-turn-backtrack-guard", [Some(-2), Some(-14), Some(17)]),
    ("wide-map-capacity", [Some(10), Some(33), Some(9)]),
    ("wonder-adjacent-sites", [Some(29), Some(38), Some(37)]),
    ("wonder-adjacent-sites-2", [Some(-62), Some(-26), Some(-36)]),
    ("wonder-ring-recon", [Some(15), Some(5), Some(2)]),
    ("wonder-score-tally", [Some(5), Some(-1), Some(-1)]),
    ("wounded-out-of-reach", [Some(3), Some(5), Some(-8)]),
];
...
pub(super) const VERDICTS: &[GeneVerdict] = &[
    ...
    GeneVerdict { tag: "competition-victory-points", verdict: Verdict::Unresolved, default_on: false, wins_last_10k: Some(35), wins_prior_10k: Some(0), win_diff_pp: Some(0.309119), posterior_pp: Some(15.760591), posterior_se_pp: Some(17.698531), family_wise: false, screen: Some(Measure { pairs: 19080, win_delta_pp: 0.702, win_z: 1.841, share_delta_pp: 0.037, share_z: 0.463, source: "2026-08-24-standard-continuous-38160-total-seats.json" }) },
