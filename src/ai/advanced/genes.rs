...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(24), Some(7), Some(17)]),
    ("air-surge", [Some(-5), Some(-23), Some(11)]),
    ("air-surge-2", [Some(20), Some(-43), Some(6)]),
    ("amenity-district-path", [Some(-4), Some(-29), Some(8)]),
    ("amenity-project-preemption", [Some(-6), Some(-10), Some(14)]),
    ("amenity-project-preemption-2", [Some(13), Some(-10), Some(-3)]),
    ("anvil", [Some(-3), Some(-5), Some(3)]),
    ("apostle-promotion-by-role", [Some(25), Some(-51), Some(-17)]),
    ("army-target-weighs-enemy", [Some(-23), Some(-1), Some(-12)]),
    ("barbarian-bargain", [Some(14), Some(-12), Some(-7)]),
    ("barbarian-ranged-answer", [Some(-6), Some(12), Some(15)]),
    ("barbarian-scouts-are-scouts", [Some(-5), Some(-18), Some(11)]),
    ("barbarian-settler-capture", [Some(60), Some(48), Some(19)]),
    ("battle-planner", [Some(-10), Some(24), Some(7)]),
    ("battle-planner-2", [Some(42), Some(-27), Some(35)]),
    ("battle-planner-3", [Some(4), Some(49), Some(24)]),
    ("blind-objective-strength", [Some(15), Some(-21), Some(-15)]),
    ("blind-objective-units", [Some(-10), Some(-10), Some(-3)]),
    ("boost-first-research", [Some(-2), Some(-11), Some(17)]),
    ("boost-unlock-research", [Some(6), Some(-28), Some(2)]),
    ("boost-wait-research", [Some(-3), Some(4), Some(-9)]),
    ("boost-wait-research-2", [Some(8), Some(5), Some(-10)]),
    ("boosted-bargain-first", [Some(27), Some(-20), Some(-25)]),
    ("boosted-bargain-first-2", [Some(-8), Some(-13), Some(3)]),
    ("border-parity", [Some(1), Some(-70), Some(-1)]),
    ("border-parity-2", [Some(-10), Some(3), Some(-12)]),
    ("border-parity-3", [Some(-10), Some(49), Some(6)]),
    ("bounded-recovery", [Some(4), Some(13), Some(-4)]),
    ("build-what-cards-boost", [Some(-1), Some(-19), Some(1)]),
    ("builder-barbarian-safety", [Some(5), Some(-34), Some(7)]),
    ("builder-supply-floor", [Some(-3), Some(-76), Some(-1)]),
    ("builder-tries-the-next-tile", [Some(37), Some(35), Some(-5)]),
    ("buildings-before-projects", [Some(-15), Some(28), Some(6)]),
    ("buy-what-cards-cannot-boost", [Some(16), Some(12), Some(-4)]),
    ("camp-party", [Some(16), Some(-25), Some(32)]),
    ("camp-tile-buyout", [Some(13), Some(-10), Some(9)]),
    ("campaign-pillage", [Some(-15), Some(60), Some(-9)]),
    ("campus-adjacency-threshold", [Some(-10), Some(17), Some(11)]),
    ("campus-adjacency-threshold-2", [Some(4), Some(25), Some(3)]),
    ("campus-through-expansion", [Some(-23), Some(-17), Some(-13)]),
    ("canal-city", [Some(0), Some(-12), Some(3)]),
    ("capital-settler-after-completion", [Some(-2), Some(26), Some(0)]),
    ("capture-go-or-stand-down", [Some(18), Some(18), Some(-8)]),
    ("capture-go-or-stand-down-2", [Some(-5), Some(-56), Some(-2)]),
    ("chain-payback-window", [Some(4), Some(-7), Some(-6)]),
    ("chain-payback-window-2", [Some(12), Some(-25), Some(5)]),
    ("chase-every-boost", [Some(9), Some(71), Some(2)]),
    ("chase-every-boost-2", [Some(-7), Some(-38), Some(9)]),
    ("cheapest-wonder-first", [Some(-5), Some(43), Some(5)]),
    ("chokepoint-claim", [Some(6), Some(25), Some(2)]),
    ("chokepoint-garrison", [Some(-4), Some(-14), Some(-7)]),
    ("chokepoint-siting", [Some(-24), Some(21), Some(3)]),
    ("chop-into-the-queue", [Some(-45), Some(-36), Some(-14)]),
    ("city-campaign", [Some(-22), Some(-39), Some(-27)]),
    ("city-campaign-2", [Some(29), Some(59), Some(0)]),
    ("city-target-meets-the-map", [Some(-4), Some(5), Some(-6)]),
    ("civilian-out-of-reach", [Some(-6), Some(-43), Some(-4)]),
    ("close-as-a-body", [Some(-16), Some(23), Some(-25)]),
    ("coalition-before-war", [Some(10), Some(27), Some(8)]),
    ("coalition-before-war-2", [Some(2), Some(26), Some(-5)]),
    ("coalition-before-war-3", [Some(6), Some(-5), Some(-2)]),
    ("coastal-city-sites", [Some(1), Some(31), Some(6)]),
    ("coastal-city-sites-2", [Some(-13), Some(-20), Some(6)]),
    ("come-ashore", [Some(-15), Some(41), Some(9)]),
    ("commitment-owner-acts", [Some(-12), Some(17), Some(-9)]),
    ("commitment-patience", [Some(21), Some(-37), Some(10)]),
    ("competition-victory-points", [Some(-7), Some(-46), Some(1)]),
    ("congress-counter-leader", [Some(26), Some(28), Some(-12)]),
    ("connect-the-luxury", [Some(24), Some(16), Some(-2)]),
    ("contested-land-first", [Some(14), Some(51), Some(16)]),
    ("contested-suzerainty-brake", [Some(-45), Some(9), None]),
    ("conversion-majority-alarm", [Some(2), Some(24), Some(2)]),
    ("conversion-majority-alarm-2", [Some(-4), Some(-21), Some(13)]),
    ("coordinated-finish", [Some(15), Some(74), Some(19)]),
    ("culture-building-debt", [Some(0), Some(42), Some(7)]),
    ("culture-floor", [Some(14), Some(-11), Some(5)]),
    ("culture-lane-forecast", [Some(0), Some(13), Some(2)]),
    ("deals-at-the-ceiling", [Some(25), Some(25), Some(26)]),
    ("deals-for-our-gain", [Some(6), Some(-69), Some(-4)]),
    ("defend-where-you-stand", [Some(-15), Some(6), Some(-7)]),
    ("defensible-sites", [Some(2), Some(27), Some(22)]),
    ("detour-keeps-the-site-worth", [Some(8), Some(11), None]),
    ("diplomatic-lane-forecast", [Some(5), Some(-29), Some(18)]),
    ("diplomatic-lane-forecast-2", [Some(-5), Some(18), Some(-30)]),
    ("district-coverage", [Some(-6), Some(-2), Some(-2)]),
    ("district-coverage-2", [Some(7), Some(-17), Some(-3)]),
    ("district-planning", [Some(5), Some(5), Some(-1)]),
    ("district-planning-2", [Some(4), Some(-8), Some(-1)]),
    ("district-planning-3", [Some(0), Some(-10), Some(-2)]),
    ("domination-city-count", [Some(10), Some(19), Some(-15)]),
    ("doomed-blow-veto", [Some(-6), Some(19), Some(-3)]),
    ("early-archers", [Some(25), Some(-7), Some(-7)]),
    ("early-contact-window", [Some(2), Some(-15), Some(2)]),
    ("early-project-restraint", [Some(-24), Some(-1), Some(3)]),
    ("early-project-restraint-2", [Some(0), Some(-6), Some(4)]),
    ("elective-war-in-reach", [Some(5), Some(21), Some(0)]),
    ("elective-war-yields-to-a-lane", [Some(54), Some(34), Some(39)]),
    ("encampment-seals-the-pass", [Some(7), Some(42), Some(16)]),
    ("enemy-of-my-enemy", [Some(17), Some(5), Some(15)]),
    ("engine-faith-price", [Some(27), Some(34), Some(0)]),
    ("enhancer-for-the-corps", [Some(8), Some(8), Some(6)]),
    ("enter-the-prophet-race", [Some(-33), Some(-36), Some(-11)]),
    ("enter-the-prophet-race-2", [Some(39), Some(-15), Some(22)]),
    ("escort-cap-holds", [Some(-5), Some(-21), Some(9)]),
    ("escort-unstick", [Some(-10), Some(25), Some(19)]),
    ("eureka-chasing-builder", [Some(1), Some(31), Some(12)]),
    ("eureka-chasing-builder-2", [Some(-10), Some(-44), Some(-3)]),
    ("eureka-chasing-production", [Some(-16), Some(-3), Some(-9)]),
    ("exchange-is-the-engines", [Some(19), Some(-35), Some(-19)]),
    ("exhaustion-loyalty-guard", [Some(-7), Some(-1), Some(-1)]),
    ("expansion-pays-back", [Some(22), Some(-24), Some(-6)]),
    ("expansion-schedule", [Some(-25), Some(-28), Some(11)]),
    ("fire-plan", [Some(6), Some(-28), Some(1)]),
    ("first-builder-reserve", [Some(-20), Some(-42), Some(0)]),
    ("first-builder-reserve-2", [Some(18), Some(31), Some(6)]),
    ("first-district-first", [Some(-5), Some(4), Some(6)]),
    ("first-granary-reserve", [Some(3), Some(61), Some(-24)]),
    ("first-luxury-first", [Some(41), Some(17), Some(-2)]),
    ("first-research-building-reserve", [Some(20), Some(-11), Some(-4)]),
    ("flip-nearby-city-states", [Some(9), Some(-7), Some(13)]),
    ("founder-temple", [Some(27), Some(1), Some(-7)]),
    ("frontier-massing-alarm", [Some(-8), Some(49), Some(-3)]),
    ("garrison-under-fire", [Some(-25), Some(45), Some(1)]),
    ("gold-for-the-young-city", [Some(0), Some(-23), Some(0)]),
    ("gold-income-floor", [Some(-2), Some(-7), Some(-17)]),
    ("government-capacity-fallback", [Some(14), Some(29), Some(6)]),
    ("government-ladder", [Some(17), Some(-20), Some(-15)]),
    ("government-ladder-2", [Some(3), Some(-29), Some(10)]),
    ("great-person-housing", [Some(16), Some(36), Some(-9)]),
    ("growth-to-settle", [Some(-19), Some(-65), Some(-6)]),
    ("guru-heals-the-corps-2", [Some(-3), Some(-9), Some(27)]),
    ("holy-lane-parity", [Some(9), Some(-18), Some(-15)]),
    ("holy-site-where-the-threat-is", [Some(-4), Some(41), Some(-8)]),
    ("holy-site-where-the-threat-is-2", [Some(13), Some(-4), Some(-17)]),
    ("hostile-memory", [Some(-39), Some(-29), Some(-11)]),
    ("housing-research", [Some(-20), Some(-1), Some(4)]),
    ("idle-faith-patronage", [Some(15), Some(-14), Some(-11)]),
    ("improvement-housing-value", [Some(-14), Some(-32), Some(-21)]),
    ("industrial-chain-debt", [Some(9), Some(-32), Some(16)]),
    ("island-exploration", [Some(22), Some(8), Some(-2)]),
    ("lane-culture-spending", [Some(3), Some(1), Some(-8)]),
    ("lane-great-people", [Some(9), Some(-11), Some(-3)]),
    ("lane-policy-deck", [Some(-18), Some(-9), Some(0)]),
    ("lane-release-when-hopeless", [Some(-14), Some(-30), Some(-10)]),
    ("lane-space-race", [Some(30), Some(-4), Some(7)]),
    ("lane-votes-its-favor", [Some(-18), Some(39), Some(12)]),
    ("loyalty-rate-alarm", [Some(51), Some(32), Some(61)]),
    ("maintenance-aware-deck", [Some(11), Some(24), Some(8)]),
    ("missionary-evades-raiders", [Some(18), Some(56), Some(18)]),
    ("missionary-last-charge-explores", [Some(2), Some(-30), Some(-1)]),
    ("missionary-last-charge-explores-2", [Some(-16), Some(-2), None]),
    ("modernize-before-spending", [Some(-6), Some(36), Some(-6)]),
    ("moksha-defends-the-faithless", [Some(-16), Some(-18), Some(-13)]),
    ("native-emergency-purchase", [Some(-23), Some(0), Some(-13)]),
    ("native-emergency-purchase-2", [Some(14), Some(-6), Some(15)]),
    ("naval-recon", [Some(8), Some(99), Some(8)]),
    ("naval-recon-2", [Some(-16), Some(-31), Some(12)]),
    ("naval-recon-3", [Some(11), Some(-27), Some(-4)]),
    ("naval-threat-triage", [Some(7), Some(-9), Some(18)]),
    ("never-an-empty-queue", [Some(7), Some(15), Some(5)]),
    ("never-an-empty-queue-2", [Some(7), Some(17), Some(2)]),
    ("never-an-empty-queue-3", [Some(-5), Some(4), Some(1)]),
    ("no-free-passage", [Some(-17), Some(-23), Some(-7)]),
    ("objective-board", [Some(-4), Some(-51), Some(-27)]),
    ("one-launch-pad", [Some(-2), Some(45), Some(-4)]),
    ("one-shot-recovery", [Some(-5), Some(-13), Some(-25)]),
    ("one-war-at-a-time", [Some(-21), Some(-14), Some(6)]),
    ("opening-warrior-recon", [Some(-25), Some(-46), Some(-28)]),
    ("opening-warrior-recon-2", [Some(22), Some(-13), Some(33)]),
    ("opportunistic-war", [Some(-13), Some(21), Some(-20)]),
    ("order-retry", [Some(-18), Some(-16), Some(9)]),
    ("overseas-settlement", [Some(6), Some(1), Some(3)]),
    ("pantheon-board", [Some(7), Some(19), Some(6)]),
    ("pass-picket", [Some(0), Some(-41), Some(-16)]),
    ("peace-when-the-war-does-not-pay", [Some(-3), Some(-87), Some(10)]),
    ("peacetime-deterrence", [Some(2), Some(4), Some(-22)]),
    ("power-the-laboratory", [Some(1), Some(-1), Some(2)]),
    ("power-the-laboratory-2", [Some(-10), Some(18), Some(3)]),
    ("price-the-suzerainty", [Some(29), Some(5), Some(3)]),
    ("promote-when-wounded", [Some(24), Some(21), Some(7)]),
    ("quest-boost", [Some(24), Some(-24), Some(9)]),
    ("quest-camp-errand", [Some(-7), Some(-24), Some(20)]),
    ("quest-production", [Some(-2), Some(-49), Some(-8)]),
    ("quest-trade-route", [Some(19), Some(25), Some(8)]),
    ("raid-pillage-prizes", [Some(7), Some(4), Some(-14)]),
    ("rapid-city-expansion", [Some(-163), Some(-206), Some(-166)]),
    ("rapid-city-expansion-2", [Some(108), Some(164), Some(98)]),
    ("recon-replacement", [Some(0), Some(30), Some(17)]),
    ("recorded-tactical-step", [Some(-2), Some(-10), Some(-10)]),
    ("recovery-reads-the-war", [Some(-1), Some(21), Some(-3)]),
    ("recovery-reads-the-war-2", [Some(-9), Some(-12), Some(11)]),
    ("relief-column-marches", [Some(4), Some(-6), Some(-7)]),
    ("relief-targets-the-siege", [Some(36), Some(20), Some(-6)]),
    ("religion-race-is-closed", [Some(7), Some(3), Some(-4)]),
    ("religion-sues-peace", [Some(-5), Some(25), Some(8)]),
    ("religious-defence-scales", [Some(23), Some(-12), Some(3)]),
    ("religious-units-heal-first", [Some(15), Some(0), Some(16)]),
    ("religious-veto-defence", [Some(44), Some(-18), Some(26)]),
    ("requisitions", [Some(-31), Some(36), Some(-5)]),
    ("research-tier-premium", [Some(-24), Some(4), Some(-11)]),
    ("rival-suzerainty-alarm", [Some(-5), Some(-8), Some(0)]),
    ("route-block-is-a-wait", [Some(-17), Some(-26), None]),
    ("safest-stand", [Some(-24), Some(32), Some(21)]),
    ("science-building-first", [Some(32), Some(46), Some(0)]),
    ("science-chain-alarm", [Some(-9), Some(1), Some(1)]),
    ("science-expansion-phase", [Some(-19), Some(-1), Some(8)]),
    ("science-multiplier-payoff", [Some(0), Some(10), Some(18)]),
    ("science-opening-band", [Some(-5), Some(9), Some(29)]),
    ("science-victory-drive", [Some(20), Some(-12), Some(7)]),
    ("science-victory-drive-2", [Some(28), Some(8), Some(38)]),
    ("score-horizon", [Some(-17), Some(-77), Some(-5)]),
    ("screen-the-shooters", [Some(-1), Some(8), Some(11)]),
    ("settle-sooner", [Some(3), Some(-17), Some(6)]),
    ("settlement-gap-target", [Some(4), Some(4), Some(-14)]),
    ("settler-backlog-brake", [Some(-18), Some(39), Some(-6)]),
    ("settler-backlog-brake-2", [Some(11), Some(4), Some(8)]),
    ("settler-factory-coordination", [Some(-5), Some(-13), Some(-4)]),
    ("settler-guard-holds", [Some(-21), Some(-14), Some(-10)]),
    ("settler-guard-holds-2", [Some(-11), Some(16), Some(1)]),
    ("settler-never-idles", [Some(21), Some(44), Some(24)]),
    ("settler-screen", [Some(-5), Some(-27), Some(29)]),
    ("settler-second-look", [Some(19), Some(-25), Some(-6)]),
    ("settler-site-gate", [Some(3), Some(-23), Some(14)]),
    ("settler-target-floor", [Some(-11), Some(-55), Some(-3)]),
    ("settler-target-hysteresis", [Some(10), Some(0), Some(4)]),
    ("settler-target-hysteresis-2", [Some(-18), Some(-36), Some(-5)]),
    ("settler-threat-detour", [Some(7), Some(50), Some(0)]),
    ("settler-walk-deadline", [Some(-3), Some(-2), Some(17)]),
    ("siege-commitment", [Some(27), Some(3), Some(17)]),
    ("siege-is-progress-2", [Some(-20), Some(-47), Some(3)]),
    ("siege-is-progress-3", [Some(10), Some(14), Some(9)]),
    ("siege-preempts-the-queue", [Some(11), Some(-21), Some(-2)]),
    ("siege-train", [Some(-14), Some(30), Some(16)]),
    ("skip-the-prophet-race", [Some(-51), Some(-24), Some(4)]),
    ("skip-the-prophet-race-2", [Some(26), Some(17), Some(13)]),
    ("slot-kind-tiebreak", [Some(-12), Some(0), Some(5)]),
    ("solvency-first-trade-slot", [Some(71), Some(84), Some(66)]),
    ("spaceport-surplus-veto", [Some(-12), Some(28), Some(5)]),
    ("standing-still-is-a-risk", [Some(1), Some(-15), None]),
    ("stranded-settler-discount", [Some(13), Some(2), Some(21)]),
    ("strategic-wonders", [Some(4), Some(11), Some(-13)]),
    ("strike-opening", [Some(14), Some(10), Some(-9)]),
    ("strike-reach", [Some(-7), Some(-46), Some(-10)]),
    ("surprise-war-mobilization", [Some(-31), Some(17), Some(18)]),
    ("swap-rotation", [Some(-20), Some(35), Some(15)]),
    ("swap-rotation-2", [Some(20), Some(-10), Some(15)]),
    ("threatened-city-reserve", [Some(-8), Some(21), Some(-11)]),
    ("trade-route-network", [Some(-9), Some(3), Some(2)]),
    ("treasury-at-work", [Some(15), Some(15), Some(17)]),
    ("treasury-at-work-2", [Some(21), Some(32), Some(8)]),
    ("unchosen-war-keeps-the-lane", [Some(6), Some(30), Some(-18)]),
    ("unit-cost-efficiency", [Some(17), Some(-63), Some(-8)]),
    ("unit-objective-memory", [Some(-2), Some(-32), Some(-14)]),
    ("upgrade-the-garrison", [Some(-4), Some(18), Some(-6)]),
    ("veterans-withdraw-early", [Some(-2), Some(-14), Some(0)]),
    ("walls-after-districts", [Some(-16), Some(-40), Some(12)]),
    ("war-economy", [Some(1), Some(-54), Some(9)]),
    ("war-needs-a-treasury", [Some(27), Some(12), Some(-10)]),
    ("war-policy-via-board", [Some(13), Some(15), Some(15)]),
    ("war-reinforcement", [Some(0), Some(-31), Some(-10)]),
    ("whole-turn-backtrack-guard", [Some(-13), Some(-2), Some(-14)]),
    ("wide-map-capacity", [Some(-7), Some(10), Some(33)]),
    ("wonder-adjacent-sites", [Some(-3), Some(29), Some(38)]),
    ("wonder-adjacent-sites-2", [Some(6), Some(-62), Some(-26)]),
    ("wonder-ring-recon", [Some(15), Some(15), Some(5)]),
    ("wonder-ring-recon-2", [Some(-16), None, None]),
    ("wonder-score-tally", [Some(-26), Some(5), Some(-1)]),
    ("wounded-out-of-reach", [Some(-19), Some(3), Some(5)]),
];
