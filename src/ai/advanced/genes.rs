...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(-20), Some(-11), Some(0)]),
    ("air-surge", [Some(29), Some(18), Some(30)]),
    ("amenity-district-path", [Some(-12), Some(35), Some(9)]),
    ("amenity-project-preemption", [Some(-29), Some(11), Some(24)]),
    ("amenity-project-preemption-2", [Some(25), Some(-17), Some(-14)]),
    ("apostle-promotion-by-role", [Some(10), Some(-1), Some(7)]),
    ("army-target-weighs-enemy", [Some(3), Some(19), Some(1)]),
    ("barbarian-bargain", [Some(2), Some(14), Some(14)]),
    ("barbarian-ranged-answer", [Some(-20), Some(-14), Some(20)]),
    ("barbarian-scouts-are-scouts", [Some(-3), Some(-23), Some(11)]),
    ("barbarian-settler-capture", [Some(19), Some(35), Some(34)]),
    ("blind-objective-strength", [Some(12), Some(-19), Some(9)]),
    ("blind-objective-units", [Some(-16), Some(20), Some(0)]),
    ("boost-first-research", [Some(-21), Some(4), Some(-12)]),
    ("boost-unlock-research", [Some(8), Some(-23), Some(1)]),
    ("boost-wait-research", [Some(-3), Some(-8), Some(-23)]),
    ("boosted-bargain-first", [Some(-20), Some(-39), Some(9)]),
    ("border-parity", [Some(3), Some(9), Some(-5)]),
    ("border-parity-2", [Some(-6), Some(-10), Some(-13)]),
    ("bounded-recovery", [Some(-19), Some(9), Some(10)]),
    ("build-what-cards-boost", [Some(17), Some(-9), Some(-9)]),
    ("builder-barbarian-safety", [Some(-18), Some(-5), Some(1)]),
    ("builder-supply-floor", [Some(8), Some(-17), Some(-26)]),
    ("builder-tries-the-next-tile", [Some(24), Some(-23), Some(-3)]),
    ("buildings-before-projects", [Some(-16), Some(-26), Some(19)]),
    ("buy-what-cards-cannot-boost", [Some(-1), Some(24), Some(-7)]),
    ("camp-party", [Some(-7), Some(-3), Some(-14)]),
    ("camp-tile-buyout", [Some(1), Some(-22), Some(19)]),
    ("campaign-pillage", [Some(17), Some(-6), Some(-14)]),
    ("campus-adjacency-threshold", [Some(-20), Some(22), Some(-25)]),
    ("campus-adjacency-threshold-2", [Some(4), Some(-20), Some(13)]),
    ("canal-city", [Some(24), Some(19), Some(5)]),
    ("capital-settler-after-completion", [Some(26), Some(23), Some(-16)]),
    ("capture-go-or-stand-down", [Some(-19), Some(-25), Some(-1)]),
    ("capture-go-or-stand-down-2", [Some(-1), Some(25), Some(8)]),
    ("chain-payback-window", [Some(2), Some(-6), Some(-5)]),
    ("chain-payback-window-2", [Some(13), Some(-26), Some(-19)]),
    ("cheapest-wonder-first", [Some(29), Some(-10), Some(-11)]),
    ("chokepoint-claim", [Some(17), Some(-19), Some(2)]),
    ("chokepoint-garrison", [Some(10), Some(-1), Some(-6)]),
    ("chokepoint-siting", [Some(19), Some(22), Some(-5)]),
    ("chop-into-the-queue", [Some(-15), Some(-17), Some(-22)]),
    ("city-campaign", [Some(4), Some(-19), Some(-16)]),
    ("city-target-meets-the-map", [Some(26), Some(-14), Some(6)]),
    ("civilian-out-of-reach", [Some(-41), Some(14), Some(2)]),
    ("close-as-a-body", [Some(3), Some(-10), Some(-5)]),
    ("coalition-before-war", [Some(-24), Some(-20), Some(-5)]),
    ("coastal-city-sites", [Some(-13), Some(-2), Some(9)]),
    ("coastal-city-sites-2", [Some(2), Some(-8), Some(-1)]),
    ("come-ashore", [Some(5), Some(-42), Some(10)]),
    ("commitment-patience", [Some(21), Some(26), Some(1)]),
    ("competition-victory-points", [Some(2), Some(12), Some(36)]),
    ("congress-counter-leader", [Some(-23), Some(-23), Some(-11)]),
    ("connect-the-luxury", [Some(39), Some(66), Some(29)]),
    ("contested-land-first", [Some(19), Some(41), Some(4)]),
    ("conversion-majority-alarm", [Some(-33), Some(6), Some(-9)]),
    ("coordinated-finish", [Some(11), Some(-2), Some(-7)]),
    ("culture-building-debt", [Some(13), Some(24), Some(-22)]),
    ("culture-floor", [Some(-18), Some(8), Some(4)]),
    ("culture-lane-forecast", [Some(-8), Some(29), Some(24)]),
    ("deals-at-the-ceiling", [Some(-7), Some(7), Some(23)]),
    ("deals-for-our-gain", [Some(-30), Some(-2), Some(-12)]),
    ("defend-where-you-stand", [Some(-7), Some(-44), Some(-4)]),
    ("defensible-sites", [Some(16), Some(3), Some(24)]),
    ("diplomatic-lane-forecast", [Some(-31), Some(-30), Some(-14)]),
    ("district-coverage", [Some(3), Some(-18), Some(-7)]),
    ("district-coverage-2", [Some(3), Some(17), Some(-2)]),
    ("district-planning", [Some(14), Some(1), Some(0)]),
    ("domination-city-count", [Some(2), Some(26), Some(20)]),
    ("early-archers", [Some(9), Some(-15), Some(18)]),
    ("early-contact-window", [Some(-12), Some(8), Some(17)]),
    ("early-project-restraint", [Some(-10), Some(-9), Some(-10)]),
    ("elective-war-in-reach", [Some(16), Some(-5), Some(6)]),
    ("elective-war-yields-to-a-lane", [Some(67), Some(24), Some(32)]),
    ("encampment-seals-the-pass", [Some(-7), Some(18), Some(13)]),
    ("enemy-of-my-enemy", [Some(7), Some(6), Some(15)]),
    ("engine-faith-price", [Some(22), Some(5), Some(17)]),
    ("enhancer-for-the-corps", [Some(-2), Some(14), Some(-15)]),
    ("enter-the-prophet-race", [Some(-41), Some(-30), Some(35)]),
    ("escort-cap-holds", [Some(-18), Some(46), Some(-9)]),
    ("escort-unstick", [Some(35), Some(-28), Some(19)]),
    ("eureka-chasing-builder", [Some(1), Some(-20), Some(-16)]),
    ("eureka-chasing-production", [Some(11), Some(-19), Some(19)]),
    ("exchange-is-the-engines", [Some(13), Some(2), Some(13)]),
    ("exhaustion-loyalty-guard", [Some(5), Some(-7), Some(2)]),
    ("expansion-pays-back", [Some(7), Some(21), Some(-10)]),
    ("expansion-schedule", [Some(8), Some(17), Some(8)]),
    ("fire-plan", [Some(18), Some(-6), Some(-10)]),
    ("first-builder-reserve", [Some(-14), Some(9), Some(-18)]),
    ("first-district-first", [Some(-5), Some(-5), Some(-8)]),
    ("first-granary-reserve", [Some(7), Some(-8), Some(-5)]),
    ("first-luxury-first", [Some(17), Some(15), Some(1)]),
    ("first-research-building-reserve", [Some(-2), Some(-5), Some(7)]),
    ("flip-nearby-city-states", [Some(3), Some(3), Some(-6)]),
    ("founder-temple", [Some(3), Some(17), Some(18)]),
    ("frontier-massing-alarm", [Some(6), Some(0), Some(-12)]),
    ("garrison-under-fire", [Some(-28), Some(10), Some(-8)]),
    ("gold-for-the-young-city", [Some(-9), Some(30), Some(8)]),
    ("gold-income-floor", [Some(4), Some(18), Some(-15)]),
    ("government-capacity-fallback", [Some(-10), Some(-23), Some(-13)]),
    ("government-ladder", [Some(-29), Some(-9), Some(-25)]),
    ("government-ladder-2", [Some(28), Some(-9), Some(36)]),
    ("great-person-housing", [Some(23), Some(26), Some(22)]),
    ("growth-to-settle", [Some(10), Some(-8), Some(0)]),
    ("guru-heals-the-corps-2", [Some(-4), Some(5), Some(12)]),
    ("holy-lane-parity", [Some(5), Some(4), Some(3)]),
    ("holy-site-where-the-threat-is", [Some(-9), Some(-6), Some(12)]),
    ("holy-site-where-the-threat-is-2", [Some(8), Some(37), Some(-10)]),
    ("hostile-memory", [Some(-22), Some(-23), Some(-5)]),
    ("housing-research", [Some(-16), Some(8), Some(2)]),
    ("idle-faith-patronage", [Some(6), Some(26), Some(9)]),
    ("improvement-housing-value", [Some(-4), Some(18), Some(-12)]),
    ("island-exploration", [Some(-23), Some(46), Some(0)]),
    ("lane-culture-spending", [Some(11), Some(-11), Some(22)]),
    ("lane-great-people", [Some(-4), Some(-24), Some(-7)]),
    ("lane-policy-deck", [Some(5), Some(-13), Some(-1)]),
    ("lane-release-when-hopeless", [Some(11), Some(3), Some(-28)]),
    ("lane-space-race", [Some(7), Some(-13), Some(-12)]),
    ("lane-votes-its-favor", [Some(-15), Some(6), Some(1)]),
    ("loyalty-rate-alarm", [Some(39), Some(8), Some(54)]),
    ("maintenance-aware-deck", [Some(-2), Some(25), Some(35)]),
    ("missionary-evades-raiders", [Some(17), Some(10), Some(21)]),
    ("missionary-last-charge-explores", [Some(-5), Some(42), Some(16)]),
    ("moksha-defends-the-faithless", [Some(-7), Some(18), Some(-24)]),
    ("native-emergency-purchase", [Some(-38), Some(-33), Some(2)]),
    ("naval-recon", [Some(1), Some(29), Some(9)]),
    ("naval-recon-2", [Some(-39), Some(-17), Some(-10)]),
    ("naval-threat-triage", [Some(-4), Some(14), Some(1)]),
    ("never-an-empty-queue", [Some(-2), Some(-19), Some(-18)]),
    ("never-an-empty-queue-2", [Some(-23), Some(-21), Some(-11)]),
    ("no-free-passage", [Some(11), Some(-2), Some(-2)]),
    ("one-launch-pad", [Some(-13), Some(-2), Some(-7)]),
    ("one-shot-recovery", [Some(-7), Some(17), Some(-14)]),
    ("one-war-at-a-time", [Some(-1), Some(-1), Some(7)]),
    ("opening-warrior-recon", [Some(-26), Some(4), Some(-27)]),
    ("opportunistic-war", [Some(12), Some(18), Some(0)]),
    ("order-retry", [Some(-15), Some(-11), Some(-14)]),
    ("overseas-settlement", [Some(7), Some(-20), Some(-7)]),
    ("pantheon-board", [Some(18), Some(36), Some(6)]),
    ("pass-picket", [Some(2), Some(14), Some(0)]),
    ("peace-when-the-war-does-not-pay", [Some(19), Some(-27), Some(25)]),
    ("peacetime-deterrence", [Some(27), Some(-37), Some(10)]),
    ("power-the-laboratory", [Some(7), Some(15), Some(-8)]),
    ("power-the-laboratory-2", [Some(20), Some(-23), Some(-7)]),
    ("price-the-suzerainty", [Some(2), Some(51), Some(1)]),
    ("promote-when-wounded", [Some(9), Some(1), Some(0)]),
    ("quest-boost", [Some(-5), Some(25), Some(-13)]),
    ("quest-camp-errand", [Some(-16), Some(-16), Some(11)]),
    ("quest-production", [Some(12), Some(-40), Some(-25)]),
    ("quest-trade-route", [Some(8), Some(10), Some(19)]),
    ("raid-pillage-prizes", [Some(-17), Some(7), Some(-7)]),
    ("rapid-city-expansion", [Some(-60), Some(-118), Some(-104)]),
    ("recon-replacement", [Some(-13), Some(46), Some(-4)]),
    ("recorded-tactical-step", [Some(1), Some(45), Some(25)]),
    ("recovery-reads-the-war", [Some(-8), Some(36), Some(-26)]),
    ("relief-column-marches", [Some(0), Some(-12), Some(12)]),
    ("relief-targets-the-siege", [Some(-25), Some(-2), Some(13)]),
    ("religion-race-is-closed", [Some(-6), Some(37), Some(21)]),
    ("religion-sues-peace", [Some(-16), Some(17), Some(-8)]),
    ("religious-defence-scales", [Some(-7), Some(23), Some(-5)]),
    ("religious-units-heal-first", [Some(-14), Some(18), Some(-26)]),
    ("religious-veto-defence", [Some(-24), Some(-4), Some(12)]),
    ("research-tier-premium", [Some(-2), Some(-33), Some(3)]),
    ("rival-suzerainty-alarm", [Some(-2), Some(11), Some(-4)]),
    ("science-building-first", [Some(13), Some(25), Some(28)]),
    ("science-chain-alarm", [Some(13), Some(10), Some(12)]),
    ("science-expansion-phase", [Some(25), Some(-22), Some(-1)]),
    ("science-multiplier-payoff", [Some(8), Some(5), Some(1)]),
    ("science-opening-band", [Some(7), Some(40), Some(12)]),
    ("science-victory-drive", [Some(-4), Some(20), Some(16)]),
    ("science-victory-drive-2", [Some(23), Some(-13), Some(12)]),
    ("score-horizon", [Some(-17), Some(-32), Some(-27)]),
    ("screen-the-shooters", [Some(-9), Some(0), Some(18)]),
    ("settle-sooner", [Some(45), Some(29), Some(18)]),
    ("settlement-gap-target", [Some(21), Some(-17), Some(12)]),
    ("settler-backlog-brake", [Some(-14), Some(-12), Some(0)]),
    ("settler-factory-coordination", [Some(-7), Some(7), Some(-21)]),
    ("settler-guard-holds", [Some(1), Some(-16), Some(-31)]),
    ("settler-guard-holds-2", [Some(6), Some(13), Some(6)]),
    ("settler-never-idles", [Some(7), Some(-27), Some(27)]),
    ("settler-screen", [Some(-29), Some(-29), Some(7)]),
    ("settler-second-look", [Some(-23), Some(28), Some(4)]),
    ("settler-target-hysteresis", [Some(11), Some(-5), Some(-2)]),
    ("settler-target-hysteresis-2", [Some(5), Some(-1), Some(0)]),
    ("settler-threat-detour", [Some(14), Some(10), Some(1)]),
    ("siege-commitment", [Some(9), Some(-21), Some(-26)]),
    ("siege-is-progress-2", [Some(-1), Some(-19), Some(-16)]),
    ("skip-the-prophet-race", [Some(-12), Some(2), Some(-115)]),
    ("slot-kind-tiebreak", [Some(21), Some(16), Some(-7)]),
    ("solvency-first-trade-slot", [Some(120), Some(108), Some(111)]),
    ("stranded-settler-discount", [Some(-19), Some(-18), Some(31)]),
    ("strategic-wonders", [Some(-10), Some(0), Some(6)]),
    ("strike-opening", [Some(-10), Some(-15), Some(-5)]),
    ("surprise-war-mobilization", [Some(-4), Some(18), Some(-4)]),
    ("swap-rotation", [Some(-17), Some(-15), Some(-2)]),
    ("threatened-city-reserve", [Some(12), Some(-3), Some(10)]),
    ("treasury-at-work", [Some(-9), Some(10), Some(-1)]),
    ("treasury-at-work-2", [Some(17), Some(29), Some(4)]),
    ("unchosen-war-keeps-the-lane", [Some(-1), Some(1), Some(8)]),
    ("unit-cost-efficiency", [Some(4), Some(-9), Some(-17)]),
    ("unit-objective-memory", [Some(11), Some(-5), Some(14)]),
    ("upgrade-the-garrison", [Some(-7), Some(-33), Some(7)]),
    ("walls-after-districts", [Some(-5), Some(-14), Some(-9)]),
    ("war-economy", [Some(23), Some(-1), Some(-8)]),
    ("war-needs-a-treasury", [Some(1), Some(-27), Some(15)]),
    ("war-reinforcement", [Some(1), Some(15), Some(8)]),
    ("whole-turn-backtrack-guard", [Some(1), Some(-3), Some(0)]),
    ("wide-map-capacity", [Some(19), Some(21), Some(30)]),
    ("wonder-adjacent-sites", [Some(5), Some(32), Some(15)]),
    ("wonder-adjacent-sites-2", [Some(-11), Some(-6), Some(-12)]),
    ("wonder-ring-recon", [Some(-11), Some(5), Some(-2)]),
    ("wonder-score-tally", [Some(-13), Some(1), Some(3)]),
];
