...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("air-surge", [Some(0), Some(-10), Some(15)]),
    ("amenity-district-path", [Some(-15), Some(-9), Some(13)]),
    ("amenity-project-preemption", [Some(30), Some(20), Some(-34)]),
    ("amenity-project-preemption-2", [Some(-34), Some(-14), Some(19)]),
    ("apostle-promotion-by-role", [Some(-9), Some(6), Some(-24)]),
    ("army-target-weighs-enemy", [Some(0), Some(-4), Some(26)]),
    ("barbarian-bargain", [Some(14), Some(19), Some(11)]),
    ("barbarian-ranged-answer", [Some(8), Some(10), Some(7)]),
    ("barbarian-scouts-are-scouts", [Some(34), Some(8), Some(26)]),
    ("barbarian-settler-capture", [Some(51), Some(23), None]),
    ("blind-objective-strength", [Some(8), Some(30), Some(-28)]),
    ("blind-objective-units", [Some(-4), Some(-16), Some(-14)]),
    ("boost-first-research", [Some(-13), Some(-16), Some(-35)]),
    ("boost-unlock-research", [Some(-25), Some(-43), Some(-30)]),
    ("boost-wait-research", [Some(3), Some(-3), Some(20)]),
    ("bounded-recovery", [Some(8), Some(26), Some(-21)]),
    ("build-what-cards-boost", [Some(-21), Some(-20), Some(-27)]),
    ("builder-barbarian-safety", [Some(-17), Some(3), Some(-1)]),
    ("builder-supply-floor", [Some(-10), Some(0), Some(-1)]),
    ("builder-tries-the-next-tile", [Some(-4), Some(12), Some(-14)]),
    ("buildings-before-projects", [Some(16), Some(-7), Some(12)]),
    ("buy-what-cards-cannot-boost", [Some(-2), Some(9), Some(-9)]),
    ("camp-party", [Some(8), Some(2), Some(-1)]),
    ("camp-tile-buyout", [Some(6), Some(8), Some(4)]),
    ("campaign-pillage", [Some(-19), Some(-20), Some(-12)]),
    ("campus-adjacency-threshold", [Some(-2), Some(9), Some(17)]),
    ("campus-adjacency-threshold-2", [Some(-2), Some(-15), Some(-5)]),
    ("canal-city", [Some(17), Some(8), Some(10)]),
    ("chain-payback-window", [Some(3), Some(-2), Some(8)]),
    ("chain-payback-window-2", [Some(13), Some(18), Some(-1)]),
    ("chokepoint-claim", [Some(2), Some(12), Some(-5)]),
    ("chokepoint-garrison", [Some(-7), Some(11), Some(-18)]),
    ("chokepoint-siting", [Some(12), Some(-15), Some(-14)]),
    ("chop-into-the-queue", [Some(-28), Some(11), Some(7)]),
    ("city-campaign", [Some(-41), Some(1), Some(-18)]),
    ("city-target-meets-the-map", [Some(1), Some(-5), Some(-6)]),
    ("civilian-out-of-reach", [Some(29), Some(20), Some(31)]),
    ("close-as-a-body", [Some(21), Some(-1), None]),
    ("coalition-before-war", [Some(12), Some(2), Some(31)]),
    ("coastal-city-sites", [Some(-4), Some(23), None]),
    ("coastal-city-sites-2", [Some(-7), Some(0), None]),
    ("come-ashore", [Some(5), Some(22), Some(10)]),
    ("competition-victory-points", [Some(10), Some(-12), Some(-17)]),
    ("congress-counter-leader", [Some(-7), Some(-6), Some(25)]),
    ("contested-land-first", [Some(6), Some(25), Some(24)]),
    ("conversion-majority-alarm", [Some(0), Some(13), Some(12)]),
    ("coordinated-finish", [Some(-5), Some(-5), Some(-20)]),
    ("culture-building-debt", [Some(-24), Some(0), Some(24)]),
    ("culture-floor", [Some(-4), None, None]),
    ("culture-lane-forecast", [Some(-11), Some(-11), Some(10)]),
    ("deals-at-the-ceiling", [Some(14), Some(-2), Some(18)]),
    ("deals-for-our-gain", [Some(-12), Some(-1), Some(-8)]),
    ("defend-where-you-stand", [Some(15), None, None]),
    ("defensible-sites", [Some(32), Some(19), Some(17)]),
    ("diplomatic-lane-forecast", [Some(-4), Some(-21), Some(-21)]),
    ("district-coverage", [Some(36), Some(14), Some(-8)]),
    ("district-coverage-2", [Some(-9), Some(-4), Some(-1)]),
    ("district-planning", [Some(4), Some(16), Some(-30)]),
    ("domination-city-count", [Some(-9), Some(12), Some(0)]),
    ("early-archers", [Some(18), None, None]),
    ("early-contact-window", [Some(9), Some(-1), Some(-29)]),
    ("elective-war-in-reach", [Some(4), Some(10), Some(-1)]),
    ("elective-war-yields-to-a-lane", [Some(26), Some(28), Some(23)]),
    ("encampment-seals-the-pass", [Some(-3), Some(-1), Some(-5)]),
    ("enemy-of-my-enemy", [Some(-1), Some(29), Some(13)]),
    ("engine-faith-price", [Some(22), Some(-15), Some(59)]),
    ("enhancer-for-the-corps", [Some(26), Some(20), Some(-11)]),
    ("escort-unstick", [Some(20), Some(-13), Some(25)]),
    ("eureka-chasing-builder", [Some(-5), Some(-16), Some(-17)]),
    ("eureka-chasing-production", [Some(-9), Some(-34), Some(25)]),
    ("exchange-is-the-engines", [Some(21), None, None]),
    ("expansion-pays-back", [Some(8), Some(10), Some(17)]),
    ("expansion-schedule", [Some(15), Some(-7), Some(18)]),
    ("fire-plan", [Some(-9), Some(-5), None]),
    ("first-builder-reserve", [Some(-18), Some(-25), Some(-14)]),
    ("first-research-building-reserve", [Some(0), Some(-5), Some(-1)]),
    ("flip-nearby-city-states", [Some(8), Some(10), Some(-4)]),
    ("founder-temple", [Some(-7), Some(22), Some(-5)]),
    ("frontier-massing-alarm", [Some(-2), Some(-15), Some(-2)]),
    ("garrison-under-fire", [Some(21), Some(-11), Some(17)]),
    ("gold-for-the-young-city", [Some(10), Some(11), Some(-6)]),
    ("gold-income-floor", [Some(14), None, None]),
    ("government-capacity-fallback", [Some(3), Some(-13), Some(5)]),
    ("government-ladder", [Some(-20), Some(-13), Some(3)]),
    ("government-ladder-2", [Some(10), Some(-21), Some(-16)]),
    ("great-person-housing", [Some(13), Some(-4), Some(11)]),
    ("growth-to-settle", [Some(0), Some(-21), Some(16)]),
    ("guru-heals-the-corps-2", [Some(5), Some(39), Some(27)]),
    ("holy-lane-parity", [Some(12), Some(-21), Some(-38)]),
    ("holy-site-where-the-threat-is", [Some(33), Some(27), Some(-7)]),
    ("holy-site-where-the-threat-is-2", [Some(-12), Some(-15), Some(15)]),
    ("housing-research", [Some(-1), Some(3), Some(-19)]),
    ("idle-faith-patronage", [Some(28), Some(9), Some(-23)]),
    ("improvement-housing-value", [Some(18), Some(-14), Some(-6)]),
    ("lane-culture-spending", [Some(-2), Some(-21), Some(-12)]),
    ("lane-great-people", [Some(21), Some(24), Some(-14)]),
    ("lane-policy-deck", [Some(8), Some(5), Some(-7)]),
    ("lane-release-when-hopeless", [Some(24), Some(-4), Some(-14)]),
    ("lane-space-race", [Some(-5), Some(2), Some(-5)]),
    ("lane-votes-its-favor", [Some(16), Some(-19), Some(-15)]),
    ("loyalty-rate-alarm", [Some(38), Some(9), Some(42)]),
    ("maintenance-aware-deck", [Some(24), Some(10), Some(12)]),
    ("missionary-evades-raiders", [Some(25), Some(-4), Some(48)]),
    ("missionary-last-charge-explores", [Some(9), Some(10), Some(2)]),
    ("moksha-defends-the-faithless", [Some(1), Some(-27), Some(25)]),
    ("native-emergency-purchase", [Some(-15), Some(4), Some(-19)]),
    ("naval-recon", [Some(-22), Some(-11), Some(8)]),
    ("naval-recon-2", [Some(-3), Some(7), Some(-6)]),
    ("naval-threat-triage", [Some(3), Some(14), Some(9)]),
    ("never-an-empty-queue", [Some(20), Some(-34), Some(-19)]),
    ("never-an-empty-queue-2", [Some(-29), Some(21), Some(19)]),
    ("no-free-passage", [Some(13), Some(-18), Some(29)]),
    ("one-launch-pad", [Some(0), Some(-13), Some(22)]),
    ("one-shot-recovery", [Some(8), Some(18), Some(37)]),
    ("one-war-at-a-time", [Some(-1), Some(11), Some(29)]),
    ("opening-warrior-recon", [Some(-35), Some(-31), Some(-5)]),
    ("opportunistic-war", [Some(2), Some(11), Some(14)]),
    ("order-retry", [Some(0), Some(18), Some(11)]),
    ("pantheon-board", [Some(-17), Some(7), Some(-11)]),
    ("pass-picket", [Some(-14), Some(-8), Some(-20)]),
    ("peace-when-the-war-does-not-pay", [Some(9), Some(6), Some(23)]),
    ("peacetime-deterrence", [Some(3), Some(14), Some(21)]),
    ("power-the-laboratory", [Some(4), Some(20), Some(-22)]),
    ("power-the-laboratory-2", [Some(6), Some(7), Some(2)]),
    ("price-the-suzerainty", [Some(-9), Some(12), Some(26)]),
    ("promote-when-wounded", [Some(-1), Some(4), Some(18)]),
    ("quest-boost", [Some(15), Some(11), Some(-14)]),
    ("quest-camp-errand", [Some(-5), Some(2), Some(-8)]),
    ("quest-production", [Some(24), Some(21), Some(7)]),
    ("quest-trade-route", [Some(6), Some(13), Some(11)]),
    ("raid-pillage-prizes", [Some(8), Some(-3), Some(14)]),
    ("rapid-city-expansion", [Some(-122), Some(-94), Some(-81)]),
    ("recon-replacement", [Some(6), Some(8), Some(11)]),
    ("recorded-tactical-step", [Some(-17), Some(-9), Some(-12)]),
    ("recovery-reads-the-war", [Some(-3), Some(0), Some(-15)]),
    ("relief-targets-the-siege", [Some(-7), Some(8), Some(45)]),
    ("religion-race-is-closed", [Some(22), Some(5), Some(11)]),
    ("religion-sues-peace", [Some(-6), Some(-12), Some(-16)]),
    ("religious-defence-scales", [Some(14), Some(-6), Some(-2)]),
    ("religious-units-heal-first", [Some(-11), Some(8), Some(0)]),
    ("religious-veto-defence", [Some(8), Some(20), Some(10)]),
    ("research-tier-premium", [Some(-13), Some(-25), Some(42)]),
    ("rival-suzerainty-alarm", [Some(-19), Some(5), Some(32)]),
    ("science-building-first", [Some(-29), Some(-22), Some(1)]),
    ("science-chain-alarm", [Some(9), Some(8), Some(-6)]),
    ("science-multiplier-payoff", [Some(5), Some(1), Some(11)]),
    ("science-victory-drive", [Some(52), Some(0), Some(9)]),
    ("score-horizon", [Some(19), Some(-7), Some(12)]),
    ("screen-the-shooters", [Some(-4), Some(-5), None]),
    ("settle-sooner", [Some(36), Some(1), Some(4)]),
    ("settlement-gap-target", [Some(9), Some(0), Some(-5)]),
    ("settler-factory-coordination", [Some(2), Some(-3), Some(-6)]),
    ("settler-guard-holds", [Some(-2), Some(20), Some(15)]),
    ("settler-guard-holds-2", [Some(-1), Some(-9), Some(14)]),
    ("settler-screen", [Some(3), Some(2), Some(0)]),
    ("settler-second-look", [Some(-14), Some(-48), Some(-4)]),
    ("settler-target-hysteresis", [Some(-15), Some(-3), Some(-6)]),
    ("settler-target-hysteresis-2", [Some(12), Some(-15), Some(10)]),
    ("settler-threat-detour", [Some(-16), Some(15), Some(21)]),
    ("siege-commitment", [Some(16), Some(-19), Some(21)]),
    ("siege-is-progress-2", [Some(10), Some(-11), Some(5)]),
    ("skip-the-prophet-race", [Some(-130), Some(-119), Some(-136)]),
    ("slot-kind-tiebreak", [Some(9), Some(-7), Some(9)]),
    ("solvency-first-trade-slot", [Some(133), Some(100), Some(136)]),
    ("solvency-first-trade-slot-2", [Some(-46), Some(-25), Some(-58)]),
    ("stranded-settler-discount", [Some(-5), Some(-23), Some(-2)]),
    ("strategic-wonders", [Some(-5), Some(2), Some(-17)]),
    ("strike-opening", [Some(-14), Some(12), Some(-3)]),
    ("surprise-war-mobilization", [Some(-18), Some(7), Some(1)]),
    ("swap-rotation", [Some(-10), None, None]),
    ("treasury-at-work", [Some(6), Some(12), Some(2)]),
    ("treasury-at-work-2", [Some(7), Some(13), Some(-3)]),
    ("unchosen-war-keeps-the-lane", [Some(-1), Some(6), Some(22)]),
    ("unit-cost-efficiency", [Some(-5), Some(7), Some(-3)]),
    ("unit-objective-memory", [Some(-6), Some(-5), Some(1)]),
    ("upgrade-the-garrison", [Some(16), Some(1), Some(0)]),
    ("war-economy", [Some(2), Some(-11), Some(10)]),
    ("war-needs-a-treasury", [Some(6), Some(14), Some(-36)]),
    ("war-reinforcement", [Some(-1), Some(10), Some(-12)]),
    ("whole-turn-backtrack-guard", [Some(12), Some(18), Some(4)]),
    ("wide-map-capacity", [Some(41), Some(16), Some(35)]),
    ("wonder-adjacent-sites", [Some(-9), Some(-8), Some(0)]),
    ("wonder-adjacent-sites-2", [Some(6), Some(-2), Some(-7)]),
    ("wonder-ring-recon", [Some(-12), Some(3), Some(0)]),
    ("wonder-score-tally", [Some(-7), Some(-6), Some(40)]),
];
