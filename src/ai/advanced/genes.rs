...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("air-surge", [Some(15), Some(5), Some(30)]),
    ("amenity-district-path", [Some(13), Some(-19), Some(-9)]),
    ("amenity-project-preemption", [Some(-34), Some(53), Some(-20)]),
    ("amenity-project-preemption-2", [Some(19), Some(-8), Some(16)]),
    ("apostle-promotion-by-role", [Some(-24), Some(-8), Some(18)]),
    ("army-target-weighs-enemy", [Some(26), Some(-12), Some(5)]),
    ("barbarian-bargain", [Some(11), Some(14), Some(24)]),
    ("barbarian-ranged-answer", [Some(7), Some(-12), Some(-5)]),
    ("barbarian-scouts-are-scouts", [Some(26), Some(1), Some(28)]),
    ("blind-objective-strength", [Some(-28), Some(6), Some(1)]),
    ("blind-objective-units", [Some(-14), Some(17), Some(-10)]),
    ("boost-first-research", [Some(-35), Some(-1), Some(-3)]),
    ("boost-unlock-research", [Some(-30), Some(-34), Some(-16)]),
    ("boost-wait-research", [Some(20), Some(-3), Some(9)]),
    ("bounded-recovery", [Some(-21), Some(1), Some(-14)]),
    ("build-what-cards-boost", [Some(-27), Some(14), Some(-5)]),
    ("builder-barbarian-safety", [Some(-1), Some(1), Some(-2)]),
    ("builder-supply-floor", [Some(-1), Some(25), Some(15)]),
    ("builder-tries-the-next-tile", [Some(-14), Some(2), Some(-1)]),
    ("buildings-before-projects", [Some(12), Some(1), Some(13)]),
    ("buy-what-cards-cannot-boost", [Some(-9), Some(3), Some(22)]),
    ("camp-party", [Some(-1), Some(-40), Some(4)]),
    ("camp-tile-buyout", [Some(4), Some(-6), Some(-2)]),
    ("campaign-pillage", [Some(-12), Some(-5), Some(0)]),
    ("campus-adjacency-threshold", [Some(17), Some(2), Some(-3)]),
    ("campus-adjacency-threshold-2", [Some(-5), Some(1), Some(-2)]),
    ("canal-city", [Some(10), Some(1), Some(-15)]),
    ("chain-payback-window", [Some(8), Some(-5), Some(-10)]),
    ("chain-payback-window-2", [Some(-1), Some(-9), Some(7)]),
    ("chokepoint-claim", [Some(-5), Some(1), Some(16)]),
    ("chokepoint-garrison", [Some(-18), Some(14), Some(-10)]),
    ("chokepoint-siting", [Some(-14), Some(-12), Some(-16)]),
    ("chop-into-the-queue", [Some(7), Some(-6), Some(-9)]),
    ("city-campaign", [Some(-18), Some(-5), Some(-12)]),
    ("city-target-meets-the-map", [Some(-6), None, None]),
    ("civilian-out-of-reach", [Some(31), Some(18), Some(-5)]),
    ("coalition-before-war", [Some(31), Some(14), Some(16)]),
    ("come-ashore", [Some(10), Some(-40), Some(7)]),
    ("competition-victory-points", [Some(-17), Some(3), Some(-9)]),
    ("congress-counter-leader", [Some(25), Some(-11), Some(-4)]),
    ("contested-land-first", [Some(24), Some(5), Some(-10)]),
    ("conversion-majority-alarm", [Some(12), Some(-5), Some(-9)]),
    ("coordinated-finish", [Some(-20), Some(-2), Some(-18)]),
    ("culture-building-debt", [Some(24), Some(-6), Some(-11)]),
    ("culture-lane-forecast", [Some(10), Some(10), Some(-10)]),
    ("deals-at-the-ceiling", [Some(18), Some(-2), Some(5)]),
    ("deals-for-our-gain", [Some(-8), Some(16), Some(21)]),
    ("defensible-sites", [Some(17), Some(34), Some(25)]),
    ("diplomatic-lane-forecast", [Some(-21), Some(6), Some(-10)]),
    ("district-coverage", [Some(-8), Some(-4), Some(-4)]),
    ("district-coverage-2", [Some(-1), Some(-18), Some(-5)]),
    ("district-planning", [Some(-30), Some(-7), Some(25)]),
    ("domination-city-count", [Some(0), Some(1), Some(-17)]),
    ("early-contact-window", [Some(-29), Some(-8), Some(10)]),
    ("elective-war-in-reach", [Some(-1), Some(7), Some(-5)]),
    ("elective-war-yields-to-a-lane", [Some(23), Some(49), Some(16)]),
    ("encampment-seals-the-pass", [Some(-5), Some(1), Some(3)]),
    ("enemy-of-my-enemy", [Some(13), Some(5), Some(-9)]),
    ("engine-faith-price", [Some(59), Some(20), Some(18)]),
    ("enhancer-for-the-corps", [Some(-11), Some(8), Some(5)]),
    ("escort-unstick", [Some(25), Some(-3), Some(-6)]),
    ("eureka-chasing-builder", [Some(-17), Some(-22), Some(1)]),
    ("eureka-chasing-production", [Some(25), Some(-20), Some(-10)]),
    ("expansion-pays-back", [Some(17), Some(-7), Some(-23)]),
    ("expansion-schedule", [Some(18), Some(-13), Some(1)]),
    ("first-builder-reserve", [Some(-14), Some(5), Some(-12)]),
    ("first-research-building-reserve", [Some(-1), Some(0), Some(-17)]),
    ("flip-nearby-city-states", [Some(-4), Some(0), Some(-3)]),
    ("founder-temple", [Some(-5), Some(-3), Some(1)]),
    ("frontier-massing-alarm", [Some(-2), Some(-5), Some(16)]),
    ("garrison-under-fire", [Some(17), Some(-12), Some(14)]),
    ("gold-for-the-young-city", [Some(-6), Some(5), Some(10)]),
    ("government-capacity-fallback", [Some(5), None, None]),
    ("government-ladder", [Some(3), Some(-21), Some(-4)]),
    ("government-ladder-2", [Some(-16), None, None]),
    ("great-person-housing", [Some(11), Some(32), Some(13)]),
    ("growth-to-settle", [Some(16), Some(3), Some(-1)]),
    ("guru-heals-the-corps-2", [Some(27), Some(12), Some(-18)]),
    ("holy-lane-parity", [Some(-38), Some(-11), Some(14)]),
    ("holy-site-where-the-threat-is", [Some(-7), Some(12), Some(-2)]),
    ("holy-site-where-the-threat-is-2", [Some(15), Some(1), Some(11)]),
    ("housing-research", [Some(-19), Some(-38), Some(1)]),
    ("idle-faith-patronage", [Some(-23), Some(8), Some(1)]),
    ("improvement-housing-value", [Some(-6), Some(-16), Some(-6)]),
    ("lane-culture-spending", [Some(-12), Some(-31), Some(-18)]),
    ("lane-great-people", [Some(-14), Some(-10), Some(-8)]),
    ("lane-policy-deck", [Some(-7), Some(-19), Some(-4)]),
    ("lane-release-when-hopeless", [Some(-14), None, None]),
    ("lane-space-race", [Some(-5), Some(5), Some(-19)]),
    ("lane-votes-its-favor", [Some(-15), None, None]),
    ("loyalty-rate-alarm", [Some(42), Some(21), Some(53)]),
    ("maintenance-aware-deck", [Some(12), Some(7), Some(8)]),
    ("missionary-evades-raiders", [Some(48), Some(8), Some(12)]),
    ("missionary-last-charge-explores", [Some(2), Some(4), Some(-19)]),
    ("moksha-defends-the-faithless", [Some(25), None, None]),
    ("native-emergency-purchase", [Some(-19), Some(3), Some(6)]),
    ("naval-recon", [Some(8), Some(52), Some(-8)]),
    ("naval-recon-2", [Some(-6), Some(-26), Some(-10)]),
    ("naval-threat-triage", [Some(9), Some(27), Some(7)]),
    ("never-an-empty-queue", [Some(-19), Some(-2), Some(17)]),
    ("never-an-empty-queue-2", [Some(19), Some(6), Some(-8)]),
    ("no-free-passage", [Some(29), Some(-7), Some(11)]),
    ("one-launch-pad", [Some(22), Some(10), Some(29)]),
    ("one-shot-recovery", [Some(37), Some(-29), Some(-8)]),
    ("one-war-at-a-time", [Some(29), Some(-22), Some(-25)]),
    ("opening-warrior-recon", [Some(-5), Some(-33), Some(-33)]),
    ("opportunistic-war", [Some(14), Some(12), Some(22)]),
    ("order-retry", [Some(11), Some(-5), Some(-4)]),
    ("pantheon-board", [Some(-11), Some(2), Some(4)]),
    ("pass-picket", [Some(-20), Some(14), Some(-14)]),
    ("peace-when-the-war-does-not-pay", [Some(23), None, None]),
    ("peacetime-deterrence", [Some(21), Some(-25), Some(10)]),
    ("power-the-laboratory", [Some(-22), Some(4), Some(9)]),
    ("power-the-laboratory-2", [Some(2), Some(-8), Some(8)]),
    ("price-the-suzerainty", [Some(26), Some(22), Some(31)]),
    ("promote-when-wounded", [Some(18), Some(-13), Some(30)]),
    ("quest-boost", [Some(-14), Some(15), Some(1)]),
    ("quest-camp-errand", [Some(-8), Some(-13), Some(-6)]),
    ("quest-production", [Some(7), Some(-5), Some(3)]),
    ("quest-trade-route", [Some(11), Some(15), Some(21)]),
    ("raid-pillage-prizes", [Some(14), Some(-26), Some(-1)]),
    ("rapid-city-expansion", [Some(-81), Some(-112), Some(-137)]),
    ("recon-replacement", [Some(11), Some(8), Some(6)]),
    ("recorded-tactical-step", [Some(-12), Some(15), Some(-13)]),
    ("recovery-reads-the-war", [Some(-15), Some(11), Some(-12)]),
    ("relief-targets-the-siege", [Some(45), Some(11), Some(8)]),
    ("religion-race-is-closed", [Some(11), None, None]),
    ("religion-sues-peace", [Some(-16), Some(-4), Some(5)]),
    ("religious-defence-scales", [Some(-2), Some(-17), Some(-4)]),
    ("religious-units-heal-first", [Some(0), Some(21), Some(2)]),
    ("religious-veto-defence", [Some(10), Some(30), Some(23)]),
    ("research-tier-premium", [Some(42), Some(-7), Some(34)]),
    ("rival-suzerainty-alarm", [Some(32), Some(30), Some(-11)]),
    ("science-building-first", [Some(1), Some(3), Some(-18)]),
    ("science-chain-alarm", [Some(-6), Some(12), Some(7)]),
    ("science-multiplier-payoff", [Some(11), Some(-8), Some(-3)]),
    ("science-victory-drive", [Some(9), Some(16), Some(41)]),
    ("score-horizon", [Some(12), Some(-5), Some(-11)]),
    ("settle-sooner", [Some(4), Some(6), Some(22)]),
    ("settlement-gap-target", [Some(-5), Some(-4), Some(4)]),
    ("settler-factory-coordination", [Some(-6), Some(-34), Some(10)]),
    ("settler-guard-holds", [Some(15), Some(-24), Some(1)]),
    ("settler-guard-holds-2", [Some(14), Some(19), Some(-2)]),
    ("settler-screen", [Some(0), Some(-4), Some(1)]),
    ("settler-second-look", [Some(-4), Some(-15), Some(0)]),
    ("settler-target-hysteresis", [Some(-6), Some(2), Some(13)]),
    ("settler-target-hysteresis-2", [Some(10), Some(20), Some(6)]),
    ("settler-threat-detour", [Some(21), Some(18), Some(16)]),
    ("siege-commitment", [Some(21), Some(-3), Some(-16)]),
    ("siege-is-progress-2", [Some(5), Some(-17), Some(4)]),
    ("skip-the-prophet-race", [Some(-136), Some(-129), Some(-148)]),
    ("slot-kind-tiebreak", [Some(9), Some(27), Some(4)]),
    ("solvency-first-trade-slot", [Some(136), Some(121), Some(99)]),
    ("solvency-first-trade-slot-2", [Some(-58), Some(-31), Some(-22)]),
    ("stranded-settler-discount", [Some(-2), Some(38), Some(17)]),
    ("strategic-wonders", [Some(-17), Some(1), Some(4)]),
    ("strike-opening", [Some(-3), Some(15), Some(-9)]),
    ("surprise-war-mobilization", [Some(1), Some(0), Some(-5)]),
    ("treasury-at-work", [Some(2), None, None]),
    ("treasury-at-work-2", [Some(-3), None, None]),
    ("unchosen-war-keeps-the-lane", [Some(22), Some(7), Some(6)]),
    ("unit-cost-efficiency", [Some(-3), Some(3), Some(25)]),
    ("unit-objective-memory", [Some(1), Some(19), Some(2)]),
    ("upgrade-the-garrison", [Some(0), Some(-10), Some(7)]),
    ("war-economy", [Some(10), Some(-8), Some(-2)]),
    ("war-needs-a-treasury", [Some(-36), None, None]),
    ("war-reinforcement", [Some(-12), Some(5), Some(13)]),
    ("whole-turn-backtrack-guard", [Some(4), Some(11), Some(4)]),
    ("wide-map-capacity", [Some(35), Some(40), Some(40)]),
    ("wonder-adjacent-sites", [Some(0), Some(8), Some(6)]),
    ("wonder-adjacent-sites-2", [Some(-7), Some(-10), Some(-3)]),
    ("wonder-ring-recon", [Some(0), Some(0), Some(-6)]),
    ("wonder-score-tally", [Some(40), Some(6), Some(14)]),
];
