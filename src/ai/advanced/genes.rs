...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(16), Some(2), Some(24)]),
    ("air-surge", [Some(-19), Some(-2), Some(-5)]),
    ("air-surge-2", [Some(-7), Some(17), Some(20)]),
    ("amenity-district-path", [Some(4), Some(-2), Some(-4)]),
    ("amenity-project-preemption", [Some(-7), Some(26), Some(-6)]),
    ("amenity-project-preemption-2", [Some(13), Some(6), Some(13)]),
    ("anvil", [Some(-5), Some(14), Some(-3)]),
    ("apostle-promotion-by-role", [Some(1), Some(5), Some(25)]),
    ("army-target-weighs-enemy", [Some(-2), Some(31), Some(-23)]),
    ("barbarian-bargain", [Some(31), Some(13), Some(14)]),
    ("barbarian-ranged-answer", [Some(0), Some(0), Some(-6)]),
    ("barbarian-scouts-are-scouts", [Some(25), Some(-3), Some(-5)]),
    ("barbarian-settler-capture", [Some(27), Some(28), Some(60)]),
    ("battle-planner", [Some(-3), Some(5), Some(-10)]),
    ("battle-planner-2", [Some(35), Some(25), Some(42)]),
    ("battle-planner-3", [Some(17), Some(18), Some(4)]),
    ("blind-objective-strength", [Some(0), Some(-9), Some(15)]),
    ("blind-objective-units", [Some(-17), Some(-13), Some(-10)]),
    ("boost-first-research", [Some(-27), Some(-12), Some(-2)]),
    ("boost-unlock-research", [Some(26), Some(10), Some(6)]),
    ("boost-wait-research", [Some(-27), Some(7), Some(-3)]),
    ("boost-wait-research-2", [Some(17), Some(3), Some(8)]),
    ("boosted-bargain-first", [Some(-9), Some(-21), Some(27)]),
    ("boosted-bargain-first-2", [Some(5), Some(11), Some(-8)]),
    ("border-parity", [Some(-5), Some(2), Some(1)]),
    ("border-parity-2", [Some(-6), Some(-10), Some(-10)]),
    ("border-parity-3", [Some(6), Some(-10), Some(-10)]),
    ("bounded-recovery", [Some(10), Some(0), Some(4)]),
    ("build-what-cards-boost", [Some(-15), Some(6), Some(-1)]),
    ("builder-barbarian-safety", [Some(12), Some(7), Some(5)]),
    ("builder-supply-floor", [Some(13), Some(0), Some(-3)]),
    ("builder-tries-the-next-tile", [Some(-19), Some(-16), Some(37)]),
    ("buildings-before-projects", [Some(9), Some(7), Some(-15)]),
    ("buy-what-cards-cannot-boost", [Some(-14), Some(-6), Some(16)]),
    ("camp-party", [Some(32), Some(23), Some(16)]),
    ("camp-tile-buyout", [Some(-26), Some(-1), Some(13)]),
    ("campaign-pillage", [Some(6), Some(-28), Some(-15)]),
    ("campus-adjacency-threshold", [Some(8), Some(5), Some(-10)]),
    ("campus-adjacency-threshold-2", [Some(-14), Some(-1), Some(4)]),
    ("campus-through-expansion", [Some(-8), Some(-8), Some(-23)]),
    ("canal-city", [Some(-2), Some(-6), Some(0)]),
    ("capital-settler-after-completion", [Some(-11), Some(-3), Some(-2)]),
    ("capture-go-or-stand-down", [Some(-3), Some(5), Some(18)]),
    ("capture-go-or-stand-down-2", [Some(-13), Some(1), Some(-5)]),
    ("chain-payback-window", [Some(-9), Some(-28), Some(4)]),
    ("chain-payback-window-2", [Some(12), Some(38), Some(12)]),
    ("chase-every-boost", [Some(0), Some(2), Some(9)]),
    ("chase-every-boost-2", [Some(4), Some(13), Some(-7)]),
    ("cheapest-wonder-first", [Some(-1), Some(-14), Some(-5)]),
    ("chokepoint-claim", [Some(2), Some(-12), Some(6)]),
    ("chokepoint-garrison", [Some(-4), Some(-8), Some(-4)]),
    ("chokepoint-siting", [Some(6), Some(23), Some(-24)]),
    ("chop-into-the-queue", [Some(-11), Some(-21), Some(-45)]),
    ("city-campaign", [Some(-7), Some(-7), Some(-22)]),
    ("city-campaign-2", [Some(-11), Some(-1), Some(29)]),
    ("city-target-meets-the-map", [Some(10), Some(-13), Some(-4)]),
    ("civilian-out-of-reach", [Some(7), Some(-2), Some(-6)]),
    ("close-as-a-body", [Some(-25), Some(-2), Some(-16)]),
    ("coalition-before-war", [Some(-12), Some(-5), Some(10)]),
    ("coalition-before-war-2", [Some(3), Some(-1), Some(2)]),
    ("coalition-before-war-3", [Some(1), Some(7), Some(6)]),
    ("coastal-city-sites", [Some(0), Some(-8), Some(1)]),
    ("coastal-city-sites-2", [Some(-7), Some(25), Some(-13)]),
    ("come-ashore", [Some(-1), Some(15), Some(-15)]),
    ("commitment-owner-acts", [Some(-6), Some(-6), Some(-12)]),
    ("commitment-patience", [Some(-16), Some(-18), Some(21)]),
    ("competition-victory-points", [Some(16), Some(-5), Some(-7)]),
    ("congress-counter-leader", [Some(-11), Some(10), Some(26)]),
    ("connect-the-luxury", [Some(20), Some(50), Some(24)]),
    ("contested-land-first", [Some(1), Some(1), Some(14)]),
    ("contested-suzerainty-brake", [Some(-11), Some(-22), Some(-45)]),
    ("conversion-majority-alarm", [Some(30), Some(3), Some(2)]),
    ("conversion-majority-alarm-2", [Some(8), Some(15), Some(-4)]),
    ("coordinated-finish", [Some(9), Some(2), Some(15)]),
    ("culture-building-debt", [Some(6), Some(5), Some(0)]),
    ("culture-floor", [Some(-11), Some(17), Some(14)]),
    ("culture-lane-forecast", [Some(-4), Some(-12), Some(0)]),
    ("deals-at-the-ceiling", [Some(4), Some(29), Some(25)]),
    ("deals-for-our-gain", [Some(3), Some(14), Some(6)]),
    ("defend-where-you-stand", [Some(-6), Some(25), Some(-15)]),
    ("defensible-sites", [Some(41), Some(11), Some(2)]),
    ("detour-keeps-the-site-worth", [Some(1), Some(9), Some(8)]),
    ("diplomatic-lane-forecast", [Some(-9), Some(-32), Some(5)]),
    ("diplomatic-lane-forecast-2", [Some(0), Some(3), Some(-5)]),
    ("district-coverage", [Some(-18), Some(-6), Some(-6)]),
    ("district-coverage-2", [Some(-6), Some(2), Some(7)]),
    ("district-planning", [Some(10), Some(3), Some(5)]),
    ("district-planning-2", [Some(-16), Some(3), Some(4)]),
    ("district-planning-3", [Some(-1), Some(-11), Some(0)]),
    ("domination-city-count", [Some(-12), Some(42), Some(10)]),
    ("doomed-blow-veto", [Some(-14), Some(5), Some(-6)]),
    ("early-archers", [Some(12), Some(-11), Some(25)]),
    ("early-contact-window", [Some(2), Some(-8), Some(2)]),
    ("early-project-restraint", [Some(6), Some(9), Some(-24)]),
    ("early-project-restraint-2", [Some(-6), Some(-15), Some(0)]),
    ("elective-war-in-reach", [Some(-14), Some(-2), Some(5)]),
    ("elective-war-yields-to-a-lane", [Some(40), Some(30), Some(54)]),
    ("encampment-seals-the-pass", [Some(-16), Some(17), Some(7)]),
    ("enemy-of-my-enemy", [Some(4), Some(-2), Some(17)]),
    ("engine-faith-price", [Some(17), Some(13), Some(27)]),
    ("enhancer-for-the-corps", [Some(1), Some(-6), Some(8)]),
    ("enter-the-prophet-race", [Some(-54), Some(-13), Some(-33)]),
    ("enter-the-prophet-race-2", [Some(53), Some(20), Some(39)]),
    ("escort-cap-holds", [Some(17), Some(21), Some(-5)]),
    ("escort-unstick", [Some(16), Some(12), Some(-10)]),
    ("eureka-chasing-builder", [Some(1), Some(-8), Some(1)]),
    ("eureka-chasing-builder-2", [Some(2), Some(17), Some(-10)]),
    ("eureka-chasing-production", [Some(11), Some(5), Some(-16)]),
    ("exchange-is-the-engines", [Some(-6), Some(6), Some(19)]),
    ("exhaustion-loyalty-guard", [Some(-13), Some(-15), Some(-7)]),
    ("expansion-pays-back", [Some(-8), Some(11), Some(22)]),
    ("expansion-schedule", [Some(-1), Some(40), Some(-25)]),
    ("fire-plan", [Some(-9), Some(5), Some(6)]),
    ("first-builder-reserve", [Some(21), Some(37), Some(-20)]),
    ("first-builder-reserve-2", [Some(9), Some(-39), Some(18)]),
    ("first-district-first", [Some(-2), Some(-8), Some(-5)]),
    ("first-granary-reserve", [Some(-1), Some(-31), Some(3)]),
    ("first-luxury-first", [Some(7), Some(2), Some(41)]),
    ("first-research-building-reserve", [Some(-10), Some(4), Some(20)]),
    ("flip-nearby-city-states", [Some(-16), Some(-7), Some(9)]),
    ("founder-temple", [Some(9), Some(7), Some(27)]),
    ("frontier-massing-alarm", [Some(-10), Some(7), Some(-8)]),
    ("garrison-under-fire", [Some(-6), Some(-23), Some(-25)]),
    ("gold-for-the-young-city", [Some(-16), Some(4), Some(0)]),
    ("gold-income-floor", [Some(20), Some(-11), Some(-2)]),
    ("government-capacity-fallback", [Some(-4), Some(7), Some(14)]),
    ("government-ladder", [Some(7), Some(23), Some(17)]),
    ("government-ladder-2", [Some(14), Some(-8), Some(3)]),
    ("great-person-housing", [Some(9), Some(0), Some(16)]),
    ("growth-to-settle", [Some(7), Some(6), Some(-19)]),
    ("guru-heals-the-corps-2", [Some(-6), Some(-2), Some(-3)]),
    ("holy-lane-parity", [Some(2), Some(-2), Some(9)]),
    ("holy-site-where-the-threat-is", [Some(1), Some(25), Some(-4)]),
    ("holy-site-where-the-threat-is-2", [Some(-9), Some(-5), Some(13)]),
    ("hostile-memory", [Some(-9), Some(-38), Some(-39)]),
    ("housing-research", [Some(-22), Some(12), Some(-20)]),
    ("idle-faith-patronage", [Some(6), Some(12), Some(15)]),
    ("improvement-housing-value", [Some(-11), Some(-21), Some(-14)]),
    ("industrial-chain-debt", [Some(6), Some(9), Some(9)]),
    ("island-exploration", [Some(4), Some(-14), Some(22)]),
    ("lane-culture-spending", [Some(-1), Some(-15), Some(3)]),
    ("lane-great-people", [Some(28), Some(12), Some(9)]),
    ("lane-policy-deck", [Some(11), Some(17), Some(-18)]),
    ("lane-release-when-hopeless", [Some(5), Some(-2), Some(-14)]),
    ("lane-space-race", [Some(8), Some(37), Some(30)]),
    ("lane-votes-its-favor", [Some(17), Some(6), Some(-18)]),
    ("loyalty-rate-alarm", [Some(42), Some(47), Some(51)]),
    ("maintenance-aware-deck", [Some(21), Some(24), Some(11)]),
    ("missionary-evades-raiders", [Some(-6), Some(-7), Some(18)]),
    ("missionary-last-charge-explores", [Some(2), Some(-16), Some(2)]),
    ("missionary-last-charge-explores-2", [Some(15), Some(-11), Some(-16)]),
    ("modernize-before-spending", [Some(-4), Some(2), Some(-6)]),
    ("moksha-defends-the-faithless", [Some(10), Some(-12), Some(-16)]),
    ("native-emergency-purchase", [Some(0), Some(17), Some(-23)]),
    ("native-emergency-purchase-2", [Some(2), Some(17), Some(14)]),
    ("naval-recon", [Some(23), Some(2), Some(8)]),
    ("naval-recon-2", [Some(-5), Some(-3), Some(-16)]),
    ("naval-recon-3", [Some(11), Some(-4), Some(11)]),
    ("naval-threat-triage", [Some(16), Some(18), Some(7)]),
    ("never-an-empty-queue", [Some(17), Some(5), Some(7)]),
    ("never-an-empty-queue-2", [Some(-5), Some(-14), Some(7)]),
    ("never-an-empty-queue-3", [Some(-10), Some(6), Some(-5)]),
    ("no-free-passage", [Some(15), Some(-2), Some(-17)]),
    ("objective-board", [Some(-5), Some(4), Some(-4)]),
    ("one-launch-pad", [Some(3), Some(-6), Some(-2)]),
    ("one-shot-recovery", [Some(3), Some(-1), Some(-5)]),
    ("one-war-at-a-time", [Some(-6), Some(-4), Some(-21)]),
    ("opening-warrior-recon", [Some(-38), Some(-24), Some(-25)]),
    ("opening-warrior-recon-2", [Some(26), Some(9), Some(22)]),
    ("opportunistic-war", [Some(-8), Some(16), Some(-13)]),
    ("order-retry", [Some(5), Some(10), Some(-18)]),
    ("overseas-settlement", [Some(-8), Some(-17), Some(6)]),
    ("pantheon-board", [Some(9), Some(18), Some(7)]),
    ("pass-picket", [Some(4), Some(-7), Some(0)]),
    ("peace-when-the-war-does-not-pay", [Some(-17), Some(-15), Some(-3)]),
    ("peacetime-deterrence", [Some(-8), Some(-3), Some(2)]),
    ("power-the-laboratory", [Some(-14), Some(-9), Some(1)]),
    ("power-the-laboratory-2", [Some(-4), Some(-19), Some(-10)]),
    ("price-the-suzerainty", [Some(19), Some(9), Some(29)]),
    ("promote-when-wounded", [Some(31), Some(5), Some(24)]),
    ("quest-boost", [Some(2), Some(7), Some(24)]),
    ("quest-camp-errand", [Some(3), Some(7), Some(-7)]),
    ("quest-production", [Some(6), Some(4), Some(-2)]),
    ("quest-trade-route", [Some(1), Some(16), Some(19)]),
    ("raid-pillage-prizes", [Some(-26), Some(2), Some(7)]),
    ("rapid-city-expansion", [Some(-120), Some(-180), Some(-163)]),
    ("rapid-city-expansion-2", [Some(67), Some(134), Some(108)]),
    ("recon-replacement", [Some(-11), Some(-8), Some(0)]),
    ("recorded-tactical-step", [Some(-20), Some(3), Some(-2)]),
    ("recovery-reads-the-war", [Some(-1), Some(-7), Some(-1)]),
    ("recovery-reads-the-war-2", [Some(-3), Some(11), Some(-9)]),
    ("relief-column-marches", [Some(2), Some(-14), Some(4)]),
    ("relief-targets-the-siege", [Some(-6), Some(-3), Some(36)]),
    ("religion-race-is-closed", [Some(5), Some(15), Some(7)]),
    ("religion-sues-peace", [Some(1), Some(9), Some(-5)]),
    ("religious-defence-scales", [Some(-18), Some(10), Some(23)]),
    ("religious-units-heal-first", [Some(-9), Some(7), Some(15)]),
    ("religious-veto-defence", [Some(39), Some(30), Some(44)]),
    ("requisitions", [Some(-17), Some(-9), Some(-31)]),
    ("research-tier-premium", [Some(-11), Some(1), Some(-24)]),
    ("rival-suzerainty-alarm", [Some(4), Some(-10), Some(-5)]),
    ("route-block-is-a-wait", [Some(6), Some(6), Some(-17)]),
    ("safest-stand", [Some(8), Some(-14), Some(-24)]),
    ("science-building-first", [Some(13), Some(29), Some(32)]),
    ("science-chain-alarm", [Some(6), Some(13), Some(-9)]),
    ("science-expansion-phase", [Some(12), Some(19), Some(-19)]),
    ("science-multiplier-payoff", [Some(5), Some(11), Some(0)]),
    ("science-opening-band", [Some(-9), Some(0), Some(-5)]),
    ("science-victory-drive", [Some(35), Some(8), Some(20)]),
    ("science-victory-drive-2", [Some(13), Some(42), Some(28)]),
    ("score-horizon", [Some(-25), Some(-16), Some(-17)]),
    ("screen-the-shooters", [Some(9), Some(9), Some(-1)]),
    ("settle-sooner", [Some(-7), Some(-29), Some(3)]),
    ("settlement-gap-target", [Some(-7), Some(-13), Some(4)]),
    ("settler-backlog-brake", [Some(17), Some(7), Some(-18)]),
    ("settler-backlog-brake-2", [Some(-11), Some(19), Some(11)]),
    ("settler-factory-coordination", [Some(2), Some(5), Some(-5)]),
    ("settler-guard-holds", [Some(10), Some(22), Some(-21)]),
    ("settler-guard-holds-2", [Some(1), Some(-10), Some(-11)]),
    ("settler-never-idles", [Some(16), Some(7), Some(21)]),
    ("settler-screen", [Some(-26), Some(2), Some(-5)]),
    ("settler-second-look", [Some(-13), Some(19), Some(19)]),
    ("settler-site-gate", [Some(-4), Some(11), Some(3)]),
    ("settler-target-floor", [Some(6), Some(32), Some(-11)]),
    ("settler-target-hysteresis", [Some(-18), Some(15), Some(10)]),
    ("settler-target-hysteresis-2", [Some(3), Some(-19), Some(-18)]),
    ("settler-threat-detour", [Some(7), Some(-19), Some(7)]),
    ("settler-walk-deadline", [Some(32), Some(-6), Some(-3)]),
    ("siege-commitment", [Some(-10), Some(-11), Some(27)]),
    ("siege-is-progress-2", [Some(9), Some(5), Some(-20)]),
    ("siege-is-progress-3", [Some(0), Some(12), Some(10)]),
    ("siege-preempts-the-queue", [Some(8), Some(-27), Some(11)]),
    ("siege-train", [Some(-23), Some(13), Some(-14)]),
    ("skip-the-prophet-race", [Some(-24), Some(-11), Some(-51)]),
    ("skip-the-prophet-race-2", [Some(20), Some(-6), Some(26)]),
    ("slot-kind-tiebreak", [Some(-4), Some(2), Some(-12)]),
    ("solvency-first-trade-slot", [Some(77), Some(59), Some(71)]),
    ("spaceport-surplus-veto", [Some(2), Some(-13), Some(-12)]),
    ("standing-still-is-a-risk", [Some(4), Some(1), Some(1)]),
    ("stranded-settler-discount", [Some(27), Some(-9), Some(13)]),
    ("strategic-wonders", [Some(3), Some(-22), Some(4)]),
    ("strike-opening", [Some(-2), Some(-5), Some(14)]),
    ("strike-reach", [Some(-6), Some(-4), Some(-7)]),
    ("surprise-war-mobilization", [Some(-17), Some(-6), Some(-31)]),
    ("swap-rotation", [Some(8), Some(-3), Some(-20)]),
    ("swap-rotation-2", [Some(-3), Some(3), Some(20)]),
    ("threatened-city-reserve", [Some(3), Some(3), Some(-8)]),
    ("trade-route-network", [Some(-3), Some(-1), Some(-9)]),
    ("treasury-at-work", [Some(-4), Some(5), Some(15)]),
    ("treasury-at-work-2", [Some(36), Some(32), Some(21)]),
    ("unchosen-war-keeps-the-lane", [Some(15), Some(-2), Some(6)]),
    ("unit-cost-efficiency", [Some(15), Some(-9), Some(17)]),
    ("unit-objective-memory", [Some(15), Some(-16), Some(-2)]),
    ("upgrade-the-garrison", [Some(-7), Some(8), Some(-4)]),
    ("veterans-withdraw-early", [Some(12), Some(16), Some(-2)]),
    ("walls-after-districts", [Some(4), Some(36), Some(-16)]),
    ("war-economy", [Some(-17), Some(0), Some(1)]),
    ("war-needs-a-treasury", [Some(9), Some(-38), Some(27)]),
    ("war-policy-via-board", [Some(10), Some(0), Some(13)]),
    ("war-reinforcement", [Some(-7), Some(-24), Some(0)]),
    ("whole-turn-backtrack-guard", [Some(-23), Some(17), Some(-13)]),
    ("wide-map-capacity", [Some(17), Some(20), Some(-7)]),
    ("wonder-adjacent-sites", [Some(-19), Some(15), Some(-3)]),
    ("wonder-adjacent-sites-2", [Some(17), Some(-19), Some(6)]),
    ("wonder-ring-recon", [Some(3), Some(-18), Some(15)]),
    ("wonder-ring-recon-2", [Some(17), Some(-16), Some(-16)]),
    ("wonder-score-tally", [Some(-1), Some(9), Some(-26)]),
    ("wounded-out-of-reach", [Some(-19), Some(6), Some(-19)]),
];
