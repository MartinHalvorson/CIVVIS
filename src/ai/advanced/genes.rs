...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(21), Some(-3), None]),
    ("air-surge", [Some(16), Some(0), Some(-7)]),
    ("amenity-district-path", [Some(4), Some(5), Some(-8)]),
    ("amenity-project-preemption", [Some(7), Some(22), Some(-5)]),
    ("amenity-project-preemption-2", [Some(-2), Some(18), Some(22)]),
    ("apostle-promotion-by-role", [Some(6), Some(15), Some(2)]),
    ("army-target-weighs-enemy", [Some(20), Some(9), Some(12)]),
    ("barbarian-bargain", [Some(-16), Some(38), Some(9)]),
    ("barbarian-ranged-answer", [Some(5), Some(-10), Some(20)]),
    ("barbarian-scouts-are-scouts", [Some(-2), Some(5), Some(-2)]),
    ("barbarian-settler-capture", [Some(34), Some(32), Some(44)]),
    ("blind-objective-strength", [Some(16), Some(7), Some(1)]),
    ("blind-objective-units", [Some(4), Some(-7), Some(11)]),
    ("boost-first-research", [Some(-3), Some(-3), Some(-11)]),
    ("boost-unlock-research", [Some(-38), Some(-35), Some(3)]),
    ("boost-wait-research", [Some(-19), Some(-18), Some(1)]),
    ("boosted-bargain-first", [Some(-21), Some(-14), None]),
    ("border-parity", [Some(-10), Some(9), None]),
    ("border-parity-2", [Some(-12), Some(-10), None]),
    ("bounded-recovery", [Some(4), Some(-9), Some(11)]),
    ("build-what-cards-boost", [Some(31), Some(-21), Some(-6)]),
    ("builder-barbarian-safety", [Some(9), Some(-23), Some(4)]),
    ("builder-supply-floor", [Some(-9), Some(0), Some(13)]),
    ("builder-tries-the-next-tile", [Some(-7), Some(15), Some(2)]),
    ("buildings-before-projects", [Some(0), Some(1), Some(6)]),
    ("buy-what-cards-cannot-boost", [Some(21), Some(4), Some(-6)]),
    ("camp-party", [Some(-4), Some(8), Some(0)]),
    ("camp-tile-buyout", [Some(-5), Some(-9), Some(-10)]),
    ("campaign-pillage", [Some(-1), Some(18), Some(7)]),
    ("campus-adjacency-threshold", [Some(19), Some(5), Some(10)]),
    ("campus-adjacency-threshold-2", [Some(-5), Some(-12), Some(2)]),
    ("canal-city", [Some(9), Some(-3), Some(-9)]),
    ("capture-go-or-stand-down", [Some(-8), Some(11), Some(-2)]),
    ("capture-go-or-stand-down-2", [Some(1), Some(-7), None]),
    ("chain-payback-window", [Some(-1), Some(4), Some(-4)]),
    ("chain-payback-window-2", [Some(6), Some(-9), Some(14)]),
    ("cheapest-wonder-first", [Some(-4), Some(11), None]),
    ("chokepoint-claim", [Some(0), Some(-13), Some(-17)]),
    ("chokepoint-garrison", [Some(-7), Some(-5), Some(-3)]),
    ("chokepoint-siting", [Some(24), Some(7), Some(7)]),
    ("chop-into-the-queue", [Some(-24), Some(-8), Some(-31)]),
    ("city-campaign", [Some(-7), Some(-2), Some(-15)]),
    ("city-target-meets-the-map", [Some(2), Some(11), Some(-4)]),
    ("civilian-out-of-reach", [Some(4), Some(-4), Some(23)]),
    ("close-as-a-body", [Some(12), Some(1), Some(-12)]),
    ("coalition-before-war", [Some(13), Some(1), Some(-6)]),
    ("coastal-city-sites", [Some(-6), Some(-10), Some(-4)]),
    ("coastal-city-sites-2", [Some(-3), Some(-16), Some(2)]),
    ("come-ashore", [Some(1), Some(26), Some(-3)]),
    ("commitment-patience", [Some(2), Some(6), Some(-16)]),
    ("competition-victory-points", [Some(7), Some(-19), Some(11)]),
    ("congress-counter-leader", [Some(27), Some(5), Some(-9)]),
    ("connect-the-luxury", [Some(27), Some(13), None]),
    ("contested-land-first", [Some(-2), Some(-10), Some(1)]),
    ("conversion-majority-alarm", [Some(-2), Some(1), Some(12)]),
    ("coordinated-finish", [Some(0), Some(14), Some(0)]),
    ("culture-building-debt", [Some(4), Some(-6), Some(3)]),
    ("culture-floor", [Some(-15), Some(-8), Some(-13)]),
    ("culture-lane-forecast", [Some(-3), Some(12), Some(-14)]),
    ("deals-at-the-ceiling", [Some(8), Some(-3), Some(11)]),
    ("deals-for-our-gain", [Some(8), Some(-15), Some(6)]),
    ("defend-where-you-stand", [Some(7), Some(-9), Some(-12)]),
    ("defensible-sites", [Some(26), Some(29), Some(12)]),
    ("diplomatic-lane-forecast", [Some(-13), Some(-2), Some(-13)]),
    ("district-coverage", [Some(13), Some(-11), Some(14)]),
    ("district-coverage-2", [Some(-6), Some(-3), Some(-19)]),
    ("district-planning", [Some(14), Some(4), Some(4)]),
    ("domination-city-count", [Some(17), Some(3), Some(-5)]),
    ("early-archers", [Some(29), Some(47), Some(32)]),
    ("early-contact-window", [Some(-18), Some(20), Some(-4)]),
    ("elective-war-in-reach", [Some(3), Some(-2), Some(-13)]),
    ("elective-war-yields-to-a-lane", [Some(27), Some(34), Some(23)]),
    ("encampment-seals-the-pass", [Some(10), Some(-3), Some(-4)]),
    ("enemy-of-my-enemy", [Some(-5), Some(-12), Some(-1)]),
    ("engine-faith-price", [Some(41), Some(10), Some(41)]),
    ("enhancer-for-the-corps", [Some(-5), Some(-23), Some(20)]),
    ("enter-the-prophet-race", [Some(16), Some(35), Some(-45)]),
    ("escort-cap-holds", [Some(-13), Some(-4), None]),
    ("escort-unstick", [Some(6), Some(24), Some(24)]),
    ("eureka-chasing-builder", [Some(-32), Some(-6), Some(-17)]),
    ("eureka-chasing-production", [Some(-8), Some(9), Some(-4)]),
    ("exchange-is-the-engines", [Some(-1), Some(3), Some(2)]),
    ("exhaustion-loyalty-guard", [Some(-11), Some(-5), None]),
    ("expansion-pays-back", [Some(-5), Some(-3), Some(-10)]),
    ("expansion-schedule", [Some(3), Some(16), Some(-14)]),
    ("fire-plan", [Some(-10), Some(7), Some(-2)]),
    ("first-builder-reserve", [Some(-6), Some(-1), Some(6)]),
    ("first-district-first", [Some(7), Some(9), None]),
    ("first-granary-reserve", [Some(13), Some(-6), None]),
    ("first-luxury-first", [Some(5), Some(16), None]),
    ("first-research-building-reserve", [Some(-3), Some(7), Some(5)]),
    ("flip-nearby-city-states", [Some(-15), Some(11), Some(9)]),
    ("founder-temple", [Some(-24), Some(18), Some(19)]),
    ("frontier-massing-alarm", [Some(0), Some(17), Some(3)]),
    ("garrison-under-fire", [Some(-8), Some(-1), Some(-14)]),
    ("gold-for-the-young-city", [Some(-6), Some(12), Some(4)]),
    ("gold-income-floor", [Some(-1), Some(-12), Some(3)]),
    ("government-capacity-fallback", [Some(3), Some(12), Some(20)]),
    ("government-ladder", [Some(-16), Some(-6), Some(-3)]),
    ("government-ladder-2", [Some(27), Some(12), Some(20)]),
    ("great-person-housing", [Some(20), Some(11), Some(24)]),
    ("growth-to-settle", [Some(20), Some(-20), Some(5)]),
    ("guru-heals-the-corps-2", [Some(-2), Some(-6), Some(-2)]),
    ("holy-lane-parity", [Some(0), Some(-22), Some(-2)]),
    ("holy-site-where-the-threat-is", [Some(-7), Some(-1), Some(13)]),
    ("holy-site-where-the-threat-is-2", [Some(8), Some(2), Some(-13)]),
    ("hostile-memory", [Some(-7), Some(0), None]),
    ("housing-research", [Some(-7), Some(-6), Some(-6)]),
    ("idle-faith-patronage", [Some(1), Some(-3), Some(1)]),
    ("improvement-housing-value", [Some(-5), Some(-8), Some(-14)]),
    ("island-exploration", [Some(-8), Some(-33), Some(-18)]),
    ("lane-culture-spending", [Some(9), Some(-18), Some(-4)]),
    ("lane-great-people", [Some(-11), Some(4), Some(4)]),
    ("lane-policy-deck", [Some(-20), Some(-7), Some(13)]),
    ("lane-release-when-hopeless", [Some(6), Some(0), Some(4)]),
    ("lane-space-race", [Some(11), Some(-18), Some(1)]),
    ("lane-votes-its-favor", [Some(5), Some(-14), Some(10)]),
    ("loyalty-rate-alarm", [Some(42), Some(26), Some(50)]),
    ("maintenance-aware-deck", [Some(12), Some(20), Some(-5)]),
    ("missionary-evades-raiders", [Some(32), Some(-2), Some(10)]),
    ("missionary-last-charge-explores", [Some(-10), Some(-6), Some(16)]),
    ("moksha-defends-the-faithless", [Some(-11), Some(6), Some(4)]),
    ("native-emergency-purchase", [Some(9), Some(-12), Some(-9)]),
    ("naval-recon", [Some(-1), Some(1), Some(-7)]),
    ("naval-recon-2", [Some(13), Some(-16), Some(4)]),
    ("naval-threat-triage", [Some(5), Some(-7), Some(-10)]),
    ("never-an-empty-queue", [Some(-8), Some(6), Some(9)]),
    ("never-an-empty-queue-2", [Some(0), Some(8), Some(-2)]),
    ("no-free-passage", [Some(14), Some(-18), Some(2)]),
    ("one-launch-pad", [Some(-4), Some(-24), Some(6)]),
    ("one-shot-recovery", [Some(14), Some(3), Some(-13)]),
    ("one-war-at-a-time", [Some(-1), Some(-18), Some(-4)]),
    ("opening-warrior-recon", [Some(-17), Some(-27), Some(-23)]),
    ("opportunistic-war", [Some(8), Some(5), Some(15)]),
    ("order-retry", [Some(-17), Some(1), Some(1)]),
    ("overseas-settlement", [Some(12), Some(16), Some(6)]),
    ("pantheon-board", [Some(31), Some(-10), Some(8)]),
    ("pass-picket", [Some(0), Some(-9), Some(1)]),
    ("peace-when-the-war-does-not-pay", [Some(-7), Some(40), Some(-8)]),
    ("peacetime-deterrence", [Some(0), Some(4), Some(12)]),
    ("power-the-laboratory", [Some(-8), Some(18), Some(-2)]),
    ("power-the-laboratory-2", [Some(-3), Some(12), Some(1)]),
    ("price-the-suzerainty", [Some(20), Some(39), Some(20)]),
    ("promote-when-wounded", [Some(7), Some(3), Some(-17)]),
    ("quest-boost", [Some(-8), Some(-18), Some(4)]),
    ("quest-camp-errand", [Some(-18), Some(25), Some(9)]),
    ("quest-production", [Some(-2), Some(-13), Some(-10)]),
    ("quest-trade-route", [Some(-4), Some(-7), Some(2)]),
    ("raid-pillage-prizes", [Some(0), Some(12), Some(3)]),
    ("rapid-city-expansion", [Some(-83), Some(-66), Some(-36)]),
    ("recon-replacement", [Some(2), Some(10), Some(-7)]),
    ("recorded-tactical-step", [Some(-5), Some(-24), Some(-11)]),
    ("recovery-reads-the-war", [Some(3), Some(-30), Some(-20)]),
    ("relief-column-marches", [Some(10), Some(-6), Some(2)]),
    ("relief-targets-the-siege", [Some(-2), Some(19), Some(4)]),
    ("religion-race-is-closed", [Some(-15), Some(13), Some(8)]),
    ("religion-sues-peace", [Some(5), Some(-3), Some(22)]),
    ("religious-defence-scales", [Some(18), Some(10), Some(-13)]),
    ("religious-units-heal-first", [Some(-4), Some(-7), Some(9)]),
    ("religious-veto-defence", [Some(42), Some(33), Some(12)]),
    ("research-tier-premium", [Some(-6), Some(4), Some(-6)]),
    ("rival-suzerainty-alarm", [Some(-10), Some(14), Some(0)]),
    ("science-building-first", [Some(-2), Some(-9), Some(-8)]),
    ("science-chain-alarm", [Some(1), Some(-20), Some(-6)]),
    ("science-expansion-phase", [Some(-3), Some(4), None]),
    ("science-multiplier-payoff", [Some(-10), Some(3), Some(-7)]),
    ("science-opening-band", [Some(-5), Some(6), None]),
    ("science-victory-drive", [Some(18), Some(13), Some(23)]),
    ("score-horizon", [Some(2), Some(-18), Some(-19)]),
    ("screen-the-shooters", [Some(-13), Some(13), Some(2)]),
    ("settle-sooner", [Some(-5), Some(-4), Some(-11)]),
    ("settlement-gap-target", [Some(9), Some(0), Some(23)]),
    ("settler-backlog-brake", [Some(5), Some(-12), None]),
    ("settler-factory-coordination", [Some(-26), Some(-11), Some(6)]),
    ("settler-guard-holds", [Some(4), Some(5), Some(13)]),
    ("settler-guard-holds-2", [Some(-8), Some(-6), Some(-12)]),
    ("settler-never-idles", [Some(3), Some(-23), Some(7)]),
    ("settler-screen", [Some(0), Some(-13), Some(4)]),
    ("settler-second-look", [Some(-4), Some(2), Some(-16)]),
    ("settler-target-hysteresis", [Some(-2), Some(-2), Some(-9)]),
    ("settler-target-hysteresis-2", [Some(2), Some(-2), Some(20)]),
    ("settler-threat-detour", [Some(-11), Some(-11), Some(4)]),
    ("siege-commitment", [Some(-6), Some(1), Some(9)]),
    ("siege-is-progress-2", [Some(-3), Some(8), Some(-3)]),
    ("skip-the-prophet-race", [Some(-118), Some(-95), Some(5)]),
    ("slot-kind-tiebreak", [Some(7), Some(-14), Some(1)]),
    ("solvency-first-trade-slot", [Some(136), Some(128), Some(140)]),
    ("solvency-first-trade-slot-2", [Some(-50), Some(-49), Some(-55)]),
    ("stranded-settler-discount", [Some(5), Some(6), Some(9)]),
    ("strategic-wonders", [Some(-11), Some(3), Some(8)]),
    ("strike-opening", [Some(-2), Some(5), Some(-4)]),
    ("surprise-war-mobilization", [Some(7), Some(3), Some(3)]),
    ("swap-rotation", [Some(-3), Some(8), Some(9)]),
    ("threatened-city-reserve", [Some(3), Some(-26), Some(2)]),
    ("treasury-at-work", [Some(8), Some(-6), Some(11)]),
    ("treasury-at-work-2", [Some(17), Some(13), Some(0)]),
    ("unchosen-war-keeps-the-lane", [Some(-9), Some(11), Some(16)]),
    ("unit-cost-efficiency", [Some(9), Some(-14), Some(2)]),
    ("unit-objective-memory", [Some(16), Some(28), Some(12)]),
    ("upgrade-the-garrison", [Some(-5), Some(-18), Some(10)]),
    ("walls-after-districts", [Some(-1), Some(5), None]),
    ("war-economy", [Some(21), Some(-10), Some(10)]),
    ("war-needs-a-treasury", [Some(19), Some(-15), Some(8)]),
    ("war-reinforcement", [Some(26), Some(-3), Some(-3)]),
    ("whole-turn-backtrack-guard", [Some(-7), Some(-21), Some(19)]),
    ("wide-map-capacity", [Some(52), Some(22), Some(25)]),
    ("wonder-adjacent-sites", [Some(29), Some(10), Some(-13)]),
    ("wonder-adjacent-sites-2", [Some(-17), Some(21), Some(-2)]),
    ("wonder-ring-recon", [Some(-8), Some(-2), Some(-4)]),
    ("wonder-score-tally", [Some(-5), Some(29), Some(-2)]),
];
