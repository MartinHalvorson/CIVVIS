...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("air-surge", [Some(5), Some(30), Some(5)]),
    ("amenity-district-path", [Some(-19), Some(-9), Some(5)]),
    ("amenity-project-preemption", [Some(53), Some(-20), Some(23)]),
    ("amenity-project-preemption-2", [Some(-8), Some(16), Some(-13)]),
    ("apostle-promotion-by-role", [Some(-8), Some(18), Some(12)]),
    ("army-target-weighs-enemy", [Some(-12), Some(5), Some(9)]),
    ("barbarian-bargain", [Some(14), Some(24), Some(8)]),
    ("barbarian-ranged-answer", [Some(-12), Some(-5), Some(10)]),
    ("barbarian-scouts-are-scouts", [Some(1), Some(28), Some(-13)]),
    ("blind-objective-strength", [Some(6), Some(1), Some(-11)]),
    ("blind-objective-units", [Some(17), Some(-10), Some(18)]),
    ("boost-first-research", [Some(-1), Some(-3), None]),
    ("boost-unlock-research", [Some(-34), Some(-16), None]),
    ("boost-wait-research", [Some(-3), Some(9), None]),
    ("bounded-recovery", [Some(1), Some(-14), Some(-25)]),
    ("build-what-cards-boost", [Some(14), Some(-5), None]),
    ("builder-barbarian-safety", [Some(1), Some(-2), Some(3)]),
    ("builder-supply-floor", [Some(25), Some(15), Some(-5)]),
    ("builder-tries-the-next-tile", [Some(2), Some(-1), Some(-26)]),
    ("buildings-before-projects", [Some(1), Some(13), Some(1)]),
    ("buy-what-cards-cannot-boost", [Some(3), Some(22), None]),
    ("camp-party", [Some(-40), Some(4), Some(25)]),
    ("camp-tile-buyout", [Some(-6), Some(-2), Some(-4)]),
    ("campaign-pillage", [Some(-5), Some(0), Some(20)]),
    ("campus-adjacency-threshold", [Some(2), Some(-3), Some(14)]),
    ("campus-adjacency-threshold-2", [Some(1), Some(-2), Some(3)]),
    ("canal-city", [Some(1), Some(-15), None]),
    ("chain-payback-window", [Some(-5), Some(-10), Some(11)]),
    ("chain-payback-window-2", [Some(-9), Some(7), Some(-5)]),
    ("chokepoint-claim", [Some(1), Some(16), None]),
    ("chokepoint-garrison", [Some(14), Some(-10), None]),
    ("chokepoint-siting", [Some(-12), Some(-16), None]),
    ("chop-into-the-queue", [Some(-6), Some(-9), Some(-18)]),
    ("city-campaign", [Some(-5), Some(-12), Some(-11)]),
    ("civilian-out-of-reach", [Some(18), Some(-5), Some(39)]),
    ("coalition-before-war", [Some(14), Some(16), Some(25)]),
    ("come-ashore", [Some(-40), Some(7), Some(-4)]),
    ("competition-victory-points", [Some(3), Some(-9), Some(14)]),
    ("congress-counter-leader", [Some(-11), Some(-4), Some(0)]),
    ("contested-land-first", [Some(5), Some(-10), Some(-6)]),
    ("conversion-majority-alarm", [Some(-5), Some(-9), Some(10)]),
    ("coordinated-finish", [Some(-2), Some(-18), Some(12)]),
    ("culture-building-debt", [Some(-6), Some(-11), Some(1)]),
    ("culture-lane-forecast", [Some(10), Some(-10), Some(-7)]),
    ("deals-at-the-ceiling", [Some(-2), Some(5), Some(11)]),
    ("deals-for-our-gain", [Some(16), Some(21), Some(-10)]),
    ("defensible-sites", [Some(34), Some(25), Some(26)]),
    ("diplomatic-lane-forecast", [Some(6), Some(-10), Some(-17)]),
    ("district-coverage", [Some(-4), Some(-4), Some(14)]),
    ("district-coverage-2", [Some(-18), Some(-5), Some(-2)]),
    ("district-planning", [Some(-7), Some(25), Some(2)]),
    ("domination-city-count", [Some(1), Some(-17), Some(-8)]),
    ("early-contact-window", [Some(-8), Some(10), Some(17)]),
    ("elective-war-in-reach", [Some(7), Some(-5), Some(5)]),
    ("elective-war-yields-to-a-lane", [Some(49), Some(16), Some(49)]),
    ("encampment-seals-the-pass", [Some(1), Some(3), None]),
    ("enemy-of-my-enemy", [Some(5), Some(-9), Some(-18)]),
    ("engine-faith-price", [Some(20), Some(18), Some(37)]),
    ("enhancer-for-the-corps", [Some(8), Some(5), Some(-3)]),
    ("escort-unstick", [Some(-3), Some(-6), Some(16)]),
    ("eureka-chasing-builder", [Some(-22), Some(1), Some(-9)]),
    ("eureka-chasing-production", [Some(-20), Some(-10), Some(-10)]),
    ("expansion-pays-back", [Some(-7), Some(-23), Some(-8)]),
    ("expansion-schedule", [Some(-13), Some(1), Some(11)]),
    ("first-builder-reserve", [Some(5), Some(-12), Some(3)]),
    ("first-research-building-reserve", [Some(0), Some(-17), Some(-21)]),
    ("flip-nearby-city-states", [Some(0), Some(-3), Some(-9)]),
    ("founder-temple", [Some(-3), Some(1), Some(8)]),
    ("frontier-massing-alarm", [Some(-5), Some(16), Some(2)]),
    ("garrison-under-fire", [Some(-12), Some(14), Some(-8)]),
    ("gold-for-the-young-city", [Some(5), Some(10), None]),
    ("government-ladder", [Some(-21), Some(-4), Some(20)]),
    ("great-person-housing", [Some(32), Some(13), Some(34)]),
    ("growth-to-settle", [Some(3), Some(-1), Some(-25)]),
    ("guru-heals-the-corps-2", [Some(12), Some(-18), Some(18)]),
    ("holy-lane-parity", [Some(-11), Some(14), Some(0)]),
    ("holy-site-where-the-threat-is", [Some(12), Some(-2), Some(-12)]),
    ("holy-site-where-the-threat-is-2", [Some(1), Some(11), Some(5)]),
    ("housing-research", [Some(-38), Some(1), Some(-19)]),
    ("idle-faith-patronage", [Some(8), Some(1), Some(-18)]),
    ("improvement-housing-value", [Some(-16), Some(-6), Some(-2)]),
    ("lane-culture-spending", [Some(-31), Some(-18), Some(-10)]),
    ("lane-great-people", [Some(-10), Some(-8), Some(22)]),
    ("lane-policy-deck", [Some(-19), Some(-4), Some(22)]),
    ("lane-space-race", [Some(5), Some(-19), Some(17)]),
    ("loyalty-rate-alarm", [Some(21), Some(53), Some(31)]),
    ("maintenance-aware-deck", [Some(7), Some(8), Some(28)]),
    ("missionary-evades-raiders", [Some(8), Some(12), Some(16)]),
    ("missionary-last-charge-explores", [Some(4), Some(-19), Some(-10)]),
    ("native-emergency-purchase", [Some(3), Some(6), None]),
    ("naval-recon", [Some(52), Some(-8), Some(-15)]),
    ("naval-recon-2", [Some(-26), Some(-10), Some(-3)]),
    ("naval-threat-triage", [Some(27), Some(7), Some(18)]),
    ("never-an-empty-queue", [Some(-2), Some(17), Some(14)]),
    ("never-an-empty-queue-2", [Some(6), Some(-8), Some(-16)]),
    ("no-free-passage", [Some(-7), Some(11), Some(-15)]),
    ("one-launch-pad", [Some(10), Some(29), Some(15)]),
    ("one-shot-recovery", [Some(-29), Some(-8), Some(6)]),
    ("one-war-at-a-time", [Some(-22), Some(-25), Some(5)]),
    ("opening-warrior-recon", [Some(-33), Some(-33), Some(-24)]),
    ("opportunistic-war", [Some(12), Some(22), Some(38)]),
    ("order-retry", [Some(-5), Some(-4), Some(-4)]),
    ("pantheon-board", [Some(2), Some(4), Some(4)]),
    ("pass-picket", [Some(14), Some(-14), Some(3)]),
    ("peacetime-deterrence", [Some(-25), Some(10), Some(4)]),
    ("power-the-laboratory", [Some(4), Some(9), Some(-8)]),
    ("power-the-laboratory-2", [Some(-8), Some(8), Some(-1)]),
    ("price-the-suzerainty", [Some(22), Some(31), Some(24)]),
    ("promote-when-wounded", [Some(-13), Some(30), Some(2)]),
    ("quest-boost", [Some(15), Some(1), None]),
    ("quest-camp-errand", [Some(-13), Some(-6), None]),
    ("quest-production", [Some(-5), Some(3), None]),
    ("quest-trade-route", [Some(15), Some(21), None]),
    ("raid-pillage-prizes", [Some(-26), Some(-1), Some(-17)]),
    ("rapid-city-expansion", [Some(-112), Some(-137), Some(-81)]),
    ("recon-replacement", [Some(8), Some(6), Some(13)]),
    ("recorded-tactical-step", [Some(15), Some(-13), Some(-5)]),
    ("recovery-reads-the-war", [Some(11), Some(-12), Some(-16)]),
    ("relief-targets-the-siege", [Some(11), Some(8), Some(0)]),
    ("religion-sues-peace", [Some(-4), Some(5), Some(-8)]),
    ("religious-defence-scales", [Some(-17), Some(-4), Some(-18)]),
    ("religious-units-heal-first", [Some(21), Some(2), Some(2)]),
    ("religious-veto-defence", [Some(30), Some(23), Some(27)]),
    ("research-tier-premium", [Some(-7), Some(34), Some(15)]),
    ("rival-suzerainty-alarm", [Some(30), Some(-11), Some(6)]),
    ("science-building-first", [Some(3), Some(-18), None]),
    ("science-chain-alarm", [Some(12), Some(7), Some(0)]),
    ("science-multiplier-payoff", [Some(-8), Some(-3), Some(-1)]),
    ("science-victory-drive", [Some(16), Some(41), Some(40)]),
    ("score-horizon", [Some(-5), Some(-11), Some(-4)]),
    ("settle-sooner", [Some(6), Some(22), Some(3)]),
    ("settlement-gap-target", [Some(-4), Some(4), Some(12)]),
    ("settler-factory-coordination", [Some(-34), Some(10), Some(-12)]),
    ("settler-guard-holds", [Some(-24), Some(1), Some(0)]),
    ("settler-guard-holds-2", [Some(19), Some(-2), Some(-12)]),
    ("settler-screen", [Some(-4), Some(1), Some(4)]),
    ("settler-second-look", [Some(-15), Some(0), Some(4)]),
    ("settler-target-hysteresis", [Some(2), Some(13), Some(21)]),
    ("settler-target-hysteresis-2", [Some(20), Some(6), Some(15)]),
    ("settler-threat-detour", [Some(18), Some(16), Some(-1)]),
    ("siege-commitment", [Some(-3), Some(-16), Some(-10)]),
    ("siege-is-progress-2", [Some(-17), Some(4), Some(-6)]),
    ("skip-the-prophet-race", [Some(-129), Some(-148), None]),
    ("slot-kind-tiebreak", [Some(27), Some(4), Some(-12)]),
    ("solvency-first-trade-slot", [Some(121), Some(99), Some(143)]),
    ("solvency-first-trade-slot-2", [Some(-31), Some(-22), Some(-44)]),
    ("stranded-settler-discount", [Some(38), Some(17), Some(2)]),
    ("strategic-wonders", [Some(1), Some(4), Some(0)]),
    ("strike-opening", [Some(15), Some(-9), Some(0)]),
    ("surprise-war-mobilization", [Some(0), Some(-5), Some(15)]),
    ("unchosen-war-keeps-the-lane", [Some(7), Some(6), Some(-1)]),
    ("unit-cost-efficiency", [Some(3), Some(25), Some(-3)]),
    ("unit-objective-memory", [Some(19), Some(2), Some(7)]),
    ("upgrade-the-garrison", [Some(-10), Some(7), Some(-6)]),
    ("war-economy", [Some(-8), Some(-2), Some(8)]),
    ("war-reinforcement", [Some(5), Some(13), Some(11)]),
    ("whole-turn-backtrack-guard", [Some(11), Some(4), Some(-19)]),
    ("wide-map-capacity", [Some(40), Some(40), Some(28)]),
    ("wonder-adjacent-sites", [Some(8), Some(6), Some(4)]),
    ("wonder-adjacent-sites-2", [Some(-10), Some(-3), Some(-6)]),
    ("wonder-ring-recon", [Some(0), Some(-6), Some(4)]),
    ("wonder-score-tally", [Some(6), Some(14), Some(9)]),
];
