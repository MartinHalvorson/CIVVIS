...
pub const GENES: &[Gene] = &[
    ...
    // Version 2 smooths each civilization's majority separately, then gives
    // those equal shares the victory condition gives them. One enormous
    // converted empire can no longer outweigh several untouched holdouts.
