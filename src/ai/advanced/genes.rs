...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(19), Some(4), Some(-9)]),
    ("air-surge", [Some(17), Some(23), Some(4)]),
    ("air-surge-2", [Some(-15), Some(-3), Some(7)]),
    ("amenity-district-path", [Some(11), Some(10), Some(-17)]),
    ("amenity-project-preemption", [Some(2), Some(10), Some(0)]),
    ("amenity-project-preemption-2", [Some(-5), Some(3), Some(7)]),
    ("anvil", [Some(-3), Some(-6), None]),
    ("apostle-promotion-by-role", [Some(-12), Some(18), Some(16)]),
    ("army-target-weighs-enemy", [Some(-5), Some(-9), Some(26)]),
    ("barbarian-bargain", [Some(21), Some(1), Some(-19)]),
    ("barbarian-ranged-answer", [Some(-16), Some(-1), Some(34)]),
    ("barbarian-scouts-are-scouts", [Some(6), Some(-2), Some(-13)]),
    ("barbarian-settler-capture", [Some(19), Some(16), Some(40)]),
    ("battle-planner", [Some(16), Some(-3), Some(56)]),
    ("battle-planner-2", [Some(25), Some(6), None]),
    ("battle-planner-3", [Some(8), Some(25), None]),
    ("blind-objective-strength", [Some(20), Some(-1), Some(-31)]),
    ("blind-objective-units", [Some(-20), Some(-11), Some(-2)]),
    ("boost-first-research", [Some(-9), Some(5), Some(-9)]),
    ("boost-unlock-research", [Some(7), Some(-8), Some(-10)]),
    ("boost-wait-research", [Some(-14), Some(-6), Some(-8)]),
    ("boost-wait-research-2", [Some(-14), Some(29), Some(1)]),
    ("boosted-bargain-first", [Some(12), Some(-5), Some(-14)]),
    ("boosted-bargain-first-2", [Some(17), Some(9), None]),
    ("border-parity", [Some(-9), Some(1), Some(-25)]),
    ("border-parity-2", [Some(-25), Some(18), Some(5)]),
    ("border-parity-3", [Some(13), Some(19), None]),
    ("bounded-recovery", [Some(-11), Some(24), Some(-2)]),
    ("build-what-cards-boost", [Some(-5), Some(-19), Some(-10)]),
    ("builder-barbarian-safety", [Some(-20), Some(46), Some(9)]),
    ("builder-supply-floor", [Some(-24), Some(19), Some(-1)]),
    ("builder-tries-the-next-tile", [Some(-6), Some(-7), Some(5)]),
    ("buildings-before-projects", [Some(-5), Some(-16), Some(-10)]),
    ("buy-what-cards-cannot-boost", [Some(3), Some(14), Some(8)]),
    ("camp-party", [Some(8), Some(11), Some(22)]),
    ("camp-tile-buyout", [Some(-1), Some(-13), Some(14)]),
    ("campaign-pillage", [Some(12), Some(23), Some(15)]),
    ("campus-adjacency-threshold", [Some(-8), Some(-15), Some(-11)]),
    ("campus-adjacency-threshold-2", [Some(-1), Some(-2), Some(-10)]),
    ("campus-through-expansion", [Some(10), Some(-25), Some(3)]),
    ("canal-city", [Some(18), Some(-22), Some(10)]),
    ("capital-settler-after-completion", [Some(5), Some(-6), Some(-10)]),
    ("capture-go-or-stand-down", [Some(10), Some(-37), Some(1)]),
    ("capture-go-or-stand-down-2", [Some(9), Some(27), Some(24)]),
    ("chain-payback-window", [Some(13), Some(-29), Some(-3)]),
    ("chain-payback-window-2", [Some(-17), Some(18), Some(-11)]),
    ("chase-every-boost", [Some(-10), Some(-18), Some(-26)]),
    ("chase-every-boost-2", [Some(4), None, None]),
    ("cheapest-wonder-first", [Some(9), Some(5), Some(-3)]),
    ("chokepoint-claim", [Some(0), Some(-10), Some(-23)]),
    ("chokepoint-garrison", [Some(4), Some(5), Some(23)]),
    ("chokepoint-siting", [Some(-6), Some(-3), Some(-4)]),
    ("chop-into-the-queue", [Some(11), Some(-3), Some(-23)]),
    ("city-campaign", [Some(-3), Some(-27), Some(-38)]),
    ("city-campaign-2", [Some(16), None, None]),
    ("city-target-meets-the-map", [Some(-6), Some(0), Some(34)]),
    ("civilian-out-of-reach", [Some(-8), Some(-12), Some(-39)]),
    ("close-as-a-body", [Some(-14), Some(16), Some(3)]),
    ("coalition-before-war", [Some(13), Some(-14), Some(-4)]),
    ("coalition-before-war-2", [Some(11), Some(26), Some(-18)]),
    ("coalition-before-war-3", [Some(-6), None, None]),
    ("coastal-city-sites", [Some(16), Some(-6), Some(-9)]),
    ("coastal-city-sites-2", [Some(3), Some(-8), Some(-27)]),
    ("come-ashore", [Some(13), Some(-4), Some(-2)]),
    ("commitment-owner-acts", [Some(26), Some(26), Some(-10)]),
    ("commitment-patience", [Some(22), Some(-14), Some(-13)]),
    ("competition-victory-points", [Some(-16), Some(-13), Some(20)]),
    ("congress-counter-leader", [Some(12), Some(-13), Some(-27)]),
    ("connect-the-luxury", [Some(-4), Some(42), Some(30)]),
    ("contested-land-first", [Some(10), Some(12), Some(-15)]),
    ("conversion-majority-alarm", [Some(17), Some(-1), Some(-4)]),
    ("conversion-majority-alarm-2", [Some(-11), Some(21), None]),
    ("coordinated-finish", [Some(-11), Some(3), Some(21)]),
    ("culture-building-debt", [Some(6), Some(-16), Some(6)]),
    ("culture-floor", [Some(15), Some(8), Some(-8)]),
    ("culture-lane-forecast", [Some(-2), Some(-8), Some(-5)]),
    ("deals-at-the-ceiling", [Some(10), Some(-5), Some(20)]),
    ("deals-for-our-gain", [Some(-10), Some(3), Some(43)]),
    ("defend-where-you-stand", [Some(3), Some(6), Some(24)]),
    ("defensible-sites", [Some(33), Some(7), Some(40)]),
    ("diplomatic-lane-forecast", [Some(-6), Some(25), Some(1)]),
    ("diplomatic-lane-forecast-2", [Some(15), Some(11), None]),
    ("district-coverage", [Some(-19), Some(-23), Some(6)]),
    ("district-coverage-2", [Some(-6), Some(-8), Some(10)]),
    ("district-planning", [Some(1), Some(27), Some(10)]),
    ("district-planning-2", [Some(10), Some(1), Some(-11)]),
    ("district-planning-3", [Some(-2), Some(-18), None]),
    ("domination-city-count", [Some(-2), Some(24), Some(-3)]),
    ("early-archers", [Some(-23), Some(11), Some(2)]),
    ("early-contact-window", [Some(-4), Some(-23), Some(-10)]),
    ("early-project-restraint", [Some(7), Some(-3), Some(-26)]),
    ("early-project-restraint-2", [Some(-14), Some(-25), None]),
    ("elective-war-in-reach", [Some(-18), Some(10), Some(21)]),
    ("elective-war-yields-to-a-lane", [Some(51), Some(31), Some(52)]),
    ("encampment-seals-the-pass", [Some(17), Some(-12), Some(33)]),
    ("enemy-of-my-enemy", [Some(-16), Some(1), Some(-15)]),
    ("engine-faith-price", [Some(11), Some(-12), Some(51)]),
    ("enhancer-for-the-corps", [Some(-5), Some(12), Some(-8)]),
    ("enter-the-prophet-race", [Some(-13), Some(7), Some(-6)]),
    ("enter-the-prophet-race-2", [Some(35), Some(44), None]),
    ("escort-cap-holds", [Some(20), Some(2), Some(-4)]),
    ("escort-unstick", [Some(38), Some(23), Some(-8)]),
    ("eureka-chasing-builder", [Some(25), Some(13), Some(-5)]),
    ("eureka-chasing-builder-2", [Some(6), Some(-25), None]),
    ("eureka-chasing-production", [Some(-14), Some(18), Some(-12)]),
    ("exchange-is-the-engines", [Some(-17), Some(-14), Some(24)]),
    ("exhaustion-loyalty-guard", [Some(6), Some(-36), Some(11)]),
    ("expansion-pays-back", [Some(-5), Some(19), Some(8)]),
    ("expansion-schedule", [Some(6), Some(3), Some(30)]),
    ("fire-plan", [Some(-14), Some(1), Some(19)]),
    ("first-builder-reserve", [Some(-8), Some(23), Some(-4)]),
    ("first-builder-reserve-2", [Some(17), Some(-10), Some(-11)]),
    ("first-district-first", [Some(-20), Some(-17), Some(-55)]),
    ("first-granary-reserve", [Some(14), Some(3), Some(11)]),
    ("first-luxury-first", [Some(3), Some(20), Some(-19)]),
    ("first-research-building-reserve", [Some(1), Some(-47), Some(-28)]),
    ("flip-nearby-city-states", [Some(11), Some(-19), Some(-22)]),
    ("founder-temple", [Some(11), Some(17), Some(42)]),
    ("frontier-massing-alarm", [Some(-2), Some(-4), Some(-2)]),
    ("garrison-under-fire", [Some(-4), Some(-30), Some(-19)]),
    ("gold-for-the-young-city", [Some(4), Some(-10), Some(7)]),
    ("gold-income-floor", [Some(16), Some(31), Some(11)]),
    ("government-capacity-fallback", [Some(-14), Some(-4), Some(21)]),
    ("government-ladder", [Some(-25), Some(-15), Some(-25)]),
    ("government-ladder-2", [Some(32), Some(8), Some(26)]),
    ("great-person-housing", [Some(9), Some(16), Some(23)]),
    ("growth-to-settle", [Some(-12), Some(-8), Some(0)]),
    ("guru-heals-the-corps-2", [Some(-6), Some(-12), Some(17)]),
    ("holy-lane-parity", [Some(12), Some(-6), Some(33)]),
    ("holy-site-where-the-threat-is", [Some(-3), Some(-31), Some(-7)]),
    ("holy-site-where-the-threat-is-2", [Some(17), Some(6), Some(-6)]),
    ("hostile-memory", [Some(-9), Some(-29), Some(-9)]),
    ("housing-research", [Some(-13), Some(2), Some(12)]),
    ("idle-faith-patronage", [Some(18), Some(-34), Some(-4)]),
    ("improvement-housing-value", [Some(-29), Some(-18), Some(-24)]),
    ("industrial-chain-debt", [Some(-22), Some(24), Some(1)]),
    ("island-exploration", [Some(1), Some(-22), Some(15)]),
    ("lane-culture-spending", [Some(22), Some(25), Some(-19)]),
    ("lane-great-people", [Some(-4), Some(-15), Some(11)]),
    ("lane-policy-deck", [Some(-5), Some(1), Some(-5)]),
    ("lane-release-when-hopeless", [Some(1), Some(-20), Some(-19)]),
    ("lane-space-race", [Some(15), Some(17), Some(0)]),
    ("lane-votes-its-favor", [Some(-4), Some(-3), Some(-21)]),
    ("loyalty-rate-alarm", [Some(47), Some(8), Some(-7)]),
    ("maintenance-aware-deck", [Some(7), Some(5), Some(-11)]),
    ("missionary-evades-raiders", [Some(-9), Some(34), Some(1)]),
    ("missionary-last-charge-explores", [Some(2), Some(18), Some(-30)]),
    ("modernize-before-spending", [Some(-7), Some(4), None]),
    ("moksha-defends-the-faithless", [Some(0), Some(-9), Some(-9)]),
    ("native-emergency-purchase", [Some(-10), Some(-5), Some(-29)]),
    ("native-emergency-purchase-2", [Some(15), None, None]),
    ("naval-recon", [Some(-1), Some(8), Some(-8)]),
    ("naval-recon-2", [Some(26), Some(16), Some(0)]),
    ("naval-recon-3", [Some(-14), Some(1), Some(-2)]),
    ("naval-threat-triage", [Some(1), Some(6), Some(1)]),
    ("never-an-empty-queue", [Some(-30), Some(13), Some(-11)]),
    ("never-an-empty-queue-2", [Some(-3), Some(-5), Some(9)]),
    ("never-an-empty-queue-3", [Some(0), Some(7), Some(-21)]),
    ("no-free-passage", [Some(-3), Some(-10), Some(-16)]),
    ("objective-board", [Some(-5), Some(-17), None]),
    ("one-launch-pad", [Some(-28), Some(-4), Some(27)]),
    ("one-shot-recovery", [Some(8), Some(-11), Some(-28)]),
    ("one-war-at-a-time", [Some(-10), Some(-1), Some(-9)]),
    ("opening-warrior-recon", [Some(-3), Some(-12), Some(3)]),
    ("opening-warrior-recon-2", [Some(10), Some(-1), None]),
    ("opportunistic-war", [Some(2), Some(-15), Some(19)]),
    ("order-retry", [Some(-35), Some(12), Some(-1)]),
    ("overseas-settlement", [Some(20), Some(0), Some(5)]),
    ("pantheon-board", [Some(12), Some(20), Some(-5)]),
    ("pass-picket", [Some(3), Some(-14), Some(-10)]),
    ("peace-when-the-war-does-not-pay", [Some(-17), Some(-17), Some(-15)]),
    ("peacetime-deterrence", [Some(11), Some(15), Some(12)]),
    ("power-the-laboratory", [Some(3), Some(-12), Some(-2)]),
    ("power-the-laboratory-2", [Some(-15), Some(14), Some(-7)]),
    ("price-the-suzerainty", [Some(38), Some(35), Some(17)]),
    ("promote-when-wounded", [Some(0), Some(1), Some(-1)]),
    ("quest-boost", [Some(13), Some(10), Some(1)]),
    ("quest-camp-errand", [Some(-33), Some(32), Some(-9)]),
    ("quest-production", [Some(5), Some(-6), Some(-11)]),
    ("quest-trade-route", [Some(-9), Some(19), Some(6)]),
    ("raid-pillage-prizes", [Some(3), Some(8), Some(-21)]),
    ("rapid-city-expansion", [Some(-158), Some(-173), Some(-64)]),
    ("rapid-city-expansion-2", [Some(115), Some(139), Some(27)]),
    ("recon-replacement", [Some(5), Some(-18), Some(5)]),
    ("recorded-tactical-step", [Some(18), Some(10), Some(12)]),
    ("recovery-reads-the-war", [Some(-23), Some(9), Some(-9)]),
    ("recovery-reads-the-war-2", [Some(12), None, None]),
    ("relief-column-marches", [Some(10), Some(-17), Some(7)]),
    ("relief-targets-the-siege", [Some(6), Some(-6), Some(-20)]),
    ("religion-race-is-closed", [Some(3), Some(11), Some(5)]),
    ("religion-sues-peace", [Some(-2), Some(13), Some(6)]),
    ("religious-defence-scales", [Some(3), Some(-14), Some(15)]),
    ("religious-units-heal-first", [Some(-16), Some(4), Some(21)]),
    ("religious-veto-defence", [Some(-11), Some(31), Some(51)]),
    ("requisitions", [Some(-2), Some(-9), None]),
    ("research-tier-premium", [Some(10), Some(26), Some(-39)]),
    ("rival-suzerainty-alarm", [Some(-13), Some(-11), Some(15)]),
    ("science-building-first", [Some(5), Some(3), Some(-3)]),
    ("science-chain-alarm", [Some(8), Some(6), Some(9)]),
    ("science-expansion-phase", [Some(3), Some(2), Some(-12)]),
    ("science-multiplier-payoff", [Some(-4), Some(-14), Some(-9)]),
    ("science-opening-band", [Some(14), Some(7), Some(17)]),
    ("science-victory-drive", [Some(-34), Some(-9), Some(-22)]),
    ("science-victory-drive-2", [Some(44), Some(-1), Some(-1)]),
    ("score-horizon", [Some(-1), Some(-26), Some(19)]),
    ("screen-the-shooters", [Some(-25), Some(-10), Some(-3)]),
    ("settle-sooner", [Some(-16), Some(1), Some(17)]),
    ("settlement-gap-target", [Some(-3), Some(-13), Some(36)]),
    ("settler-backlog-brake", [Some(-17), Some(24), Some(-2)]),
    ("settler-factory-coordination", [Some(2), Some(-8), Some(4)]),
    ("settler-guard-holds", [Some(-1), Some(2), Some(-5)]),
    ("settler-guard-holds-2", [Some(-8), Some(6), Some(10)]),
    ("settler-never-idles", [Some(24), Some(25), Some(8)]),
    ("settler-screen", [Some(17), Some(-9), Some(24)]),
    ("settler-second-look", [Some(-3), Some(-25), Some(14)]),
    ("settler-site-gate", [Some(-14), Some(-13), Some(0)]),
    ("settler-target-floor", [Some(-7), Some(-4), Some(8)]),
    ("settler-target-hysteresis", [Some(1), Some(-7), Some(-8)]),
    ("settler-target-hysteresis-2", [Some(1), Some(16), Some(19)]),
    ("settler-threat-detour", [Some(9), Some(37), Some(8)]),
    ("settler-walk-deadline", [Some(26), Some(16), Some(-2)]),
    ("siege-commitment", [Some(0), Some(-7), Some(-16)]),
    ("siege-is-progress-2", [Some(-6), Some(13), Some(11)]),
    ("siege-is-progress-3", [Some(18), None, None]),
    ("siege-preempts-the-queue", [Some(-27), Some(-37), Some(-2)]),
    ("siege-train", [Some(4), Some(-39), None]),
    ("skip-the-prophet-race", [Some(-25), Some(-105), Some(-45)]),
    ("skip-the-prophet-race-2", [Some(3), Some(85), Some(16)]),
    ("slot-kind-tiebreak", [Some(-10), Some(-11), Some(24)]),
    ("solvency-first-trade-slot", [Some(82), Some(54), Some(45)]),
    ("spaceport-surplus-veto", [Some(4), Some(-23), Some(-18)]),
    ("stranded-settler-discount", [Some(23), Some(19), Some(14)]),
    ("strategic-wonders", [Some(-15), Some(-26), Some(14)]),
    ("strike-opening", [Some(12), Some(10), Some(19)]),
    ("surprise-war-mobilization", [Some(-13), Some(-1), Some(25)]),
    ("swap-rotation", [Some(6), Some(-3), Some(-37)]),
    ("threatened-city-reserve", [Some(-21), Some(-29), Some(17)]),
    ("trade-route-network", [Some(13), Some(-10), Some(22)]),
    ("treasury-at-work", [Some(4), Some(4), Some(-11)]),
    ("treasury-at-work-2", [Some(24), Some(20), Some(21)]),
    ("unchosen-war-keeps-the-lane", [Some(10), Some(58), Some(3)]),
    ("unit-cost-efficiency", [Some(-1), Some(3), Some(38)]),
    ("unit-objective-memory", [Some(4), Some(-15), Some(-19)]),
    ("upgrade-the-garrison", [Some(0), Some(-6), Some(-23)]),
    ("veterans-withdraw-early", [Some(4), Some(18), None]),
    ("walls-after-districts", [Some(-17), Some(23), Some(-12)]),
    ("war-economy", [Some(23), Some(-3), Some(-2)]),
    ("war-needs-a-treasury", [Some(0), Some(21), Some(-11)]),
    ("war-policy-via-board", [Some(4), Some(-1), None]),
    ("war-reinforcement", [Some(19), Some(-38), Some(-8)]),
    ("whole-turn-backtrack-guard", [Some(17), Some(-2), Some(-31)]),
    ("wide-map-capacity", [Some(9), Some(27), Some(28)]),
    ("wonder-adjacent-sites", [Some(37), Some(16), Some(-3)]),
    ("wonder-adjacent-sites-2", [Some(-36), Some(5), Some(9)]),
    ("wonder-ring-recon", [Some(2), Some(10), Some(-11)]),
    ("wonder-score-tally", [Some(-1), Some(9), Some(23)]),
    ("wounded-out-of-reach", [Some(-8), Some(-7), Some(26)]),
];
...
pub(super) const VERDICTS: &[GeneVerdict] = &[
    ...
    GeneVerdict { tag: "maintenance-aware-deck", verdict: Verdict::Helps, default_on: false, wins_last_10k: Some(61), wins_prior_10k: None, win_diff_pp: Some(1.229909), posterior_pp: Some(61.49546), posterior_se_pp: Some(19.045342), family_wise: true, screen: Some(Measure { pairs: 19080, win_delta_pp: 1.23, win_z: 3.229, share_delta_pp: 0.341, share_z: 4.381, source: "2026-08-24-standard-continuous-38160-total-seats.json" }) },
