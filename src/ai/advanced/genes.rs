...
pub const GENES: &[Gene] = &[
    ...
    // Version two never weakens the held tile: the relief must match the
    // wounded unit's effective strength, and strength ranks before health.
    // It also reads siege depth from a nearby hostile city even after a force
    // group dissolves, and teaches the joint battle planner the same rule.
...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(-9), Some(-6), Some(-20)]),
    ("air-surge", [Some(4), Some(26), Some(29)]),
    ("air-surge-2", [Some(7), None, None]),
    ("amenity-district-path", [Some(-17), Some(6), Some(-12)]),
    ("amenity-project-preemption", [Some(0), Some(-18), Some(-29)]),
    ("amenity-project-preemption-2", [Some(7), Some(-2), Some(25)]),
    ("apostle-promotion-by-role", [Some(16), Some(14), Some(10)]),
    ("army-target-weighs-enemy", [Some(26), Some(-7), Some(3)]),
    ("barbarian-bargain", [Some(-19), Some(22), Some(2)]),
    ("barbarian-ranged-answer", [Some(34), Some(-15), Some(-20)]),
    ("barbarian-scouts-are-scouts", [Some(-13), Some(10), Some(-3)]),
    ("barbarian-settler-capture", [Some(40), Some(27), Some(19)]),
    ("battle-planner", [Some(56), None, None]),
    ("blind-objective-strength", [Some(-31), Some(11), Some(12)]),
    ("blind-objective-units", [Some(-2), Some(3), Some(-16)]),
    ("boost-first-research", [Some(-9), Some(5), Some(-21)]),
    ("boost-unlock-research", [Some(-10), Some(13), Some(8)]),
    ("boost-wait-research", [Some(-8), Some(-4), Some(-3)]),
    ("boost-wait-research-2", [Some(1), None, None]),
    ("boosted-bargain-first", [Some(-14), Some(-19), Some(-20)]),
    ("border-parity", [Some(-25), Some(-2), Some(3)]),
    ("border-parity-2", [Some(5), Some(-12), Some(-6)]),
    ("bounded-recovery", [Some(-2), Some(0), Some(-19)]),
    ("build-what-cards-boost", [Some(-10), Some(3), Some(17)]),
    ("builder-barbarian-safety", [Some(9), Some(-18), Some(-18)]),
    ("builder-supply-floor", [Some(-1), Some(0), Some(8)]),
    ("builder-tries-the-next-tile", [Some(5), Some(-4), Some(24)]),
    ("buildings-before-projects", [Some(-10), Some(6), Some(-16)]),
    ("buy-what-cards-cannot-boost", [Some(8), Some(-15), Some(-1)]),
    ("camp-party", [Some(22), Some(1), Some(-7)]),
    ("camp-tile-buyout", [Some(14), Some(-2), Some(1)]),
    ("campaign-pillage", [Some(15), Some(7), Some(17)]),
    ("campus-adjacency-threshold", [Some(-11), Some(-8), Some(-20)]),
    ("campus-adjacency-threshold-2", [Some(-10), Some(-7), Some(4)]),
    ("campus-through-expansion", [Some(3), None, None]),
    ("canal-city", [Some(10), Some(12), Some(24)]),
    ("capital-settler-after-completion", [Some(-10), Some(-2), Some(26)]),
    ("capture-go-or-stand-down", [Some(1), Some(7), Some(-19)]),
    ("capture-go-or-stand-down-2", [Some(24), Some(-1), Some(-1)]),
    ("chain-payback-window", [Some(-3), Some(-3), Some(2)]),
    ("chain-payback-window-2", [Some(-11), Some(5), Some(13)]),
    ("chase-every-boost", [Some(-26), None, None]),
    ("cheapest-wonder-first", [Some(-3), Some(-11), Some(29)]),
    ("chokepoint-claim", [Some(-23), Some(4), Some(17)]),
    ("chokepoint-garrison", [Some(23), Some(-22), Some(10)]),
    ("chokepoint-siting", [Some(-4), Some(12), Some(19)]),
    ("chop-into-the-queue", [Some(-23), Some(-19), Some(-15)]),
    ("city-campaign", [Some(-38), Some(-31), Some(4)]),
    ("city-target-meets-the-map", [Some(34), Some(-14), Some(26)]),
    ("civilian-out-of-reach", [Some(-39), Some(14), Some(-41)]),
    ("close-as-a-body", [Some(3), Some(17), Some(3)]),
    ("coalition-before-war", [Some(-4), Some(28), Some(-24)]),
    ("coalition-before-war-2", [Some(-18), None, None]),
    ("coastal-city-sites", [Some(-9), Some(7), Some(-13)]),
    ("coastal-city-sites-2", [Some(-27), Some(-14), Some(2)]),
    ("come-ashore", [Some(-2), Some(-24), Some(5)]),
    ("commitment-owner-acts", [Some(-10), None, None]),
    ("commitment-patience", [Some(-13), Some(0), Some(21)]),
    ("competition-victory-points", [Some(20), Some(0), Some(2)]),
    ("congress-counter-leader", [Some(-27), Some(4), Some(-23)]),
    ("connect-the-luxury", [Some(30), Some(28), Some(39)]),
    ("contested-land-first", [Some(-15), Some(1), Some(19)]),
    ("conversion-majority-alarm", [Some(-4), Some(-13), Some(-33)]),
    ("coordinated-finish", [Some(21), Some(-4), Some(11)]),
    ("culture-building-debt", [Some(6), Some(-2), Some(13)]),
    ("culture-floor", [Some(-8), Some(-10), Some(-18)]),
    ("culture-lane-forecast", [Some(-5), Some(0), Some(-8)]),
    ("deals-at-the-ceiling", [Some(20), Some(5), Some(-7)]),
    ("deals-for-our-gain", [Some(43), Some(-2), Some(-30)]),
    ("defend-where-you-stand", [Some(24), Some(1), Some(-7)]),
    ("defensible-sites", [Some(40), Some(7), Some(16)]),
    ("diplomatic-lane-forecast", [Some(1), Some(19), Some(-31)]),
    ("district-coverage", [Some(6), Some(1), Some(3)]),
    ("district-coverage-2", [Some(10), Some(5), Some(3)]),
    ("district-planning", [Some(10), Some(20), Some(14)]),
    ("district-planning-2", [Some(-11), Some(-39), None]),
    ("domination-city-count", [Some(-3), Some(5), Some(2)]),
    ("early-archers", [Some(2), Some(19), Some(9)]),
    ("early-contact-window", [Some(-10), Some(-2), Some(-12)]),
    ("early-project-restraint", [Some(-26), Some(7), Some(-10)]),
    ("elective-war-in-reach", [Some(21), Some(7), Some(16)]),
    ("elective-war-yields-to-a-lane", [Some(52), Some(29), Some(67)]),
    ("encampment-seals-the-pass", [Some(33), Some(-16), Some(-7)]),
    ("enemy-of-my-enemy", [Some(-15), Some(3), Some(7)]),
    ("engine-faith-price", [Some(51), Some(33), Some(22)]),
    ("enhancer-for-the-corps", [Some(-8), Some(-26), Some(-2)]),
    ("enter-the-prophet-race", [Some(-6), Some(15), Some(-41)]),
    ("escort-cap-holds", [Some(-4), Some(-6), Some(-18)]),
    ("escort-unstick", [Some(-8), Some(1), Some(35)]),
    ("eureka-chasing-builder", [Some(-5), Some(-6), Some(1)]),
    ("eureka-chasing-production", [Some(-12), Some(2), Some(11)]),
    ("exchange-is-the-engines", [Some(24), Some(12), Some(13)]),
    ("exhaustion-loyalty-guard", [Some(11), Some(12), Some(5)]),
    ("expansion-pays-back", [Some(8), Some(1), Some(7)]),
    ("expansion-schedule", [Some(30), Some(-11), Some(8)]),
    ("fire-plan", [Some(19), Some(10), Some(18)]),
    ("first-builder-reserve", [Some(-4), Some(-1), Some(-14)]),
    ("first-builder-reserve-2", [Some(-11), None, None]),
    ("first-district-first", [Some(-55), Some(-10), Some(-5)]),
    ("first-granary-reserve", [Some(11), Some(11), Some(7)]),
    ("first-luxury-first", [Some(-19), Some(9), Some(17)]),
    ("first-research-building-reserve", [Some(-28), Some(7), Some(-2)]),
    ("flip-nearby-city-states", [Some(-22), Some(7), Some(3)]),
    ("founder-temple", [Some(42), Some(-7), Some(3)]),
    ("frontier-massing-alarm", [Some(-2), Some(23), Some(6)]),
    ("garrison-under-fire", [Some(-19), Some(1), Some(-28)]),
    ("gold-for-the-young-city", [Some(7), Some(-6), Some(-9)]),
    ("gold-income-floor", [Some(11), Some(-17), Some(4)]),
    ("government-capacity-fallback", [Some(21), Some(3), Some(-10)]),
    ("government-ladder", [Some(-25), Some(2), Some(-29)]),
    ("government-ladder-2", [Some(26), Some(1), Some(28)]),
    ("great-person-housing", [Some(23), Some(-5), Some(23)]),
    ("growth-to-settle", [Some(0), Some(0), Some(10)]),
    ("guru-heals-the-corps-2", [Some(17), Some(-14), Some(-4)]),
    ("holy-lane-parity", [Some(33), Some(14), Some(5)]),
    ("holy-site-where-the-threat-is", [Some(-7), Some(-12), Some(-9)]),
    ("holy-site-where-the-threat-is-2", [Some(-6), Some(10), Some(8)]),
    ("hostile-memory", [Some(-9), Some(5), Some(-22)]),
    ("housing-research", [Some(12), Some(-13), Some(-16)]),
    ("idle-faith-patronage", [Some(-4), Some(11), Some(6)]),
    ("improvement-housing-value", [Some(-24), Some(-6), Some(-4)]),
    ("industrial-chain-debt", [Some(1), None, None]),
    ("island-exploration", [Some(15), Some(4), Some(-23)]),
    ("lane-culture-spending", [Some(-19), Some(1), Some(11)]),
    ("lane-great-people", [Some(11), Some(5), Some(-4)]),
    ("lane-policy-deck", [Some(-5), Some(0), Some(5)]),
    ("lane-release-when-hopeless", [Some(-19), Some(6), Some(11)]),
    ("lane-space-race", [Some(0), Some(7), Some(7)]),
    ("lane-votes-its-favor", [Some(-21), Some(4), Some(-15)]),
    ("loyalty-rate-alarm", [Some(-7), Some(10), Some(39)]),
    ("maintenance-aware-deck", [Some(-11), Some(-12), Some(-2)]),
    ("missionary-evades-raiders", [Some(1), Some(-28), Some(17)]),
    ("missionary-last-charge-explores", [Some(-30), Some(2), Some(-5)]),
    ("moksha-defends-the-faithless", [Some(-9), Some(-11), Some(-7)]),
    ("native-emergency-purchase", [Some(-29), Some(-10), Some(-38)]),
    ("naval-recon", [Some(-8), Some(-5), Some(1)]),
    ("naval-recon-2", [Some(0), Some(9), Some(-39)]),
    ("naval-recon-3", [Some(-2), None, None]),
    ("naval-threat-triage", [Some(1), Some(-6), Some(-4)]),
    ("never-an-empty-queue", [Some(-11), Some(13), Some(-2)]),
    ("never-an-empty-queue-2", [Some(9), Some(-12), Some(-23)]),
    ("never-an-empty-queue-3", [Some(-21), None, None]),
    ("no-free-passage", [Some(-16), Some(-28), Some(11)]),
    ("one-launch-pad", [Some(27), Some(7), Some(-13)]),
    ("one-shot-recovery", [Some(-28), Some(-16), Some(-7)]),
    ("one-war-at-a-time", [Some(-9), Some(17), Some(-1)]),
    ("opening-warrior-recon", [Some(3), Some(-47), Some(-26)]),
    ("opportunistic-war", [Some(19), Some(0), Some(12)]),
    ("order-retry", [Some(-1), Some(-2), Some(-15)]),
    ("overseas-settlement", [Some(5), Some(8), Some(7)]),
    ("pantheon-board", [Some(-5), Some(16), Some(18)]),
    ("pass-picket", [Some(-10), Some(10), Some(2)]),
    ("peace-when-the-war-does-not-pay", [Some(-15), Some(-8), Some(19)]),
    ("peacetime-deterrence", [Some(12), Some(15), Some(27)]),
    ("power-the-laboratory", [Some(-2), Some(-19), Some(7)]),
    ("power-the-laboratory-2", [Some(-7), Some(11), Some(20)]),
    ("price-the-suzerainty", [Some(17), Some(23), Some(2)]),
    ("promote-when-wounded", [Some(-1), Some(1), Some(9)]),
    ("quest-boost", [Some(1), Some(6), Some(-5)]),
    ("quest-camp-errand", [Some(-9), Some(-8), Some(-16)]),
    ("quest-production", [Some(-11), Some(-6), Some(12)]),
    ("quest-trade-route", [Some(6), Some(8), Some(8)]),
    ("raid-pillage-prizes", [Some(-21), Some(-13), Some(-17)]),
    ("rapid-city-expansion", [Some(-64), Some(-171), Some(-60)]),
    ("rapid-city-expansion-2", [Some(27), None, None]),
    ("recon-replacement", [Some(5), Some(-1), Some(-13)]),
    ("recorded-tactical-step", [Some(12), Some(32), Some(1)]),
    ("recovery-reads-the-war", [Some(-9), Some(9), Some(-8)]),
    ("relief-column-marches", [Some(7), Some(15), Some(0)]),
    ("relief-targets-the-siege", [Some(-20), Some(-5), Some(-25)]),
    ("religion-race-is-closed", [Some(5), Some(-3), Some(-6)]),
    ("religion-sues-peace", [Some(6), Some(-11), Some(-16)]),
    ("religious-defence-scales", [Some(15), Some(-2), Some(-7)]),
    ("religious-units-heal-first", [Some(21), Some(-11), Some(-14)]),
    ("religious-veto-defence", [Some(51), Some(19), Some(-24)]),
    ("research-tier-premium", [Some(-39), Some(-2), Some(-2)]),
    ("rival-suzerainty-alarm", [Some(15), Some(-11), Some(-2)]),
    ("science-building-first", [Some(-3), Some(10), Some(13)]),
    ("science-chain-alarm", [Some(9), Some(10), Some(13)]),
    ("science-expansion-phase", [Some(-12), Some(2), Some(25)]),
    ("science-multiplier-payoff", [Some(-9), Some(1), Some(8)]),
    ("science-opening-band", [Some(17), Some(-11), Some(7)]),
    ("science-victory-drive", [Some(-22), Some(-13), Some(-4)]),
    ("science-victory-drive-2", [Some(-1), Some(33), Some(23)]),
    ("score-horizon", [Some(19), Some(-15), Some(-17)]),
    ("screen-the-shooters", [Some(-3), Some(5), Some(-9)]),
    ("settle-sooner", [Some(17), Some(9), Some(45)]),
    ("settlement-gap-target", [Some(36), Some(-1), Some(21)]),
    ("settler-backlog-brake", [Some(-2), Some(-14), Some(-14)]),
    ("settler-factory-coordination", [Some(4), Some(-6), Some(-7)]),
    ("settler-guard-holds", [Some(-5), Some(2), Some(1)]),
    ("settler-guard-holds-2", [Some(10), Some(4), Some(6)]),
    ("settler-never-idles", [Some(8), Some(-14), Some(7)]),
    ("settler-screen", [Some(24), Some(18), Some(-29)]),
    ("settler-second-look", [Some(14), Some(26), Some(-23)]),
    ("settler-site-gate", [Some(0), None, None]),
    ("settler-target-floor", [Some(8), None, None]),
    ("settler-target-hysteresis", [Some(-8), Some(7), Some(11)]),
    ("settler-target-hysteresis-2", [Some(19), Some(2), Some(5)]),
    ("settler-threat-detour", [Some(8), Some(-1), Some(14)]),
    ("settler-walk-deadline", [Some(-2), None, None]),
    ("siege-commitment", [Some(-16), Some(-23), Some(9)]),
    ("siege-is-progress-2", [Some(11), Some(-2), Some(-1)]),
    ("siege-preempts-the-queue", [Some(-2), None, None]),
    ("skip-the-prophet-race", [Some(-45), Some(-50), Some(-12)]),
    ("skip-the-prophet-race-2", [Some(16), None, None]),
    ("slot-kind-tiebreak", [Some(24), Some(8), Some(21)]),
    ("solvency-first-trade-slot", [Some(45), Some(104), Some(120)]),
    ("spaceport-surplus-veto", [Some(-18), Some(12), None]),
    ("stranded-settler-discount", [Some(14), Some(-1), Some(-19)]),
    ("strategic-wonders", [Some(14), Some(-6), Some(-10)]),
    ("strike-opening", [Some(19), Some(25), Some(-10)]),
    ("surprise-war-mobilization", [Some(25), Some(-11), Some(-4)]),
    ("swap-rotation", [Some(-37), Some(9), Some(-17)]),
    ("threatened-city-reserve", [Some(17), Some(-10), Some(12)]),
    ("trade-route-network", [Some(22), None, None]),
    ("treasury-at-work", [Some(-11), Some(-3), Some(-9)]),
    ("treasury-at-work-2", [Some(21), Some(37), Some(17)]),
    ("unchosen-war-keeps-the-lane", [Some(3), Some(6), Some(-1)]),
    ("unit-cost-efficiency", [Some(38), Some(10), Some(4)]),
    ("unit-objective-memory", [Some(-19), Some(11), Some(11)]),
    ("upgrade-the-garrison", [Some(-23), Some(-13), Some(-7)]),
    ("walls-after-districts", [Some(-12), Some(13), Some(-5)]),
    ("war-economy", [Some(-2), Some(7), Some(23)]),
    ("war-needs-a-treasury", [Some(-11), Some(6), Some(1)]),
    ("war-reinforcement", [Some(-8), Some(-3), Some(1)]),
    ("whole-turn-backtrack-guard", [Some(-31), Some(5), Some(1)]),
    ("wide-map-capacity", [Some(28), Some(14), Some(19)]),
    ("wonder-adjacent-sites", [Some(-3), Some(8), Some(5)]),
    ("wonder-adjacent-sites-2", [Some(9), Some(-19), Some(-11)]),
    ("wonder-ring-recon", [Some(-11), Some(-3), Some(-11)]),
    ("wonder-score-tally", [Some(23), Some(-25), Some(-13)]),
    ("wounded-out-of-reach", [Some(26), None, None]),
];
