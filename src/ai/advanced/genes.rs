...
pub(super) const BATCH_COLUMNS: &[(&str, [Option<i32>; 3])] = &[
    ("age-closer", [Some(-6), Some(-20), Some(-11)]),
    ("air-surge", [Some(26), Some(29), Some(18)]),
    ("amenity-district-path", [Some(6), Some(-12), Some(35)]),
    ("amenity-project-preemption", [Some(-18), Some(-29), Some(11)]),
    ("amenity-project-preemption-2", [Some(-2), Some(25), Some(-17)]),
    ("apostle-promotion-by-role", [Some(14), Some(10), Some(-1)]),
    ("army-target-weighs-enemy", [Some(-7), Some(3), Some(19)]),
    ("barbarian-bargain", [Some(22), Some(2), Some(14)]),
    ("barbarian-ranged-answer", [Some(-15), Some(-20), Some(-14)]),
    ("barbarian-scouts-are-scouts", [Some(10), Some(-3), Some(-23)]),
    ("barbarian-settler-capture", [Some(27), Some(19), Some(35)]),
    ("blind-objective-strength", [Some(11), Some(12), Some(-19)]),
    ("blind-objective-units", [Some(3), Some(-16), Some(20)]),
    ("boost-first-research", [Some(5), Some(-21), Some(4)]),
    ("boost-unlock-research", [Some(13), Some(8), Some(-23)]),
    ("boost-wait-research", [Some(-4), Some(-3), Some(-8)]),
    ("boosted-bargain-first", [Some(-19), Some(-20), Some(-39)]),
    ("border-parity", [Some(-2), Some(3), Some(9)]),
    ("border-parity-2", [Some(-12), Some(-6), Some(-10)]),
    ("bounded-recovery", [Some(0), Some(-19), Some(9)]),
    ("build-what-cards-boost", [Some(3), Some(17), Some(-9)]),
    ("builder-barbarian-safety", [Some(-18), Some(-18), Some(-5)]),
    ("builder-supply-floor", [Some(0), Some(8), Some(-17)]),
    ("builder-tries-the-next-tile", [Some(-4), Some(24), Some(-23)]),
    ("buildings-before-projects", [Some(6), Some(-16), Some(-26)]),
    ("buy-what-cards-cannot-boost", [Some(-15), Some(-1), Some(24)]),
    ("camp-party", [Some(1), Some(-7), Some(-3)]),
    ("camp-tile-buyout", [Some(-2), Some(1), Some(-22)]),
    ("campaign-pillage", [Some(7), Some(17), Some(-6)]),
    ("campus-adjacency-threshold", [Some(-8), Some(-20), Some(22)]),
    ("campus-adjacency-threshold-2", [Some(-7), Some(4), Some(-20)]),
    ("canal-city", [Some(12), Some(24), Some(19)]),
    ("capital-settler-after-completion", [Some(-2), Some(26), Some(23)]),
    ("capture-go-or-stand-down", [Some(7), Some(-19), Some(-25)]),
    ("capture-go-or-stand-down-2", [Some(-1), Some(-1), Some(25)]),
    ("chain-payback-window", [Some(-3), Some(2), Some(-6)]),
    ("chain-payback-window-2", [Some(5), Some(13), Some(-26)]),
    ("cheapest-wonder-first", [Some(-11), Some(29), Some(-10)]),
    ("chokepoint-claim", [Some(4), Some(17), Some(-19)]),
    ("chokepoint-garrison", [Some(-22), Some(10), Some(-1)]),
    ("chokepoint-siting", [Some(12), Some(19), Some(22)]),
    ("chop-into-the-queue", [Some(-19), Some(-15), Some(-17)]),
    ("city-campaign", [Some(-31), Some(4), Some(-19)]),
    ("city-target-meets-the-map", [Some(-14), Some(26), Some(-14)]),
    ("civilian-out-of-reach", [Some(14), Some(-41), Some(14)]),
    ("close-as-a-body", [Some(17), Some(3), Some(-10)]),
    ("coalition-before-war", [Some(28), Some(-24), Some(-20)]),
    ("coastal-city-sites", [Some(7), Some(-13), Some(-2)]),
    ("coastal-city-sites-2", [Some(-14), Some(2), Some(-8)]),
    ("come-ashore", [Some(-24), Some(5), Some(-42)]),
    ("commitment-patience", [Some(0), Some(21), Some(26)]),
    ("competition-victory-points", [Some(0), Some(2), Some(12)]),
    ("congress-counter-leader", [Some(4), Some(-23), Some(-23)]),
    ("connect-the-luxury", [Some(28), Some(39), Some(66)]),
    ("contested-land-first", [Some(1), Some(19), Some(41)]),
    ("conversion-majority-alarm", [Some(-13), Some(-33), Some(6)]),
    ("coordinated-finish", [Some(-4), Some(11), Some(-2)]),
    ("culture-building-debt", [Some(-2), Some(13), Some(24)]),
    ("culture-floor", [Some(-10), Some(-18), Some(8)]),
    ("culture-lane-forecast", [Some(0), Some(-8), Some(29)]),
    ("deals-at-the-ceiling", [Some(5), Some(-7), Some(7)]),
    ("deals-for-our-gain", [Some(-2), Some(-30), Some(-2)]),
    ("defend-where-you-stand", [Some(1), Some(-7), Some(-44)]),
    ("defensible-sites", [Some(7), Some(16), Some(3)]),
    ("diplomatic-lane-forecast", [Some(19), Some(-31), Some(-30)]),
    ("district-coverage", [Some(1), Some(3), Some(-18)]),
    ("district-coverage-2", [Some(5), Some(3), Some(17)]),
    ("district-planning", [Some(20), Some(14), Some(1)]),
    ("district-planning-2", [Some(-39), None, None]),
    ("domination-city-count", [Some(5), Some(2), Some(26)]),
    ("early-archers", [Some(19), Some(9), Some(-15)]),
    ("early-contact-window", [Some(-2), Some(-12), Some(8)]),
    ("early-project-restraint", [Some(7), Some(-10), Some(-9)]),
    ("elective-war-in-reach", [Some(7), Some(16), Some(-5)]),
    ("elective-war-yields-to-a-lane", [Some(29), Some(67), Some(24)]),
    ("encampment-seals-the-pass", [Some(-16), Some(-7), Some(18)]),
    ("enemy-of-my-enemy", [Some(3), Some(7), Some(6)]),
    ("engine-faith-price", [Some(33), Some(22), Some(5)]),
    ("enhancer-for-the-corps", [Some(-26), Some(-2), Some(14)]),
    ("enter-the-prophet-race", [Some(15), Some(-41), Some(-30)]),
    ("escort-cap-holds", [Some(-6), Some(-18), Some(46)]),
    ("escort-unstick", [Some(1), Some(35), Some(-28)]),
    ("eureka-chasing-builder", [Some(-6), Some(1), Some(-20)]),
    ("eureka-chasing-production", [Some(2), Some(11), Some(-19)]),
    ("exchange-is-the-engines", [Some(12), Some(13), Some(2)]),
    ("exhaustion-loyalty-guard", [Some(12), Some(5), Some(-7)]),
    ("expansion-pays-back", [Some(1), Some(7), Some(21)]),
    ("expansion-schedule", [Some(-11), Some(8), Some(17)]),
    ("fire-plan", [Some(10), Some(18), Some(-6)]),
    ("first-builder-reserve", [Some(-1), Some(-14), Some(9)]),
    ("first-district-first", [Some(-10), Some(-5), Some(-5)]),
    ("first-granary-reserve", [Some(11), Some(7), Some(-8)]),
    ("first-luxury-first", [Some(9), Some(17), Some(15)]),
    ("first-research-building-reserve", [Some(7), Some(-2), Some(-5)]),
    ("flip-nearby-city-states", [Some(7), Some(3), Some(3)]),
    ("founder-temple", [Some(-7), Some(3), Some(17)]),
    ("frontier-massing-alarm", [Some(23), Some(6), Some(0)]),
    ("garrison-under-fire", [Some(1), Some(-28), Some(10)]),
    ("gold-for-the-young-city", [Some(-6), Some(-9), Some(30)]),
    ("gold-income-floor", [Some(-17), Some(4), Some(18)]),
    ("government-capacity-fallback", [Some(3), Some(-10), Some(-23)]),
    ("government-ladder", [Some(2), Some(-29), Some(-9)]),
    ("government-ladder-2", [Some(1), Some(28), Some(-9)]),
    ("great-person-housing", [Some(-5), Some(23), Some(26)]),
    ("growth-to-settle", [Some(0), Some(10), Some(-8)]),
    ("guru-heals-the-corps-2", [Some(-14), Some(-4), Some(5)]),
    ("holy-lane-parity", [Some(14), Some(5), Some(4)]),
    ("holy-site-where-the-threat-is", [Some(-12), Some(-9), Some(-6)]),
    ("holy-site-where-the-threat-is-2", [Some(10), Some(8), Some(37)]),
    ("hostile-memory", [Some(5), Some(-22), Some(-23)]),
    ("housing-research", [Some(-13), Some(-16), Some(8)]),
    ("idle-faith-patronage", [Some(11), Some(6), Some(26)]),
    ("improvement-housing-value", [Some(-6), Some(-4), Some(18)]),
    ("island-exploration", [Some(4), Some(-23), Some(46)]),
    ("lane-culture-spending", [Some(1), Some(11), Some(-11)]),
    ("lane-great-people", [Some(5), Some(-4), Some(-24)]),
    ("lane-policy-deck", [Some(0), Some(5), Some(-13)]),
    ("lane-release-when-hopeless", [Some(6), Some(11), Some(3)]),
    ("lane-space-race", [Some(7), Some(7), Some(-13)]),
    ("lane-votes-its-favor", [Some(4), Some(-15), Some(6)]),
    ("loyalty-rate-alarm", [Some(10), Some(39), Some(8)]),
    ("maintenance-aware-deck", [Some(-12), Some(-2), Some(25)]),
    ("missionary-evades-raiders", [Some(-28), Some(17), Some(10)]),
    ("missionary-last-charge-explores", [Some(2), Some(-5), Some(42)]),
    ("moksha-defends-the-faithless", [Some(-11), Some(-7), Some(18)]),
    ("native-emergency-purchase", [Some(-10), Some(-38), Some(-33)]),
    ("naval-recon", [Some(-5), Some(1), Some(29)]),
    ("naval-recon-2", [Some(9), Some(-39), Some(-17)]),
    ("naval-threat-triage", [Some(-6), Some(-4), Some(14)]),
    ("never-an-empty-queue", [Some(13), Some(-2), Some(-19)]),
    ("never-an-empty-queue-2", [Some(-12), Some(-23), Some(-21)]),
    ("no-free-passage", [Some(-28), Some(11), Some(-2)]),
    ("one-launch-pad", [Some(7), Some(-13), Some(-2)]),
    ("one-shot-recovery", [Some(-16), Some(-7), Some(17)]),
    ("one-war-at-a-time", [Some(17), Some(-1), Some(-1)]),
    ("opening-warrior-recon", [Some(-47), Some(-26), Some(4)]),
    ("opportunistic-war", [Some(0), Some(12), Some(18)]),
    ("order-retry", [Some(-2), Some(-15), Some(-11)]),
    ("overseas-settlement", [Some(8), Some(7), Some(-20)]),
    ("pantheon-board", [Some(16), Some(18), Some(36)]),
    ("pass-picket", [Some(10), Some(2), Some(14)]),
    ("peace-when-the-war-does-not-pay", [Some(-8), Some(19), Some(-27)]),
    ("peacetime-deterrence", [Some(15), Some(27), Some(-37)]),
    ("power-the-laboratory", [Some(-19), Some(7), Some(15)]),
    ("power-the-laboratory-2", [Some(11), Some(20), Some(-23)]),
    ("price-the-suzerainty", [Some(23), Some(2), Some(51)]),
    ("promote-when-wounded", [Some(1), Some(9), Some(1)]),
    ("quest-boost", [Some(6), Some(-5), Some(25)]),
    ("quest-camp-errand", [Some(-8), Some(-16), Some(-16)]),
    ("quest-production", [Some(-6), Some(12), Some(-40)]),
    ("quest-trade-route", [Some(8), Some(8), Some(10)]),
    ("raid-pillage-prizes", [Some(-13), Some(-17), Some(7)]),
    ("rapid-city-expansion", [Some(-171), Some(-60), Some(-118)]),
    ("recon-replacement", [Some(-1), Some(-13), Some(46)]),
    ("recorded-tactical-step", [Some(32), Some(1), Some(45)]),
    ("recovery-reads-the-war", [Some(9), Some(-8), Some(36)]),
    ("relief-column-marches", [Some(15), Some(0), Some(-12)]),
    ("relief-targets-the-siege", [Some(-5), Some(-25), Some(-2)]),
    ("religion-race-is-closed", [Some(-3), Some(-6), Some(37)]),
    ("religion-sues-peace", [Some(-11), Some(-16), Some(17)]),
    ("religious-defence-scales", [Some(-2), Some(-7), Some(23)]),
    ("religious-units-heal-first", [Some(-11), Some(-14), Some(18)]),
    ("religious-veto-defence", [Some(19), Some(-24), Some(-4)]),
    ("research-tier-premium", [Some(-2), Some(-2), Some(-33)]),
    ("rival-suzerainty-alarm", [Some(-11), Some(-2), Some(11)]),
    ("science-building-first", [Some(10), Some(13), Some(25)]),
    ("science-chain-alarm", [Some(10), Some(13), Some(10)]),
    ("science-expansion-phase", [Some(2), Some(25), Some(-22)]),
    ("science-multiplier-payoff", [Some(1), Some(8), Some(5)]),
    ("science-opening-band", [Some(-11), Some(7), Some(40)]),
    ("science-victory-drive", [Some(-13), Some(-4), Some(20)]),
    ("science-victory-drive-2", [Some(33), Some(23), Some(-13)]),
    ("score-horizon", [Some(-15), Some(-17), Some(-32)]),
    ("screen-the-shooters", [Some(5), Some(-9), Some(0)]),
    ("settle-sooner", [Some(9), Some(45), Some(29)]),
    ("settlement-gap-target", [Some(-1), Some(21), Some(-17)]),
    ("settler-backlog-brake", [Some(-14), Some(-14), Some(-12)]),
    ("settler-factory-coordination", [Some(-6), Some(-7), Some(7)]),
    ("settler-guard-holds", [Some(2), Some(1), Some(-16)]),
    ("settler-guard-holds-2", [Some(4), Some(6), Some(13)]),
    ("settler-never-idles", [Some(-14), Some(7), Some(-27)]),
    ("settler-screen", [Some(18), Some(-29), Some(-29)]),
    ("settler-second-look", [Some(26), Some(-23), Some(28)]),
    ("settler-target-hysteresis", [Some(7), Some(11), Some(-5)]),
    ("settler-target-hysteresis-2", [Some(2), Some(5), Some(-1)]),
    ("settler-threat-detour", [Some(-1), Some(14), Some(10)]),
    ("siege-commitment", [Some(-23), Some(9), Some(-21)]),
    ("siege-is-progress-2", [Some(-2), Some(-1), Some(-19)]),
    ("skip-the-prophet-race", [Some(-50), Some(-12), Some(2)]),
    ("slot-kind-tiebreak", [Some(8), Some(21), Some(16)]),
    ("solvency-first-trade-slot", [Some(104), Some(120), Some(108)]),
    ("spaceport-surplus-veto", [Some(12), None, None]),
    ("stranded-settler-discount", [Some(-1), Some(-19), Some(-18)]),
    ("strategic-wonders", [Some(-6), Some(-10), Some(0)]),
    ("strike-opening", [Some(25), Some(-10), Some(-15)]),
    ("surprise-war-mobilization", [Some(-11), Some(-4), Some(18)]),
    ("swap-rotation", [Some(9), Some(-17), Some(-15)]),
    ("threatened-city-reserve", [Some(-10), Some(12), Some(-3)]),
    ("treasury-at-work", [Some(-3), Some(-9), Some(10)]),
    ("treasury-at-work-2", [Some(37), Some(17), Some(29)]),
    ("unchosen-war-keeps-the-lane", [Some(6), Some(-1), Some(1)]),
    ("unit-cost-efficiency", [Some(10), Some(4), Some(-9)]),
    ("unit-objective-memory", [Some(11), Some(11), Some(-5)]),
    ("upgrade-the-garrison", [Some(-13), Some(-7), Some(-33)]),
    ("walls-after-districts", [Some(13), Some(-5), Some(-14)]),
    ("war-economy", [Some(7), Some(23), Some(-1)]),
    ("war-needs-a-treasury", [Some(6), Some(1), Some(-27)]),
    ("war-reinforcement", [Some(-3), Some(1), Some(15)]),
    ("whole-turn-backtrack-guard", [Some(5), Some(1), Some(-3)]),
    ("wide-map-capacity", [Some(14), Some(19), Some(21)]),
    ("wonder-adjacent-sites", [Some(8), Some(5), Some(32)]),
    ("wonder-adjacent-sites-2", [Some(-19), Some(-11), Some(-6)]),
    ("wonder-ring-recon", [Some(-3), Some(-11), Some(5)]),
    ("wonder-score-tally", [Some(-25), Some(-13), Some(1)]),
];
