...
mod tests {
    ...
    fn shipped_ruleset_fingerprint_tracks_the_audited_firaxis_rows() {
        ...
        //
        // Moved again by the ELEVEN remaining `civ6_fidelity` divergences, ten of
        ...
        // zero; `rock_hewn_church` needed `requires_hills`, since every host
        // terrain for it is a `*_HILLS` variant.
        //
        ...
        // that can never be built. The audit therefore stands at 1, not 0, on
        // purpose.
        //
