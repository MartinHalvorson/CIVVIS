...
mod tests {
    use super::{
        ...
        Session, Shared, SpectatorFrame, EMBEDDED_CIV6_UNIT_FLAGS, EMBEDDED_HIDDEN_MAP_MONSTERS,
        EMBEDDED_INDEX, RESULT_COUNTDOWN_MS, SAVE_DIR, STATE_LONG_POLL, VIEWER_ACTIVE,
    };
    use crate::game::{
