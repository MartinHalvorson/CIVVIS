...
const EMBEDDED_CIV6_YIELD_ICONS: &[u8] =
    include_bytes!("../web/assets/civ6-yield-icons.png");
...
mod tests {
    ...
    fn a_civilian_counter_is_the_base_games_rounded_triangle() {
        ...
        assert!(EMBEDDED_INDEX.contains("function strategicUnitCounterHalfWidth(r, dy, civilian) {"));
        assert!(EMBEDDED_INDEX.contains(
    ...
    fn unit_health_bars_only_label_damage() {
        let renderer = EMBEDDED_INDEX
            ...
            .nth(1)
            .and_then(|tail| tail.split("// Civ 6 hangs a small flag off each unit").next())
    ...
    fn browser_tile_yield_signs_are_the_base_games_own_icons() {
        ...
        assert!(EMBEDDED_INDEX
            .contains("CIV6_YIELD_ICON_ATLAS.src = \"/assets/civ6-yield-icons.png\""));
        assert!(EMBEDDED_INDEX.contains(
        ...
        assert!(sign
            .contains("cx.rect(x - r, y + r - r * 2 * fraction, r * 2, r * 2 * fraction);"));
